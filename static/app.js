...
System.register("game/ui/HUD", ["engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/ui/OffScreenMarker"], function (exports_47, context_47) {
    "use strict";
    var Entity_2, point_23, TileComponent_3, TileTransform_6, Tilesets_2, OffScreenMarker_1, HUD;
...
System.register("game/ui/NotificationDisplay", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "engine/tiles/NineSlice", "engine/tiles/TileTransform", "game/graphics/ImageFilters", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_86, context_86) {
    "use strict";
    var component_20, Entity_16, point_47, BasicRenderComponent_7, TextRender_6, NineSlice_5, TileTransform_19, ImageFilters_3, Tilesets_22, Text_7, UIStateManager_9, NotificationDisplay;
        ...
        execute: function () {
            NotificationDisplay = /** @class */ (function (_super) {
                ...
                function NotificationDisplay() {
                    ...
                    _this.offset = new point_47.Point(4, 22);
                ...
                NotificationDisplay.prototype.renderNotification = function (n, index) {
                    var pos = this.offset.plusY(32 * index);
                    var textPixelWidth = n.text.length * Text_7.TEXT_PIXEL_WIDTH;
                    var icon = null;
                    var height = Tilesets_22.TILE_SIZE * 2 - 2;
                    var textPos = pos.plusX(Tilesets_22.TILE_SIZE / 2).plusY(height / 2 - Text_7.TEXT_SIZE / 2 + .5);
                    if (!!n.icon) {
                        var width = 20;
                    ...
                    var backgroundTiles = NineSlice_5.NineSlice.makeStretchedNineSliceComponents(Tilesets_22.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), pos, new point_47.Point(textPixelWidth + Tilesets_22.TILE_SIZE, height));
...
System.register("game/SaveManager", ["game/characters/Player", "game/saves/SaveGame", "game/world/LocationManager", "game/ui/UIStateManager", "game/cutscenes/Camera", "game/ui/HUD", "game/world/WorldTime", "game/world/events/EventQueue"], function (exports_89, context_89) {
    "use strict";
    var Player_7, SaveGame_1, LocationManager_12, UIStateManager_10, Camera_7, HUD_1, WorldTime_6, EventQueue_5, SAVE_KEY, SaveManager, saveManager;
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils", "engine/tiles/TileTransform", "game/world/elements/Elements"], function (exports_90, context_90) {
    "use strict";
    var component_21, Tilesets_24, point_48, NineSlice_6, UIStateManager_11, LocationManager_13, PlaceElementDisplay_1, utils_7, TileTransform_20, Elements_2, PlaceElementFrame;
        ...
        execute: function () {
            ...
            PlaceElementFrame = /** @class */ (function (_super) {
                ...
                PlaceElementFrame.prototype.getTiles = function (suffix) {
                    if (this.dimensions.equals(new point_48.Point(1, 2))) {
                        ...
                        var bottom = Tilesets_24.Tilesets.instance.outdoorTiles.getTileSource("placingElementFrame_1x2_" + suffix + "_bottom")
                            .toComponent(new TileTransform_20.TileTransform(new point_48.Point(0, Tilesets_24.TILE_SIZE)).relativeTo(top_1.transform));
                        return [top_1, bottom];
                    }
                    ...
                    return NineSlice_6.NineSlice.makeNineSliceComponents(Tilesets_24.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_" + suffix), new point_48.Point(0, 0), this.dimensions);
                };
                PlaceElementFrame.prototype.update = function (updateData) {
                    var startPos = updateData.input.mousePos;
                    var tilePt = this.pixelPtToTilePt(startPos.minus(new point_48.Point(this.dimensions.x / 2, this.dimensions.y / 2).times(Tilesets_24.TILE_SIZE)));
            ...
            exports_90("PlaceElementFrame", PlaceElementFrame);
        }
    };
});
System.register("game/ui/PlaceElementDisplay", ["engine/Entity", "engine/component", "game/world/elements/Elements", "game/Controls", "game/world/LocationManager", "game/characters/Player", "game/ui/PlaceElementFrame"], function (exports_91, context_91) {
    "use strict";
    var Entity_17, component_22, Elements_3, Controls_3, LocationManager_14, Player_8, PlaceElementFrame_1, PlaceElementDisplay;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_91("PlaceElementDisplay", PlaceElementDisplay);
        }
    };
});
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "engine/tiles/AnimatedTileComponent", "engine/tiles/NineSlice", "engine/tiles/TileTransform", "game/characters/Player", "game/characters/weapons/WeaponType", "game/Controls", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/items/Items", "game/SaveManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "game/ui/Text", "game/ui/Tooltip", "game/ui/UIStateManager"], function (exports_92, context_92) {
    "use strict";
    var component_23, Entity_18, point_49, BasicRenderComponent_8, TextRender_7, AnimatedTileComponent_4, NineSlice_7, TileTransform_21, Player_9, WeaponType_1, Controls_4, Camera_8, Tilesets_25, Items_3, SaveManager_3, LocationManager_15, PlaceElementDisplay_2, Text_8, Tooltip_3, UIStateManager_12, InventoryDisplay;
        ...
        execute: function () {
            InventoryDisplay = /** @class */ (function (_super) {
                ...
                function InventoryDisplay() {
                    ...
                    _this.coinsOffset = new point_49.Point(0, -18);
                ...
                InventoryDisplay.prototype.spawnBG = function (inv) {
                    ...
                    var bgTiles = NineSlice_7.NineSlice.makeNineSliceComponents(Tilesets_25.Tilesets.instance.oneBit.getNineSlice("invBoxNW"), offset.minus(new point_49.Point(Tilesets_25.TILE_SIZE / 2, Tilesets_25.TILE_SIZE / 2)), new point_49.Point(1 + InventoryDisplay.COLUMNS, 1 + inv.size / InventoryDisplay.COLUMNS));
                ...
                InventoryDisplay.prototype.show = function (onClose, tradingInv) {
                    ...
                    this.tiles = [];
                    var displayDimensions = new point_49.Point(InventoryDisplay.COLUMNS, this.playerInv.size / InventoryDisplay.COLUMNS).times(Tilesets_25.TILE_SIZE);
                    this.offset = new point_49.Point(Math.floor(screenDimensions.x / 2 - displayDimensions.x / 2), Math.floor(screenDimensions.y / 5));
                ...
                InventoryDisplay.prototype.getPositionForInventoryIndex = function (i, inv) {
                    return new point_49.Point(i % InventoryDisplay.COLUMNS, Math.floor(i / InventoryDisplay.COLUMNS)).times(Tilesets_25.TILE_SIZE)
            ...
            exports_92("InventoryDisplay", InventoryDisplay);
        }
    };
});
...
System.register("game/ui/ControlsUI", ["game/ui/KeyPressIndicator", "engine/point", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/ui/Text", "game/ui/UIStateManager"], function (exports_94, context_94) {
    "use strict";
    var KeyPressIndicator_1, point_50, Tilesets_26, TileTransform_22, Text_9, UIStateManager_13, makeControlsUI;
    ...
    return {
        ...
        execute: function () {
            exports_94("makeControlsUI", makeControlsUI = function (dimensions, offset) {
                var topLeft = new point_50.Point(dimensions.x / 2 - Tilesets_26.TILE_SIZE * 4 + 1, dimensions.y / 2 - Tilesets_26.TILE_SIZE * 5).plus(offset);
...
System.register("game/ui/PauseMenu", ["engine/component", "engine/Entity", "game/ui/UIStateManager", "engine/point", "game/ui/ButtonsMenu", "game/SaveManager", "game/cutscenes/CutsceneManager", "game/ui/ControlsUI", "engine/renderer/BasicRenderComponent"], function (exports_95, context_95) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_95("PauseMenu", PauseMenu);
        }
    };
});
System.register("game/ui/UIStateManager", ["game/ui/HUD", "game/characters/Player", "game/ui/InventoryDisplay", "game/ui/DialogueDisplay", "game/ui/PlaceElementDisplay", "game/ui/PauseMenu", "game/ui/CraftingMenu", "game/ui/SellMenu", "game/ui/NotificationDisplay"], function (exports_96, context_96) {
    "use strict";
    var HUD_2, Player_10, InventoryDisplay_1, DialogueDisplay_4, PlaceElementDisplay_3, PauseMenu_1, CraftingMenu_2, SellMenu_2, NotificationDisplay_2, UIStateManager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_96("UIStateManager", UIStateManager);
        }
    };
});
System.register("game/ui/KeyPressIndicator", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/renderer/TextRender", "game/Controls", "game/ui/Text", "game/ui/UIStateManager"], function (exports_97, context_97) {
    "use strict";
    var component_25, Tilesets_27, TileTransform_23, point_52, TextRender_8, Controls_5, Text_10, UIStateManager_15, KeyPressIndicator;
        ...
        execute: function () {
            KeyPressIndicator = /** @class */ (function (_super) {
                ...
                KeyPressIndicator.prototype.getRenderMethods = function () {
                    return [
                        Tilesets_27.Tilesets.instance.oneBit.getTileSource("keycap").toImageRender(new TileTransform_23.TileTransform(this.pos, null, 0, false, false, UIStateManager_15.UIStateManager.UI_SPRITE_DEPTH)),
                        new TextRender_8.TextRender(Controls_5.Controls.keyString(this.key).toLowerCase(), this.pos.plus(new point_52.Point(4, 4)), Text_10.TEXT_SIZE, Text_10.TEXT_FONT, "#222222" /* BLACK */, UIStateManager_15.UIStateManager.UI_SPRITE_DEPTH)
                    ];
                };
                return KeyPressIndicator;
            }(component_25.Component));
            exports_97("KeyPressIndicator", KeyPressIndicator);
        }
    };
});
System.register("game/world/elements/Interactable", ["engine/component", "engine/point", "game/ui/KeyPressIndicator", "game/Controls", "game/graphics/Tilesets", "game/ui/UIStateManager"], function (exports_98, context_98) {
    "use strict";
    var component_26, point_53, KeyPressIndicator_2, Controls_6, Tilesets_28, UIStateManager_16, Interactable;
        ...
        execute: function () {
            Interactable = /** @class */ (function (_super) {
                ...
                Interactable.prototype.getRenderMethods = function () {
                    ...
                    return new KeyPressIndicator_2.KeyPressIndicator(this.position.minus(new point_53.Point(Tilesets_28.TILE_SIZE / 2, Tilesets_28.TILE_SIZE / 2)).plus(this.uiOffset), Controls_6.Controls.interactButton).getRenderMethods();
                };
                return Interactable;
            }(component_26.Component));
            exports_98("Interactable", Interactable);
        }
    };
});
System.register("game/world/Teleporter", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/elements/ElementComponent", "game/world/elements/Interactable", "game/world/elements/ElementFactory"], function (exports_99, context_99) {
    "use strict";
    var component_27, Entity_21, point_54, TileTransform_24, Tilesets_29, ElementComponent_3, Interactable_3, ElementFactory_3, Teleporters, TeleporterFactory;
    ...
    return {
        ...
        execute: function () {
            exports_99("Teleporters", Teleporters = {
            ...
            TeleporterFactory = /** @class */ (function (_super) {
                ...
                TeleporterFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactPos = point_54.Point.fromString(i);
                    var id = data["id"];
                    var interactComponent = e.addComponent(new Interactable_3.Interactable(interactPos, function () { return wl.useTeleporter(destinationUUID, id); }, new point_54.Point(0, Tilesets_29.TILE_SIZE / 2)));
            ...
            exports_99("TeleporterFactory", TeleporterFactory);
        }
    };
});
System.register("game/world/elements/Chest", ["engine/collision/BoxCollider", "engine/Entity", "engine/point", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileSetAnimation", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/items/Inventory", "game/ui/InventoryDisplay", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/Interactable"], function (exports_100, context_100) {
    "use strict";
    var BoxCollider_3, Entity_22, point_55, AnimatedTileComponent_5, TileSetAnimation_5, TileTransform_25, Tilesets_30, Inventory_2, InventoryDisplay_2, ElementComponent_4, ElementFactory_4, Interactable_4, INVENTORY, ChestFactory;
        ...
        execute: function () {
            ...
            ChestFactory = /** @class */ (function (_super) {
                ...
                ChestFactory.prototype.make = function (wl, pos, data) {
                    ...
                    }, new point_55.Point(0, -17));
                    var collider = new BoxCollider_3.BoxCollider(pos.times(Tilesets_30.TILE_SIZE).plusY(9), new point_55.Point(Tilesets_30.TILE_SIZE, 7));
            ...
            exports_100("ChestFactory", ChestFactory);
        }
    };
});
System.register("game/world/elements/Hittable", ["engine/component", "engine/util/Animator"], function (exports_101, context_101) {
    "use strict";
    var component_28, Animator_2, Hittable;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_101("Hittable", Hittable);
        }
    };
});
System.register("game/world/elements/Mushroom", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/characters/DudeFactory", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/Hittable"], function (exports_102, context_102) {
    "use strict";
    var component_29, Entity_23, point_56, TileComponent_6, TileTransform_26, DudeFactory_3, Tilesets_31, Items_4, LocationManager_16, TimeUnit_5, WorldTime_7, ElementComponent_5, ElementFactory_5, Hittable_1, NEXT_GROWTH_TIME, MushroomFactory, GrowableShroom;
        ...
        execute: function () {
            ...
            MushroomFactory = /** @class */ (function (_super) {
                ...
                MushroomFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var randomOffset = new point_56.Point(0, -4).randomlyShifted(3, 3);
                    ...
                    var hittableCenter = pos.times(Tilesets_31.TILE_SIZE).plus(new point_56.Point(Tilesets_31.TILE_SIZE / 2, Tilesets_31.TILE_SIZE / 2));
            ...
            exports_102("MushroomFactory", MushroomFactory);
...
System.register("game/world/elements/HittableResource", ["engine/collision/BoxCollider", "engine/point", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/elements/ElementComponent", "game/world/elements/Hittable"], function (exports_103, context_103) {
    "use strict";
    var BoxCollider_4, point_57, Tilesets_32, Items_5, LocationManager_17, ElementComponent_6, Hittable_2, HittableResource;
    ...
    return {
        ...
        execute: function () {
                ...
                HittableResource.prototype.hitCallback = function (hitDir) {
                    ...
                    for (var i = 0; i < itemsOut; i++) {
                        ...
                        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                            ...
                            Items_5.spawnItem(this.position.plus(new point_57.Point(0, Tilesets_32.TILE_SIZE / 2)).plus(itemDirection.times(placeDistance)), // bottom center, then randomly adjusted
            ...
            exports_103("HittableResource", HittableResource);
        }
    };
});
System.register("game/world/elements/Rock", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/ElementComponent", "game/world/elements/HittableResource", "game/characters/Player", "game/characters/weapons/WeaponType", "game/world/elements/ElementFactory"], function (exports_104, context_104) {
    "use strict";
    var point_58, Tilesets_33, BoxCollider_5, TileComponent_7, TileTransform_27, Entity_24, ElementComponent_7, HittableResource_1, Player_11, WeaponType_2, ElementFactory_6, RockFactory;
        ...
        execute: function () {
            RockFactory = /** @class */ (function (_super) {
                ...
                RockFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var hitboxDims = new point_58.Point(12, 4);
                    e.addComponent(new BoxCollider_5.BoxCollider(pos.plus(new point_58.Point(.5, 1)).times(Tilesets_33.TILE_SIZE).minus(new point_58.Point(hitboxDims.x / 2, hitboxDims.y + 2)), hitboxDims));
                    var hittableResource = e.addComponent(new HittableResource_1.HittableResource(pos.plus(new point_58.Point(.5, .5)).times(Tilesets_33.TILE_SIZE), [tile.transform], availableResources, maxResourcesCount, function () {
            ...
            exports_104("RockFactory", RockFactory);
        }
    };
});
System.register("game/world/interior/AsciiInteriorBuilder", ["engine/point"], function (exports_105, context_105) {
    "use strict";
    var point_59, AsciiInteriorBuilder;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_105("AsciiInteriorBuilder", AsciiInteriorBuilder);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/WorldLocation", "game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_106, context_106) {
    "use strict";
    var WorldLocation_2, LocationManager_18, point_60, Tilesets_34, NineSlice_8, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_106("makeTentInterior", makeTentInterior = function (outside, color) {
                ...
                var interactablePos = new point_60.Point(2.5, 4).times(Tilesets_34.TILE_SIZE);
                var teleporter = { to: outside.uuid, pos: interactablePos.plusY(-4) };
                l.addTeleporter(teleporter);
                l.addElement(5 /* TELEPORTER */, new point_60.Point(2, 4), { to: outside.uuid, i: interactablePos.toString() });
                var groundType = color + "tentInterior";
                NineSlice_8.NineSlice.nineSliceForEach(new point_60.Point(5, 4), function (pt, index) { return l.addGroundElement(1 /* BASIC_NINE_SLICE */, pt, { k: groundType, i: index }); });
...
System.register("game/world/elements/Tent", ["engine/collision/BoxCollider", "engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/interior/Tent", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/ElementUtils", "game/world/elements/Interactable"], function (exports_107, context_107) {
    "use strict";
    var BoxCollider_6, Entity_25, point_61, TileComponent_8, TileTransform_28, Tilesets_35, Tent_1, ElementComponent_8, ElementFactory_7, ElementUtils_3, Interactable_5, TentFactory, addTile;
        ...
        execute: function () {
            ...
            TentFactory = /** @class */ (function (_super) {
                ...
                function TentFactory() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.type = 3 /* TENT */;
                    _this.dimensions = new point_61.Point(4, 3);
                    return _this;
                }
                TentFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactablePos = pos.plus(new point_61.Point(2, 2)).times(Tilesets_35.TILE_SIZE);
                    ...
                    addTile(e, color + "tentNE", pos.plus(new point_61.Point(2, 0)), depth);
                    addTile(e, color + "tentSW", pos.plus(new point_61.Point(1, 1)), depth);
                    addTile(e, color + "tentSE", pos.plus(new point_61.Point(2, 1)), depth);
                    e.addComponent(new BoxCollider_6.BoxCollider(pos.plus(new point_61.Point(1, 1)).times(Tilesets_35.TILE_SIZE), new point_61.Point(Tilesets_35.TILE_SIZE * 2, Tilesets_35.TILE_SIZE)));
                    // Set up teleporter
                    e.addComponent(new Interactable_5.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_61.Point(1, -Tilesets_35.TILE_SIZE * 1.4)));
                    return e.addComponent(new ElementComponent_8.ElementComponent(3 /* TENT */, pos, ElementUtils_3.ElementUtils.rectPoints(pos.plus(new point_61.Point(1, 1)), new point_61.Point(2, 1)), function () { return { destinationUUID: destinationUUID, color: color }; }));
                };
                return TentFactory;
            }(ElementFactory_7.ElementFactory));
            exports_107("TentFactory", TentFactory);
...
System.register("game/world/elements/Tree", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/HittableResource", "game/world/elements/ElementComponent", "game/characters/weapons/WeaponType", "game/characters/Player", "game/world/elements/ElementFactory", "engine/component", "game/world/WorldTime", "game/world/TimeUnit", "game/world/LocationManager"], function (exports_108, context_108) {
    "use strict";
    var point_62, Tilesets_36, BoxCollider_7, TileComponent_9, TileTransform_29, Entity_26, HittableResource_2, ElementComponent_9, WeaponType_3, Player_12, ElementFactory_8, component_30, WorldTime_8, TimeUnit_6, LocationManager_19, NEXT_GROWTH_TIME, SIZE, AVAILABLE_RESOURCES, TreeFactory, GrowableTree;
        ...
        execute: function () {
            ...
            TreeFactory = /** @class */ (function (_super) {
                ...
                function TreeFactory(type) {
                    var _this = _super.call(this) || this;
                    _this.dimensions = new point_62.Point(1, 2);
                    _this.type = type;
                    return _this;
                }
                TreeFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var randomOffset = new point_62.Point(0, -4).randomlyShifted(2, 4);
                    ...
                    var tiles;
                    if (size === 3) {
                        tiles = [addTile(prefix + "Top", pos), addTile(prefix + "Base", pos.plus(new point_62.Point(0, 1)))];
                    }
                    else {
                        tiles = [addTile("" + prefix + ["Sapling", "Small"][size - 1], pos.plus(new point_62.Point(0, 1)))];
                    }
                    var hitboxDims = new point_62.Point(8, 3);
                    e.addComponent(new BoxCollider_7.BoxCollider(pos.plus(new point_62.Point(.5, 2)).times(Tilesets_36.TILE_SIZE).minus(new point_62.Point(hitboxDims.x / 2, hitboxDims.y)).plus(randomOffset), hitboxDims));
                    var saplingType = this.type === 0 /* TREE_ROUND */ ? 7 /* ROUND_SAPLING */ : 8 /* POINTY_SAPLING */;
                    var hittableCenter = pos.times(Tilesets_36.TILE_SIZE).plus(new point_62.Point(Tilesets_36.TILE_SIZE / 2, Tilesets_36.TILE_SIZE + Tilesets_36.TILE_SIZE / 2)).plus(randomOffset); // center of bottom tile
            ...
            exports_108("TreeFactory", TreeFactory);
...
System.register("game/world/elements/Elements", ["game/world/Teleporter", "game/world/elements/Campfire", "game/world/elements/Chest", "game/world/elements/House", "game/world/elements/Mushroom", "game/world/elements/Rock", "game/world/elements/Tent", "game/world/elements/Tree"], function (exports_109, context_109) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_109("SavedElement", SavedElement);
            ...
            exports_109("Elements", Elements);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/util/Grid", "engine/util/Lists", "engine/util/Noise", "game/graphics/Tilesets", "game/world/LocationManager", "game/world/WorldLocation"], function (exports_110, context_110) {
    "use strict";
    var point_63, Grid_4, Lists_5, Noise_1, Tilesets_37, LocationManager_20, WorldLocation_3, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    ...
                    this.tentPos = new point_63.Point(-3, -3);
                ...
                MapGenerator.prototype.spawnTreesAtEdge = function () {
                    ...
                    for (var x = -MapGenerator.MAP_SIZE / 2; x < MapGenerator.MAP_SIZE / 2; x++) {
                        for (var y = -MapGenerator.MAP_SIZE / 2; y < MapGenerator.MAP_SIZE / 2; y++) {
                            var distToCenter = new point_63.Point(x, y).distanceTo(point_63.Point.ZERO);
                            var pt = new point_63.Point(x, y);
                ...
                MapGenerator.prototype.spawnTrees = function () {
                    ...
                    for (var i = 0; i < trees; i++) {
                        var pt = new point_63.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE - 1)) - MapGenerator.MAP_SIZE / 2);
                        this.spawnTree(pt);
                    }
                };
                ...
                MapGenerator.prototype.clearPathToCenter = function () {
                    ...
                    for (var x = MapGenerator.MAP_SIZE / 2 - 11; x < MapGenerator.MAP_SIZE / 2 + 10; x++) {
                        for (var y = MapGenerator.MAP_SIZE / 2 - 25; y < MapGenerator.MAP_SIZE / 2 - 23; y++) {
                            var element = this.location.getElement(new point_63.Point(x, y));
                    ...
                    // clear around tent
                    var clearingCorner = this.tentPos.minus(new point_63.Point(1, 0));
                    for (var x = 0; x < 6; x++) {
                        for (var y = 0; y < 4; y++) {
                            var element = this.location.getElement(clearingCorner.plus(new point_63.Point(x, y)));
                            if (!!element && typesToClear.indexOf(element.type) !== -1) {
                                this.location.removeElement(element);
                            }
                        }
                ...
                MapGenerator.prototype.spawnRocks = function () {
                    ...
                    while (placedRocks < 20) {
                        var p = new point_63.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE)) - MapGenerator.MAP_SIZE / 2);
                ...
                MapGenerator.prototype.noise = function () {
                    ...
                    for (var i = -MapGenerator.MAP_SIZE / 2; i < MapGenerator.MAP_SIZE / 2; i++) {
                        for (var j = -MapGenerator.MAP_SIZE / 2; j < MapGenerator.MAP_SIZE / 2; j++) {
                            ...
                            str += v;
                            grid.set(new point_63.Point(j, i), v);
                        }
                        str += "\n";
                    }
                    console.log(str);
                ...
                MapGenerator.ENTER_LAND_POS = new point_63.Point(1, 1).times(MapGenerator.MAP_SIZE / 2 * Tilesets_37.TILE_SIZE).plusY(-Tilesets_37.TILE_SIZE * 25).plusX(Tilesets_37.TILE_SIZE * 2);
                return MapGenerator;
            }());
            exports_110("MapGenerator", MapGenerator);
        }
    };
});
System.register("game/cutscenes/Camera", ["engine/point", "game/world/MapGenerator", "game/graphics/Tilesets"], function (exports_111, context_111) {
    "use strict";
    var point_64, MapGenerator_5, Tilesets_38, Camera;
    ...
    return {
        ...
        execute: function () {
            Camera = /** @class */ (function () {
                function Camera() {
                    this.shakeOffset = point_64.Point.ZERO;
                ...
                Camera.prototype.getUpdatedPosition = function (dimensions, elapsedTimeMillis) {
                    ...
                    var clampedTrackedPoint = new point_64.Point(this.clamp(trackedPoint.x, -xLimit, xLimit), this.clamp(trackedPoint.y, -yLimit, yLimit));
                    ...
                    if (this.shakeDuration > 0) {
                        ...
                        this.shakeOffset = new point_64.Point(Math.random() - .5, Math.random() - .5).times(this.shakePower);
                    }
            ...
            exports_111("Camera", Camera);
        }
    };
});
System.register("game/world/TownStats", ["game/SaveManager"], function (exports_112, context_112) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_112("TownStats", TownStats);
        }
    };
});
System.register("game/characters/Player", ["engine/component", "engine/debug", "engine/point", "engine/util/Lists", "game/Controls", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/ui/NotificationDisplay", "game/ui/UIStateManager", "game/world/elements/Interactable", "game/world/LocationManager", "game/characters/Dude", "game/characters/DudeFactory"], function (exports_113, context_113) {
    "use strict";
    var component_31, debug_3, point_65, Lists_6, Controls_7, Camera_9, Tilesets_39, NotificationDisplay_3, UIStateManager_17, Interactable_6, LocationManager_21, Dude_2, DudeFactory_4, Player;
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    var dx = 0;
                    var dy = 0;
                    if (!UIStateManager_17.UIStateManager.instance.isMenuOpen) {
                    ...
                    this.dude.move(updateData, new point_65.Point(dx, dy), this.dude.rolling() ? 0 : updateData.input.mousePos.x - this.dude.standingPosition.x, 1 + (this.dude.rolling() ? 1.2 : 0));
                    ...
                    if (debug_3.debug.enableDevControls) {
                        ...
                        if (updateData.input.isKeyDown(222 /* QUOTE */)) {
                            var expirationTime_2 = Date.now() + 5000;
                            NotificationDisplay_3.NotificationDisplay.instance.push({
                                text: "ORC ATTACK!",
                                icon: "sword",
                                isExpired: function () { return Date.now() > expirationTime_2; }
                            });
                        }
            ...
            exports_113("Player", Player);
        }
    };
});
System.register("game/characters/Enemy", ["engine/component", "game/graphics/Tilesets", "game/world/OutdoorDarknessMask", "game/characters/Dude", "game/characters/NPC"], function (exports_114, context_114) {
    "use strict";
    var component_32, Tilesets_40, OutdoorDarknessMask_3, Dude_3, NPC_3, Enemy;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_114("Enemy", Enemy);
        }
    };
});
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_115, context_115) {
    "use strict";
    var component_33, Player_13, Dude_4, point_66, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_66.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_66.Point.ZERO;
                };
            ...
            exports_115("CutscenePlayerController", CutscenePlayerController);
        }
    };
});
System.register("game/characters/ShroomNPC", ["engine/component", "game/graphics/Tilesets", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/characters/Dude", "game/characters/DudeFactory", "game/characters/Enemy", "game/characters/weapons/WeaponType"], function (exports_116, context_116) {
    "use strict";
    var component_34, Tilesets_41, LocationManager_22, TimeUnit_7, WorldTime_9, Dude_5, DudeFactory_5, Enemy_1, WeaponType_4, SIZE, NEXT_GROWTH_TIME, ShroomNPC;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_116("ShroomNPC", ShroomNPC);
        }
    };
});
System.register("game/characters/Centaur", ["engine/component", "game/characters/dialogues/GenericDialogue", "game/characters/Dude", "game/characters/NPC"], function (exports_117, context_117) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_117("Centaur", Centaur);
        }
    };
});
System.register("game/characters/Villager", ["engine/component", "game/characters/Dude", "game/characters/NPC", "game/world/OutdoorDarknessMask", "game/characters/ShroomNPC", "game/characters/Centaur"], function (exports_118, context_118) {
    "use strict";
    var component_36, Dude_7, NPC_5, OutdoorDarknessMask_4, ShroomNPC_1, Centaur_1, Villager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_118("Villager", Villager);
        }
    };
});
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/characters/Dialogue", "game/cutscenes/CutscenePlayerController", "game/characters/Villager", "game/characters/NPCSchedule", "engine/util/Lists", "game/characters/weapons/WeaponType", "game/characters/dialogues/BertoIntro", "game/characters/ShroomNPC", "game/saves/uuid", "game/characters/Centaur"], function (exports_119, context_119) {
    "use strict";
    var Entity_27, point_67, Player_14, Dude_8, NPC_6, LocationManager_23, Enemy_2, Inventory_3, Dialogue_6, CutscenePlayerController_1, Villager_1, NPCSchedule_3, Lists_7, WeaponType_5, BertoIntro_2, ShroomNPC_2, uuid_2, Centaur_2, DudeFactory;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.load = function (saveState, location) {
                    this.make(saveState.type, point_67.Point.fromString(saveState.pos), saveState, location);
                };
                    ...
                    switch (type) {
                        ...
                        case 1 /* DIP */: {
                            ...
                            additionalComponents = [
                                new NPC_6.NPC(NPCSchedule_3.NPCSchedules.newGoToSchedule(new point_67.Point(0, 0))),
                        ...
                        case 4 /* HERALD */: {
                            ...
                            additionalComponents = [
                                ...
                                Lists_7.Lists.oneOf([new point_67.Point(-3, 0), new point_67.Point(-3, 1), new point_67.Point(-2, 0), new point_67.Point(-2, 1)].filter(function (pt) { return !location.isOccupied(pt); })))),
                                new Villager_1.Villager()
                            ];
            ...
            exports_119("DudeFactory", DudeFactory);
        }
    };
});
System.register("game/saves/DudeSaveState", [], function (exports_120, context_120) {
    "use strict";
    var DudeSaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_120("DudeSaveState", DudeSaveState);
        }
    };
});
System.register("game/saves/LocationSaveState", [], function (exports_121, context_121) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_121("LocationSaveState", LocationSaveState);
        }
    };
});
System.register("game/saves/LocationManagerSaveState", [], function (exports_122, context_122) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_122("LocationManagerSaveState", LocationManagerSaveState);
        }
    };
});
System.register("game/world/LocationManager", ["game/world/WorldLocation"], function (exports_123, context_123) {
    "use strict";
...
System.register("game/items/DroppedItem", ["engine/collision/BoxCollider", "engine/component", "engine/point", "game/characters/Player", "game/world/LocationManager", "game/items/Items", "game/SaveManager"], function (exports_124, context_124) {
    "use strict";
    var BoxCollider_8, component_37, point_68, Player_15, LocationManager_24, Items_6, SaveManager_7, DroppedItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_124("DroppedItem", DroppedItem);
        }
    };
});
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point", "game/characters/weapons/WeaponType", "game/characters/Player"], function (exports_125, context_125) {
    "use strict";
    var _a, Tilesets_42, Entity_28, LocationManager_25, DroppedItem_1, point_69, WeaponType_6, Player_16, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_125("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_125("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
             ...
             * @param position The bottom center where the item should be placed
             */
            exports_125("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_69.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_126, context_126) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_126("ItemStack", ItemStack);
            ...
            exports_126("Inventory", Inventory);
        }
    };
});
System.register("game/characters/DudeAnimationUtils", ["game/graphics/ImageFilters", "game/graphics/Tilesets", "game/SaveManager"], function (exports_127, context_127) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_127("DudeAnimationUtils", DudeAnimationUtils = {
...
System.register("game/characters/weapons/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_128, context_128) {
    "use strict";
    var component_38, TileComponent_10, Tilesets_44, TileTransform_30, point_70, Dude_9, State, Shield;
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                Shield.prototype.update = function (updateData) {
                    ...
                    var pos = this.dude.animation.transform.dimensions.minus(new point_70.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_70.Point(-6, -1));
                    }
                    else if (this.state === State.DRAWN) {
                        pos = pos.plus(new point_70.Point(5, 4).times(this.raisedPerc < .7 ? this.raisedPerc : 1.4 - this.raisedPerc).apply(Math.floor));
            ...
            exports_128("Shield", Shield);
        }
    };
});
System.register("game/characters/weapons/Weapon", ["engine/component", "game/world/LocationManager", "game/characters/Dude", "game/world/elements/Hittable", "engine/point"], function (exports_129, context_129) {
    "use strict";
    var component_39, LocationManager_26, Dude_10, Hittable_3, point_71, Weapon;
        ...
        execute: function () {
            Weapon = /** @class */ (function (_super) {
                ...
                Weapon.hitResources = function (dude) {
                    var interactDistance = 20;
                    var interactCenter = dude.standingPosition.minus(new point_71.Point(0, 7));
            ...
            exports_129("Weapon", Weapon);
        }
    };
});
System.register("game/characters/weapons/UnarmedWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType"], function (exports_130, context_130) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_130("UnarmedWeapon", UnarmedWeapon);
        }
    };
});
System.register("game/characters/weapons/MeleeWeapon", ["game/characters/weapons/Weapon", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator"], function (exports_131, context_131) {
    "use strict";
    var Weapon_2, TileTransform_31, point_72, Tilesets_45, Animator_3, State, MeleeWeapon;
            ...
            MeleeWeapon = /** @class */ (function (_super) {
                ...
                function MeleeWeapon(weaponType, weaponId, offsetFromCenter) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.weaponTransform = new TileTransform_31.TileTransform(point_72.Point.ZERO, _this.weaponSprite.dimensions).relativeTo(_this.dude.animation.transform);
                ...
                MeleeWeapon.prototype.animate = function () {
                    var _a;
                    var offsetFromEdge = new point_72.Point(this.dude.animation.transform.dimensions.x / 2 - this.weaponTransform.dimensions.x / 2, this.dude.animation.transform.dimensions.y - this.weaponTransform.dimensions.y).plus(this.offsetFromCenter);
                    var pos = new point_72.Point(0, 0);
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                        pos = offsetFromEdge;
                    }
                        ...
                        // center on back
                        pos = offsetFromEdge.plus(new point_72.Point(3, -1));
                    }
                    ...
                    this.slashSprite.transform.position = this.dude.animation.transform.position.plus(new point_72.Point((this.weaponTransform.mirrorX ? -1 : 1) * (this.weaponTransform.dimensions.y - 10), 8));
                };
                ...
                MeleeWeapon.prototype.getAttackAnimationPosition = function () {
                    ...
                    if (this.currentAnimationFrame < swingStartFrame) {
                        return [new point_72.Point(this.currentAnimationFrame * 3, 0), 0];
                    }
                    else if (this.currentAnimationFrame < resettingFrame) {
                        return [
                            new point_72.Point((6 - this.currentAnimationFrame) + this.weaponTransform.dimensions.y - swingStartFrame * 3, Math.floor(this.weaponTransform.dimensions.y / 2 - 1)),
                            90
                        ];
                    }
                    else {
                        return [new point_72.Point((1 - this.currentAnimationFrame + resettingFrame) * 3, 2), 0];
                    }
                };
                return MeleeWeapon;
            }(Weapon_2.Weapon));
            exports_131("MeleeWeapon", MeleeWeapon);
        }
    };
});
System.register("game/characters/weapons/Projectile", ["engine/collision/BoxCollider", "engine/component", "engine/Entity", "engine/point", "game/world/LocationManager", "game/items/DroppedItem", "engine/util/Lists"], function (exports_132, context_132) {
    "use strict";
    var BoxCollider_9, component_40, Entity_29, point_73, LocationManager_27, DroppedItem_2, Lists_8, Projectile, spawnProjectile;
    ...
    return {
        ...
        execute: function () {
            Projectile = /** @class */ (function (_super) {
                ...
                function Projectile(position, sprite, item, velocity, attacker) {
                    ...
                    _this.start = function () {
                        ...
                        var pos = position.minus(new point_73.Point(_this.tile.transform.dimensions.x / 2, _this.tile.transform.dimensions.y));
                        _this.tile.transform.position = pos;
                        _this.tile.transform.rotation = velocity.x > 0 ? 90 : -90;
                        _this.tile.transform.mirrorX = velocity.x > 0;
                        var colliderSize = new point_73.Point(8, 8);
                        var sourceCollider = attacker.entity.getComponent(BoxCollider_9.BoxCollider);
                        _this.collider = _this.entity.addComponent(new BoxCollider_9.BoxCollider(pos.plus(new point_73.Point(10, 10)), colliderSize, DroppedItem_2.DroppedItem.COLLISION_LAYER, !!sourceCollider ? [sourceCollider] : []));
                        _this.reposition();
                        var last = new Date().getTime();
                        var move = function () {
                            if (!_this.enabled) {
                            ...
                            if (diff > 0) {
                                if (_this.reposition(velocity)) {
                                    ...
                                    if (!!enemy) {
                                        ...
                                        _this.tile.transform.position = new point_73.Point(_this.tile.transform.dimensions.y - 10, relativeOffset.y);
                ...
                Projectile.prototype.reposition = function (delta) {
                    if (delta === void 0) { delta = new point_73.Point(0, 0); }
                    var colliderOffset = this.collider.position.minus(this.tile.transform.position);
            ...
            exports_132("spawnProjectile", spawnProjectile = function (pos, sprite, item, velocity, attacker) {
...
System.register("game/characters/weapons/SpearWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator", "game/characters/weapons/Projectile"], function (exports_133, context_133) {
    "use strict";
    var Weapon_3, WeaponType_8, TileTransform_32, point_74, Tilesets_46, Animator_4, Projectile_1, State, SpearWeapon;
            ...
            SpearWeapon = /** @class */ (function (_super) {
                ...
                function SpearWeapon() {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.weaponTransform = new TileTransform_32.TileTransform(point_74.Point.ZERO, _this.weaponSprite.dimensions).relativeTo(_this.dude.animation.transform);
                        _this.offsetFromCenter = new point_74.Point(-5, 0);
                        _this._range = _this.weaponSprite.dimensions.y;
                    };
                    return _this;
                }
                ...
                SpearWeapon.prototype.cancelAttack = function () {
                    ...
                    if (this.timeDrawn > timeToThrow) {
                        ...
                        Projectile_1.spawnProjectile(newTransform.position.plusY(24), this.weaponSprite, 100021 /* SPEAR */, new point_74.Point(40 * this.dude.facingMultipler(), 4.5), this.dude);
                    }
                    else {
                        this.state = State.ATTACKING;
                        setTimeout(function () { return _this.damageEnemies(); }, 100);
                ...
                SpearWeapon.prototype.getBasePosition = function (rotation) {
                    var offset = new point_74.Point(this.dude.animation.transform.dimensions.x / 2 - this.weaponTransform.dimensions.x / 2, this.dude.animation.transform.dimensions.y - this.weaponTransform.dimensions.y).plus(this.offsetFromCenter);
                    if (rotation === 90) {
                        offset = offset.plus(new point_74.Point(10, 10));
                    }
                    return offset.plus(this.dude.getAnimationOffsetPosition());
                };
                SpearWeapon.prototype.animate = function () {
                    var drawSpeed = 100;
                    var pos = point_74.Point.ZERO;
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                ...
                SpearWeapon.prototype.getAttackAnimationPosition = function () {
                    if (this.currentAnimationFrame >= this.frameCount - 1) {
                        return [new point_74.Point(2, 0), 90];
                    }
                    else {
                        var x = [8, 14, 16, 12, 8][this.currentAnimationFrame];
                        return [new point_74.Point(x, 0), 90];
                    }
                };
                return SpearWeapon;
            }(Weapon_3.Weapon));
            exports_133("SpearWeapon", SpearWeapon);
        }
    };
});
System.register("game/characters/weapons/WeaponFactory", ["game/characters/weapons/WeaponType", "game/characters/weapons/UnarmedWeapon", "game/characters/weapons/MeleeWeapon", "engine/point", "game/characters/weapons/SpearWeapon"], function (exports_134, context_134) {
    "use strict";
    var WeaponType_9, UnarmedWeapon_1, MeleeWeapon_1, point_75, SpearWeapon_1, WeaponFactory;
    ...
    return {
        ...
        execute: function () {
            exports_134("WeaponFactory", WeaponFactory = {
                ...
                make: function (type) {
                    switch (type) {
                        ...
                        case WeaponType_9.WeaponType.SWORD:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_9.WeaponType.SWORD, "weapon_regular_sword", new point_75.Point(-6, -2));
                        case WeaponType_9.WeaponType.CLUB:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_9.WeaponType.CLUB, "weapon_baton_with_spikes", new point_75.Point(-6, -2));
                        case WeaponType_9.WeaponType.PICKAXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_9.WeaponType.PICKAXE, "weapon_pickaxe", new point_75.Point(-5, -2));
                        case WeaponType_9.WeaponType.AXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_9.WeaponType.AXE, "weapon_axe", new point_75.Point(-3, -1));
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(uuid, type, factions, characterAnimName, position, weaponType, shieldId, maxHealth, health, speed, inventory, dialogue, blob) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_76.Point(3, 15);
                    ...
                    _this.awake = function () {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_6.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_33.TileTransform(new point_76.Point(0, 28 - height))));
                        ...
                        var colliderSize = new point_76.Point(10, 8);
                        _this.relativeColliderPos = new point_76.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_7.Interactable(new point_76.Point(0, 0), function () { return DialogueDisplay_5.DialogueDisplay.instance.startDialogue(_this); }, point_76.Point.ZERO, function () { var _a; return !UIStateManager_18.UIStateManager.instance.isMenuOpen && !!_this.dialogue && ((_a = _this.entity.getComponent(NPC_7.NPC)) === null || _a === void 0 ? void 0 : _a.canTalk()); }));
                    };
                    return _this;
                }
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_76.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: false,
                    configurable: true
                });
                ...
                Dude.prototype.update = function (updateData) {
                    ...
                    if (!!this.dialogueInteract) {
                        this.dialogueInteract.position = this.standingPosition.minus(new point_76.Point(0, 5));
                        this.dialogueInteract.uiOffset = new point_76.Point(0, -Tilesets_47.TILE_SIZE * 1.5).plus(this.getAnimationOffsetPosition());
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_76.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_76.Point(0, 5)));
                    this.deathOffset = this.animation.transform.position.minus(prePos);
                    this.animation.goToAnimation(0);
                    this.animation.pause();
                    setTimeout(function () { return Items_8.spawnItem(_this.standingPosition.minus(new point_76.Point(0, 2)), _this.droppedItemSupplier()); }, 100);
                    this.dropWeapon();
                ...
                Dude.prototype.roll = function () {
                    ...
                    var setRotation = function (rot, offset) {
                        if (_this.animation.transform.mirrorX) {
                            ...
                            _this.rollingOffset = new point_76.Point(-offset.x, offset.y);
                        }
                        else {
                            _this.animation.transform.rotation = rot;
                    ...
                    this.isRolling = true;
                    this.canRoll = false;
                    setRotation(90, new point_76.Point(6, 8));
                    setTimeout(function () { return setRotation(180, new point_76.Point(0, 14)); }, speed);
                    setTimeout(function () { return setRotation(270, new point_76.Point(-6, 8)); }, speed * 2);
                    setTimeout(function () {
                        setRotation(0, point_76.Point.ZERO);
                        _this.isRolling = false;
                    }, speed * 3);
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    return new point_76.Point(0, arr[f]);
                };
                ...
                Dude.prototype.getIndicator = function () {
                    ...
                    if (!tile || ((_a = this.dialogueInteract) === null || _a === void 0 ? void 0 : _a.isShowingUI) || DialogueDisplay_5.DialogueDisplay.instance.dialogueSource === this) {
                        ...
                        return [tile.toImageRender(new TileTransform_33.TileTransform(this.standingPosition.plusY(-28).plus(new point_76.Point(1, 1).times(-Tilesets_47.TILE_SIZE / 2)).plus(this.getAnimationOffsetPosition()), new point_76.Point(Tilesets_47.TILE_SIZE, Tilesets_47.TILE_SIZE), 0, false, false, UIStateManager_18.UIStateManager.UI_SPRITE_DEPTH))];
                    }
                };
            ...
            exports_135("Dude", Dude);
        }
    };
});
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager", "game/ui/ControlsUI", "game/characters/dialogues/DipIntro"], function (exports_136, context_136) {
    "use strict";
    var component_42, CutscenePlayerController_2, Player_17, point_77, Camera_10, CutsceneManager_2, LocationManager_28, ControlsUI_2, DipIntro_3, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_77.Point(-1, 0));
            ...
            exports_136("IntroCutscene", IntroCutscene);
        }
    };
});
System.register("game/scenes/GameScene", ["engine/collision/CollisionEngine", "engine/point", "game/characters/Dude", "game/characters/DudeFactory", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/cutscenes/IntroCutscene", "game/graphics/Tilesets", "game/items/DroppedItem", "game/SaveManager", "game/ui/UIStateManager", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/MapGenerator", "game/world/OutdoorDarknessMask", "game/world/TimeUnit", "game/world/WorldTime", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/characters/NPC", "engine/renderer/BasicRenderComponent", "game/characters/Player", "engine/renderer/LineRender", "engine/Entity", "engine/debug"], function (exports_137, context_137) {
    "use strict";
    var CollisionEngine_4, point_78, Dude_11, DudeFactory_6, Camera_11, CutsceneManager_3, IntroCutscene_1, Tilesets_48, DroppedItem_3, SaveManager_9, UIStateManager_19, GroundRenderer_2, LocationManager_29, MapGenerator_6, OutdoorDarknessMask_5, TimeUnit_8, WorldTime_10, EventQueue_6, QueuedEvent_4, NPC_8, BasicRenderComponent_10, Player_18, LineRender_2, Entity_30, debug_4, ZOOM, GameScene;
        ...
        execute: function () {
            ...
            GameScene = /** @class */ (function () {
                ...
                GameScene.prototype.newGame = function () {
                    ...
                    DudeFactory_6.DudeFactory.instance.new(1 /* DIP */, point_78.Point.ZERO);
                    DudeFactory_6.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_78.Point(3, 1).times(Tilesets_48.TILE_SIZE));
                    DudeFactory_6.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_78.Point(-1, 3).times(Tilesets_48.TILE_SIZE));
                    DudeFactory_6.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_78.Point(-4, 0).times(Tilesets_48.TILE_SIZE));
                ...
                GameScene.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.uiView = {
                        ...
                        entities: UIStateManager_19.UIStateManager.instance.get(dimensions, updateViewsContext.elapsedTimeMillis)
                    };
                };
                GameScene.prototype.getDebugEntity = function () {
                    ...
                    var base = Tilesets_48.pixelPtToTilePt(Player_18.Player.instance.dude.standingPosition);
                    var lines = [];
                    var gridRange = 50;
                    // vertical lines
            ...
            exports_137("GameScene", GameScene);
        }
    };
});
System.register("game/ui/MainMenuButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_138, context_138) {
    "use strict";
    var component_43, point_79, TextRender_9, utils_8, Tilesets_49, Text_11, UIStateManager_20, MainMenuButton;
        ...
        execute: function () {
            MainMenuButton = /** @class */ (function (_super) {
                ...
                MainMenuButton.prototype.update = function (updateData) {
                    this.hovering = utils_8.rectContains(this.position.plusX(-this.width / 2).plusY(-4), new point_79.Point(this.width, Tilesets_49.TILE_SIZE), updateData.input.mousePos);
                    if (this.hovering && updateData.input.isMouseDown) {
                        this.onClick();
                    }
                };
                MainMenuButton.prototype.getRenderMethods = function () {
                    ...
                    return [new TextRender_9.TextRender(text.toUpperCase(), this.position.plusX(-this.width / 2).plusX(offset), Text_11.TEXT_SIZE, Text_11.TEXT_FONT, this.hovering ? "#fdf7ed" /* WHITE */ : "#417089" /* DARK_BLUE */, UIStateManager_20.UIStateManager.UI_SPRITE_DEPTH)];
                };
                return MainMenuButton;
            }(component_43.Component));
            exports_138("MainMenuButton", MainMenuButton);
        }
    };
});
System.register("engine/renderer/RectRender", ["engine/point", "engine/renderer/RenderMethod"], function (exports_139, context_139) {
    "use strict";
    var point_80, RenderMethod_4, RectRender;
        ...
        execute: function () {
            RectRender = /** @class */ (function (_super) {
                ...
                function RectRender(_a) {
                    var _b = _a === void 0 ? {} : _a, _c = _b.depth, depth = _c === void 0 ? 0 : _c, _d = _b.position, position = _d === void 0 ? point_80.Point.ZERO : _d, _e = _b.dimensions, dimensions = _e === void 0 ? point_80.Point.ZERO : _e, _f = _b.color, color = _f === void 0 ? "#ff0000" : _f;
                    var _this = _super.call(this, depth) || this;
                    _this.position = position;
                    _this.dimensions = dimensions;
                    _this.color = color;
            ...
            exports_139("RectRender", RectRender);
        }
    };
});
System.register("game/ui/PlumePicker", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/RectRender", "engine/util/utils", "game/graphics/Tilesets", "game/SaveManager"], function (exports_140, context_140) {
    "use strict";
    var component_44, Entity_31, point_81, RectRender_1, utils_9, Tilesets_50, SaveManager_10, CUSTOMIZATION_OPTIONS, PlumePicker;
        ...
        execute: function () {
            ...
            PlumePicker = /** @class */ (function (_super) {
                ...
                function PlumePicker(callback) {
                    var _this = _super.call(this) || this;
                    _this.position = point_81.Point.ZERO; // top-center position
                ...
                PlumePicker.prototype.update = function (updateData) {
                    ...
                    this.renders = CUSTOMIZATION_OPTIONS.map(function (colors, index) {
                        ...
                        var dimensions = new point_81.Point(Tilesets_50.TILE_SIZE, Tilesets_50.TILE_SIZE);
                        ...
                        return new RectRender_1.RectRender({
                            position: position.plus(big ? new point_81.Point(-bigBuffer, -bigBuffer) : point_81.Point.ZERO),
                            dimensions: dimensions.plus(big ? new point_81.Point(bigBuffer, bigBuffer).times(2) : point_81.Point.ZERO),
                            color: colors[1],
            ...
            exports_140("PlumePicker", PlumePicker);
        }
    };
});
System.register("game/scenes/MainMenuScene", ["engine/debug", "engine/Entity", "engine/point", "game/characters/DudeAnimationUtils", "game/SaveManager", "game/ui/MainMenuButton", "game/ui/PlumePicker"], function (exports_141, context_141) {
    "use strict";
    var debug_5, Entity_32, point_82, DudeAnimationUtils_2, SaveManager_11, MainMenuButton_1, PlumePicker_1, ZOOM, MainMenuScene;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_141("MainMenuScene", MainMenuScene);
        }
    };
});
System.register("game/quest_game", ["engine/game", "game/scenes/GameScene", "game/scenes/MainMenuScene"], function (exports_142, context_142) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_142("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_143, context_143) {
    "use strict";
...
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_144, context_144) {
    "use strict";
    var component_45, utils_10, Clickable;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_144("Clickable", Clickable);
        }
    };
});
System.register("engine/util/Comparators", [], function (exports_145, context_145) {
    "use strict";
    var Comparators;
    ...
    return {
        setters: [],
        execute: function () {
            exports_145("Comparators", Comparators = {
                orderBy: function (fn) {
...
window['dice'] = doGame;
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_146, context_146) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_146("serialize", serialize = function (object) {
...
// TODO
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_147, context_147) {
    "use strict";
    var component_46, Tilesets_52, TileTransform_34, point_83, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_52.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_34.TileTransform(_this.topLeftPos.plus(new point_83.Point(10 * i, 0))));
                    });
                };
            ...
            exports_147("StringTiles", StringTiles);
        }
    };
});
