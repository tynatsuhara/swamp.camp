...
System.register("game/characters/NPCSchedule", [], function (exports_49, context_49) {
    "use strict";
    var NPCSchedules;
    ...
    return {
        setters: [],
        execute: function () {
            exports_49("NPCSchedules", NPCSchedules = {
                SCHEDULE_KEY: "sch",
...
System.register("game/ui/DudeInteractIndicator", ["game/graphics/Tilesets", "engine/point"], function (exports_50, context_50) {
    "use strict";
    var Tilesets_3, point_25, DudeInteractIndicator;
    ...
    return {
        ...
        execute: function () {
            exports_50("DudeInteractIndicator", DudeInteractIndicator = {
                NONE: "",
                IMPORTANT_DIALOGUE: "!",
                getTile: function (indicator) {
                    switch (indicator) {
                        ...
                        case DudeInteractIndicator.IMPORTANT_DIALOGUE:
                            return Tilesets_3.Tilesets.instance.oneBit.getTileAt(new point_25.Point(19, 25));
                    }
                },
            });
        }
...
System.register("game/world/events/EventQueue", ["engine/util/BinaryHeap", "game/world/events/QueuedEvent"], function (exports_51, context_51) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_51("EventQueue", EventQueue);
        }
    };
});
System.register("game/world/TimeUnit", [], function (exports_52, context_52) {
    "use strict";
    var TimeUnit;
...
System.register("game/world/WorldTime", ["engine/Entity", "engine/component", "game/world/events/EventQueue", "game/world/TimeUnit"], function (exports_53, context_53) {
    "use strict";
    var Entity_3, component_7, EventQueue_1, TimeUnit_1, WorldTime;
...
System.register("game/ui/Tooltip", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/renderer/TextRender", "game/ui/Text", "game/ui/UIStateManager", "engine/util/Lists", "engine/tiles/TileTransform"], function (exports_54, context_54) {
    "use strict";
    var component_8, Tilesets_4, point_26, TextRender_3, Text_1, UIStateManager_1, Lists_2, TileTransform_8, Tooltip;
    ...
    return {
        ...
        execute: function () {
            Tooltip = /** @class */ (function (_super) {
                ...
                function Tooltip() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.position = new point_26.Point(0, 0);
                    _this.tiles = [];
                    return _this;
                }
                ...
                Tooltip.prototype.update = function (updateData) {
                    ...
                    var leftPos = this.position.plus(new point_26.Point(Tilesets_4.TILE_SIZE / 2, -Tilesets_4.TILE_SIZE)).apply(Math.floor);
                    var centerPos = leftPos.plus(new point_26.Point(Tilesets_4.TILE_SIZE, 0));
                    var rightPos = leftPos.plus(new point_26.Point(width - Tilesets_4.TILE_SIZE + Tooltip.margin * 2, 0)).apply(Math.floor);
                    var spacing = 6;
                    var centerWidth = new point_26.Point(width + Tooltip.margin * 2 - Tilesets_4.TILE_SIZE * 2, Tilesets_4.TILE_SIZE);
                    var tiles = [];
                    for (var i = 0; i < (this.text.length - 1) * 2 + 1; i++) {
                        // left
                        tiles.push(Tilesets_4.Tilesets.instance.oneBit.getTileSource("tooltipLeft").toImageRender(new TileTransform_8.TileTransform(leftPos.plusY(-i * spacing), Tilesets_4.TILE_DIMENSIONS, 0, false, false, UIStateManager_1.UIStateManager.UI_SPRITE_DEPTH + 1)));
                        // center
                        tiles.push(Tilesets_4.Tilesets.instance.oneBit.getTileSource("tooltipCenter").toImageRender(new TileTransform_8.TileTransform(centerPos.plusY(-i * spacing), centerWidth, 0, false, false, UIStateManager_1.UIStateManager.UI_SPRITE_DEPTH + 1)));
                        // right
                        tiles.push(Tilesets_4.Tilesets.instance.oneBit.getTileSource("tooltipRight").toImageRender(new TileTransform_8.TileTransform(rightPos.plusY(-i * spacing), Tilesets_4.TILE_DIMENSIONS, 0, false, false, UIStateManager_1.UIStateManager.UI_SPRITE_DEPTH + 1)));
                    }
                    this.tiles = tiles;
                ...
                Tooltip.margin = 6;
                Tooltip.textOffset = new point_26.Point(Tooltip.margin, Tooltip.margin - 1);
                return Tooltip;
        ...
        execute: function () {
            CraftingMenu = /** @class */ (function (_super) {
                ...
                function CraftingMenu() {
                    ...
                    _this.isOpen = false;
                    _this.dimensions = new point_27.Point(160, 158);
                    _this.innerDimensions = _this.dimensions.minus(new point_27.Point(10, 14));
                ...
                CraftingMenu.prototype.renderCategories = function (updateData, topLeft) {
                    ...
                    for (var i = 0; i < this.recipes.length; i++) {
                        ...
                        var dims = new point_27.Point(2, 2);
                ...
                CraftingMenu.prototype.canCraft = function (recipe) {
                    return this.justCraftedRow === -1
                        && !this.justOpened
                        && Player_1.Player.instance.dude.inventory.canAddItem(recipe.output)
                        && recipe.input.every(function (input) { return Player_1.Player.instance.dude.inventory.getItemCount(input.item) >= input.count; });
                };
                CraftingMenu.prototype.renderRecipes = function (updateData, topLeft, recipes) {
                    ...
                    backgroundTiles[0].transform.depth = UIStateManager_2.UIStateManager.UI_SPRITE_DEPTH;
                    ...
                    for (var r = 0; r < recipes.length; r++) {
                        var hovered = utils_4.rectContains(topLeft.plusX(margin).plusY(rowHeight * r + margin * 2), new point_27.Point(this.innerDimensions.x, rowHeight), shiftedMousePos) && utils_4.rectContains(// within the frame itself
                        ...
                        if (hovered && updateData.input.isMouseDown && this.canCraft(recipe)) {
                            ...
                            recipe.input.forEach(function (ingr) {
                                Player_1.Player.instance.dude.inventory.removeItem(ingr.item, ingr.count);
                            });
                            Player_1.Player.instance.dude.inventory.addItem(recipe.output);
                            this.justCraftedRow = r;
                            setTimeout(function () { return _this.justCraftedRow = -1; }, 900);
                        }
                        if (hovered && !this.canCraft(recipe)) {
                            if (!Player_1.Player.instance.dude.inventory.canAddItem(recipe.output)) {
                                this.tooltip.say("Inventory full");
                            }
                            else if (recipe.input.some(function (input) { return Player_1.Player.instance.dude.inventory.getItemCount(input.item) < input.count; })) {
                        ...
                        for (var i = 0; i < recipe.input.length; i++) {
                            ...
                            if (Player_1.Player.instance.dude.inventory.getItemCount(ingr.item) < ingr.count) {
                            ...
                            new point_27.Point(width - offsetFromRight + margin, verticalOffset + margin * 1.5).plus(topLeft), new point_27.Point(Tilesets_5.TILE_SIZE, Tilesets_5.TILE_SIZE), updateData.input.mousePos)) {
                                var displayName = Items_1.ITEM_METADATA_MAP[ingr.item].displayName;
                                this.tooltip.say(displayName + " (" + Player_1.Player.instance.dude.inventory.getItemCount(ingr.item) + "/" + ingr.count + ")");
                            }
                        }
                        // draw line
                    ...
                    var renderComp = new BasicRenderComponent_2.BasicRenderComponent(new ImageRender_2.ImageRender(this.canvas, point_27.Point.ZERO, this.innerDimensions, innerOffset.plus(topLeft).apply(Math.floor), this.innerDimensions, UIStateManager_2.UIStateManager.UI_SPRITE_DEPTH - 10));
...
System.register("game/characters/dialogues/DipIntro", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator", "game/Controls", "game/world/LocationManager", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/WorldTime", "game/ui/CraftingMenu", "game/items/CraftingRecipe"], function (exports_56, context_56) {
    ...
    return {
        ...
        execute: function () {
            exports_56("ROCKS_NEEDED_FOR_CAMPFIRE", ROCKS_NEEDED_FOR_CAMPFIRE = 10);
            exports_56("WOOD_NEEDED_FOR_CAMPFIRE", WOOD_NEEDED_FOR_CAMPFIRE = 5);
            CRAFT_OPTION = "<Craft>";
            exports_56("DIP_STARTING_DIALOGUE", DIP_STARTING_DIALOGUE = "dip-0");
            ...
            exports_56("DIP_INTRO_DIALOGUE", DIP_INTRO_DIALOGUE = (_a = {},
...
System.register("game/items/CraftingRecipe", ["game/items/Inventory", "game/graphics/Tilesets", "engine/point", "game/characters/dialogues/DipIntro"], function (exports_57, context_57) {
    "use strict";
    var Inventory_1, Tilesets_6, point_28, DipIntro_1, getDipRecipes;
    ...
    return {
        ...
        execute: function () {
            exports_57("getDipRecipes", getDipRecipes = function () { return [{
                    icon: Tilesets_6.Tilesets.instance.oneBit.getTileAt(new point_28.Point(0, 7)),
                    ...
                    icon: Tilesets_6.Tilesets.instance.oneBit.getTileAt(new point_28.Point(10, 27)),
                    name: "Equipment",
                    recipes: [{
                    ...
                    icon: Tilesets_6.Tilesets.instance.oneBit.getTileAt(new point_28.Point(0, 19)),
                    name: "Buildings",
                    recipes: [{
                            output: 3 /* TENT */,
...
System.register("game/ui/SellMenu", ["engine/Entity", "engine/component", "engine/point", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "engine/tiles/NineSlice", "game/graphics/Tilesets", "engine/renderer/ImageRender", "game/ui/UIStateManager", "game/items/Items", "game/ui/Text", "game/graphics/ImageFilters", "game/characters/Player", "engine/util/utils", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/TextRender", "game/SaveManager"], function (exports_58, context_58) {
    "use strict";
    var Entity_5, component_10, point_29, BasicRenderComponent_3, Camera_3, NineSlice_2, Tilesets_7, ImageRender_3, UIStateManager_3, Items_2, Text_3, ImageFilters_2, Player_2, utils_5, Tooltip_2, AnimatedTileComponent_2, TileTransform_10, TextRender_4, SaveManager_1, SellMenu;
        ...
        execute: function () {
            ...
            SellMenu = /** @class */ (function (_super) {
                ...
                function SellMenu() {
                    ...
                    _this.coinsOffset = new point_29.Point(7, -11); // for the spinny coin in the corner
                    _this.isOpen = false;
                    _this.dimensions = new point_29.Point(160, 158);
                    _this.innerDimensions = _this.dimensions.minus(new point_29.Point(10, 14));
                    _this.scrollOffset = 0;
                ...
                SellMenu.prototype.canSell = function (sale) {
                    return this.justSoldRow === -1
                        && !this.justOpened
                        && Player_2.Player.instance.dude.inventory.getItemCount(sale.item) >= sale.count;
                };
                SellMenu.prototype.renderRecipes = function (updateData, topLeft, items) {
                    var _this = this;
                    var inv = Player_2.Player.instance.dude.inventory;
                    var coinCountComponent = new BasicRenderComponent_3.BasicRenderComponent(new TextRender_4.TextRender("x" + inv.getItemCount(0 /* COIN */), new point_29.Point(9, 1).plus(topLeft).plus(this.coinsOffset), Text_3.TEXT_SIZE, Text_3.TEXT_FONT, "#facb3e" /* YELLOW */, UIStateManager_3.UIStateManager.UI_SPRITE_DEPTH));
                    this.context.imageSmoothingEnabled = false; // TODO figure out why text is aliased
                    ...
                    for (var r = 0; r < items.length; r++) {
                        var hovered = utils_5.rectContains(topLeft.plusX(margin).plusY(rowHeight * r + margin * 2), new point_29.Point(this.innerDimensions.x, rowHeight), shiftedMousePos) && utils_5.rectContains(// within the frame itself
                        topLeft.plus(innerOffset), this.innerDimensions, updateData.input.mousePos);
                        var sale = items[r];
                    ...
                    var renderComp = new BasicRenderComponent_3.BasicRenderComponent(new ImageRender_3.ImageRender(this.canvas, point_29.Point.ZERO, this.innerDimensions, innerOffset.plus(topLeft).apply(Math.floor), this.innerDimensions, UIStateManager_3.UIStateManager.UI_SPRITE_DEPTH - 10));
            ...
            exports_58("SellMenu", SellMenu);
        }
    };
});
System.register("game/saves/uuid", [], function (exports_59, context_59) {
    "use strict";
    var newUUID;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_59("newUUID", newUUID = function () {
        ...
        execute: function () {
            exports_60("ElementUtils", ElementUtils = {
                rectPoints: function (position, dimensions) {
                    ...
                    for (var x = 0; x < dimensions.x; x++) {
                        for (var y = 0; y < dimensions.y; y++) {
                            result.push(position.plus(new point_30.Point(x, y)));
                        }
                    }
                    return result;
                }
...
System.register("game/world/ground/GroundComponent", ["engine/component"], function (exports_61, context_61) {
    "use strict";
    var component_11, GroundComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_61("GroundComponent", GroundComponent);
        }
    };
});
System.register("game/world/WorldLocation", ["engine/point", "engine/util/Grid", "game/characters/DudeFactory", "game/characters/NPC", "game/characters/Player", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/saves/uuid", "game/world/elements/Elements", "game/world/elements/ElementUtils", "game/world/ground/Ground", "game/world/LocationManager", "game/world/MapGenerator", "game/world/Teleporter"], function (exports_62, context_62) {
    "use strict";
    var point_31, Grid_1, DudeFactory_1, NPC_1, Player_3, Camera_4, Tilesets_8, uuid_1, Elements_1, ElementUtils_1, Ground_1, LocationManager_4, MapGenerator_1, Teleporter_1, WorldLocation;
            ...
            WorldLocation = /** @class */ (function () {
                ...
                WorldLocation.prototype.getTeleporter = function (toUUID) {
                    return Object.entries(this.teleporters)
                        ...
                        to: toUUID,
                        pos: point_31.Point.fromString(kv[1]),
                ...
                WorldLocation.prototype.getTeleporterLinkedPos = function (to, id) {
                    ...
                    return point_31.Point.fromString(link);
                };
                ...
                WorldLocation.prototype.useTeleporter = function (to, id) {
                    ...
                    var p = Player_3.Player.instance.dude;
                    ...
                    var niceTransition = Tilesets_8.TILE_SIZE * 2 * (linkedLocation.isInterior ? -1 : 1);
                ...
                WorldLocation.load = function (saveState) {
                    ...
                    saveState.elements.forEach(function (el) { return n.addElement(el.type, point_31.Point.fromString(el.pos), el.obj); });
                    saveState.ground.forEach(function (el) { return n.addGroundElement(el.type, point_31.Point.fromString(el.pos), el.obj); });
                    saveState.dudes.forEach(function (d) { return DudeFactory_1.DudeFactory.instance.load(d, n); });
                    return n;
                };
                return WorldLocation;
            }());
            exports_62("WorldLocation", WorldLocation);
        }
    };
});
System.register("game/world/GroundRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/world/LocationManager", "engine/tiles/TileTransform"], function (exports_63, context_63) {
    "use strict";
    var point_32, ImageRender_4, Entity_6, BasicRenderComponent_4, Camera_5, MapGenerator_2, Tilesets_9, Grid_2, LocationManager_5, TileTransform_11, GroundRenderer;
        ...
        execute: function () {
            ...
            GroundRenderer = /** @class */ (function () {
                function GroundRenderer() {
                    ...
                    this.size = MapGenerator_2.MapGenerator.MAP_SIZE * Tilesets_9.TILE_SIZE * 2;
                ...
                GroundRenderer.prototype.renderToOffscreenCanvas = function () {
                    ...
                    locationTileGrid.entries().forEach(function (entry) {
                        var pos = entry[0].times(Tilesets_9.TILE_SIZE).plus(_this.shift);
                        var tile = entry[1];
                        var imageRender = tile.toImageRender(new TileTransform_11.TileTransform());
                        _this.context.drawImage(imageRender.source, imageRender.sourcePosition.x, imageRender.sourcePosition.y, Tilesets_9.TILE_SIZE, Tilesets_9.TILE_SIZE, pos.x, pos.y, Tilesets_9.TILE_SIZE, Tilesets_9.TILE_SIZE);
                    });
                };
                GroundRenderer.prototype.getEntity = function () {
                    ...
                    var dimensions = Camera_5.Camera.instance.dimensions.plus(new point_32.Point(1, 1));
                    return new Entity_6.Entity([new BasicRenderComponent_4.BasicRenderComponent(new ImageRender_4.ImageRender(this.canvas, Camera_5.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_5.Camera.instance.position.apply(Math.floor), dimensions, Number.MIN_SAFE_INTEGER))]);
                };
                return GroundRenderer;
            }());
            exports_63("GroundRenderer", GroundRenderer);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/ground/GroundComponent"], function (exports_64, context_64) {
    "use strict";
    var component_12, Entity_7, point_33, TileTransform_12, Tilesets_10, GroundRenderer_1, LocationManager_6, GroundComponent_1, INDEX, TALL_GRASS_COUNT, makeGrass, TallGrass;
    ...
    return {
        ...
        execute: function () {
            INDEX = "i";
            TALL_GRASS_COUNT = "t";
            exports_64("makeGrass", makeGrass = function (d) {
                var _a, _b;
                var tile;
                ...
                if (index > 0) {
                    tile = Tilesets_10.Tilesets.instance.tilemap.getTileAt(new point_33.Point(0, index));
                }
                else {
                    tile = Tilesets_10.Tilesets.instance.tilemap.getTileAt(new point_33.Point(0, 7));
                }
            ...
            TallGrass = /** @class */ (function (_super) {
                ...
                function TallGrass(tilePos) {
                    ...
                    var offset = new point_33.Point(-6 + Math.round(Math.random() * 11), -Tilesets_10.TILE_SIZE + 2 + Math.round(Math.random() * (Tilesets_10.TILE_SIZE - 2)));
                    var grassPos = tilePos.times(Tilesets_10.TILE_SIZE).plus(offset);
                    var render = Tilesets_10.Tilesets.instance.outdoorTiles
                        .getTileSource("grass" + Math.ceil(Math.random() * 2))
                        .toImageRender(new TileTransform_12.TileTransform(grassPos, null, 0, Math.random() > .5, false, grassPos.y + Tilesets_10.TILE_SIZE));
...
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_65, context_65) {
    "use strict";
    var point_34, TileTransform_13, ConnectingTile_1, ConnectingTileSchema;
        ...
        execute: function () {
            ...
            ConnectingTileSchema = /** @class */ (function () {
                ...
                ConnectingTileSchema.prototype.render = function (grid, position) {
                    ...
                    var y = position.y;
                    // TODO: add diagonals?
                    var n = this.get(grid, new point_34.Point(x, y - 1));
                    var s = this.get(grid, new point_34.Point(x, y + 1));
                    var e = this.get(grid, new point_34.Point(x + 1, y));
                    var w = this.get(grid, new point_34.Point(x - 1, y));
            ...
            exports_65("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_66, context_66) {
    "use strict";
    var point_35, component_13, ConnectingTile;
        ...
        execute: function () {
            ConnectingTile = /** @class */ (function (_super) {
                ...
                function ConnectingTile(schema, grid, position) {
                    if (position === void 0) { position = new point_35.Point(0, 0); }
                    var _this = _super.call(this) || this;
                    _this.schema = schema;
                    _this.grid = grid;
                    _this.position = position;
            ...
            exports_66("ConnectingTile", ConnectingTile);
        }
    };
});
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_67, context_67) {
    "use strict";
    var GroundComponent_2, Entity_8, ConnectingTile_2, Ground_2, makePath;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_67("makePath", makePath = function (d) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_68, context_68) {
    "use strict";
    var Tilesets_11, GroundComponent_3, Entity_9, TileTransform_14, makeBasicGround, makeBasicNineSliceGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_68("makeBasicGround", makeBasicGround = function (g, d, rotation) {
                var key = d.data["k"];
                var tile = Tilesets_11.Tilesets.instance.getBasicTileSource(key);
                var c = tile.toComponent(new TileTransform_14.TileTransform(d.pos.times(Tilesets_11.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                c.transform.rotation = rotation;
                return new Entity_9.Entity([c]).addComponent(new GroundComponent_3.GroundComponent(g, function () { return d.data; }));
            });
            exports_68("makeBasicNineSliceGround", makeBasicNineSliceGround = function (d) {
                var key = d.data["k"];
                var slice = Tilesets_11.Tilesets.instance.getBasicTileNineSlice(key);
                var nineSliceIndex = d.data["i"];
                var c = slice[nineSliceIndex].toComponent(new TileTransform_14.TileTransform(d.pos.times(Tilesets_11.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                return new Entity_9.Entity([c]).addComponent(new GroundComponent_3.GroundComponent(1 /* BASIC_NINE_SLICE */, function () { return d.data; }));
            });
        }
    };
});
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_69, context_69) {
    "use strict";
    var point_36, Tilesets_12, GroundComponent_4, Entity_10, TileTransform_15, makeLedge;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_69("makeLedge", makeLedge = function (d) {
                var c = Tilesets_12.Tilesets.instance.tilemap.getTileAt(new point_36.Point(3, 2)).toComponent(new TileTransform_15.TileTransform(d.pos.times(Tilesets_12.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                return new Entity_10.Entity([c]).addComponent(new GroundComponent_4.GroundComponent(2 /* GRASS */, function () { return {}; }));
            });
        }
    };
});
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/BasicGround", "game/world/ground/Ledge"], function (exports_70, context_70) {
    "use strict";
    var point_37, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_13, BasicGround_1, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_70("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(2, 6)))
                        .angle(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(0, 5)))
                        .tShape(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(3, 5)))
                        .plusShape(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(5, 5)))
                        .cap(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(2, 6)))
                        .single(Tilesets_13.Tilesets.instance.tilemap.getTileAt(new point_37.Point(7, 5)));
            ...
            exports_70("Ground", Ground);
        }
    };
});
System.register("game/world/interior/House", ["engine/point", "game/graphics/Tilesets", "game/world/LocationManager", "game/world/WorldLocation"], function (exports_71, context_71) {
    "use strict";
    var point_38, Tilesets_14, LocationManager_7, WorldLocation_1, makeHouseInterior;
    ...
    return {
        ...
        execute: function () {
            exports_71("makeHouseInterior", makeHouseInterior = function (outside) {
                var l = new WorldLocation_1.WorldLocation(true, true);
                LocationManager_7.LocationManager.instance.add(l);
                var dimensions = new point_38.Point(7, 5);
                var interactablePos = new point_38.Point(dimensions.x / 2, dimensions.y).times(Tilesets_14.TILE_SIZE);
                var teleporter = { to: outside.uuid, pos: interactablePos.plusY(-4) };
                l.addTeleporter(teleporter);
                l.addElement(5 /* TELEPORTER */, new point_38.Point(3, 5), { to: outside.uuid, i: interactablePos.toString() });
                var woodType = Math.ceil(Math.random() * 2);
                for (var x = 0; x < dimensions.x; x++) {
                    for (var y = 0; y < dimensions.y; y++) {
                        l.addGroundElement(0 /* BASIC */, new point_38.Point(x, y), { k: "hardwood" + woodType });
                    }
                    ...
                    l.addGroundElement(0 /* BASIC */, new point_38.Point(x, -1), { k: topAndBottomTiles[0] });
                    l.addGroundElement(5 /* BASIC_ROTATED_180 */, new point_38.Point(x, -2), { k: topAndBottomTiles[1] });
                }
                return l;
            });
        }
...
System.register("game/world/elements/ElementFactory", [], function (exports_72, context_72) {
    "use strict";
    var ElementFactory;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_72("ElementFactory", ElementFactory);
        }
    };
});
System.register("game/world/elements/House", ["engine/collision/BoxCollider", "engine/component", "engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/interior/House", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/ElementUtils", "game/world/elements/Interactable"], function (exports_73, context_73) {
    "use strict";
    var BoxCollider_1, component_14, Entity_11, point_39, TileComponent_4, TileTransform_16, Tilesets_15, House_1, ElementComponent_1, ElementFactory_1, ElementUtils_2, Interactable_1, RESIDENT_ATTRIBUTE, HouseFactory, House;
        ...
        execute: function () {
            ...
            HouseFactory = /** @class */ (function (_super) {
                ...
                function HouseFactory() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.type = 6 /* HOUSE */;
                    _this.dimensions = new point_39.Point(5, 4);
                    return _this;
                }
                HouseFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactablePos = pos.plus(new point_39.Point(2.5, 3)).times(Tilesets_15.TILE_SIZE);
                    ...
                    // flat roof
                    var flatRoofTopLeft = new point_39.Point(6, 0);
                    ...
                    // door
                    addTile(new point_39.Point(7, 6), basePos.plusY(2).plusX(1));
                    // no windows
                    addTile(new point_39.Point(7, 5), basePos.plusY(2));
                    addTile(new point_39.Point(9, 5), basePos.plusY(2).plusX(2));
                    // alternative with windows
                    // addTile(new Point(5, 6), basePos.plusY(2))
                    // addTile(new Point(6, 6), basePos.plusY(2).plusX(2))
                    e.addComponent(new BoxCollider_1.BoxCollider(basePos.plus(new point_39.Point(0, 1)).times(Tilesets_15.TILE_SIZE), new point_39.Point(Tilesets_15.TILE_SIZE * 3, Tilesets_15.TILE_SIZE * 2)));
                    // Set up teleporter
                    e.addComponent(new Interactable_1.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_39.Point(0, -Tilesets_15.TILE_SIZE * 1.4)));
                    var resident = data[RESIDENT_ATTRIBUTE];
                    var house = e.addComponent(new House(destinationUUID));
                    house.setResident(resident);
                    return e.addComponent(new ElementComponent_1.ElementComponent(6 /* HOUSE */, pos, ElementUtils_2.ElementUtils.rectPoints(pos.plus(new point_39.Point(1, 1)), new point_39.Point(3, 2)), function () {
                        var _a;
                        return (_a = {
            ...
            exports_73("HouseFactory", HouseFactory);
            ...
            exports_73("House", House);
        }
    };
});
System.register("game/characters/dialogues/BertoIntro", ["game/ui/DudeInteractIndicator", "game/ui/SellMenu", "game/world/elements/House", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/LocationManager", "game/world/WorldTime", "game/characters/Dialogue"], function (exports_74, context_74) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_74("BERTO_STARTING_DIALOGUE", BERTO_STARTING_DIALOGUE = "bert-start");
...
System.register("game/characters/dialogues/GenericDialogue", ["engine/util/Lists", "game/characters/Dialogue"], function (exports_75, context_75) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_75("GenericDialogue", GenericDialogue);
            exports_75("GENERIC_DIALOGUE", GENERIC_DIALOGUE = (_a = {},
...
System.register("game/world/Vignette", ["engine/component", "engine/point", "engine/renderer/ImageRender", "game/ui/Color", "game/ui/UIStateManager"], function (exports_76, context_76) {
    "use strict";
    var component_15, point_40, ImageRender_5, Color_2, UIStateManager_4, Vignette;
            ...
            Vignette = /** @class */ (function (_super) {
                ...
                function Vignette(topLeftPosition, diameter) {
                    ...
                    _this.start = function () {
                        ...
                        var center = new point_40.Point(diameter / 2, diameter / 2).apply(Math.floor);
                        for (var x = 0; x < diameter; x++) {
                            for (var y = 0; y < diameter; y++) {
                                var i = (x + y * diameter) * 4;
                                var pt = new point_40.Point(x, y);
                        ...
                        context.putImageData(imageData, 0, 0);
                        _this.render = new ImageRender_5.ImageRender(canvas, new point_40.Point(0, 0), new point_40.Point(diameter, diameter), topLeftPosition, new point_40.Point(diameter, diameter), UIStateManager_4.UIStateManager.UI_SPRITE_DEPTH - 100 // make sure all UI goes on top of light
                        );
                    };
                    return _this;
                }
...
System.register("game/world/OutdoorDarknessMask", ["engine/Entity", "engine/point", "engine/renderer/BasicRenderComponent", "engine/renderer/ImageRender", "engine/util/Grid", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/ui/UIStateManager", "game/world/LocationManager", "game/world/MapGenerator", "game/world/TimeUnit", "game/world/Vignette", "game/world/WorldTime"], function (exports_77, context_77) {
    "use strict";
    var Entity_12, point_41, BasicRenderComponent_5, ImageRender_6, Grid_3, Camera_6, Tilesets_16, UIStateManager_5, LocationManager_9, MapGenerator_3, TimeUnit_2, Vignette_1, WorldTime_3, OutdoorDarknessMask;
        ...
        execute: function () {
            OutdoorDarknessMask = /** @class */ (function () {
                function OutdoorDarknessMask() {
                    ...
                    this.vignetteEntity = new Entity_12.Entity([new Vignette_1.Vignette(new point_41.Point(1, 1).times(-this.size / 2), this.size)]);
                ...
                OutdoorDarknessMask.prototype.getEntities = function () {
                    ...
                    var dynamicDarknessEntity = new Entity_12.Entity([new BasicRenderComponent_5.BasicRenderComponent(new ImageRender_6.ImageRender(this.canvas, Camera_6.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_6.Camera.instance.position.apply(Math.floor), dimensions, UIStateManager_5.UIStateManager.UI_SPRITE_DEPTH - 100 // make sure all UI goes on top of light
                        ))]);
            ...
            exports_77("OutdoorDarknessMask", OutdoorDarknessMask);
        }
    };
});
System.register("game/world/elements/Campfire", ["engine/component", "engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider", "game/world/elements/ElementComponent", "engine/Entity", "game/world/OutdoorDarknessMask", "game/ui/DialogueDisplay", "game/world/WorldTime", "game/world/TimeUnit", "game/characters/dialogues/ItemDialogues", "game/world/elements/ElementFactory"], function (exports_78, context_78) {
    "use strict";
    var component_16, TileComponent_5, AnimatedTileComponent_3, Tilesets_17, TileTransform_17, point_42, Interactable_2, BoxCollider_2, ElementComponent_2, Entity_13, OutdoorDarknessMask_1, DialogueDisplay_1, WorldTime_4, TimeUnit_3, ItemDialogues_1, ElementFactory_2, CampfireFactory, Campfire;
        ...
        execute: function () {
            CampfireFactory = /** @class */ (function (_super) {
                ...
                CampfireFactory.prototype.make = function (wl, pos, data) {
                    ...
                    e.addComponent(new BoxCollider_2.BoxCollider(scaledPos.plus(offset), new point_42.Point(Tilesets_17.TILE_SIZE, Tilesets_17.TILE_SIZE).minus(offset)));
                    ...
                    var updateFire = function (logCount) {
                        ...
                        var lightCenterPos = pos.times(Tilesets_17.TILE_SIZE).plus(new point_42.Point(Tilesets_17.TILE_SIZE / 2, Tilesets_17.TILE_SIZE / 2));
                    ...
                    e.addComponent(new Interactable_2.Interactable(scaledPos.plus(new point_42.Point(Tilesets_17.TILE_SIZE / 2, Tilesets_17.TILE_SIZE / 2)), function () {
                        DialogueDisplay_1.DialogueDisplay.instance.startDialogue(cf);
                    }, new point_42.Point(1, -Tilesets_17.TILE_SIZE)));
...
System.register("game/characters/dialogues/ItemDialogues", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator", "game/ui/DialogueDisplay", "game/world/elements/Campfire", "game/characters/Player"], function (exports_79, context_79) {
    "use strict";
    var _a, Dialogue_4, DudeInteractIndicator_3, DialogueDisplay_2, Campfire_1, Player_4, CAMPFIRE_DIALOGUE, ITEM_DIALOGUES;
...
System.register("game/characters/Dialogue", ["game/SaveManager", "game/ui/DudeInteractIndicator", "game/characters/dialogues/BertoIntro", "game/characters/dialogues/DipIntro", "game/characters/dialogues/GenericDialogue", "game/characters/dialogues/ItemDialogues", "game/characters/Player"], function (exports_80, context_80) {
    "use strict";
    var SaveManager_2, DudeInteractIndicator_4, BertoIntro_1, DipIntro_2, GenericDialogue_1, ItemDialogues_2, Player_5, EMPTY_DIALOGUE, DialogueInstance, dialogueWithOptions, dialogue, option, saveAfterDialogueStage, inv, DialogueOption, NextDialogue, getDialogue, DIALOGUE_SOURCES, DIALOGUE_MAP;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_80("inv", inv = function () { return Player_5.Player.instance.dude.inventory; });
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/tiles/TileTransform", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_81, context_81) {
    "use strict";
    var component_17, point_43, TextRender_5, TileTransform_18, utils_6, Tilesets_18, Text_4, UIStateManager_6, TextButton;
            ...
            TextButton = /** @class */ (function (_super) {
                ...
                function TextButton(position, text, onClick, buttonColor, textColor, hoverColor) {
                    ...
                    _this.start = function () {
                        ...
                        var centerPos = leftPos.plus(new point_43.Point(Tilesets_18.TILE_SIZE, 0));
                        var rightPos = leftPos.plus(new point_43.Point(_this.width - Tilesets_18.TILE_SIZE, 0)).apply(Math.floor);
                        ...
                        _this.center = Tilesets_18.Tilesets.instance.oneBit.getTileSource("btnCenter_" + buttonColor).toImageRender(new TileTransform_18.TileTransform(centerPos, new point_43.Point(_this.width + TextButton.margin * 2 - Tilesets_18.TILE_SIZE * 2, Tilesets_18.TILE_SIZE)));
                ...
                TextButton.prototype.update = function (updateData) {
                    this.hovering = utils_6.rectContains(this.position, new point_43.Point(this.width, Tilesets_18.TILE_SIZE), updateData.input.mousePos);
...
System.register("game/ui/ButtonsMenu", ["engine/point", "game/ui/TextButton", "game/ui/UIStateManager", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/ui/Text", "engine/Entity"], function (exports_82, context_82) {
    "use strict";
    var point_44, TextButton_1, UIStateManager_7, Tilesets_19, NineSlice_3, Text_5, Entity_14, ButtonsMenu;
        ...
        execute: function () {
            ...
            exports_82("ButtonsMenu", ButtonsMenu = {
                render: function (screenDimensions, backgroundColor, options) {
                    ...
                    var marginSide = 9;
                    var buttonPadding = 3;
                    var dimensions = new point_44.Point(longestOption * Text_5.TEXT_PIXEL_WIDTH + marginSide * 2 + TextButton_1.TextButton.margin * 2, (options.length - 1) * buttonPadding + options.length * Tilesets_19.TILE_SIZE + marginTop + marginBottom);
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/Controls", "game/ui/UIStateManager", "game/ui/ButtonsMenu"], function (exports_83, context_83) {
    "use strict";
    var Dialogue_5, Tilesets_20, NineSlice_4, point_45, component_18, Entity_15, BasicRenderComponent_6, Text_6, Controls_2, UIStateManager_8, ButtonsMenu_1, DialogueDisplay;
        ...
        execute: function () {
            DialogueDisplay = /** @class */ (function (_super) {
                ...
                function DialogueDisplay() {
                    var _this = _super.call(this) || this;
                    _this.e = new Entity_15.Entity([_this]);
                ...
                DialogueDisplay.prototype.update = function (updateData) {
                    ...
                    this.displayEntity = new Entity_15.Entity();
...
System.register("game/characters/NPC", ["engine/component", "engine/point", "engine/util/Lists", "game/graphics/Tilesets", "game/ui/DialogueDisplay", "game/world/elements/House", "game/world/LocationManager", "game/world/OutdoorDarknessMask", "game/world/TimeUnit", "game/characters/Dude", "game/characters/NPCSchedule", "game/characters/Player"], function (exports_84, context_84) {
    "use strict";
    var component_19, point_46, Lists_4, Tilesets_21, DialogueDisplay_3, House_3, LocationManager_10, OutdoorDarknessMask_2, TimeUnit_4, Dude_1, NPCSchedule_1, Player_6, NPC;
            ...
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.update = function (updateData) {
                    ...
                    if (DialogueDisplay_3.DialogueDisplay.instance.dialogueSource === this.dude) {
                        ...
                        this.dude.move(updateData, point_46.Point.ZERO, Player_6.Player.instance.dude.standingPosition.x - this.dude.standingPosition.x);
                    }
...
System.register("game/world/events/QueuedEvent", ["game/characters/DudeFactory", "game/world/MapGenerator", "game/world/LocationManager", "game/characters/NPCSchedule", "game/characters/NPC", "game/graphics/Tilesets", "game/world/events/EventQueue", "game/world/WorldTime", "game/world/elements/House"], function (exports_85, context_85) {
    "use strict";
    var _a, DudeFactory_2, MapGenerator_4, LocationManager_11, NPCSchedule_2, NPC_2, Tilesets_22, EventQueue_4, WorldTime_5, House_4, QueuedEventType, EVENT_QUEUE_HANDLERS;
        ...
        execute: function () {
            ...
            exports_85("EVENT_QUEUE_HANDLERS", EVENT_QUEUE_HANDLERS = (_a = {},
                ...
                _a[QueuedEventType.HERALD_DEPARTURE] = function (data) {
                    ...
                    npc.setSchedule(NPCSchedule_2.NPCSchedules.newGoToSchedule(Tilesets_22.pixelPtToTilePt(goalPosition)));
                    // check repeatedly until he's at the goal
                    if (berto.standingPosition.distanceTo(goalPosition) > Tilesets_22.TILE_SIZE) {
...
System.register("game/SaveManager", ["game/characters/Player", "game/saves/SaveGame", "game/world/LocationManager", "game/ui/UIStateManager", "game/cutscenes/Camera", "game/ui/HUD", "game/world/WorldTime", "game/world/events/EventQueue"], function (exports_87, context_87) {
    "use strict";
    var Player_7, SaveGame_1, LocationManager_12, UIStateManager_9, Camera_7, HUD_1, WorldTime_6, EventQueue_5, SAVE_KEY, SaveManager, saveManager;
        ...
        execute: function () {
            ...
            SaveManager = /** @class */ (function () {
                ...
                SaveManager.prototype.save = function () {
                    if (!Player_7.Player.instance.dude.isAlive) {
                ...
                SaveManager.prototype.load = function () {
                    ...
                    Camera_7.Camera.instance.focusOnDude(Array.from(LocationManager_12.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 0 /* PLAYER */; })[0]);
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils", "engine/tiles/TileTransform", "game/world/elements/Elements"], function (exports_88, context_88) {
    "use strict";
    var component_20, Tilesets_23, point_47, NineSlice_5, UIStateManager_10, LocationManager_13, PlaceElementDisplay_1, utils_7, TileTransform_19, Elements_2, PlaceElementFrame;
        ...
        execute: function () {
            ...
            PlaceElementFrame = /** @class */ (function (_super) {
                ...
                PlaceElementFrame.prototype.start = function () {
                    ...
                    this.goodTiles[0].transform.depth = UIStateManager_10.UIStateManager.UI_SPRITE_DEPTH;
                    this.badTiles = this.entity.addComponents(this.getTiles("bad"));
                    this.badTiles[0].transform.depth = UIStateManager_10.UIStateManager.UI_SPRITE_DEPTH;
                };
                PlaceElementFrame.prototype.getTiles = function (suffix) {
                    if (this.dimensions.equals(new point_47.Point(1, 2))) {
                        var top_1 = Tilesets_23.Tilesets.instance.outdoorTiles.getTileSource("placingElementFrame_1x2_" + suffix + "_top")
                            .toComponent(new TileTransform_19.TileTransform());
                        var bottom = Tilesets_23.Tilesets.instance.outdoorTiles.getTileSource("placingElementFrame_1x2_" + suffix + "_bottom")
                            .toComponent(new TileTransform_19.TileTransform(new point_47.Point(0, Tilesets_23.TILE_SIZE)).relativeTo(top_1.transform));
                        return [top_1, bottom];
                    }
                    if (this.dimensions.x === 1 || this.dimensions.y === 1) {
                        return [Tilesets_23.Tilesets.instance.outdoorTiles.getTileSource("placingElementFrame_small_" + suffix).toComponent(new TileTransform_19.TileTransform())];
                    }
                    return NineSlice_5.NineSlice.makeNineSliceComponents(Tilesets_23.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_" + suffix), new point_47.Point(0, 0), this.dimensions);
                };
                PlaceElementFrame.prototype.update = function (updateData) {
                    var startPos = updateData.input.mousePos;
                    var tilePt = this.pixelPtToTilePt(startPos.minus(new point_47.Point(this.dimensions.x / 2, this.dimensions.y / 2).times(Tilesets_23.TILE_SIZE)));
            ...
            exports_88("PlaceElementFrame", PlaceElementFrame);
        }
    };
});
System.register("game/ui/PlaceElementDisplay", ["engine/Entity", "engine/component", "game/world/elements/Elements", "game/Controls", "game/world/LocationManager", "game/characters/Player", "game/ui/PlaceElementFrame"], function (exports_89, context_89) {
    "use strict";
    var Entity_16, component_21, Elements_3, Controls_3, LocationManager_14, Player_8, PlaceElementFrame_1, PlaceElementDisplay;
        ...
        execute: function () {
            PlaceElementDisplay = /** @class */ (function (_super) {
                ...
                PlaceElementDisplay.prototype.startPlacing = function (element, successFn) {
                    ...
                    this.placingFrame = Player_8.Player.instance.entity.addComponent(new PlaceElementFrame_1.PlaceElementFrame(this.dimensions));
                };
            ...
            exports_89("PlaceElementDisplay", PlaceElementDisplay);
        }
    };
});
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "engine/tiles/AnimatedTileComponent", "engine/tiles/NineSlice", "engine/tiles/TileTransform", "engine/util/utils", "game/characters/Player", "game/Controls", "game/graphics/Tilesets", "game/items/Items", "game/SaveManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "game/ui/Text", "game/ui/Tooltip", "game/ui/UIStateManager"], function (exports_90, context_90) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_90("InventoryDisplay", InventoryDisplay);
        }
    };
});
System.register("game/cutscenes/CutsceneManager", ["engine/Entity", "game/SaveManager"], function (exports_91, context_91) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_91("CutsceneManager", CutsceneManager);
        }
    };
});
System.register("game/ui/ControlsUI", ["game/ui/KeyPressIndicator", "engine/point", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/ui/Text", "game/ui/UIStateManager"], function (exports_92, context_92) {
    "use strict";
    var KeyPressIndicator_1, point_49, Tilesets_25, TileTransform_21, Text_8, UIStateManager_12, makeControlsUI;
    ...
    return {
        ...
        execute: function () {
            exports_92("makeControlsUI", makeControlsUI = function (dimensions, offset) {
                var topLeft = new point_49.Point(dimensions.x / 2 - Tilesets_25.TILE_SIZE * 4 + 1, dimensions.y / 2 - Tilesets_25.TILE_SIZE * 5).plus(offset);
                ...
                return __spreadArrays(new KeyPressIndicator_1.KeyPressIndicator(topLeft.plusX(Tilesets_25.TILE_SIZE), 87 /* W */).getRenderMethods(), new KeyPressIndicator_1.KeyPressIndicator(topLeft.plusY(Tilesets_25.TILE_SIZE), 65 /* A */).getRenderMethods(), new KeyPressIndicator_1.KeyPressIndicator(topLeft.plusX(Tilesets_25.TILE_SIZE).plusY(Tilesets_25.TILE_SIZE), 83 /* S */).getRenderMethods(), new KeyPressIndicator_1.KeyPressIndicator(topLeft.plusX(Tilesets_25.TILE_SIZE * 2).plusY(Tilesets_25.TILE_SIZE), 68 /* D */).getRenderMethods(), [
                    ...
                    r.depth = UIStateManager_12.UIStateManager.UI_SPRITE_DEPTH;
                    return r;
                });
            });
        }
...
System.register("game/ui/PauseMenu", ["engine/component", "engine/Entity", "game/ui/UIStateManager", "engine/point", "game/ui/ButtonsMenu", "game/SaveManager", "game/cutscenes/CutsceneManager", "game/ui/ControlsUI", "engine/renderer/BasicRenderComponent"], function (exports_93, context_93) {
    "use strict";
    var component_23, Entity_19, UIStateManager_13, point_50, ButtonsMenu_2, SaveManager_5, CutsceneManager_1, ControlsUI_1, BasicRenderComponent_8, PauseMenu;
        ...
        execute: function () {
            PauseMenu = /** @class */ (function (_super) {
                ...
                PauseMenu.prototype.update = function (updateData) {
                    ...
                    else if (pressEsc && !UIStateManager_13.UIStateManager.instance.isMenuOpen && !CutsceneManager_1.CutsceneManager.instance.isMidCutscene) {
                        this.show(updateData.dimensions);
                    }
                };
                ...
                PauseMenu.prototype.show = function (dimensions) {
                    ...
                    this.controlsDisplay = new Entity_19.Entity([new (BasicRenderComponent_8.BasicRenderComponent.bind.apply(BasicRenderComponent_8.BasicRenderComponent, __spreadArrays([void 0], ControlsUI_1.makeControlsUI(dimensions, point_50.Point.ZERO))))()]);
                };
            ...
            exports_93("PauseMenu", PauseMenu);
        }
    };
});
System.register("game/ui/UIStateManager", ["game/ui/HUD", "game/characters/Player", "game/ui/InventoryDisplay", "game/ui/DialogueDisplay", "game/ui/PlaceElementDisplay", "game/ui/PauseMenu", "game/ui/CraftingMenu", "game/ui/SellMenu"], function (exports_94, context_94) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_94("UIStateManager", UIStateManager);
        }
    };
});
System.register("game/ui/KeyPressIndicator", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/renderer/TextRender", "game/Controls", "game/ui/Text", "game/ui/UIStateManager"], function (exports_95, context_95) {
    "use strict";
    var component_24, Tilesets_26, TileTransform_22, point_51, TextRender_7, Controls_5, Text_9, UIStateManager_14, KeyPressIndicator;
        ...
        execute: function () {
            KeyPressIndicator = /** @class */ (function (_super) {
                ...
                KeyPressIndicator.prototype.getRenderMethods = function () {
                    return [
                        Tilesets_26.Tilesets.instance.oneBit.getTileSource("keycap").toImageRender(new TileTransform_22.TileTransform(this.pos, null, 0, false, false, UIStateManager_14.UIStateManager.UI_SPRITE_DEPTH)),
                        new TextRender_7.TextRender(Controls_5.Controls.keyString(this.key).toLowerCase(), this.pos.plus(new point_51.Point(4, 4)), Text_9.TEXT_SIZE, Text_9.TEXT_FONT, "#222222" /* BLACK */, UIStateManager_14.UIStateManager.UI_SPRITE_DEPTH)
                    ];
                };
                return KeyPressIndicator;
            }(component_24.Component));
            exports_95("KeyPressIndicator", KeyPressIndicator);
        }
    };
});
System.register("game/world/elements/Interactable", ["engine/component", "engine/point", "game/ui/KeyPressIndicator", "game/Controls", "game/graphics/Tilesets", "game/ui/UIStateManager"], function (exports_96, context_96) {
    "use strict";
    var component_25, point_52, KeyPressIndicator_2, Controls_6, Tilesets_27, UIStateManager_15, Interactable;
        ...
        execute: function () {
            Interactable = /** @class */ (function (_super) {
                ...
                function Interactable(position, fn, uiOffset, isInteractable) {
                    if (uiOffset === void 0) { uiOffset = point_52.Point.ZERO; }
                ...
                Interactable.prototype.getRenderMethods = function () {
                    ...
                    return new KeyPressIndicator_2.KeyPressIndicator(this.position.minus(new point_52.Point(Tilesets_27.TILE_SIZE / 2, Tilesets_27.TILE_SIZE / 2)).plus(this.uiOffset), Controls_6.Controls.interactButton).getRenderMethods();
                };
                return Interactable;
            }(component_25.Component));
            exports_96("Interactable", Interactable);
        }
    };
});
System.register("game/world/Teleporter", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/elements/ElementComponent", "game/world/elements/Interactable", "game/world/elements/ElementFactory"], function (exports_97, context_97) {
    "use strict";
    var component_26, Entity_20, point_53, TileTransform_23, Tilesets_28, ElementComponent_3, Interactable_3, ElementFactory_3, Teleporters, TeleporterFactory;
    ...
    return {
        ...
        execute: function () {
            exports_97("Teleporters", Teleporters = {
            ...
            TeleporterFactory = /** @class */ (function (_super) {
                ...
                TeleporterFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactPos = point_53.Point.fromString(i);
                    var id = data["id"];
                    var interactComponent = e.addComponent(new Interactable_3.Interactable(interactPos, function () { return wl.useTeleporter(destinationUUID, id); }, new point_53.Point(0, Tilesets_28.TILE_SIZE / 2)));
            ...
            exports_97("TeleporterFactory", TeleporterFactory);
        }
    };
});
System.register("game/world/elements/Chest", ["engine/Entity", "engine/point", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileSetAnimation", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/items/Inventory", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/Interactable"], function (exports_98, context_98) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_98("ChestFactory", ChestFactory);
        }
    };
});
System.register("game/world/elements/Hittable", ["engine/component", "engine/util/Animator"], function (exports_99, context_99) {
    "use strict";
    var component_27, Animator_2, Hittable;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_99("Hittable", Hittable);
        }
    };
});
System.register("game/world/elements/Mushroom", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/characters/DudeFactory", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/Hittable"], function (exports_100, context_100) {
    "use strict";
    var component_28, Entity_22, point_55, TileComponent_6, TileTransform_25, DudeFactory_3, Tilesets_30, Items_4, LocationManager_16, TimeUnit_5, WorldTime_7, ElementComponent_5, ElementFactory_5, Hittable_1, NEXT_GROWTH_TIME, MushroomFactory, GrowableShroom;
        ...
        execute: function () {
            ...
            MushroomFactory = /** @class */ (function (_super) {
                ...
                MushroomFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var depth = (pos.y + 1) * Tilesets_30.TILE_SIZE + randomOffset.y;
                    var addTile = function (s, pos) {
                        var tile = e.addComponent(new TileComponent_6.TileComponent(Tilesets_30.Tilesets.instance.outdoorTiles.getTileSource(s), new TileTransform_25.TileTransform(pos.times(Tilesets_30.TILE_SIZE).plus(randomOffset))));
                        tile.transform.depth = depth;
                        return tile;
                    };
                    var tile = addTile("mushroomPlaced", pos);
                    var hittableCenter = pos.times(Tilesets_30.TILE_SIZE).plus(new point_55.Point(Tilesets_30.TILE_SIZE / 2, Tilesets_30.TILE_SIZE / 2));
                    e.addComponent(new Hittable_1.Hittable(hittableCenter, [tile.transform], function (dir) {
                        ...
                        Items_4.spawnItem(pos.times(Tilesets_30.TILE_SIZE).plusY(Tilesets_30.TILE_SIZE).plusX(Tilesets_30.TILE_SIZE / 2), 9 /* MUSHROOM */, itemDirection.times(5));
                    }));
                    e.addComponent(new GrowableShroom(nextGrowthTime, function () {
                        e.selfDestruct();
                        DudeFactory_3.DudeFactory.instance.new(6 /* SHROOM */, pos.times(Tilesets_30.TILE_SIZE).plusY(-Tilesets_30.TILE_SIZE).plusX(-Tilesets_30.TILE_SIZE / 2), LocationManager_16.LocationManager.instance.exterior());
                    }));
            ...
            exports_100("MushroomFactory", MushroomFactory);
...
System.register("game/world/elements/HittableResource", ["engine/collision/BoxCollider", "engine/point", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/elements/ElementComponent", "game/world/elements/Hittable"], function (exports_101, context_101) {
    "use strict";
    var BoxCollider_3, point_56, Tilesets_31, Items_5, LocationManager_17, ElementComponent_6, Hittable_2, HittableResource;
    ...
    return {
        ...
        execute: function () {
                ...
                HittableResource.prototype.hitCallback = function (hitDir) {
                    ...
                    for (var i = 0; i < itemsOut; i++) {
                        ...
                        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                            ...
                            Items_5.spawnItem(this.position.plus(new point_56.Point(0, Tilesets_31.TILE_SIZE / 2)).plus(itemDirection.times(placeDistance)), // bottom center, then randomly adjusted
            ...
            exports_101("HittableResource", HittableResource);
        }
    };
});
System.register("game/characters/weapons/WeaponType", [], function (exports_102, context_102) {
    "use strict";
    var WeaponType;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_102("WeaponType", WeaponType);
        }
    };
});
System.register("game/world/elements/Rock", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/ElementComponent", "game/world/elements/HittableResource", "game/characters/Player", "game/characters/weapons/WeaponType", "game/world/elements/ElementFactory"], function (exports_103, context_103) {
    "use strict";
    var point_57, Tilesets_32, BoxCollider_4, TileComponent_7, TileTransform_26, Entity_23, ElementComponent_7, HittableResource_1, Player_11, WeaponType_1, ElementFactory_6, RockFactory;
        ...
        execute: function () {
            RockFactory = /** @class */ (function (_super) {
                ...
                RockFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var tile = e.addComponent(new TileComponent_7.TileComponent(Tilesets_32.Tilesets.instance.outdoorTiles.getTileSource("rock" + variation + (mossy ? 'mossy' : '')), new TileTransform_26.TileTransform(pos.times(Tilesets_32.TILE_SIZE))));
                    tile.transform.depth = (pos.y + 1) * Tilesets_32.TILE_SIZE - /* prevent weapon from clipping */ 5;
                    tile.transform.mirrorX = flipped;
                    var hitboxDims = new point_57.Point(12, 4);
                    e.addComponent(new BoxCollider_4.BoxCollider(pos.plus(new point_57.Point(.5, 1)).times(Tilesets_32.TILE_SIZE).minus(new point_57.Point(hitboxDims.x / 2, hitboxDims.y + 2)), hitboxDims));
                    var hittableResource = e.addComponent(new HittableResource_1.HittableResource(pos.plus(new point_57.Point(.5, .5)).times(Tilesets_32.TILE_SIZE), [tile.transform], availableResources, maxResourcesCount, function () {
            ...
            exports_103("RockFactory", RockFactory);
        }
    };
});
System.register("game/world/interior/AsciiInteriorBuilder", ["engine/point"], function (exports_104, context_104) {
    "use strict";
    var point_58, AsciiInteriorBuilder;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_104("AsciiInteriorBuilder", AsciiInteriorBuilder);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/WorldLocation", "game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_105, context_105) {
    "use strict";
    var WorldLocation_2, LocationManager_18, point_59, Tilesets_33, NineSlice_7, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_105("makeTentInterior", makeTentInterior = function (outside, color) {
                ...
                var interactablePos = new point_59.Point(2.5, 4).times(Tilesets_33.TILE_SIZE);
                var teleporter = { to: outside.uuid, pos: interactablePos.plusY(-4) };
                l.addTeleporter(teleporter);
                l.addElement(5 /* TELEPORTER */, new point_59.Point(2, 4), { to: outside.uuid, i: interactablePos.toString() });
                var groundType = color + "tentInterior";
                NineSlice_7.NineSlice.nineSliceForEach(new point_59.Point(5, 4), function (pt, index) { return l.addGroundElement(1 /* BASIC_NINE_SLICE */, pt, { k: groundType, i: index }); });
...
System.register("game/world/elements/Tent", ["engine/collision/BoxCollider", "engine/Entity", "engine/point", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/interior/Tent", "game/world/elements/ElementComponent", "game/world/elements/ElementFactory", "game/world/elements/ElementUtils", "game/world/elements/Interactable"], function (exports_106, context_106) {
    "use strict";
    var BoxCollider_5, Entity_24, point_60, TileComponent_8, TileTransform_27, Tilesets_34, Tent_1, ElementComponent_8, ElementFactory_7, ElementUtils_3, Interactable_5, TentFactory, addTile;
        ...
        execute: function () {
            ...
            TentFactory = /** @class */ (function (_super) {
                ...
                function TentFactory() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.type = 3 /* TENT */;
                    _this.dimensions = new point_60.Point(4, 3);
                    return _this;
                }
                TentFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactablePos = pos.plus(new point_60.Point(2, 2)).times(Tilesets_34.TILE_SIZE);
                    var sourceTeleporter = { to: destinationUUID, pos: interactablePos.plusY(12) };
                    wl.addTeleporter(sourceTeleporter);
                    // Set up tiles
                    var depth = (pos.y + 1) * Tilesets_34.TILE_SIZE + /* prevent clipping */ 1;
                    addTile(e, color + "tentNW", pos.plusX(1), depth);
                    addTile(e, color + "tentNE", pos.plus(new point_60.Point(2, 0)), depth);
                    addTile(e, color + "tentSW", pos.plus(new point_60.Point(1, 1)), depth);
                    addTile(e, color + "tentSE", pos.plus(new point_60.Point(2, 1)), depth);
                    e.addComponent(new BoxCollider_5.BoxCollider(pos.plus(new point_60.Point(1, 1)).times(Tilesets_34.TILE_SIZE), new point_60.Point(Tilesets_34.TILE_SIZE * 2, Tilesets_34.TILE_SIZE)));
                    // Set up teleporter
                    e.addComponent(new Interactable_5.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_60.Point(1, -Tilesets_34.TILE_SIZE * 1.4)));
                    return e.addComponent(new ElementComponent_8.ElementComponent(3 /* TENT */, pos, ElementUtils_3.ElementUtils.rectPoints(pos.plus(new point_60.Point(1, 1)), new point_60.Point(2, 1)), function () { return { destinationUUID: destinationUUID, color: color }; }));
                };
                return TentFactory;
            }(ElementFactory_7.ElementFactory));
            exports_106("TentFactory", TentFactory);
            addTile = function (e, s, pos, depth) {
                var tile = e.addComponent(new TileComponent_8.TileComponent(Tilesets_34.Tilesets.instance.outdoorTiles.getTileSource(s), new TileTransform_27.TileTransform(pos.times(Tilesets_34.TILE_SIZE))));
                tile.transform.depth = depth;
            };
        }
    };
});
System.register("game/world/elements/Tree", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/HittableResource", "game/world/elements/ElementComponent", "game/characters/weapons/WeaponType", "game/characters/Player", "game/world/elements/ElementFactory", "engine/component", "game/world/WorldTime", "game/world/TimeUnit", "game/world/LocationManager"], function (exports_107, context_107) {
    "use strict";
    var point_61, Tilesets_35, BoxCollider_6, TileComponent_9, TileTransform_28, Entity_25, HittableResource_2, ElementComponent_9, WeaponType_2, Player_12, ElementFactory_8, component_29, WorldTime_8, TimeUnit_6, LocationManager_19, NEXT_GROWTH_TIME, SIZE, AVAILABLE_RESOURCES, TreeFactory, GrowableTree;
        ...
        execute: function () {
            ...
            TreeFactory = /** @class */ (function (_super) {
                ...
                function TreeFactory(type) {
                    var _this = _super.call(this) || this;
                    _this.dimensions = new point_61.Point(1, 2);
                    _this.type = type;
                    return _this;
                }
                TreeFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var randomOffset = new point_61.Point(0, -4).randomlyShifted(2, 4);
                    var depth = (pos.y + 2) * Tilesets_35.TILE_SIZE + randomOffset.y;
                    var addTile = function (s, pos) {
                        var tile = e.addComponent(new TileComponent_9.TileComponent(Tilesets_35.Tilesets.instance.outdoorTiles.getTileSource(s), new TileTransform_28.TileTransform(pos.times(Tilesets_35.TILE_SIZE).plus(randomOffset))));
                        tile.transform.depth = depth;
                        return tile;
                    };
                    ...
                    var tiles;
                    if (size === 3) {
                        tiles = [addTile(prefix + "Top", pos), addTile(prefix + "Base", pos.plus(new point_61.Point(0, 1)))];
                    }
                    else {
                        tiles = [addTile("" + prefix + ["Sapling", "Small"][size - 1], pos.plus(new point_61.Point(0, 1)))];
                    }
                    var hitboxDims = new point_61.Point(8, 3);
                    e.addComponent(new BoxCollider_6.BoxCollider(pos.plus(new point_61.Point(.5, 2)).times(Tilesets_35.TILE_SIZE).minus(new point_61.Point(hitboxDims.x / 2, hitboxDims.y)).plus(randomOffset), hitboxDims));
                    var saplingType = this.type === 0 /* TREE_ROUND */ ? 7 /* ROUND_SAPLING */ : 8 /* POINTY_SAPLING */;
                    var hittableCenter = pos.times(Tilesets_35.TILE_SIZE).plus(new point_61.Point(Tilesets_35.TILE_SIZE / 2, Tilesets_35.TILE_SIZE + Tilesets_35.TILE_SIZE / 2)).plus(randomOffset); // center of bottom tile
            ...
            exports_107("TreeFactory", TreeFactory);
...
System.register("game/world/elements/Elements", ["game/world/Teleporter", "game/world/elements/Campfire", "game/world/elements/Chest", "game/world/elements/House", "game/world/elements/Mushroom", "game/world/elements/Rock", "game/world/elements/Tent", "game/world/elements/Tree"], function (exports_108, context_108) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_108("SavedElement", SavedElement);
            ...
            exports_108("Elements", Elements);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/util/Grid", "engine/util/Lists", "engine/util/Noise", "game/graphics/Tilesets", "game/world/LocationManager", "game/world/WorldLocation"], function (exports_109, context_109) {
    "use strict";
    var point_62, Grid_4, Lists_5, Noise_1, Tilesets_36, LocationManager_20, WorldLocation_3, MapGenerator;
    ...
    return {
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                ...
                MapGenerator.prototype.spawnTreesAtEdge = function () {
                    ...
                    for (var x = -MapGenerator.MAP_SIZE / 2; x < MapGenerator.MAP_SIZE; x++) {
                        for (var y = -MapGenerator.MAP_SIZE / 2; y < MapGenerator.MAP_SIZE; y++) {
                            var distToCenter = new point_62.Point(x, y).distanceTo(point_62.Point.ZERO);
                            var pt = new point_62.Point(x, y);
                ...
                MapGenerator.prototype.clearPathToCenter = function () {
                    ...
                    for (var x = MapGenerator.MAP_SIZE / 2 - 11; x < MapGenerator.MAP_SIZE / 2; x++) {
                        for (var y = MapGenerator.MAP_SIZE / 2 - 25; y < MapGenerator.MAP_SIZE / 2 - 23; y++) {
                            var element = this.location.getElement(new point_62.Point(x, y));
                    ...
                    for (var x = 0; x < 6; x++) {
                        for (var y = 0; y < 4; y++) {
                            var element = this.location.getElement(clearingCorner.plus(new point_62.Point(x, y)));
                            if (!!element && typesToClear.indexOf(element.type) !== -1) {
                                this.location.removeElement(element);
                            }
                        }
                ...
                MapGenerator.ENTER_LAND_POS = new point_62.Point(1, 1).times(MapGenerator.MAP_SIZE / 2 * Tilesets_36.TILE_SIZE).plusY(-Tilesets_36.TILE_SIZE * 25).plusX(Tilesets_36.TILE_SIZE * 2);
                return MapGenerator;
            }());
            exports_109("MapGenerator", MapGenerator);
        }
    };
});
System.register("game/cutscenes/Camera", ["engine/point", "game/world/MapGenerator", "game/graphics/Tilesets"], function (exports_110, context_110) {
    "use strict";
    var point_63, MapGenerator_5, Tilesets_37, Camera;
    ...
    return {
        ...
        execute: function () {
            Camera = /** @class */ (function () {
                function Camera() {
                    this.shakeOffset = point_63.Point.ZERO;
                ...
                Camera.prototype.getUpdatedPosition = function (dimensions, elapsedTimeMillis) {
                    ...
                    var xLimit = MapGenerator_5.MapGenerator.MAP_SIZE / 2 * Tilesets_37.TILE_SIZE - dimensions.x / 2;
                    var yLimit = MapGenerator_5.MapGenerator.MAP_SIZE / 2 * Tilesets_37.TILE_SIZE - dimensions.y / 2;
                    var trackedPoint = (_b = (_a = this.dudeTarget) === null || _a === void 0 ? void 0 : _a.position) !== null && _b !== void 0 ? _b : this.pointTarget;
                    var clampedTrackedPoint = new point_63.Point(this.clamp(trackedPoint.x, -xLimit, xLimit), this.clamp(trackedPoint.y, -yLimit, yLimit));
                    ...
                    if (this.shakeDuration > 0) {
                        ...
                        this.shakeOffset = new point_63.Point(Math.random() - .5, Math.random() - .5).times(this.shakePower);
                    }
            ...
            exports_110("Camera", Camera);
        }
    };
});
System.register("game/world/TownStats", ["game/SaveManager"], function (exports_111, context_111) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_111("TownStats", TownStats);
        }
    };
});
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_64.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    var dx = 0;
                    var dy = 0;
                    if (!UIStateManager_16.UIStateManager.instance.isMenuOpen) {
                    ...
                    this.dude.move(updateData, new point_64.Point(dx, dy), this.dude.rolling() ? 0 : updateData.input.mousePos.x - this.dude.standingPosition.x, 1 + (this.dude.rolling() ? 1.2 : 0));
                ...
                Player.prototype.updateInteractables = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_64.Point(0, 7));
...
System.register("game/characters/Enemy", ["engine/component", "game/graphics/Tilesets", "game/world/OutdoorDarknessMask", "game/characters/Dude", "game/characters/NPC"], function (exports_113, context_113) {
    "use strict";
    var component_31, Tilesets_39, OutdoorDarknessMask_3, Dude_3, NPC_3, Enemy;
                ...
                Enemy.prototype.awake = function () {
                    ...
                    if (this.dude.factions.includes(3 /* DEMONS */)) {
                        ...
                        this.npc.pathFindingHeuristic = function (pt, goal) {
                            return pt.distanceTo(goal) + (OutdoorDarknessMask_3.OutdoorDarknessMask.instance.isDark(pt.times(Tilesets_39.TILE_SIZE)) ? 0 : 100);
                        };
...
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_114, context_114) {
    "use strict";
    var component_32, Player_13, Dude_4, point_65, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_65.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_65.Point.ZERO;
                };
...
System.register("game/characters/ShroomNPC", ["engine/component", "game/graphics/Tilesets", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/characters/Dude", "game/characters/DudeFactory", "game/characters/Enemy", "game/characters/weapons/WeaponType"], function (exports_115, context_115) {
    "use strict";
    var component_33, Tilesets_40, LocationManager_22, TimeUnit_7, WorldTime_9, Dude_5, DudeFactory_5, Enemy_1, WeaponType_3, SIZE, NEXT_GROWTH_TIME, ShroomNPC;
            ...
            ShroomNPC = /** @class */ (function (_super) {
                ...
                ShroomNPC.prototype.lateUpdate = function (data) {
                    ...
                    if (ogSize === 3 || Math.random() > 0.5) {
                        // spread more shrooms
                        var tilePos = Tilesets_40.pixelPtToTilePt(this.dude.standingPosition);
...
System.register("game/characters/Centaur", ["engine/component", "game/characters/dialogues/GenericDialogue", "game/characters/Dude", "game/characters/NPC"], function (exports_116, context_116) {
    "use strict";
    var component_34, GenericDialogue_2, Dude_6, NPC_4, Centaur;
...
System.register("game/characters/Villager", ["engine/component", "game/characters/Dude", "game/characters/NPC", "game/world/OutdoorDarknessMask", "game/characters/ShroomNPC", "game/characters/Centaur"], function (exports_117, context_117) {
    "use strict";
    var component_35, Dude_7, NPC_5, OutdoorDarknessMask_4, ShroomNPC_1, Centaur_1, Villager;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.load = function (saveState, location) {
                    this.make(saveState.type, point_66.Point.fromString(saveState.pos), saveState, location);
                };
                DudeFactory.prototype.make = function (type, pos, saveState, location) {
                    ...
                    switch (type) {
                        ...
                        case 1 /* DIP */: {
                            ...
                            additionalComponents = [
                                new NPC_6.NPC(NPCSchedule_3.NPCSchedules.newGoToSchedule(new point_66.Point(0, 0))),
                        ...
                        case 4 /* HERALD */: {
                            ...
                            additionalComponents = [
                                ...
                                Lists_7.Lists.oneOf([new point_66.Point(-3, 0), new point_66.Point(-3, 1), new point_66.Point(-2, 0), new point_66.Point(-2, 1)].filter(function (pt) { return !location.isOccupied(pt); })))),
                                new Villager_1.Villager()
                            ];
                    ...
                    new Entity_26.Entity([d].concat(additionalComponents));
...
System.register("game/saves/DudeSaveState", [], function (exports_119, context_119) {
    "use strict";
    var DudeSaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_119("DudeSaveState", DudeSaveState);
        }
    };
});
System.register("game/saves/LocationSaveState", [], function (exports_120, context_120) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_120("LocationSaveState", LocationSaveState);
        }
    };
});
System.register("game/saves/LocationManagerSaveState", [], function (exports_121, context_121) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_121("LocationManagerSaveState", LocationManagerSaveState);
        }
    };
});
System.register("game/world/LocationManager", ["game/world/WorldLocation"], function (exports_122, context_122) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_122("LocationManager", LocationManager);
        }
    };
});
System.register("game/items/DroppedItem", ["engine/collision/BoxCollider", "engine/component", "engine/point", "game/characters/Player", "game/world/LocationManager", "game/items/Items", "game/SaveManager"], function (exports_123, context_123) {
    "use strict";
    var BoxCollider_7, component_36, point_67, Player_15, LocationManager_24, Items_6, SaveManager_7, DroppedItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_123("DroppedItem", DroppedItem);
        }
    };
});
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point", "game/characters/weapons/WeaponType", "game/characters/Player"], function (exports_124, context_124) {
    "use strict";
    var _a, Tilesets_41, Entity_27, LocationManager_25, DroppedItem_1, point_68, WeaponType_5, Player_16, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_124("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_124("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
                _a[0 /* COIN */] = new ItemMetadata({
                    displayName: "Coin",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("coin"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150); },
                    stackLimit: Number.MAX_SAFE_INTEGER,
                }),
                _a[1 /* ROCK */] = new ItemMetadata({
                    displayName: "Rock",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("rock"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("rockItem"); },
                }),
                _a[2 /* WOOD */] = new ItemMetadata({
                    displayName: "Wood",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("wood"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("woodItem"); },
                }),
                _a[3 /* TENT */] = new ItemMetadata({
                    displayName: "Tent",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("tent"); },
                    stackLimit: 1,
                    element: 3 /* TENT */
                }),
                _a[4 /* CAMPFIRE */] = new ItemMetadata({
                    displayName: "Campfire",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("campfire"); },
                    stackLimit: 1,
                    element: 4 /* CAMPFIRE */
                }),
                _a[5 /* IRON */] = new ItemMetadata({
                    displayName: "Iron",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("iron"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("ironItem"); },
                }),
                _a[6 /* HOUSE */] = new ItemMetadata({
                    displayName: "House",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("house"); },
                    stackLimit: 1,
                    element: 6 /* HOUSE */
                }),
                _a[7 /* ROUND_SAPLING */] = new ItemMetadata({
                    displayName: "Sapling",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("treeRound"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("treeRoundSapling"); },
                    element: 0 /* TREE_ROUND */
                }),
                _a[8 /* POINTY_SAPLING */] = new ItemMetadata({
                    displayName: "Sapling",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("treePointy"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("treePointySapling"); },
                    element: 1 /* TREE_POINTY */
                }),
                _a[9 /* MUSHROOM */] = new ItemMetadata({
                    displayName: "Mushroom",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("mushroom"); },
                    droppedIconSupplier: function () { return Tilesets_41.Tilesets.instance.outdoorTiles.getTileSource("mushroom"); },
                    element: 7 /* MUSHROOM */,
                ...
                _a[100012 /* AXE */] = new ItemMetadata({
                    displayName: "Axe",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("axe"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.AXE
                }),
                _a[100022 /* PICKAXE */] = new ItemMetadata({
                    displayName: "Pickaxe",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("pickaxe"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.PICKAXE
                }),
                _a[100003 /* SWORD */] = new ItemMetadata({
                    displayName: "Sword",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("sword"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.SWORD
                }),
                _a[100021 /* SPEAR */] = new ItemMetadata({
                    displayName: "Spear",
                    inventoryIconSupplier: function () { return Tilesets_41.Tilesets.instance.oneBit.getTileSource("spear"); },
                    stackLimit: 1,
             ...
             * @param position The bottom center where the item should be placed
             */
            exports_124("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_68.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
                LocationManager_25.LocationManager.instance.currentLocation.droppedItems.add(new Entity_27.Entity([
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_125, context_125) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_125("Inventory", Inventory);
        }
    };
});
System.register("game/characters/DudeAnimationUtils", ["game/graphics/ImageFilters", "game/graphics/Tilesets", "game/SaveManager"], function (exports_126, context_126) {
    "use strict";
    var ImageFilters_3, Tilesets_42, SaveManager_8, maybeFilter, DudeAnimationUtils;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_126("DudeAnimationUtils", DudeAnimationUtils = {
                getCharacterIdleAnimation: function (characterAnimName, blob) {
                    var animSpeed = 150;
                    var anim = Tilesets_42.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_idle_anim", animSpeed)
                        || Tilesets_42.Tilesets.instance.extraCharacterSet1.getTileSetAnimation(characterAnimName + "_Idle", 4, animSpeed)
                        || Tilesets_42.Tilesets.instance.extraCharacterSet2.getIdleAnimation(characterAnimName, animSpeed);
                    return maybeFilter(characterAnimName, blob, anim);
                },
                getCharacterWalkAnimation: function (characterAnimName, blob) {
                    var animSpeed = 80;
                    var anim = Tilesets_42.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_run_anim", animSpeed)
                        || Tilesets_42.Tilesets.instance.extraCharacterSet1.getTileSetAnimation(characterAnimName + "_Walk", 4, animSpeed)
                        || Tilesets_42.Tilesets.instance.extraCharacterSet2.getWalkAnimation(characterAnimName, animSpeed);
                    return maybeFilter(characterAnimName, blob, anim);
                },
            });
        }
...
System.register("game/characters/weapons/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_127, context_127) {
    "use strict";
    var component_37, TileComponent_10, Tilesets_43, TileTransform_29, point_69, Dude_9, State, Shield;
    ...
    return {
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                function Shield(shieldId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.blockingShieldSprite = _this.entity.addComponent(new TileComponent_10.TileComponent(Tilesets_43.Tilesets.instance.dungeonCharacters.getTileSource(shieldId), new TileTransform_29.TileTransform().relativeTo(_this.dude.animation.transform)));
                    };
                    return _this;
                }
                Shield.prototype.update = function (updateData) {
                    // default (drawn) position
                    var pos = this.dude.animation.transform.dimensions.minus(new point_69.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_69.Point(-6, -1));
                    }
                    else if (this.state === State.DRAWN) {
                        pos = pos.plus(new point_69.Point(5, 4).times(this.raisedPerc < .7 ? this.raisedPerc : 1.4 - this.raisedPerc).apply(Math.floor));
            ...
            exports_127("Shield", Shield);
        }
    };
});
System.register("game/characters/weapons/Weapon", ["engine/component", "game/world/LocationManager", "game/characters/Dude", "game/world/elements/Hittable", "engine/point"], function (exports_128, context_128) {
    "use strict";
    var component_38, LocationManager_26, Dude_10, Hittable_3, point_70, Weapon;
        ...
        execute: function () {
            Weapon = /** @class */ (function (_super) {
                ...
                Weapon.hitResources = function (dude) {
                    var interactDistance = 20;
                    var interactCenter = dude.standingPosition.minus(new point_70.Point(0, 7));
            ...
            exports_128("Weapon", Weapon);
        }
    };
});
System.register("game/characters/weapons/UnarmedWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType"], function (exports_129, context_129) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_129("UnarmedWeapon", UnarmedWeapon);
        }
    };
});
System.register("game/characters/weapons/MeleeWeapon", ["game/characters/weapons/Weapon", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator"], function (exports_130, context_130) {
    "use strict";
    var Weapon_2, TileTransform_30, point_71, Tilesets_44, Animator_3, State, MeleeWeapon;
        ...
        execute: function () {
            ...
            MeleeWeapon = /** @class */ (function (_super) {
                ...
                function MeleeWeapon(weaponType, weaponId, offsetFromCenter) {
                    ...
                    _this.currentAnimationFrame = 0;
                    _this.start = function (startData) {
                        _this.weaponSprite = Tilesets_44.Tilesets.instance.dungeonCharacters.getTileSource(weaponId);
                        ...
                        _this.slashSprite = _this.entity.addComponent(Tilesets_44.Tilesets.instance.oneBit.getTileSource("slash").toComponent());
                    };
                ...
                MeleeWeapon.prototype.animate = function () {
                    var _a;
                    var offsetFromEdge = new point_71.Point(this.dude.animation.transform.dimensions.x / 2 - this.weaponTransform.dimensions.x / 2, this.dude.animation.transform.dimensions.y - this.weaponTransform.dimensions.y).plus(this.offsetFromCenter);
                    var pos = new point_71.Point(0, 0);
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                        pos = offsetFromEdge;
                    }
                        ...
                        // center on back
                        pos = offsetFromEdge.plus(new point_71.Point(3, -1));
                    }
                    ...
                    this.slashSprite.transform.position = this.dude.animation.transform.position.plus(new point_71.Point((this.weaponTransform.mirrorX ? -1 : 1) * (this.weaponTransform.dimensions.y - 10), 8));
                };
                ...
                MeleeWeapon.prototype.getAttackAnimationPosition = function () {
                    ...
                    if (this.currentAnimationFrame < swingStartFrame) {
                        return [new point_71.Point(this.currentAnimationFrame * 3, 0), 0];
                    }
                    else if (this.currentAnimationFrame < resettingFrame) {
                        return [
                            new point_71.Point((6 - this.currentAnimationFrame) + this.weaponTransform.dimensions.y - swingStartFrame * 3, Math.floor(this.weaponTransform.dimensions.y / 2 - 1)),
                            90
                        ];
                    }
                    else {
                        return [new point_71.Point((1 - this.currentAnimationFrame + resettingFrame) * 3, 2), 0];
                    }
                };
                return MeleeWeapon;
            }(Weapon_2.Weapon));
            exports_130("MeleeWeapon", MeleeWeapon);
        }
    };
});
System.register("game/characters/weapons/Projectile", ["engine/collision/BoxCollider", "engine/component", "engine/Entity", "engine/point", "game/world/LocationManager", "game/items/DroppedItem", "engine/util/Lists"], function (exports_131, context_131) {
    "use strict";
    var BoxCollider_8, component_39, Entity_28, point_72, LocationManager_27, DroppedItem_2, Lists_8, Projectile, spawnProjectile;
    ...
    return {
        ...
        execute: function () {
            Projectile = /** @class */ (function (_super) {
                ...
                function Projectile(position, sprite, item, velocity, attacker) {
                    ...
                    _this.start = function () {
                        ...
                        _this.collider = _this.entity.addComponent(new BoxCollider_8.BoxCollider(pos.plus(new point_72.Point(10, 10)), colliderSize, DroppedItem_2.DroppedItem.COLLISION_LAYER, !!sourceCollider ? [sourceCollider] : []));
                        _this.reposition();
                        var last = new Date().getTime();
                        var move = function () {
                            if (!_this.enabled) {
                            ...
                            if (diff > 0) {
                                if (_this.reposition(velocity)) {
                                    ...
                                    if (!!enemy) {
                                        ...
                                        _this.tile.transform.position = new point_72.Point(_this.tile.transform.dimensions.y - 10, relativeOffset.y);
            ...
            exports_131("spawnProjectile", spawnProjectile = function (pos, sprite, item, velocity, attacker) {
                LocationManager_27.LocationManager.instance.currentLocation.droppedItems.add(new Entity_28.Entity([
...
System.register("game/characters/weapons/SpearWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator", "game/characters/weapons/Projectile"], function (exports_132, context_132) {
    "use strict";
    var Weapon_3, WeaponType_7, TileTransform_31, point_73, Tilesets_45, Animator_4, Projectile_1, State, SpearWeapon;
        ...
        execute: function () {
            ...
            SpearWeapon = /** @class */ (function (_super) {
                ...
                function SpearWeapon() {
                    ...
                    _this.currentAnimationFrame = 0;
                    _this.start = function (startData) {
                        _this.weaponSprite = Tilesets_45.Tilesets.instance.dungeonCharacters.getTileSource("weapon_spear");
                        _this.weaponTransform = new TileTransform_31.TileTransform(point_73.Point.ZERO, _this.weaponSprite.dimensions).relativeTo(_this.dude.animation.transform);
                        _this.offsetFromCenter = new point_73.Point(-5, 0);
                        _this._range = _this.weaponSprite.dimensions.y;
                    };
                    return _this;
                }
                ...
                SpearWeapon.prototype.cancelAttack = function () {
                    ...
                    if (this.timeDrawn > timeToThrow) {
                        ...
                        var newTransform = new TileTransform_31.TileTransform(this.weaponTransform.position, this.weaponTransform.dimensions, this.weaponTransform.rotation, this.weaponTransform.mirrorX, this.weaponTransform.mirrorY, this.weaponTransform.depth);
                        Projectile_1.spawnProjectile(newTransform.position.plusY(24), this.weaponSprite, 100021 /* SPEAR */, new point_73.Point(40 * this.dude.facingMultipler(), 4.5), this.dude);
                    }
                    else {
                        this.state = State.ATTACKING;
                        setTimeout(function () { return _this.damageEnemies(); }, 100);
                ...
                SpearWeapon.prototype.getBasePosition = function (rotation) {
                    var offset = new point_73.Point(this.dude.animation.transform.dimensions.x / 2 - this.weaponTransform.dimensions.x / 2, this.dude.animation.transform.dimensions.y - this.weaponTransform.dimensions.y).plus(this.offsetFromCenter);
                    if (rotation === 90) {
                        offset = offset.plus(new point_73.Point(10, 10));
                    }
                    return offset.plus(this.dude.getAnimationOffsetPosition());
                };
                SpearWeapon.prototype.animate = function () {
                    var drawSpeed = 100;
                    var pos = point_73.Point.ZERO;
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                ...
                SpearWeapon.prototype.getAttackAnimationPosition = function () {
                    if (this.currentAnimationFrame >= this.frameCount - 1) {
                        return [new point_73.Point(2, 0), 90];
                    }
                    else {
                        var x = [8, 14, 16, 12, 8][this.currentAnimationFrame];
                        return [new point_73.Point(x, 0), 90];
                    }
                };
                return SpearWeapon;
            }(Weapon_3.Weapon));
            exports_132("SpearWeapon", SpearWeapon);
        }
    };
});
System.register("game/characters/weapons/WeaponFactory", ["game/characters/weapons/WeaponType", "game/characters/weapons/UnarmedWeapon", "game/characters/weapons/MeleeWeapon", "engine/point", "game/characters/weapons/SpearWeapon"], function (exports_133, context_133) {
    "use strict";
    var WeaponType_8, UnarmedWeapon_1, MeleeWeapon_1, point_74, SpearWeapon_1, WeaponFactory;
    ...
    return {
        ...
        execute: function () {
            exports_133("WeaponFactory", WeaponFactory = {
                ...
                make: function (type) {
                    switch (type) {
                        ...
                        case WeaponType_8.WeaponType.SWORD:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.SWORD, "weapon_regular_sword", new point_74.Point(-6, -2));
                        case WeaponType_8.WeaponType.CLUB:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.CLUB, "weapon_baton_with_spikes", new point_74.Point(-6, -2));
                        case WeaponType_8.WeaponType.PICKAXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.PICKAXE, "weapon_pickaxe", new point_74.Point(-5, -2));
                        case WeaponType_8.WeaponType.AXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.AXE, "weapon_axe", new point_74.Point(-3, -1));
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(uuid, type, factions, characterAnimName, position, weaponType, shieldId, maxHealth, health, speed, inventory, dialogue, blob) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_75.Point(3, 15);
                    ...
                    _this.awake = function () {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_6.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_32.TileTransform(new point_75.Point(0, 28 - height))));
                        ...
                        var colliderSize = new point_75.Point(10, 8);
                        _this.relativeColliderPos = new point_75.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_7.Interactable(new point_75.Point(0, 0), function () { return DialogueDisplay_5.DialogueDisplay.instance.startDialogue(_this); }, point_75.Point.ZERO, function () { var _a; return !UIStateManager_17.UIStateManager.instance.isMenuOpen && !!_this.dialogue && ((_a = _this.entity.getComponent(NPC_7.NPC)) === null || _a === void 0 ? void 0 : _a.canTalk()); }));
                    };
                    return _this;
                }
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_75.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: false,
                    configurable: true
                });
                ...
                Dude.prototype.update = function (updateData) {
                    ...
                    if (!!this.dialogueInteract) {
                        this.dialogueInteract.position = this.standingPosition.minus(new point_75.Point(0, 5));
                        this.dialogueInteract.uiOffset = new point_75.Point(0, -Tilesets_46.TILE_SIZE * 1.5).plus(this.getAnimationOffsetPosition());
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_75.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_75.Point(0, 5)));
                    this.deathOffset = this.animation.transform.position.minus(prePos);
                    this.animation.goToAnimation(0);
                    this.animation.pause();
                    setTimeout(function () { return Items_8.spawnItem(_this.standingPosition.minus(new point_75.Point(0, 2)), _this.droppedItemSupplier()); }, 100);
                    this.dropWeapon();
                ...
                Dude.prototype.roll = function () {
                    ...
                    var setRotation = function (rot, offset) {
                        if (_this.animation.transform.mirrorX) {
                            ...
                            _this.rollingOffset = new point_75.Point(-offset.x, offset.y);
                        }
                        else {
                            _this.animation.transform.rotation = rot;
                    ...
                    this.isRolling = true;
                    this.canRoll = false;
                    setRotation(90, new point_75.Point(6, 8));
                    setTimeout(function () { return setRotation(180, new point_75.Point(0, 14)); }, speed);
                    setTimeout(function () { return setRotation(270, new point_75.Point(-6, 8)); }, speed * 2);
                    setTimeout(function () {
                        setRotation(0, point_75.Point.ZERO);
                        _this.isRolling = false;
                    }, speed * 3);
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    return new point_75.Point(0, arr[f]);
                };
                ...
                Dude.prototype.getIndicator = function () {
                    ...
                    if (!tile || ((_a = this.dialogueInteract) === null || _a === void 0 ? void 0 : _a.isShowingUI) || DialogueDisplay_5.DialogueDisplay.instance.dialogueSource === this) {
                        ...
                        return [tile.toImageRender(new TileTransform_32.TileTransform(this.standingPosition.plusY(-28).plus(new point_75.Point(1, 1).times(-Tilesets_46.TILE_SIZE / 2)).plus(this.getAnimationOffsetPosition()), new point_75.Point(Tilesets_46.TILE_SIZE, Tilesets_46.TILE_SIZE), 0, false, false, UIStateManager_17.UIStateManager.UI_SPRITE_DEPTH))];
                    }
                };
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_76.Point(-1, 0));
            ...
            exports_135("IntroCutscene", IntroCutscene);
        }
    };
});
        ...
        execute: function () {
            ...
            GameScene = /** @class */ (function () {
                ...
                GameScene.prototype.newGame = function () {
                    ...
                    DudeFactory_6.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_77.Point(-4, 0).times(Tilesets_47.TILE_SIZE));
                ...
                GameScene.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.uiView = {
                        ...
                        entities: UIStateManager_18.UIStateManager.instance.get(dimensions, updateViewsContext.elapsedTimeMillis)
                    };
                };
                GameScene.prototype.getDebugEntity = function () {
                    ...
                    for (var i = -gridRange; i < gridRange; i++) {
                        var top_2 = base.times(Tilesets_47.TILE_SIZE).plusX(i * Tilesets_47.TILE_SIZE).plusY(-gridRange * Tilesets_47.TILE_SIZE);
                        lines.push(new LineRender_2.LineRender(top_2, top_2.plusY(2 * gridRange * Tilesets_47.TILE_SIZE)));
                    }
                    // horizontal lines
                    for (var i = -gridRange; i < gridRange; i++) {
                        var left = base.times(Tilesets_47.TILE_SIZE).plusX(-gridRange * Tilesets_47.TILE_SIZE).plusY(i * Tilesets_47.TILE_SIZE);
                        lines.push(new LineRender_2.LineRender(left, left.plusX(2 * gridRange * Tilesets_47.TILE_SIZE)));
                    }
                    return new Entity_29.Entity([new (BasicRenderComponent_9.BasicRenderComponent.bind.apply(BasicRenderComponent_9.BasicRenderComponent, __spreadArrays([void 0], lines)))()]);
                };
                return GameScene;
            }());
            exports_136("GameScene", GameScene);
        }
    };
});
        ...
        execute: function () {
            MainMenuButton = /** @class */ (function (_super) {
                ...
                MainMenuButton.prototype.getRenderMethods = function () {
                    ...
                    return [new TextRender_8.TextRender(text.toUpperCase(), this.position.plusX(-this.width / 2).plusX(offset), Text_10.TEXT_SIZE, Text_10.TEXT_FONT, this.hovering ? "#fdf7ed" /* WHITE */ : "#417089" /* DARK_BLUE */, UIStateManager_19.UIStateManager.UI_SPRITE_DEPTH)];
                };
                return MainMenuButton;
            }(component_42.Component));
            exports_137("MainMenuButton", MainMenuButton);
        }
    };
});
System.register("engine/renderer/RectRender", ["engine/point", "engine/renderer/RenderMethod"], function (exports_138, context_138) {
    "use strict";
    var point_79, RenderMethod_4, RectRender;
        ...
        execute: function () {
            RectRender = /** @class */ (function (_super) {
                ...
                function RectRender(_a) {
                    var _b = _a === void 0 ? {} : _a, _c = _b.depth, depth = _c === void 0 ? 0 : _c, _d = _b.position, position = _d === void 0 ? point_79.Point.ZERO : _d, _e = _b.dimensions, dimensions = _e === void 0 ? point_79.Point.ZERO : _e, _f = _b.color, color = _f === void 0 ? "#ff0000" : _f;
                    var _this = _super.call(this, depth) || this;
                    _this.position = position;
                    _this.dimensions = dimensions;
                    _this.color = color;
            ...
            exports_138("RectRender", RectRender);
        }
    };
});
        ...
        execute: function () {
            ...
            PlumePicker = /** @class */ (function (_super) {
                ...
                function PlumePicker(callback) {
                    var _this = _super.call(this) || this;
                    _this.position = point_80.Point.ZERO; // top-center position
                    _this.entity = new Entity_30.Entity([_this]);
                ...
                PlumePicker.prototype.update = function (updateData) {
                    var _this = this;
                    var sqSize = Tilesets_49.TILE_SIZE;
                    var rowLen = 9;
                    ...
                    this.renders = CUSTOMIZATION_OPTIONS.map(function (colors, index) {
                        ...
                        return new RectRender_1.RectRender({
                            position: position.plus(big ? new point_80.Point(-bigBuffer, -bigBuffer) : point_80.Point.ZERO),
                            dimensions: dimensions.plus(big ? new point_80.Point(bigBuffer, bigBuffer).times(2) : point_80.Point.ZERO),
                            color: colors[1],
            ...
            exports_139("PlumePicker", PlumePicker);
        }
    };
});
System.register("game/scenes/MainMenuScene", ["engine/Entity", "engine/point", "game/characters/DudeAnimationUtils", "game/SaveManager", "game/ui/MainMenuButton", "game/ui/PlumePicker"], function (exports_140, context_140) {
    ...
    return {
        ...
        execute: function () {
            ...
            MainMenuScene = /** @class */ (function () {
                function MainMenuScene(continueFn, newGameFn) {
                    ...
                    this.plumes = new PlumePicker_1.PlumePicker(function (color) {
                        _this.knight = new Entity_31.Entity().addComponent(DudeAnimationUtils_2.DudeAnimationUtils.getCharacterIdleAnimation("knight_f", { color: color }).toComponent());
                    });
            ...
            exports_140("MainMenuScene", MainMenuScene);
        }
    };
});
System.register("game/quest_game", ["engine/game", "game/scenes/GameScene", "game/scenes/MainMenuScene"], function (exports_141, context_141) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_141("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_142, context_142) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_50, Assets_5;
    ...
    return {
        ...
        execute: function () {
            Assets_5.assets.loadImageFiles(Tilesets_50.Tilesets.getFilesToLoad()).then(function () {
...
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_143, context_143) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_143("Clickable", Clickable);
        }
    };
});
System.register("engine/util/Comparators", [], function (exports_144, context_144) {
    "use strict";
    var Comparators;
    ...
    return {
        setters: [],
        execute: function () {
            exports_144("Comparators", Comparators = {
                orderBy: function (fn) {
...
window['dice'] = doGame;
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_145, context_145) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_145("serialize", serialize = function (object) {
...
// TODO
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_146, context_146) {
    "use strict";
    var component_45, Tilesets_51, TileTransform_33, point_82, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_51.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_33.TileTransform(_this.topLeftPos.plus(new point_82.Point(10 * i, 0))));
                    });
                };
            ...
            exports_146("StringTiles", StringTiles);
        }
    };
});
