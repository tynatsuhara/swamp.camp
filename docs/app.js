...
System.register("game/world/elements/Tent", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/ElementComponent"], function (exports_47, context_47) {
    "use strict";
    var point_21, Tilesets_5, BoxCollider_5, TileComponent_6, TileTransform_8, Entity_4, ElementComponent_4, makeTent, addTile;
    ...
    return {
        ...
        execute: function () {
            exports_47("makeTent", makeTent = function (wl, pos, data) {
                var _a;
                ...
                addTile(wl, e, color + "tentNE", pos.plus(new point_21.Point(1, 0)), depth);
                addTile(wl, e, color + "tentSW", pos.plus(new point_21.Point(0, 1)), depth);
                addTile(wl, e, color + "tentSE", pos.plus(new point_21.Point(1, 1)), depth);
                e.addComponent(new BoxCollider_5.BoxCollider(pos.plus(new point_21.Point(0, 1)).times(Tilesets_5.TILE_SIZE), new point_21.Point(Tilesets_5.TILE_SIZE * 2, Tilesets_5.TILE_SIZE)));
                // e.addComponent(new Interactable(pos.plus(new Point(1, 2)).times(TILE_SIZE), () => {
                //     wl.manager.transition(destinationUUID)
                // }))
                return e.addComponent(new ElementComponent_4.ElementComponent(2 /* TENT */, [pos, pos.plusX(1), pos.plusY(1), new point_21.Point(pos.x + 1, pos.y + 1)], function () { return { destinationUUID: destinationUUID, color: color }; }));
            });
...
System.register("game/world/elements/Campfire", ["engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider", "game/world/elements/ElementComponent", "engine/Entity"], function (exports_48, context_48) {
    ...
    return {
        ...
        execute: function () {
            exports_48("makeCampfire", makeCampfire = function (wl, pos, data) {
                var _a;
                var e = new Entity_5.Entity();
                var scaledPos = pos.times(Tilesets_6.TILE_SIZE);
                var on = (_a = data["on"]) !== null && _a !== void 0 ? _a : true;
                ...
                var offset = new point_22.Point(0, 5);
                e.addComponent(new BoxCollider_6.BoxCollider(scaledPos.plus(offset), new point_22.Point(Tilesets_6.TILE_SIZE, Tilesets_6.TILE_SIZE).minus(offset)));
                // Toggle between on/off when interacted with
                e.addComponent(new Interactable_1.Interactable(scaledPos.plus(new point_22.Point(Tilesets_6.TILE_SIZE / 2, Tilesets_6.TILE_SIZE / 2)), function () {
                    on = !on;
                    campfireOff.enabled = !on;
                    campfireOn.enabled = on;
                }));
...
System.register("game/world/elements/Elements", ["game/world/elements/Tree", "game/world/elements/Rock", "engine/point", "game/world/elements/Tent", "game/world/elements/Campfire"], function (exports_49, context_49) {
    "use strict";
    var Tree_1, Rock_1, point_23, Tent_1, Campfire_1, SavedElement, Elements;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_49("SavedElement", SavedElement);
            Elements = /** @class */ (function () {
                function Elements() {
                    ...
                    */
                    this.ELEMENT_FUNCTION_MAP = (_a = {},
                        _a[0 /* TREE */] = [Tree_1.makeTree, new point_23.Point(1, 2)],
                        _a[1 /* ROCK */] = [Rock_1.makeRock, new point_23.Point(1, 1)],
                        _a[2 /* TENT */] = [Tent_1.makeTent, new point_23.Point(2, 2)],
                        _a[3 /* CAMPFIRE */] = [Campfire_1.makeCampfire, new point_23.Point(1, 1)],
                        _a);
                ...
                Elements.prototype.dimensions = function (type) {
            ...
            exports_49("Elements", Elements);
        }
    };
});
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point"], function (exports_50, context_50) {
    "use strict";
    var _a, Tilesets_7, Entity_6, LocationManager_4, DroppedItem_1, point_24, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_50("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_50("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
             ...
             * TODO: Add initial velocity
             */
            exports_50("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_24.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_51, context_51) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_51("ItemStack", ItemStack);
...
System.register("game/characters/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_52, context_52) {
    "use strict";
    var component_9, TileComponent_8, Tilesets_8, TileTransform_10, point_25, Dude_2, State, Shield;
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                Shield.prototype.animate = function () {
                    ...
                    var pos = this.dude.animation.transform.dimensions.minus(new point_25.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_25.Point(-6, -1));
                    }
                    else if (this.state === State.BLOCKING) {
                        pos = pos.plus(new point_25.Point(3, 3));
                    }
                    pos = pos.plus(this.dude.getAnimationOffsetPosition());
            ...
            exports_52("Shield", Shield);
        }
    };
});
System.register("game/characters/Dialogue", [], function (exports_53, context_53) {
    "use strict";
    var _a, DialogueInstance, getDialogue, DIALOGUE_MAP;
    ...
    return {
        ...
        execute: function () {
            DialogueInstance = /** @class */ (function () {
                 ...
                 */
                function DialogueInstance(id, lines) {
                    var options = [];
            ...
            exports_53("DialogueInstance", DialogueInstance);
            exports_53("getDialogue", getDialogue = function (d) { return DIALOGUE_MAP[d](); });
            DIALOGUE_MAP = (_a = {},
...
System.register("game/ui/HUD", ["game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/tiles/TileComponent", "engine/Entity", "engine/tiles/AnimatedTileComponent"], function (exports_54, context_54) {
    "use strict";
    var Tilesets_9, TileTransform_11, point_26, TileComponent_9, Entity_7, AnimatedTileComponent_3, HUD;
            ...
            HUD = /** @class */ (function () {
                ...
                HUD.prototype.updateHearts = function (health, maxHealth) {
                    ...
                    for (var i = 0; i < fullHearts; i++) {
                        result.push(new TileComponent_9.TileComponent(full, new TileTransform_11.TileTransform(this.offset.plus(heartOffset.times(i)))));
                    }
                    if (health % 1 > .5) {
                        result.push(new TileComponent_9.TileComponent(full, new TileTransform_11.TileTransform(this.offset.plus(heartOffset.times(result.length)))));
                    }
                    else if (health % 1 > 0) {
                        result.push(new TileComponent_9.TileComponent(half, new TileTransform_11.TileTransform(this.offset.plus(heartOffset.times(result.length)))));
                    }
                    while (result.length < maxHealth) {
                        result.push(new TileComponent_9.TileComponent(empty, new TileTransform_11.TileTransform(this.offset.plus(heartOffset.times(result.length)))));
                    }
                    result.forEach(function (c) { return _this.heartsEntity.addComponent(c); });
                };
                HUD.prototype.updateAutosave = function (screenDimensions) {
                    this.autosaveComponent.transform.position = screenDimensions.minus(this.offset).minus(new point_26.Point(Tilesets_9.TILE_SIZE, Tilesets_9.TILE_SIZE));
                };
                return HUD;
            }());
            exports_54("HUD", HUD);
...
System.register("engine/tiles/NineSlice", ["engine/point", "engine/tiles/TileTransform"], function (exports_55, context_55) {
    "use strict";
    var point_27, TileTransform_12, makeNineSliceComponents, makeStretchedNineSliceComponents;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_55("makeNineSliceComponents", makeNineSliceComponents = function (slice, pos, dimensions) {
                ...
                var tiles = [];
                tiles.push(slice[0].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, 0))));
                tiles.push(slice[2].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - 1, 0))));
                tiles.push(slice[6].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, dimensions.y - 1))));
                tiles.push(slice[8].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - 1, dimensions.y - 1))));
                // horizontal lines
                for (var i = 1; i < dimensions.x - 1; i++) {
                    tiles.push(slice[1].toComponent(new TileTransform_12.TileTransform(new point_27.Point(i, 0))));
                    tiles.push(slice[7].toComponent(new TileTransform_12.TileTransform(new point_27.Point(i, dimensions.y - 1))));
                }
                // vertical lines
                for (var j = 1; j < dimensions.y - 1; j++) {
                    tiles.push(slice[3].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, j))));
                    tiles.push(slice[5].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - 1, j))));
                }
                // middle
                for (var x = 1; x < dimensions.x - 1; x++) {
                    for (var y = 1; y < dimensions.y - 1; y++) {
                        tiles.push(slice[4].toComponent(new TileTransform_12.TileTransform(new point_27.Point(x, y))));
                    }
                }
            ...
            exports_55("makeStretchedNineSliceComponents", makeStretchedNineSliceComponents = function (slice, pos, dimensions) {
                ...
                // }
                var tiles = [];
                var topLeft = slice[0].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, 0)));
                var tileSize = topLeft.transform.dimensions.x;
                // corners
                tiles.push(topLeft);
                tiles.push(slice[2].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - tileSize, 0))));
                tiles.push(slice[6].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, dimensions.y - tileSize))));
                tiles.push(slice[8].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - tileSize, dimensions.y - tileSize))));
                // horizontal lines
                var horizontalDimensions = new point_27.Point(dimensions.x - tileSize * 2, tileSize);
                tiles.push(slice[1].toComponent(new TileTransform_12.TileTransform(new point_27.Point(tileSize, 0), horizontalDimensions)));
                tiles.push(slice[7].toComponent(new TileTransform_12.TileTransform(new point_27.Point(tileSize, dimensions.y - tileSize), horizontalDimensions)));
                // vertical lines
                var verticalDimensions = new point_27.Point(tileSize, dimensions.y - tileSize * 2);
                tiles.push(slice[3].toComponent(new TileTransform_12.TileTransform(new point_27.Point(0, tileSize), verticalDimensions)));
                tiles.push(slice[5].toComponent(new TileTransform_12.TileTransform(new point_27.Point(dimensions.x - tileSize, tileSize), verticalDimensions)));
                // middle
                tiles.push(slice[4].toComponent(new TileTransform_12.TileTransform(new point_27.Point(tileSize, tileSize), new point_27.Point(dimensions.x - tileSize * 2, dimensions.y - tileSize * 2))));
                var mainTransform = tiles[0].transform;
                tiles.forEach(function (c, i) {
                    if (i > 0) {
                        c.transform.relativeTo(mainTransform);
...
System.register("game/ui/Tooltip", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/renderer/TextRender", "game/ui/Text", "game/ui/Color", "game/ui/UIStateManager"], function (exports_58, context_58) {
    "use strict";
    var component_10, Tilesets_10, point_29, TextRender_3, Text_1, Color_1, UIStateManager_1, Tooltip;
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils"], function (exports_60, context_60) {
    "use strict";
    var component_11, Tilesets_11, point_30, NineSlice_1, UIStateManager_2, LocationManager_5, PlaceElementDisplay_1, utils_3, PlaceElementFrame;
        ...
        execute: function () {
            ...
            PlaceElementFrame = /** @class */ (function (_super) {
                ...
                PlaceElementFrame.prototype.start = function () {
                    this.goodTiles = this.entity.addComponents(NineSlice_1.makeNineSliceComponents(Tilesets_11.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_good"), new point_30.Point(0, 0), this.dimensions));
                    this.goodTiles[0].transform.depth = UIStateManager_2.UIStateManager.UI_SPRITE_DEPTH;
                    this.badTiles = this.entity.addComponents(NineSlice_1.makeNineSliceComponents(Tilesets_11.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_bad"), new point_30.Point(0, 0), this.dimensions));
                ...
                PlaceElementFrame.prototype.update = function (updateData) {
                    ...
                    var tilePt = this.pixelPtToTilePt(startPos.minus(new point_30.Point(this.dimensions.x / 2, this.dimensions.y / 2).times(Tilesets_11.TILE_SIZE)));
                ...
                PlaceElementFrame.prototype.canPlace = function (pos) {
                    for (var x = pos.x; x < pos.x + this.dimensions.x; x++) {
                        for (var y = pos.y; y < pos.y + this.dimensions.y; y++) {
                            if (!!LocationManager_5.LocationManager.instance.currentLocation.elements.get(new point_30.Point(x, y))) {
                                return false;
                            }
                        }
                    }
...
System.register("game/ui/PlaceElementDisplay", ["engine/Entity", "engine/component", "game/world/elements/Elements", "game/Controls", "game/world/LocationManager", "game/characters/Player", "game/ui/PlaceElementFrame"], function (exports_61, context_61) {
    "use strict";
    var Entity_8, component_12, Elements_1, Controls_1, LocationManager_6, Player_3, PlaceElementFrame_1, PlaceElementDisplay;
        ...
        execute: function () {
            PlaceElementDisplay = /** @class */ (function (_super) {
                ...
                PlaceElementDisplay.prototype.startPlacing = function (element, successFn) {
                    ...
                    this.dimensions = Elements_1.Elements.instance.dimensions(element);
...
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/point", "engine/util/utils", "game/graphics/Tilesets", "game/characters/Player", "engine/Entity", "game/ui/UIStateManager", "engine/tiles/NineSlice", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "game/items/Items", "game/ui/Text", "game/ui/Color", "game/Controls", "game/ui/PlaceElementDisplay"], function (exports_62, context_62) {
    "use strict";
    var component_13, point_31, utils_4, Tilesets_12, Player_4, Entity_9, UIStateManager_3, NineSlice_2, Tooltip_1, AnimatedTileComponent_4, TileTransform_13, BasicRenderComponent_2, TextRender_4, Items_4, Text_2, Color_2, Controls_2, PlaceElementDisplay_2, InventoryDisplay;
        ...
        execute: function () {
            InventoryDisplay = /** @class */ (function (_super) {
                ...
                InventoryDisplay.prototype.update = function (updateData) {
                    ...
                    var pressI = updateData.input.isKeyDown(73 /* I */);
                    ...
                    if (updateData.input.isMouseDown) {
                        inv.forEach(function (stack, index) {
                            if (utils_4.rectContains(_this.getPositionForInventoryIndex(index), new point_31.Point(Tilesets_12.TILE_SIZE, Tilesets_12.TILE_SIZE), updateData.input.mousePos)) {
                ...
                InventoryDisplay.prototype.spawnBG = function () {
                    var _this = this;
                    this.bgTiles = NineSlice_2.makeNineSliceComponents(Tilesets_12.Tilesets.instance.oneBit.getNineSlice("invBoxNW"), this.offset.minus(new point_31.Point(Tilesets_12.TILE_SIZE / 2, Tilesets_12.TILE_SIZE / 2)), new point_31.Point(1 + InventoryDisplay.COLUMNS, 1 + this.inventory().inventory.length / InventoryDisplay.COLUMNS));
                ...
                InventoryDisplay.prototype.show = function (screenDimensions) {
                    ...
                    var displayDimensions = new point_31.Point(InventoryDisplay.COLUMNS, this.inventory().inventory.length / InventoryDisplay.COLUMNS).times(Tilesets_12.TILE_SIZE);
                    ...
                    // coins
                    this.displayEntity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([Tilesets_12.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150)], new TileTransform_13.TileTransform(this.offset.plus(this.coinsOffset))));
                ...
                InventoryDisplay.prototype.getPositionForInventoryIndex = function (i) {
                    return new point_31.Point(i % InventoryDisplay.COLUMNS, Math.floor(i / InventoryDisplay.COLUMNS)).times(Tilesets_12.TILE_SIZE).plus(this.offset);
                };
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "game/graphics/Tilesets", "game/ui/Text", "engine/renderer/TextRender", "game/ui/Color", "game/ui/UIStateManager", "engine/util/utils"], function (exports_63, context_63) {
    "use strict";
    var component_14, point_32, Tilesets_13, Text_3, TextRender_5, Color_3, UIStateManager_4, utils_5, TextButton;
            ...
            TextButton = /** @class */ (function (_super) {
                ...
                function TextButton(position, text, onClick) {
                    ...
                    _this.start = function () {
                        ...
                        var centerPos = leftPos.plus(new point_32.Point(Tilesets_13.TILE_SIZE, 0));
                        var rightPos = leftPos.plus(new point_32.Point(_this.width - Tilesets_13.TILE_SIZE, 0)).apply(Math.floor);
                        _this.left.transform.position = leftPos;
                        _this.center.transform.position = centerPos;
                        _this.right.transform.position = rightPos;
                        _this.center.transform.dimensions = new point_32.Point(_this.width + TextButton.margin * 2 - Tilesets_13.TILE_SIZE * 2, Tilesets_13.TILE_SIZE);
                ...
                TextButton.prototype.update = function (updateData) {
                    this.hovering = utils_5.rectContains(this.position, new point_32.Point(this.width, Tilesets_13.TILE_SIZE), updateData.input.mousePos);
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/ui/Color", "game/Controls", "game/ui/UIStateManager", "game/ui/TextButton"], function (exports_64, context_64) {
    "use strict";
    var Dialogue_1, Tilesets_14, NineSlice_3, point_33, component_15, Entity_10, BasicRenderComponent_3, Text_4, Color_4, Controls_3, UIStateManager_5, TextButton_1, DialogueDisplay;
        ...
        execute: function () {
            DialogueDisplay = /** @class */ (function (_super) {
                ...
                DialogueDisplay.prototype.renderNextLine = function (screenDimensions) {
                    var _this = this;
                    var dimensions = new point_33.Point(288, 83);
                    var bottomBuffer = Tilesets_14.TILE_SIZE;
                    var topLeft = new point_33.Point(Math.floor(screenDimensions.x / 2 - dimensions.x / 2), Math.floor(screenDimensions.y - dimensions.y - bottomBuffer));
                    ...
                    var formattedRenders = Text_4.formatText(this.dialogue.lines[this.lineIndex], Color_4.Color.DARK_RED, topLeft.plus(new point_33.Point(margin, topOffset + margin)), width, 1 /* CENTER */);
                ...
                DialogueDisplay.prototype.renderOptions = function (screenDimensions) {
                    ...
                    var marginSide = 9;
                    var buttonPadding = 3;
                    var dimensions = new point_33.Point(longestOption * Text_4.TEXT_PIXEL_WIDTH + marginSide * 2 + TextButton_1.TextButton.margin * 2, (options.length - 1) * buttonPadding + options.length * Tilesets_14.TILE_SIZE + marginTop + marginBottom);
                    var topLeft = screenDimensions.div(2).minus(dimensions.div(2));
                    var backgroundTiles = NineSlice_3.makeStretchedNineSliceComponents(Tilesets_14.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
                    backgroundTiles[0].transform.depth = UIStateManager_5.UIStateManager.UI_SPRITE_DEPTH;
                    backgroundTiles.forEach(function (tile) { return _this.displayEntity.addComponent(tile); });
                    options.forEach(function (option, i) { return _this.displayEntity.addComponent(new TextButton_1.TextButton(topLeft.plus(new point_33.Point(marginSide, marginTop + i * (Tilesets_14.TILE_SIZE + buttonPadding))), option[0], function () {
            ...
            exports_64("DialogueDisplay", DialogueDisplay);
        }
    };
});
System.register("game/ui/UIStateManager", ["game/ui/HUD", "game/characters/Player", "game/ui/InventoryDisplay", "game/ui/DialogueDisplay", "game/ui/PlaceElementDisplay"], function (exports_65, context_65) {
    "use strict";
    var HUD_1, Player_5, InventoryDisplay_1, DialogueDisplay_1, PlaceElementDisplay_3, UIStateManager;
        ...
        execute: function () {
            UIStateManager = /** @class */ (function () {
                ...
                UIStateManager.prototype.get = function (dimensions) {
                    if (!Player_5.Player.instance.dude) {
                        return [];
                    }
                    this.captureInput = this.inventory.isOpen
                        || this.dialogueDisplay.isOpen
                        || this.placeElementDisplay.isOpen;
                    return this.hud.getEntities(Player_5.Player.instance.dude, dimensions)
            ...
            exports_65("UIStateManager", UIStateManager);
        }
    };
});
System.register("game/characters/Dude", ["engine/tiles/AnimatedTileComponent", "engine/point", "engine/component", "engine/collision/BoxCollider", "game/graphics/Tilesets", "game/characters/Weapon", "game/items/Items", "game/characters/Shield", "engine/tiles/TileTransform", "game/world/elements/Interactable", "game/ui/DialogueDisplay"], function (exports_66, context_66) {
    "use strict";
    var AnimatedTileComponent_5, point_34, component_16, BoxCollider_7, Tilesets_15, Weapon_1, Items_5, Shield_1, TileTransform_14, Interactable_2, DialogueDisplay_2, Dude;
    ...
    return {
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(type, characterAnimName, position, weaponId, shieldId, maxHealth, health, speed, inventory, dialogue) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_34.Point(3, 15);
                    ...
                    _this.start = function (startData) {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_5.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_14.TileTransform(new point_34.Point(0, 28 - height))));
                        if (!!weaponId) {
                        ...
                        // Set up collider
                        var colliderSize = new point_34.Point(10, 8);
                        _this.relativeColliderPos = new point_34.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_2.Interactable(new point_34.Point(0, 0), function () {
                            if (!!_this.dialogue) {
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_34.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Dude.prototype.update = function (updateData) {
                    ...
                    this.animation.transform.position = this.position.plus(this.isAlive ? new point_34.Point(0, 0) : this.deathOffset);
                    this.animation.transform.depth = this.collider.position.y + this.collider.dimensions.y;
                    this.dialogueInteract.position = this.standingPosition.minus(new point_34.Point(0, 5));
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_34.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_34.Point(0, 5)));
                ...
                Dude.prototype.spawnDrop = function () {
                    // TODO add velocity
                    Items_5.spawnItem(this.standingPosition.minus(new point_34.Point(0, 2)), 0 /* COIN */);
                };
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    if (!this.isMoving) {
                        return new point_34.Point(0, [0, 1, 2, 1][f]);
                    }
                    else {
                        return new point_34.Point(0, [-1, -2, -1, 0][f]);
                    }
                };
            ...
            exports_66("Dude", Dude);
        }
    };
});
System.register("game/characters/Player", ["engine/point", "engine/component", "game/characters/Dude", "game/world/elements/Interactable", "game/world/elements/Hittable", "game/ui/UIStateManager", "game/Controls"], function (exports_67, context_67) {
    "use strict";
    var point_35, component_17, Dude_3, Interactable_3, Hittable_2, UIStateManager_6, Controls_4, Player;
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_35.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    this.dude.move(updateData, new point_35.Point(dx, dy), this.dude.weapon.isDrawn() ? updateData.input.mousePos.x - this.dude.standingPosition.x : 0);
                    if (UIStateManager_6.UIStateManager.instance.isMenuOpen) {
                        return;
                    }
                    ...
                    if (updateData.input.isKeyDown(Controls_4.Controls.interactButton)) {
                        this.interact(updateData);
                    }
                    // FOR TESTING
                    if (updateData.input.isKeyDown(80 /* P */)) {
                        // this.dude.damage(.25, new Point(Math.random()-.5, Math.random()-.5), 30)
                        this.dude.damage(.25, new point_35.Point(-1, Math.random() - .5), 30);
                    }
                ...
                Player.prototype.interact = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_35.Point(0, 7));
            ...
            exports_67("Player", Player);
        }
    };
});
System.register("game/characters/NPC", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point"], function (exports_68, context_68) {
    "use strict";
    var component_18, Dude_4, Player_6, point_36, NPC;
        ...
        execute: function () {
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.update = function (updateData) {
                    ...
                    var dist = Player_6.Player.instance.dude.position.minus(this.dude.position);
                    ...
                    if (mag > followDistance || ((followDistance - mag) < buffer && Player_6.Player.instance.dude.isMoving) && this.dude.isMoving) {
                        ...
                        this.dude.move(updateData, new point_36.Point(0, 0));
                    }
                };
                return NPC;
...
System.register("game/characters/Enemy", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point"], function (exports_69, context_69) {
    "use strict";
    var component_19, Dude_5, Player_7, point_37, Enemy;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_69("Enemy", Enemy);
        }
    };
});
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_70, context_70) {
    "use strict";
    var component_20, Player_8, Dude_6, point_38, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_38.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_38.Point.ZERO;
                };
            ...
            exports_70("CutscenePlayerController", CutscenePlayerController);
        }
    };
});
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/cutscenes/CutscenePlayerController"], function (exports_71, context_71) {
    "use strict";
    var Entity_11, point_39, Player_9, Dude_7, NPC_1, LocationManager_7, Enemy_1, Inventory_1, CutscenePlayerController_1, DudeFactory;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.new = function (type, pos) {
                    ...
                    LocationManager_7.LocationManager.instance.currentLocation.dudes.add(d);
                    return d;
                };
                /**
                ...
                DudeFactory.prototype.load = function (saveState) {
                    return this.make(saveState.type, point_39.Point.fromString(saveState.pos), saveState);
                };
                DudeFactory.prototype.make = function (type, pos, saveState) {
                    ...
                    var d = new Dude_7.Dude(type, animationName, pos, (_a = saveState === null || saveState === void 0 ? void 0 : saveState.weapon) !== null && _a !== void 0 ? _a : weapon, (_b = saveState === null || saveState === void 0 ? void 0 : saveState.shield) !== null && _b !== void 0 ? _b : shield, (_c = saveState === null || saveState === void 0 ? void 0 : saveState.maxHealth) !== null && _c !== void 0 ? _c : maxHealth, (_d = saveState === null || saveState === void 0 ? void 0 : saveState.health) !== null && _d !== void 0 ? _d : health, (_e = saveState === null || saveState === void 0 ? void 0 : saveState.speed) !== null && _e !== void 0 ? _e : speed, inventory, (_f = saveState === null || saveState === void 0 ? void 0 : saveState.dialogue) !== null && _f !== void 0 ? _f : dialogue);
                    new Entity_11.Entity([d].concat(additionalComponents));
                    return d;
                };
                return DudeFactory;
            }());
            exports_71("DudeFactory", DudeFactory);
        }
    };
});
System.register("game/saves/DudeSaveState", [], function (exports_72, context_72) {
    "use strict";
    var DudeSaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_72("DudeSaveState", DudeSaveState);
        }
    };
});
System.register("game/saves/LocationSaveState", [], function (exports_73, context_73) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_73("LocationSaveState", LocationSaveState);
        }
    };
});
System.register("game/saves/uuid", [], function (exports_74, context_74) {
    "use strict";
    var newUUID;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_74("newUUID", newUUID = function () {
...
System.register("game/world/ground/GroundComponent", ["engine/component"], function (exports_75, context_75) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_75("GroundComponent", GroundComponent);
        }
    };
});
System.register("game/world/WorldLocation", ["engine/util/Grid", "game/saves/uuid", "game/world/elements/Elements", "engine/point", "game/world/ground/Ground", "game/characters/DudeFactory"], function (exports_76, context_76) {
    "use strict";
    var Grid_1, uuid_1, Elements_2, point_40, Ground_1, DudeFactory_1, WorldLocation;
        ...
        execute: function () {
            WorldLocation = /** @class */ (function () {
                ...
                WorldLocation.load = function (locationManager, saveState) {
                    ...
                    saveState.elements.forEach(function (el) { return n.addWorldElement(el.type, point_40.Point.fromString(el.pos), el.obj); });
                    saveState.ground.forEach(function (el) { return n.addGroundElement(el.type, point_40.Point.fromString(el.pos), el.obj); });
                    saveState.dudes.forEach(function (d) { return n.dudes.add(DudeFactory_1.DudeFactory.instance.load(d)); });
                    return n;
                };
                return WorldLocation;
            }());
            exports_76("WorldLocation", WorldLocation);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_77, context_77) {
    "use strict";
    var point_41, Tilesets_16, GroundComponent_1, Entity_12, TileTransform_15, makeGrass;
    ...
    return {
        ...
        execute: function () {
            exports_77("makeGrass", makeGrass = function (wl, pos, data) {
                var _a;
                var tile;
                var index = (_a = data["index"]) !== null && _a !== void 0 ? _a : (Math.random() < .65 ? Math.floor(Math.random() * 4) : 0);
                if (index > 0) {
                    tile = Tilesets_16.Tilesets.instance.tilemap.getTileAt(new point_41.Point(0, index));
                }
                else {
                    tile = Tilesets_16.Tilesets.instance.tilemap.getTileAt(new point_41.Point(0, 7));
                }
                var c = tile.toComponent(new TileTransform_15.TileTransform(pos.times(Tilesets_16.TILE_SIZE)));
...
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_78, context_78) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_78("makePath", makePath = function (wl, pos) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_79, context_79) {
    "use strict";
    var Tilesets_17, GroundComponent_3, Entity_14, TileTransform_16, makeBasicGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_79("makeBasicGround", makeBasicGround = function (tile) {
...
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_80, context_80) {
    "use strict";
    var point_42, Tilesets_18, GroundComponent_4, Entity_15, TileTransform_17, makeLedge;
    ...
    return {
        ...
        execute: function () {
            exports_80("makeLedge", makeLedge = function (wl, pos, data) {
                var c = Tilesets_18.Tilesets.instance.tilemap.getTileAt(new point_42.Point(3, 2)).toComponent(new TileTransform_17.TileTransform(pos.times(Tilesets_18.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/Ledge"], function (exports_81, context_81) {
    "use strict";
    var point_43, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_19, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_81("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(2, 6)))
                        .angle(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(0, 5)))
                        .tShape(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(3, 5)))
                        .plusShape(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(5, 5)))
                        .cap(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(2, 6)))
                        .single(Tilesets_19.Tilesets.instance.tilemap.getTileAt(new point_43.Point(7, 5)));
            ...
            exports_81("Ground", Ground);
        }
    };
});
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_82, context_82) {
    "use strict";
    var point_44, TileTransform_18, ConnectingTile_2, ConnectingTileSchema;
        ...
        execute: function () {
            ...
            ConnectingTileSchema = /** @class */ (function () {
                ...
                ConnectingTileSchema.prototype.render = function (grid, position) {
                    ...
                    var y = position.y;
                    // TODO: add diagonals?
                    var n = this.get(grid, new point_44.Point(x, y - 1));
                    var s = this.get(grid, new point_44.Point(x, y + 1));
                    var e = this.get(grid, new point_44.Point(x + 1, y));
                    var w = this.get(grid, new point_44.Point(x - 1, y));
                    ...
                    return result.toImageRender(new TileTransform_18.TileTransform(position.times(result.dimensions.x), null, rotation, false, false, Number.MIN_SAFE_INTEGER));
                };
            ...
            exports_82("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_83, context_83) {
    "use strict";
    var point_45, component_22, ConnectingTile;
        ...
        execute: function () {
            ConnectingTile = /** @class */ (function (_super) {
                ...
                function ConnectingTile(schema, grid, position) {
                    if (position === void 0) { position = new point_45.Point(0, 0); }
                    var _this = _super.call(this) || this;
                    _this.schema = schema;
                    _this.grid = grid;
                    _this.position = position;
            ...
            exports_83("ConnectingTile", ConnectingTile);
        }
    };
});
/*
...
*
*/
System.register("engine/util/Noise", [], function (exports_84, context_84) {
    "use strict";
    ...
    return {
        ...
        execute: function () {/*
            ...
            */
            ...
            exports_84("Noise", Noise);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/tiles/ConnectingTile", "engine/collision/BoxCollider", "game/world/LocationManager", "game/world/ground/Ground", "engine/util/Noise", "engine/util/Grid"], function (exports_85, context_85) {
    "use strict";
    var point_46, ConnectingTile_3, BoxCollider_8, LocationManager_8, Ground_3, Noise_1, Grid_2, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    this.location = LocationManager_8.LocationManager.instance.newLocation();
                }
                MapGenerator.prototype.doIt = function () {
                    var tentLocation = LocationManager_8.LocationManager.instance.newLocation();
                    // spawn tent
                    this.location.addWorldElement(2 /* TENT */, new point_46.Point(5, 5), { destinationUUID: tentLocation.uuid, color: "red" /* RED */ });
                    // spawn campfire
                    var campfirePos = new point_46.Point(3, 9);
                    this.location.addWorldElement(3 /* CAMPFIRE */, campfirePos);
                    // make the ground
                    this.renderPath(new point_46.Point(-10, -10), new point_46.Point(10, 10), 2);
                    this.renderPath(new point_46.Point(10, -10), new point_46.Point(-10, 10), 5);
                    this.spawnTrees();
                    this.spawnRocks();
                ...
                MapGenerator.prototype.spawnTrees = function () {
                    ...
                    for (var i = 0; i < trees; i++) {
                        var pt = new point_46.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE - 1)) - MapGenerator.MAP_SIZE / 2);
                        var occupiedPoints = [pt, pt.plus(new point_46.Point(0, 1))];
                ...
                MapGenerator.prototype.spawnRocks = function () {
                    ...
                    while (placedRocks < 20) {
                        var p = new point_46.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE)) - MapGenerator.MAP_SIZE / 2);
                ...
                MapGenerator.prototype.noise = function () {
                    ...
                    for (var i = -MapGenerator.MAP_SIZE / 2; i < MapGenerator.MAP_SIZE / 2; i++) {
                        for (var j = -MapGenerator.MAP_SIZE / 2; j < MapGenerator.MAP_SIZE / 2; j++) {
                            ...
                            str += v;
                            grid.set(new point_46.Point(j, i), v);
                        }
                        str += "\n";
                    }
                    console.log(str);
            ...
            exports_85("MapGenerator", MapGenerator);
        }
    };
});
...
System.register("game/cutscenes/CutsceneManager", ["engine/Entity"], function (exports_87, context_87) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_87("CutsceneManager", CutsceneManager);
        }
    };
});
System.register("game/cutscenes/Camera", ["engine/point", "game/world/MapGenerator", "game/graphics/Tilesets"], function (exports_88, context_88) {
    "use strict";
    var point_47, MapGenerator_1, Tilesets_20, Camera;
    ...
    return {
        ...
        execute: function () {
            Camera = /** @class */ (function () {
                ...
                Camera.prototype.getGoalPosition = function (dimensions) {
                    var _a, _b;
                    var xLimit = MapGenerator_1.MapGenerator.MAP_SIZE / 2 * Tilesets_20.TILE_SIZE - dimensions.x / 2;
                    var yLimit = MapGenerator_1.MapGenerator.MAP_SIZE / 2 * Tilesets_20.TILE_SIZE - dimensions.y / 2;
                    var trackedPoint = (_b = (_a = this.dudeTarget) === null || _a === void 0 ? void 0 : _a.position) !== null && _b !== void 0 ? _b : this.pointTarget;
                    var clampedPlayerPos = new point_47.Point(this.clamp(trackedPoint.x, -xLimit, xLimit), this.clamp(trackedPoint.y, -yLimit, yLimit));
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_48.Point(-1, 0)); // TODO: Make sure there are no trees in their way
                    setTimeout(function () {
            ...
            exports_89("IntroCutscene", IntroCutscene);
        }
    };
});
    ...
    return {
        ...
        execute: function () {
            ...
            QuestGame = /** @class */ (function (_super) {
                ...
                function QuestGame() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.tilesets = new Tilesets_21.Tilesets();
                ...
                QuestGame.prototype.initialize = function () {
                    ...
                    if (newGame) {
                        ...
                        var playerStartPos = new point_49.Point(1, 1).times(MapGenerator_2.MapGenerator.MAP_SIZE / 2 * Tilesets_21.TILE_SIZE)
                            .plusY(-Tilesets_21.TILE_SIZE * 10)
                            .plusX(Tilesets_21.TILE_SIZE * 2);
                ...
                QuestGame.prototype.getViews = function (updateViewsContext) {
                    ...
                    if (updateViewsContext.input.isKeyDown(76 /* L */)) {
                        DudeFactory_2.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_49.Point(40, 30));
                    }
                ...
                QuestGame.prototype.load = function () {
                    ...
                    this.locationManager = LocationManager_9.LocationManager.load(save.locations);
            ...
            exports_90("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_91, context_91) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_22, Assets_4;
    ...
    return {
        ...
        execute: function () {
            Assets_4.assets.loadImageFiles(Tilesets_22.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_92, context_92) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_92("Clickable", Clickable);
        }
    };
});
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_93, context_93) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_93("serialize", serialize = function (object) {
...
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_94, context_94) {
    "use strict";
    var component_25, Tilesets_23, TileTransform_19, point_50, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_23.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_19.TileTransform(_this.topLeftPos.plus(new point_50.Point(10 * i, 0))));
                    });
                };
            ...
            exports_94("StringTiles", StringTiles);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/LocationManager"], function (exports_95, context_95) {
    "use strict";
    var LocationManager_10, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_95("makeTentInterior", makeTentInterior = function () {
                var l = LocationManager_10.LocationManager.instance.newLocation();
                return l;
            });
        }
    };
