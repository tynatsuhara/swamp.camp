...
System.register("game/world/interior/AsciiInteriorBuilder", ["engine/point"], function (exports_77, context_77) {
    "use strict";
    var point_37, AsciiInteriorBuilder;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_77("AsciiInteriorBuilder", AsciiInteriorBuilder);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_78, context_78) {
    "use strict";
    var LocationManager_10, point_38, Tilesets_18, NineSlice_5, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_78("makeTentInterior", makeTentInterior = function (outside, color) {
                var l = LocationManager_10.LocationManager.instance.newLocation(true);
                var interactablePos = new point_38.Point(2.5, 4).times(Tilesets_18.TILE_SIZE);
                ...
                NineSlice_5.NineSlice.nineSliceForEach(new point_38.Point(5, 4), function (pt, index) { return l.addGroundElement(1 /* BASIC_NINE_SLICE */, pt, { k: groundType, i: index }); });
...
System.register("game/world/elements/Tent", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Interactable", "game/world/elements/ElementComponent", "game/world/elements/ElementUtils", "game/world/interior/Tent"], function (exports_79, context_79) {
    ...
    return {
        ...
        execute: function () {
            exports_79("makeTent", makeTent = function (wl, pos, data) {
                var _a, _b;
                ...
                var interactablePos = pos.plus(new point_39.Point(2, 2)).times(Tilesets_19.TILE_SIZE);
                ...
                addTile(wl, e, color + "tentNE", pos.plus(new point_39.Point(2, 0)), depth);
                addTile(wl, e, color + "tentSW", pos.plus(new point_39.Point(1, 1)), depth);
                addTile(wl, e, color + "tentSE", pos.plus(new point_39.Point(2, 1)), depth);
                e.addComponent(new BoxCollider_5.BoxCollider(pos.plus(new point_39.Point(1, 1)).times(Tilesets_19.TILE_SIZE), new point_39.Point(Tilesets_19.TILE_SIZE * 2, Tilesets_19.TILE_SIZE)));
                // Set up teleporter
                e.addComponent(new Interactable_2.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_39.Point(1, -Tilesets_19.TILE_SIZE * 1.4)));
                return e.addComponent(new ElementComponent_5.ElementComponent(2 /* TENT */, ElementUtils_1.ElementUtils.rectPoints(pos, new point_39.Point(4, 3)), function () { return { destinationUUID: destinationUUID, color: color }; }));
            });
...
System.register("game/world/PointLightMaskRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/ui/UIStateManager", "game/world/WorldTime", "game/ui/Color", "game/world/LocationManager"], function (exports_80, context_80) {
    ...
    return {
        ...
        execute: function () {
            PointLightMaskRenderer = /** @class */ (function () {
                ...
                PointLightMaskRenderer.prototype.renderToOffscreenCanvas = function () {
                    ...
                    locationLightGrid.entries().forEach(function (entry) {
                        ...
                        var circleOffset = new point_40.Point(-.5, -.5).times(diameter);
                        ...
                        _this.makeLightCircle(diameter - innerOffset * 2, adjustedPos.plus(new point_40.Point(innerOffset, innerOffset)), 0);
                    });
                };
                PointLightMaskRenderer.prototype.makeLightCircle = function (diameter, position, alpha) {
                    var center = new point_40.Point(diameter / 2, diameter / 2).minus(new point_40.Point(.5, .5));
                ...
                PointLightMaskRenderer.prototype.getEntity = function () {
                    ...
                    var dimensions = Camera_3.Camera.instance.dimensions.plus(new point_40.Point(1, 1));
            ...
            exports_80("PointLightMaskRenderer", PointLightMaskRenderer);
        }
    };
});
System.register("game/world/elements/Campfire", ["engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider", "game/world/elements/ElementComponent", "engine/Entity", "game/world/PointLightMaskRenderer"], function (exports_81, context_81) {
    "use strict";
    var TileComponent_8, AnimatedTileComponent_3, Tilesets_21, TileTransform_16, point_41, Interactable_3, BoxCollider_6, ElementComponent_6, Entity_15, PointLightMaskRenderer_1, makeCampfire;
    ...
    return {
        ...
        execute: function () {
            exports_81("makeCampfire", makeCampfire = function (wl, pos, data) {
                var _a;
                ...
                e.addComponent(new BoxCollider_6.BoxCollider(scaledPos.plus(offset), new point_41.Point(Tilesets_21.TILE_SIZE, Tilesets_21.TILE_SIZE).minus(offset)));
                var set = function (nowOn) {
                    on = nowOn;
                    campfireOff.enabled = !nowOn;
                    campfireOn.enabled = nowOn;
                    var lightCenterPos = pos.times(Tilesets_21.TILE_SIZE).plus(new point_41.Point(Tilesets_21.TILE_SIZE / 2, Tilesets_21.TILE_SIZE / 2));
                    if (nowOn) {
                ...
                e.addComponent(new Interactable_3.Interactable(scaledPos.plus(new point_41.Point(Tilesets_21.TILE_SIZE / 2, Tilesets_21.TILE_SIZE / 2)), function () { return set(!on); }, new point_41.Point(1, -Tilesets_21.TILE_SIZE)));
                return e.addComponent(new ElementComponent_6.ElementComponent(3 /* CAMPFIRE */, [pos], function () { return { on: on }; }));
            });
        }
    };
});
System.register("game/world/elements/Elements", ["game/world/elements/Tree", "game/world/elements/Rock", "engine/point", "game/world/elements/Tent", "game/world/elements/Campfire", "game/world/Teleporter"], function (exports_82, context_82) {
    "use strict";
    var Tree_1, Rock_1, point_42, Tent_2, Campfire_1, Teleporter_1, SavedElement, Elements;
                ...
                function Elements() {
                    ...
                    */
                    this.ELEMENT_FUNCTION_MAP = (_a = {},
                        _a[0 /* TREE */] = [Tree_1.makeTree, new point_42.Point(1, 2)],
                        _a[1 /* ROCK */] = [Rock_1.makeRock, new point_42.Point(1, 1)],
                        _a[2 /* TENT */] = [Tent_2.makeTent, new point_42.Point(4, 3)],
                        _a[3 /* CAMPFIRE */] = [Campfire_1.makeCampfire, new point_42.Point(1, 1)],
                        _a[4 /* TELEPORTER */] = [Teleporter_1.makeTeleporterElement, new point_42.Point(1, 1)],
                        _a);
...
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point"], function (exports_83, context_83) {
    "use strict";
    var _a, Tilesets_22, Entity_16, LocationManager_12, DroppedItem_1, point_43, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_83("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_83("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
             ...
             * TODO: Add initial velocity
             */
            exports_83("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_43.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_84, context_84) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_84("ItemStack", ItemStack);
            ...
            exports_84("Inventory", Inventory);
        }
    };
});
System.register("game/characters/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_85, context_85) {
    "use strict";
    var component_20, TileComponent_9, Tilesets_23, TileTransform_17, point_44, Dude_2, State, Shield;
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                Shield.prototype.update = function (updateData) {
                    ...
                    var pos = this.dude.animation.transform.dimensions.minus(new point_44.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_44.Point(-6, -1));
                    }
                    else if (this.state === State.DRAWN) {
                        pos = pos.plus(new point_44.Point(3, 2).times(this.raisedPerc).apply(Math.floor));
...
System.register("game/characters/AnimationUtils", ["game/graphics/Tilesets"], function (exports_86, context_86) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_86("AnimationUtils", AnimationUtils = {
...
System.register("game/characters/Dude", ["engine/tiles/AnimatedTileComponent", "engine/point", "engine/component", "engine/collision/BoxCollider", "game/graphics/Tilesets", "game/characters/Weapon", "game/items/Items", "game/characters/Shield", "engine/tiles/TileTransform", "game/world/elements/Interactable", "game/characters/Dialogue", "game/ui/DialogueDisplay", "game/ui/DudeInteractIndicator", "game/ui/UIStateManager", "game/characters/AnimationUtils"], function (exports_87, context_87) {
    "use strict";
    var AnimatedTileComponent_4, point_45, component_21, BoxCollider_7, Tilesets_25, Weapon_1, Items_5, Shield_1, TileTransform_18, Interactable_4, Dialogue_4, DialogueDisplay_2, DudeInteractIndicator_4, UIStateManager_11, AnimationUtils_1, Dude;
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(type, faction, characterAnimName, position, weaponId, shieldId, maxHealth, health, speed, inventory, dialogue, blob) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_45.Point(3, 15);
                    ...
                    _this.awake = function () {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_18.TileTransform(new point_45.Point(0, 28 - height))));
                        ...
                        // Set up collider
                        var colliderSize = new point_45.Point(10, 8);
                        _this.relativeColliderPos = new point_45.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_4.Interactable(new point_45.Point(0, 0), function () {
                            if (!!_this.dialogue) {
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_45.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_45.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_45.Point(0, 5)));
                ...
                Dude.prototype.spawnDrop = function () {
                    // TODO add velocity
                    Items_5.spawnItem(this.standingPosition.minus(new point_45.Point(0, 2)), 0 /* COIN */);
                };
            ...
            exports_87("Dude", Dude);
        }
    };
});
System.register("game/characters/Player", ["engine/point", "engine/component", "game/characters/Dude", "game/world/elements/Interactable", "game/world/elements/Hittable", "game/ui/UIStateManager", "game/Controls", "engine/util/Lists"], function (exports_88, context_88) {
    "use strict";
    var point_46, component_22, Dude_3, Interactable_5, Hittable_2, UIStateManager_12, Controls_7, Lists_2, Player;
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_46.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    if (updateData.input.isKeyDown(80 /* P */)) {
                        ...
                        this.dude.damage(.25, new point_46.Point(-1, Math.random() - .5), 30);
                    }
                ...
                Player.prototype.updateInteractables = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_46.Point(0, 7));
            ...
            exports_88("Player", Player);
        }
    };
});
System.register("game/characters/NPCSchedule", [], function (exports_89, context_89) {
    "use strict";
    var NPCSchedules;
    ...
    return {
        setters: [],
        execute: function () {
            exports_89("NPCSchedules", NPCSchedules = {
                SCHEDULE_KEY: "sch",
...
System.register("game/characters/NPC", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point", "game/world/LocationManager", "game/graphics/Tilesets", "engine/util/Lists", "game/characters/NPCSchedule", "game/ui/DialogueDisplay"], function (exports_90, context_90) {
    "use strict";
    var component_23, Dude_4, Player_7, point_47, LocationManager_13, Tilesets_26, Lists_3, NPCSchedule_1, DialogueDisplay_3, NPC;
        ...
        execute: function () {
            ...
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.doAttack = function (updateData) {
                    ...
                    if (!this.attackTarget || !this.attackTarget.isAlive) {
                        this.dude.move(updateData, new point_47.Point(0, 0));
                        return;
                    }
...
System.register("game/characters/Enemy", ["engine/component", "game/characters/Dude", "game/characters/NPC"], function (exports_91, context_91) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_91("Enemy", Enemy);
        }
    };
});
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_92, context_92) {
    "use strict";
    var component_25, Player_8, Dude_6, point_48, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_48.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_48.Point.ZERO;
                };
            ...
            exports_92("CutscenePlayerController", CutscenePlayerController);
        }
    };
});
System.register("game/characters/Villager", ["engine/component", "game/characters/NPC"], function (exports_93, context_93) {
    "use strict";
...
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/cutscenes/CutscenePlayerController", "game/characters/Villager", "game/characters/NPCSchedule", "engine/util/Lists"], function (exports_94, context_94) {
    ...
    return {
        ...
        execute: function () {
                    ...
                    switch (type) {
                        ...
                        case 1 /* DIP */: {
                            ...
                            additionalComponents = [
                                new NPC_3.NPC(NPCSchedule_2.NPCSchedules.newGoToSchedule(new point_49.Point(0, 0))),
            ...
            exports_94("DudeFactory", DudeFactory);
        }
    };
});
System.register("game/saves/DudeSaveState", [], function (exports_95, context_95) {
    "use strict";
    var DudeSaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_95("DudeSaveState", DudeSaveState);
        }
    };
});
...
System.register("game/saves/uuid", [], function (exports_97, context_97) {
    "use strict";
    var newUUID;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_97("newUUID", newUUID = function () {
...
System.register("game/world/ground/GroundComponent", ["engine/component"], function (exports_98, context_98) {
    "use strict";
        ...
        execute: function () {
            WorldLocation = /** @class */ (function () {
                ...
                WorldLocation.prototype.getTeleporterLinkedPos = function (to, id) {
                    ...
                    return point_50.Point.fromString(link);
                };
                ...
                WorldLocation.load = function (locationManager, saveState) {
                    ...
                    saveState.elements.forEach(function (el) { return n.addWorldElement(el.type, point_50.Point.fromString(el.pos), el.obj); });
                    saveState.ground.forEach(function (el) { return n.addGroundElement(el.type, point_50.Point.fromString(el.pos), el.obj); });
        ...
        execute: function () {
            ...
            GroundRenderer = /** @class */ (function () {
                function GroundRenderer() {
                    // no lights should live outside of this range
                    this.size = MapGenerator_4.MapGenerator.MAP_SIZE * Tilesets_28.TILE_SIZE * 2;
                ...
                GroundRenderer.prototype.renderToOffscreenCanvas = function () {
                    ...
                    locationTileGrid.entries().forEach(function (entry) {
                        var pos = entry[0].times(Tilesets_28.TILE_SIZE).plus(_this.shift);
                        var tile = entry[1];
                        var imageRender = tile.toImageRender(new TileTransform_19.TileTransform());
                        _this.context.drawImage(imageRender.source, imageRender.sourcePosition.x, imageRender.sourcePosition.y, Tilesets_28.TILE_SIZE, Tilesets_28.TILE_SIZE, pos.x, pos.y, Tilesets_28.TILE_SIZE, Tilesets_28.TILE_SIZE);
                    });
                };
                GroundRenderer.prototype.getEntity = function () {
                    ...
                    return new Entity_18.Entity([new BasicRenderComponent_5.BasicRenderComponent(new ImageRender_3.ImageRender(this.canvas, Camera_5.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_5.Camera.instance.position.apply(Math.floor), dimensions, Number.MIN_SAFE_INTEGER))]);
                };
                return GroundRenderer;
            }());
            exports_100("GroundRenderer", GroundRenderer);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "game/world/GroundRenderer"], function (exports_101, context_101) {
    "use strict";
    var point_52, Tilesets_29, GroundComponent_1, Entity_19, GroundRenderer_1, makeGrass;
    ...
    return {
        ...
        execute: function () {
            exports_101("makeGrass", makeGrass = function (d) {
                var _a;
                var tile;
                var index = (_a = d.data["index"]) !== null && _a !== void 0 ? _a : (Math.random() < .65 ? Math.floor(Math.random() * 4) : 0);
                if (index > 0) {
                    tile = Tilesets_29.Tilesets.instance.tilemap.getTileAt(new point_52.Point(0, index));
                }
                else {
                    tile = Tilesets_29.Tilesets.instance.tilemap.getTileAt(new point_52.Point(0, 7));
                }
...
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_102, context_102) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_102("makePath", makePath = function (d) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_103, context_103) {
    "use strict";
    var Tilesets_30, GroundComponent_3, Entity_21, TileTransform_20, makeBasicGround, makeBasicNineSliceGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_103("makeBasicGround", makeBasicGround = function (d) {
                var key = d.data["k"];
                var tile = Tilesets_30.Tilesets.instance.getBasicTileSource(key);
                var c = tile.toComponent(new TileTransform_20.TileTransform(d.pos.times(Tilesets_30.TILE_SIZE)));
            ...
            exports_103("makeBasicNineSliceGround", makeBasicNineSliceGround = function (d) {
                var key = d.data["k"];
                var slice = Tilesets_30.Tilesets.instance.getBasicTileNineSlice(key);
                var nineSliceIndex = d.data["i"];
                var c = slice[nineSliceIndex].toComponent(new TileTransform_20.TileTransform(d.pos.times(Tilesets_30.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_104, context_104) {
    "use strict";
    var point_53, Tilesets_31, GroundComponent_4, Entity_22, TileTransform_21, makeLedge;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_104("makeLedge", makeLedge = function (d) {
                var c = Tilesets_31.Tilesets.instance.tilemap.getTileAt(new point_53.Point(3, 2)).toComponent(new TileTransform_21.TileTransform(d.pos.times(Tilesets_31.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/BasicGround", "game/world/ground/Ledge"], function (exports_105, context_105) {
    "use strict";
    var point_54, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_32, BasicGround_1, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_105("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(2, 6)))
                        .angle(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(0, 5)))
                        .tShape(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(3, 5)))
                        .plusShape(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(5, 5)))
                        .cap(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(2, 6)))
                        .single(Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_54.Point(7, 5)));
            ...
            exports_105("Ground", Ground);
        }
    };
});
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_106, context_106) {
    "use strict";
    var point_55, TileTransform_22, ConnectingTile_2, ConnectingTileSchema;
        ...
        execute: function () {
            ...
            ConnectingTileSchema = /** @class */ (function () {
                ...
                ConnectingTileSchema.prototype.render = function (grid, position) {
                    ...
                    var y = position.y;
                    // TODO: add diagonals?
                    var n = this.get(grid, new point_55.Point(x, y - 1));
                    var s = this.get(grid, new point_55.Point(x, y + 1));
                    var e = this.get(grid, new point_55.Point(x + 1, y));
                    var w = this.get(grid, new point_55.Point(x - 1, y));
            ...
            exports_106("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_107, context_107) {
    "use strict";
    var point_56, component_28, ConnectingTile;
        ...
        execute: function () {
            ConnectingTile = /** @class */ (function (_super) {
                ...
                function ConnectingTile(schema, grid, position) {
                    if (position === void 0) { position = new point_56.Point(0, 0); }
                    var _this = _super.call(this) || this;
                    _this.schema = schema;
                    _this.grid = grid;
                    _this.position = position;
            ...
            exports_107("ConnectingTile", ConnectingTile);
        }
    };
});
/*
...
*
*/
System.register("engine/util/Noise", [], function (exports_108, context_108) {
    "use strict";
    ...
    return {
        ...
        execute: function () {/*
            ...
            */
            ...
            exports_108("Noise", Noise);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/tiles/ConnectingTile", "engine/collision/BoxCollider", "game/world/LocationManager", "game/world/ground/Ground", "engine/util/Noise", "engine/util/Grid", "game/graphics/Tilesets"], function (exports_109, context_109) {
    "use strict";
    var point_57, ConnectingTile_3, BoxCollider_8, LocationManager_17, Ground_3, Noise_1, Grid_4, Tilesets_33, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    ...
                    this.tentPos = new point_57.Point(-3, -3);
                }
                ...
                MapGenerator.prototype.spawnTrees = function () {
                    ...
                    for (var i = 0; i < trees; i++) {
                        var pt = new point_57.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE - 1)) - MapGenerator.MAP_SIZE / 2);
                        var occupiedPoints = [pt, pt.plus(new point_57.Point(0, 1))];
                ...
                MapGenerator.prototype.clearPathToCenter = function () {
                    ...
                    for (var x = MapGenerator.MAP_SIZE / 2 - 11; x < MapGenerator.MAP_SIZE / 2; x++) {
                        for (var y = MapGenerator.MAP_SIZE / 2 - 10; y < MapGenerator.MAP_SIZE / 2 - 8; y++) {
                            var element = this.location.elements.get(new point_57.Point(x, y));
                    ...
                    // clear around tent
                    var clearingCorner = this.tentPos.minus(new point_57.Point(1, 0));
                    for (var x = 0; x < 6; x++) {
                        for (var y = 0; y < 4; y++) {
                            var element = this.location.elements.get(clearingCorner.plus(new point_57.Point(x, y)));
                            if (!!element && typesToClear.indexOf(element.type) !== -1) {
                                this.location.elements.removeAll(element);
                            }
                        }
                ...
                MapGenerator.prototype.spawnRocks = function () {
                    ...
                    while (placedRocks < 20) {
                        var p = new point_57.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE)) - MapGenerator.MAP_SIZE / 2);
                ...
                MapGenerator.prototype.noise = function () {
                    ...
                    for (var i = -MapGenerator.MAP_SIZE / 2; i < MapGenerator.MAP_SIZE / 2; i++) {
                        for (var j = -MapGenerator.MAP_SIZE / 2; j < MapGenerator.MAP_SIZE / 2; j++) {
                            ...
                            str += v;
                            grid.set(new point_57.Point(j, i), v);
                        }
                        str += "\n";
                    }
                    console.log(str);
                ...
                MapGenerator.ENTER_LAND_POS = new point_57.Point(1, 1).times(MapGenerator.MAP_SIZE / 2 * Tilesets_33.TILE_SIZE).plusY(-Tilesets_33.TILE_SIZE * 10).plusX(Tilesets_33.TILE_SIZE * 2);
                return MapGenerator;
            }());
...
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager"], function (exports_110, context_110) {
    "use strict";
    var component_29, CutscenePlayerController_2, Player_11, point_58, Camera_6, CutsceneManager_2, LocationManager_18, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_58.Point(-1, 0));
        ...
        execute: function () {
            ...
            QuestGame = /** @class */ (function (_super) {
                ...
                QuestGame.prototype.newGame = function () {
                    ...
                    DudeFactory_3.DudeFactory.instance.new(1 /* DIP */, point_59.Point.ZERO);
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_59.Point(3, 1).times(Tilesets_34.TILE_SIZE));
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_59.Point(-1, 3).times(Tilesets_34.TILE_SIZE));
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_59.Point(-4, 0).times(Tilesets_34.TILE_SIZE));
                ...
                QuestGame.prototype.getViews = function (updateViewsContext) {
                    ...
                    if (updateViewsContext.input.isKeyDown(76 /* L */)) {
                        DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_59.Point(40, 30));
                    }
                ...
                QuestGame.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.uiView = {
                        zoom: ZOOM,
                        offset: point_59.Point.ZERO,
                        entities: UIStateManager_13.UIStateManager.instance.get(dimensions, updateViewsContext.elapsedTimeMillis)
                    };
                };
                return QuestGame;
            }(game_1.Game));
            exports_111("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_112, context_112) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_35, Assets_4;
    ...
    return {
        ...
        execute: function () {
            Assets_4.assets.loadImageFiles(Tilesets_35.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/renderer/TintRender", ["engine/renderer/RenderMethod"], function (exports_113, context_113) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_113("TintRender", TintRender);
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_114, context_114) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_114("Clickable", Clickable);
        }
    };
});
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_115, context_115) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_115("serialize", serialize = function (object) {
...
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_116, context_116) {
    "use strict";
    var component_31, Tilesets_36, TileTransform_23, point_60, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_36.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_23.TileTransform(_this.topLeftPos.plus(new point_60.Point(10 * i, 0))));
                    });
                };
            ...
            exports_116("StringTiles", StringTiles);
        }
    };
});
