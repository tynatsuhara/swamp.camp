...
System.register("game/cutscenes/Camera", ["engine/point", "game/world/MapGenerator", "game/graphics/Tilesets"], function (exports_49, context_49) {
    "use strict";
    var point_22, MapGenerator_1, Tilesets_5, Camera;
        ...
        execute: function () {
            Camera = /** @class */ (function () {
                ...
                Camera.prototype.getUpdatedPosition = function (dimensions, elapsedTimeMillis) {
                    ...
                    var clampedTrackedPoint = new point_22.Point(this.clamp(trackedPoint.x, -xLimit, xLimit), this.clamp(trackedPoint.y, -yLimit, yLimit));
...
System.register("game/ui/OffScreenMarker", ["engine/point", "engine/util/utils", "engine/util/Lists", "engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/world/LocationManager", "game/cutscenes/Camera"], function (exports_50, context_50) {
    "use strict";
    var point_23, utils_3, Lists_1, component_8, Tilesets_6, TileTransform_8, LocationManager_4, Camera_1, OffScreenMarker;
            ...
            OffScreenMarker = /** @class */ (function (_super) {
                ...
                OffScreenMarker.prototype.update = function (updateData) {
                    ...
                    this.tilePoint = intersect[1]
                        ...
                        .minus(new point_23.Point(.5, .5).times(Tilesets_6.TILE_SIZE));
...
System.register("game/ui/HUD", ["game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/tiles/TileComponent", "engine/Entity", "game/ui/OffScreenMarker"], function (exports_51, context_51) {
    "use strict";
    var Tilesets_7, TileTransform_9, point_24, TileComponent_6, Entity_4, OffScreenMarker_1, HUD;
        ...
        execute: function () {
            HUD = /** @class */ (function () {
                ...
                HUD.prototype.updateAutosave = function (screenDimensions, elapsedMillis) {
                    var base = screenDimensions.minus(this.offset).minus(new point_24.Point(Tilesets_7.TILE_SIZE, Tilesets_7.TILE_SIZE));
...
System.register("engine/tiles/NineSlice", ["engine/point", "engine/tiles/TileTransform"], function (exports_52, context_52) {
    "use strict";
    var point_25, TileTransform_10, NineSlice;
        ...
        execute: function () {
            exports_52("NineSlice", NineSlice = {
                ...
                makeNineSliceComponents: function (slice, pos, dimensions) {
                    ...
                    var tiles = [];
                    tiles.push(slice[0].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, 0))));
                    tiles.push(slice[2].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - 1, 0))));
                    tiles.push(slice[6].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, dimensions.y - 1))));
                    tiles.push(slice[8].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - 1, dimensions.y - 1))));
                    // horizontal lines
                    for (var i = 1; i < dimensions.x - 1; i++) {
                        tiles.push(slice[1].toComponent(new TileTransform_10.TileTransform(new point_25.Point(i, 0))));
                        tiles.push(slice[7].toComponent(new TileTransform_10.TileTransform(new point_25.Point(i, dimensions.y - 1))));
                    }
                    // vertical lines
                    for (var j = 1; j < dimensions.y - 1; j++) {
                        tiles.push(slice[3].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, j))));
                        tiles.push(slice[5].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - 1, j))));
                    }
                    // middle
                    for (var x = 1; x < dimensions.x - 1; x++) {
                        for (var y = 1; y < dimensions.y - 1; y++) {
                            tiles.push(slice[4].toComponent(new TileTransform_10.TileTransform(new point_25.Point(x, y))));
                        }
                    }
                ...
                makeStretchedNineSliceComponents: function (slice, pos, dimensions) {
                    ...
                    // }
                    var tiles = [];
                    var topLeft = slice[0].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, 0)));
                    var tileSize = topLeft.transform.dimensions.x;
                    // corners
                    tiles.push(topLeft);
                    tiles.push(slice[2].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - tileSize, 0))));
                    tiles.push(slice[6].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, dimensions.y - tileSize))));
                    tiles.push(slice[8].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - tileSize, dimensions.y - tileSize))));
                    // horizontal lines
                    var horizontalDimensions = new point_25.Point(dimensions.x - tileSize * 2, tileSize);
                    tiles.push(slice[1].toComponent(new TileTransform_10.TileTransform(new point_25.Point(tileSize, 0), horizontalDimensions)));
                    tiles.push(slice[7].toComponent(new TileTransform_10.TileTransform(new point_25.Point(tileSize, dimensions.y - tileSize), horizontalDimensions)));
                    // vertical lines
                    var verticalDimensions = new point_25.Point(tileSize, dimensions.y - tileSize * 2);
                    tiles.push(slice[3].toComponent(new TileTransform_10.TileTransform(new point_25.Point(0, tileSize), verticalDimensions)));
                    tiles.push(slice[5].toComponent(new TileTransform_10.TileTransform(new point_25.Point(dimensions.x - tileSize, tileSize), verticalDimensions)));
                    // middle
                    tiles.push(slice[4].toComponent(new TileTransform_10.TileTransform(new point_25.Point(tileSize, tileSize), new point_25.Point(dimensions.x - tileSize * 2, dimensions.y - tileSize * 2))));
                    var mainTransform = tiles[0].transform;
                    tiles.forEach(function (c, i) {
                        if (i > 0) {
                            c.transform.relativeTo(mainTransform);
...
System.register("game/ui/Tooltip", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/renderer/TextRender", "game/ui/Text", "game/ui/Color", "game/ui/UIStateManager"], function (exports_54, context_54) {
    "use strict";
    var component_9, Tilesets_8, point_26, TextRender_3, Text_1, Color_1, UIStateManager_1, Tooltip;
        ...
        execute: function () {
            Tooltip = /** @class */ (function (_super) {
                ...
                Tooltip.prototype.update = function (updateData) {
                    ...
                    var leftPos = this.position.plus(new point_26.Point(Tilesets_8.TILE_SIZE / 2, -Tilesets_8.TILE_SIZE)).apply(Math.floor);
                    var centerPos = leftPos.plus(new point_26.Point(Tilesets_8.TILE_SIZE, 0));
                    var rightPos = leftPos.plus(new point_26.Point(width - Tilesets_8.TILE_SIZE + Tooltip.margin * 2, 0)).apply(Math.floor);
                    this.left.transform.position = leftPos;
                    this.center.transform.position = centerPos;
                    this.right.transform.position = rightPos;
                    this.center.transform.dimensions = new point_26.Point(width + Tooltip.margin * 2 - Tilesets_8.TILE_SIZE * 2, Tilesets_8.TILE_SIZE);
                };
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils", "engine/tiles/TileTransform"], function (exports_55, context_55) {
    "use strict";
    var component_10, Tilesets_9, point_27, NineSlice_1, UIStateManager_2, LocationManager_5, PlaceElementDisplay_1, utils_4, TileTransform_11, PlaceElementFrame;
        ...
        execute: function () {
            ...
            PlaceElementFrame = /** @class */ (function (_super) {
                ...
                PlaceElementFrame.prototype.getTiles = function (suffix) {
                    ...
                    return NineSlice_1.NineSlice.makeNineSliceComponents(Tilesets_9.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_" + suffix), new point_27.Point(0, 0), this.dimensions);
                };
                PlaceElementFrame.prototype.update = function (updateData) {
                    var startPos = updateData.input.mousePos;
                    var tilePt = this.pixelPtToTilePt(startPos.minus(new point_27.Point(this.dimensions.x / 2, this.dimensions.y / 2).times(Tilesets_9.TILE_SIZE)));
                ...
                PlaceElementFrame.prototype.canPlace = function (pos) {
                    for (var x = pos.x; x < pos.x + this.dimensions.x; x++) {
                        for (var y = pos.y; y < pos.y + this.dimensions.y; y++) {
                            if (!!LocationManager_5.LocationManager.instance.currentLocation.elements.get(new point_27.Point(x, y))) {
                                return false;
                            }
                        }
                    }
...
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/point", "engine/util/utils", "game/graphics/Tilesets", "game/characters/Player", "engine/Entity", "game/ui/UIStateManager", "engine/tiles/NineSlice", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "game/items/Items", "game/ui/Text", "game/ui/Color", "game/Controls", "game/ui/PlaceElementDisplay"], function (exports_57, context_57) {
    "use strict";
    var component_12, point_28, utils_5, Tilesets_10, Player_3, Entity_6, UIStateManager_3, NineSlice_2, Tooltip_1, AnimatedTileComponent_2, TileTransform_12, BasicRenderComponent_2, TextRender_4, Items_3, Text_2, Color_2, Controls_2, PlaceElementDisplay_2, InventoryDisplay;
        ...
        execute: function () {
            InventoryDisplay = /** @class */ (function (_super) {
                ...
                function InventoryDisplay() {
                    ...
                    _this.coinsOffset = new point_28.Point(0, -18);
                ...
                InventoryDisplay.prototype.update = function (updateData) {
                    ...
                    if (updateData.input.isMouseDown) {
                        inv.forEach(function (stack, index) {
                            if (utils_5.rectContains(_this.getPositionForInventoryIndex(index), new point_28.Point(Tilesets_10.TILE_SIZE, Tilesets_10.TILE_SIZE), updateData.input.mousePos)) {
                ...
                InventoryDisplay.prototype.spawnBG = function () {
                    var _this = this;
                    this.bgTiles = NineSlice_2.NineSlice.makeNineSliceComponents(Tilesets_10.Tilesets.instance.oneBit.getNineSlice("invBoxNW"), this.offset.minus(new point_28.Point(Tilesets_10.TILE_SIZE / 2, Tilesets_10.TILE_SIZE / 2)), new point_28.Point(1 + InventoryDisplay.COLUMNS, 1 + this.inventory().inventory.length / InventoryDisplay.COLUMNS));
                ...
                InventoryDisplay.prototype.show = function (screenDimensions) {
                    ...
                    var displayDimensions = new point_28.Point(InventoryDisplay.COLUMNS, this.inventory().inventory.length / InventoryDisplay.COLUMNS).times(Tilesets_10.TILE_SIZE);
                    this.offset = new point_28.Point(Math.floor(screenDimensions.x / 2 - displayDimensions.x / 2), Math.floor(screenDimensions.y / 6));
                    ...
                    this.displayEntity.addComponent(new BasicRenderComponent_2.BasicRenderComponent(new TextRender_4.TextRender("x" + this.inventory().getItemCount(0 /* COIN */), new point_28.Point(9, 1).plus(this.offset).plus(this.coinsOffset), Text_2.TEXT_SIZE, Text_2.TEXT_FONT, Color_2.Color.YELLOW, UIStateManager_3.UIStateManager.UI_SPRITE_DEPTH)));
                    // background
                    this.spawnBG();
                    // icons
                ...
                InventoryDisplay.prototype.getPositionForInventoryIndex = function (i) {
                    return new point_28.Point(i % InventoryDisplay.COLUMNS, Math.floor(i / InventoryDisplay.COLUMNS)).times(Tilesets_10.TILE_SIZE).plus(this.offset);
                };
...
System.register("game/ui/DudeInteractIndicator", ["game/graphics/Tilesets", "engine/point"], function (exports_63, context_63) {
    "use strict";
    var Tilesets_11, point_29, DudeInteractIndicator;
                ...
                getTile: function (indicator) {
                    switch (indicator) {
                        ...
                        case DudeInteractIndicator.IMPORTANT_DIALOGUE:
                            return Tilesets_11.Tilesets.instance.oneBit.getTileAt(new point_29.Point(19, 25));
                    }
                },
            });
        }
...
System.register("game/characters/dialogues/DipIntro", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator", "game/characters/Player", "game/Controls", "game/world/LocationManager", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/WorldTime"], function (exports_64, context_64) {
    "use strict";
    var _a, Dialogue_1, DudeInteractIndicator_1, Player_5, Controls_3, LocationManager_9, EventQueue_3, QueuedEvent_2, WorldTime_2, ROCKS_NEEDED_FOR_CAMPFIRE, DIP_INTRO_DIALOGUE;
            ...
            exports_64("DIP_INTRO_DIALOGUE", DIP_INTRO_DIALOGUE = (_a = {},
                ...
                _a[6 /* DIP_MAKE_CAMPFIRE */] = function () {
                    if (Player_5.Player.instance.dude.inventory.getItemCount(1 /* ROCK */) >= ROCKS_NEEDED_FOR_CAMPFIRE) {
                        return Dialogue_1.dialogueWithOptions(["It looks like you have enough rocks. Can I have " + ROCKS_NEEDED_FOR_CAMPFIRE + " to make a campfire?"], DudeInteractIndicator_1.DudeInteractIndicator.IMPORTANT_DIALOGUE, Dialogue_1.option("<Give rocks>", 7 /* DIP_ROCKS_RECEIVED */), Dialogue_1.option("Not yet.", 6 /* DIP_MAKE_CAMPFIRE */, false));
                    }
                    else {
                        return Dialogue_1.dialogue(["We need " + ROCKS_NEEDED_FOR_CAMPFIRE + " rocks to make a campfire. Try hitting big rocks with your sword!"], function () { return new Dialogue_1.NextDialogue(6 /* DIP_MAKE_CAMPFIRE */, false); });
                    }
                },
                _a[7 /* DIP_ROCKS_RECEIVED */] = function () {
                    return Dialogue_1.dialogue(["Great! Try placing the campfire down near my tent. You can open your inventory by pressing [" + String.fromCharCode(Controls_3.Controls.inventoryButton) + "]."], function () {
                        ...
                        return new Dialogue_1.NextDialogue(8 /* DIP_CAMPFIRE_DONE */, false);
                    });
                },
                _a[8 /* DIP_CAMPFIRE_DONE */] = function () {
                    ...
                    if (campfires.length > 0) {
                        ...
                        return Dialogue_1.dialogue(["You should set up the campfire before it gets dark!"], function () { return new Dialogue_1.NextDialogue(8 /* DIP_CAMPFIRE_DONE */, false); });
                    }
                },
                _a));
        }
...
System.register("game/characters/dialogues/BertoIntro", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator"], function (exports_65, context_65) {
    "use strict";
...
System.register("game/characters/Dialogue", ["game/SaveManager", "game/ui/DudeInteractIndicator", "game/characters/dialogues/DipIntro", "game/characters/dialogues/BertoIntro"], function (exports_66, context_66) {
    "use strict";
    var SaveManager_1, DudeInteractIndicator_3, DipIntro_1, BertoIntro_1, DialogueInstance, dialogueWithOptions, dialogue, option, saveAfterDialogueStage, DialogueOption, NextDialogue, getDialogue, DIALOGUE_SOURCES, DIALOGUE_MAP;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_66("DialogueInstance", DialogueInstance);
            // Shorthand functions for creating dialogue
            exports_66("dialogueWithOptions", dialogueWithOptions = function (lines, indicator) {
                if (indicator === void 0) { indicator = DudeInteractIndicator_3.DudeInteractIndicator.NONE; }
                var options = [];
            ...
            exports_66("dialogue", dialogue = function (lines, next, indicator) {
                if (next === void 0) { next = function () { }; }
                if (indicator === void 0) { indicator = DudeInteractIndicator_3.DudeInteractIndicator.NONE; }
                return new DialogueInstance(lines, next, [], indicator);
            });
            exports_66("option", option = function (text, next, open) {
                if (open === void 0) { open = true; }
                return new DialogueOption(text, function () { return new NextDialogue(next, open); });
            });
            exports_66("saveAfterDialogueStage", saveAfterDialogueStage = function () {
            ...
            exports_66("NextDialogue", NextDialogue);
            exports_66("getDialogue", getDialogue = function (d) {
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "game/graphics/Tilesets", "game/ui/Text", "engine/renderer/TextRender", "game/ui/UIStateManager", "engine/util/utils"], function (exports_67, context_67) {
    "use strict";
    var component_14, point_30, Tilesets_12, Text_3, TextRender_5, UIStateManager_5, utils_6, TextButton;
    ...
    return {
        ...
        execute: function () {
            TextButton = /** @class */ (function (_super) {
                ...
                function TextButton(position, text, onClick, buttonColor, textColor, hoverColor) {
                    ...
                    _this.start = function () {
                        ...
                        var centerPos = leftPos.plus(new point_30.Point(Tilesets_12.TILE_SIZE, 0));
                        var rightPos = leftPos.plus(new point_30.Point(_this.width - Tilesets_12.TILE_SIZE, 0)).apply(Math.floor);
                        _this.left.transform.position = leftPos;
                        _this.center.transform.position = centerPos;
                        _this.right.transform.position = rightPos;
                        _this.center.transform.dimensions = new point_30.Point(_this.width + TextButton.margin * 2 - Tilesets_12.TILE_SIZE * 2, Tilesets_12.TILE_SIZE);
                ...
                TextButton.prototype.update = function (updateData) {
                    this.hovering = utils_6.rectContains(this.position, new point_30.Point(this.width, Tilesets_12.TILE_SIZE), updateData.input.mousePos);
            ...
            exports_67("TextButton", TextButton);
        }
    };
});
System.register("game/ui/ButtonsMenu", ["engine/point", "game/ui/TextButton", "game/ui/UIStateManager", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/ui/Text", "engine/Entity"], function (exports_68, context_68) {
    "use strict";
    var point_31, TextButton_1, UIStateManager_6, Tilesets_13, NineSlice_3, Text_4, Entity_8, ButtonsMenu;
    ...
    return {
        ...
        execute: function () {
            exports_68("ButtonsMenu", ButtonsMenu = {
                render: function (screenDimensions, backgroundColor, options) {
                    ...
                    var marginSide = 9;
                    var buttonPadding = 3;
                    var dimensions = new point_31.Point(longestOption * Text_4.TEXT_PIXEL_WIDTH + marginSide * 2 + TextButton_1.TextButton.margin * 2, (options.length - 1) * buttonPadding + options.length * Tilesets_13.TILE_SIZE + marginTop + marginBottom);
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/ui/Color", "game/Controls", "game/ui/UIStateManager", "game/ui/ButtonsMenu"], function (exports_69, context_69) {
    "use strict";
    var Dialogue_3, Tilesets_14, NineSlice_4, point_32, component_15, Entity_9, BasicRenderComponent_3, Text_5, Color_3, Controls_4, UIStateManager_7, ButtonsMenu_1, DialogueDisplay;
        ...
        execute: function () {
            DialogueDisplay = /** @class */ (function (_super) {
                ...
                function DialogueDisplay() {
                    var _this = _super.call(this) || this;
                    _this.e = new Entity_9.Entity([_this]);
                ...
                DialogueDisplay.prototype.update = function (updateData) {
                    ...
                    this.displayEntity = new Entity_9.Entity();
                ...
                DialogueDisplay.prototype.renderNextLine = function (screenDimensions) {
                    ...
                    var bottomBuffer = Tilesets_14.TILE_SIZE;
                    ...
                    var backgroundTiles = NineSlice_4.NineSlice.makeStretchedNineSliceComponents(Tilesets_14.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
                    backgroundTiles[0].transform.depth = UIStateManager_7.UIStateManager.UI_SPRITE_DEPTH;
                    var topOffset = 2;
                    var margin = 12;
                    var width = dimensions.x - margin * 2;
                    var formattedRenders = Text_5.formatText(this.dialogue.lines[this.lineIndex], Color_3.Color.DARK_RED, topLeft.plus(new point_32.Point(margin, topOffset + margin)), width, 1 /* CENTER */);
        ...
        execute: function () {
            CutsceneManager = /** @class */ (function () {
                ...
                CutsceneManager.prototype.startCutscene = function (cutsceneComponent) {
                    this.entity = new Entity_10.Entity([cutsceneComponent]);
                };
...
System.register("game/ui/ControlsUI", ["game/ui/KeyPressIndicator", "engine/point", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/ui/Text", "game/ui/Color", "game/ui/UIStateManager"], function (exports_71, context_71) {
    "use strict";
    var KeyPressIndicator_1, point_33, Tilesets_15, TileTransform_13, Text_6, Color_4, UIStateManager_8, makeControlsUI;
...
System.register("game/ui/PauseMenu", ["engine/component", "engine/Entity", "game/ui/UIStateManager", "engine/point", "game/ui/ButtonsMenu", "game/ui/Color", "game/SaveManager", "game/cutscenes/CutsceneManager", "game/ui/ControlsUI", "engine/renderer/BasicRenderComponent"], function (exports_72, context_72) {
    "use strict";
    var component_16, Entity_11, UIStateManager_9, point_34, ButtonsMenu_2, Color_5, SaveManager_3, CutsceneManager_1, ControlsUI_1, BasicRenderComponent_4, PauseMenu;
        ...
        execute: function () {
            PauseMenu = /** @class */ (function (_super) {
                ...
                PauseMenu.prototype.show = function (dimensions) {
                    ...
                    this.controlsDisplay = new Entity_11.Entity([new (BasicRenderComponent_4.BasicRenderComponent.bind.apply(BasicRenderComponent_4.BasicRenderComponent, __spreadArrays([void 0], ControlsUI_1.makeControlsUI(dimensions, point_34.Point.ZERO))))()]);
                };
            ...
            exports_72("PauseMenu", PauseMenu);
        }
    };
});
System.register("game/ui/UIStateManager", ["game/ui/HUD", "game/characters/Player", "game/ui/InventoryDisplay", "game/ui/DialogueDisplay", "game/ui/PlaceElementDisplay", "game/ui/PauseMenu"], function (exports_73, context_73) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_73("UIStateManager", UIStateManager);
        }
    };
});
System.register("game/ui/KeyPressIndicator", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/renderer/TextRender", "game/Controls", "game/ui/Text", "game/ui/UIStateManager", "game/ui/Color"], function (exports_74, context_74) {
    "use strict";
    var component_17, Tilesets_16, TileTransform_14, point_35, TextRender_6, Controls_5, Text_7, UIStateManager_10, Color_6, KeyPressIndicator;
        ...
        execute: function () {
            KeyPressIndicator = /** @class */ (function (_super) {
                ...
                KeyPressIndicator.prototype.getRenderMethods = function () {
                    return [
                        Tilesets_16.Tilesets.instance.oneBit.getTileSource("keycap").toImageRender(new TileTransform_14.TileTransform(this.pos, null, 0, false, false, UIStateManager_10.UIStateManager.UI_SPRITE_DEPTH)),
                        new TextRender_6.TextRender(Controls_5.Controls.keyString(this.key).toLowerCase(), this.pos.plus(new point_35.Point(4, 4)), Text_7.TEXT_SIZE, Text_7.TEXT_FONT, Color_6.Color.BLACK, UIStateManager_10.UIStateManager.UI_SPRITE_DEPTH)
                    ];
                };
                return KeyPressIndicator;
            }(component_17.Component));
            exports_74("KeyPressIndicator", KeyPressIndicator);
        }
    };
});
System.register("game/world/elements/Interactable", ["engine/component", "engine/point", "game/ui/KeyPressIndicator", "game/Controls", "game/graphics/Tilesets"], function (exports_75, context_75) {
    "use strict";
    var component_18, point_36, KeyPressIndicator_2, Controls_6, Tilesets_17, Interactable;
        ...
        execute: function () {
            Interactable = /** @class */ (function (_super) {
                ...
                Interactable.prototype.getRenderMethods = function () {
                    ...
                    return new KeyPressIndicator_2.KeyPressIndicator(this.position.minus(new point_36.Point(Tilesets_17.TILE_SIZE / 2, Tilesets_17.TILE_SIZE / 2)).plus(this.uiOffset), Controls_6.Controls.interactButton).getRenderMethods();
                };
                return Interactable;
            }(component_18.Component));
            exports_75("Interactable", Interactable);
        }
    };
});
System.register("game/world/elements/ElementUtils", ["engine/point"], function (exports_76, context_76) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_76("ElementUtils", ElementUtils = {
...
System.register("game/world/Teleporter", ["game/world/elements/Interactable", "engine/point", "game/world/elements/ElementComponent", "engine/Entity", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/component"], function (exports_77, context_77) {
    "use strict";
    var Interactable_1, point_38, ElementComponent_4, Entity_12, Tilesets_18, TileTransform_15, component_19, Teleporters, makeTeleporterElement;
    ...
    return {
        ...
        execute: function () {
            exports_77("Teleporters", Teleporters = {
                teleporterId: function (toUUID, id) {
                    if (id === void 0) { id = null; }
                    return "" + toUUID + (!!id ? "$" + id : '');
                },
            });
            exports_77("makeTeleporterElement", makeTeleporterElement = function (wl, pos, data) {
                ...
                var id = data["id"];
                var interactComponent = e.addComponent(new Interactable_1.Interactable(interactPos, function () { return wl.useTeleporter(destinationUUID, id); }, new point_38.Point(0, Tilesets_18.TILE_SIZE / 2)));
                ...
                e.addComponent(new /** @class */ (function (_super) {
                    ...
                    class_1.prototype.getRenderMethods = function () {
                        ...
                        return [Tilesets_18.Tilesets.instance.oneBit.getTileSource("small_arrow_down").toImageRender(new TileTransform_15.TileTransform(pos.times(Tilesets_18.TILE_SIZE)))];
                    };
                    return class_1;
...
System.register("game/world/interior/AsciiInteriorBuilder", ["engine/point"], function (exports_78, context_78) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_78("AsciiInteriorBuilder", AsciiInteriorBuilder);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_79, context_79) {
    "use strict";
    var LocationManager_10, point_40, Tilesets_19, NineSlice_5, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_79("makeTentInterior", makeTentInterior = function (outside, color) {
...
System.register("game/world/elements/Tent", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Interactable", "game/world/elements/ElementComponent", "game/world/elements/ElementUtils", "game/world/interior/Tent"], function (exports_80, context_80) {
    ...
    return {
        ...
        execute: function () {
            exports_80("makeTent", makeTent = function (wl, pos, data) {
                var _a, _b;
                ...
                addTile(wl, e, color + "tentSE", pos.plus(new point_41.Point(2, 1)), depth);
                ...
                // Set up teleporter
                e.addComponent(new Interactable_2.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_41.Point(1, -Tilesets_20.TILE_SIZE * 1.4)));
                return e.addComponent(new ElementComponent_5.ElementComponent(2 /* TENT */, ElementUtils_1.ElementUtils.rectPoints(pos, new point_41.Point(4, 3)), function () { return { destinationUUID: destinationUUID, color: color }; }));
            });
            addTile = function (wl, e, s, pos, depth) {
                var tile = e.addComponent(new TileComponent_7.TileComponent(Tilesets_20.Tilesets.instance.outdoorTiles.getTileSource(s), new TileTransform_16.TileTransform(pos.times(Tilesets_20.TILE_SIZE))));
                tile.transform.depth = depth;
            };
        }
    };
});
System.register("game/world/PointLightMaskRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/ui/UIStateManager", "game/world/WorldTime", "game/ui/Color", "game/world/LocationManager"], function (exports_81, context_81) {
    "use strict";
    var point_42, ImageRender_2, Entity_14, BasicRenderComponent_5, Camera_3, MapGenerator_3, Tilesets_21, Grid_1, UIStateManager_11, WorldTime_3, Color_7, LocationManager_11, PointLightMaskRenderer;
        ...
        execute: function () {
            PointLightMaskRenderer = /** @class */ (function () {
                ...
                PointLightMaskRenderer.prototype.updateColorForTime = function () {
                    ...
                    var nightColor = this.colorFromString(Color_7.Color.BLACK, 0.8);
                    var sunriseColor = this.colorFromString(Color_7.Color.PINK, 0.2);
                    var dayColor = this.colorFromString(Color_7.Color.LIGHT_PINK, 0);
                    var sunsetColor = this.colorFromString(Color_7.Color.DARK_PURPLE, 0.2);
                ...
                PointLightMaskRenderer.prototype.getEntity = function () {
                    ...
                    var dimensions = Camera_3.Camera.instance.dimensions.plus(new point_42.Point(1, 1));
                    return new Entity_14.Entity([new BasicRenderComponent_5.BasicRenderComponent(new ImageRender_2.ImageRender(this.canvas, Camera_3.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_3.Camera.instance.position.apply(Math.floor), dimensions, UIStateManager_11.UIStateManager.UI_SPRITE_DEPTH - 100 // make sure all UI goes on top of light
                        ))]);
                };
                return PointLightMaskRenderer;
            }());
            exports_81("PointLightMaskRenderer", PointLightMaskRenderer);
        }
    };
});
System.register("game/world/elements/Campfire", ["engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider", "game/world/elements/ElementComponent", "engine/Entity", "game/world/PointLightMaskRenderer"], function (exports_82, context_82) {
    "use strict";
    var TileComponent_8, AnimatedTileComponent_3, Tilesets_22, TileTransform_17, point_43, Interactable_3, BoxCollider_6, ElementComponent_6, Entity_15, PointLightMaskRenderer_1, makeCampfire;
    ...
    return {
        ...
        execute: function () {
            exports_82("makeCampfire", makeCampfire = function (wl, pos, data) {
                var _a;
                var e = new Entity_15.Entity();
                var scaledPos = pos.times(Tilesets_22.TILE_SIZE);
                var on = (_a = data["on"]) !== null && _a !== void 0 ? _a : false;
                var campfireOff = e.addComponent(new TileComponent_8.TileComponent(Tilesets_22.Tilesets.instance.outdoorTiles.getTileSource("campfireOff"), new TileTransform_17.TileTransform(scaledPos)));
                campfireOff.enabled = !on;
                campfireOff.transform.depth = scaledPos.y + Tilesets_22.TILE_SIZE;
                var campfireOn = e.addComponent(new AnimatedTileComponent_3.AnimatedTileComponent([Tilesets_22.Tilesets.instance.outdoorTiles.getTileSetAnimation("campfireOn", 2, 200)], new TileTransform_17.TileTransform(scaledPos)));
                campfireOn.enabled = on;
                campfireOn.transform.depth = scaledPos.y + Tilesets_22.TILE_SIZE;
                var offset = new point_43.Point(0, 5);
                e.addComponent(new BoxCollider_6.BoxCollider(scaledPos.plus(offset), new point_43.Point(Tilesets_22.TILE_SIZE, Tilesets_22.TILE_SIZE).minus(offset)));
                var set = function (nowOn) {
                    on = nowOn;
                    campfireOff.enabled = !nowOn;
                    campfireOn.enabled = nowOn;
                    var lightCenterPos = pos.times(Tilesets_22.TILE_SIZE).plus(new point_43.Point(Tilesets_22.TILE_SIZE / 2, Tilesets_22.TILE_SIZE / 2));
                    if (nowOn) {
                        PointLightMaskRenderer_1.PointLightMaskRenderer.instance.addLight(wl, lightCenterPos, Tilesets_22.TILE_SIZE * 8);
                    }
                    else {
                ...
                e.addComponent(new Interactable_3.Interactable(scaledPos.plus(new point_43.Point(Tilesets_22.TILE_SIZE / 2, Tilesets_22.TILE_SIZE / 2)), function () { return set(!on); }, new point_43.Point(1, -Tilesets_22.TILE_SIZE)));
                return e.addComponent(new ElementComponent_6.ElementComponent(3 /* CAMPFIRE */, [pos], function () { return { on: on }; }));
            });
        }
    };
});
System.register("game/world/elements/Elements", ["game/world/elements/Tree", "game/world/elements/Rock", "engine/point", "game/world/elements/Tent", "game/world/elements/Campfire", "game/world/Teleporter"], function (exports_83, context_83) {
    "use strict";
    var Tree_1, Rock_1, point_44, Tent_2, Campfire_1, Teleporter_1, SavedElement, Elements;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_83("SavedElement", SavedElement);
                ...
                function Elements() {
                    ...
                    */
                    this.ELEMENT_FUNCTION_MAP = (_a = {},
                        _a[0 /* TREE */] = [Tree_1.makeTree, new point_44.Point(1, 2)],
                        _a[1 /* ROCK */] = [Rock_1.makeRock, new point_44.Point(1, 1)],
                        _a[2 /* TENT */] = [Tent_2.makeTent, new point_44.Point(4, 3)],
                        _a[3 /* CAMPFIRE */] = [Campfire_1.makeCampfire, new point_44.Point(1, 1)],
                        _a[4 /* TELEPORTER */] = [Teleporter_1.makeTeleporterElement, new point_44.Point(1, 1)],
                        _a);
            ...
            exports_83("Elements", Elements);
        }
    };
});
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point"], function (exports_84, context_84) {
    "use strict";
    var _a, Tilesets_23, Entity_16, LocationManager_12, DroppedItem_1, point_45, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_84("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_84("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
                _a[0 /* COIN */] = new ItemMetadata("Coin", function () { return Tilesets_23.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150); }, function () { return Tilesets_23.Tilesets.instance.oneBit.getTileSource("coin"); }),
                _a[1 /* ROCK */] = new ItemMetadata("Rock", function () { return Tilesets_23.Tilesets.instance.outdoorTiles.getTileSource("rockItem"); }, function () { return Tilesets_23.Tilesets.instance.oneBit.getTileSource("rock"); }, 100),
                _a[2 /* WOOD */] = new ItemMetadata("Wood", function () { return Tilesets_23.Tilesets.instance.outdoorTiles.getTileSource("woodItem"); }, function () { return Tilesets_23.Tilesets.instance.oneBit.getTileSource("wood"); }, 100),
                _a[3 /* TENT */] = new ItemMetadata("Tent", function () { return null; }, function () { return Tilesets_23.Tilesets.instance.oneBit.getTileSource("tent"); }, 1, 2 /* TENT */),
                _a[4 /* CAMPFIRE */] = new ItemMetadata("Campfire", function () { return null; }, function () { return Tilesets_23.Tilesets.instance.oneBit.getTileSource("campfire"); }, 1, 3 /* CAMPFIRE */),
                _a));
            /**
             * @param position The bottom center where the item should be placed
             *
             * TODO: Add initial velocity
             */
            exports_84("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_45.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
                LocationManager_12.LocationManager.instance.currentLocation.droppedItems.add(new Entity_16.Entity([
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_85, context_85) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_85("ItemStack", ItemStack);
            ...
            exports_85("Inventory", Inventory);
        }
    };
});
System.register("game/characters/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_86, context_86) {
    "use strict";
    var component_20, TileComponent_9, Tilesets_24, TileTransform_18, point_46, Dude_2, State, Shield;
    ...
    return {
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                function Shield(shieldId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.blockingShieldSprite = _this.entity.addComponent(new TileComponent_9.TileComponent(Tilesets_24.Tilesets.instance.dungeonCharacters.getTileSource(shieldId), new TileTransform_18.TileTransform().relativeTo(_this.dude.animation.transform)));
                    };
                    return _this;
                }
                Shield.prototype.update = function (updateData) {
                    // default (drawn) position
                    var pos = this.dude.animation.transform.dimensions.minus(new point_46.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_46.Point(-6, -1));
                    }
                    else if (this.state === State.DRAWN) {
                        pos = pos.plus(new point_46.Point(3, 2).times(this.raisedPerc).apply(Math.floor));
            ...
            exports_86("Shield", Shield);
        }
    };
});
System.register("game/characters/AnimationUtils", ["game/graphics/Tilesets"], function (exports_87, context_87) {
    "use strict";
    var Tilesets_25, AnimationUtils;
    ...
    return {
        ...
        execute: function () {
            exports_87("AnimationUtils", AnimationUtils = {
                getCharacterIdleAnimation: function (characterAnimName) {
                    var animSpeed = 150;
                    var idleAnim = Tilesets_25.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_idle_anim", animSpeed);
                    if (!idleAnim) {
                        idleAnim = Tilesets_25.Tilesets.instance.otherCharacters.getTileSetAnimation(characterAnimName + "_Idle", 4, animSpeed);
                    }
                    return idleAnim;
                },
                getCharacterWalkAnimation: function (characterAnimName) {
                    var animSpeed = 80;
                    var idleAnim = Tilesets_25.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_run_anim", animSpeed);
                    if (!idleAnim) {
                        idleAnim = Tilesets_25.Tilesets.instance.otherCharacters.getTileSetAnimation(characterAnimName + "_Walk", 4, animSpeed);
                    }
                    return idleAnim;
                },
            });
...
System.register("game/characters/Dude", ["engine/tiles/AnimatedTileComponent", "engine/point", "engine/component", "engine/collision/BoxCollider", "game/graphics/Tilesets", "game/characters/Weapon", "game/items/Items", "game/characters/Shield", "engine/tiles/TileTransform", "game/world/elements/Interactable", "game/characters/Dialogue", "game/ui/DialogueDisplay", "game/ui/DudeInteractIndicator", "game/ui/UIStateManager", "game/characters/AnimationUtils"], function (exports_88, context_88) {
    "use strict";
    var AnimatedTileComponent_4, point_47, component_21, BoxCollider_7, Tilesets_26, Weapon_1, Items_5, Shield_1, TileTransform_19, Interactable_4, Dialogue_4, DialogueDisplay_2, DudeInteractIndicator_4, UIStateManager_12, AnimationUtils_1, Dude;
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(type, faction, characterAnimName, position, weaponId, shieldId, maxHealth, health, speed, inventory, dialogue, blob) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_47.Point(3, 15);
                    ...
                    _this.awake = function () {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_19.TileTransform(new point_47.Point(0, 28 - height))));
                        ...
                        // Set up collider
                        var colliderSize = new point_47.Point(10, 8);
                        _this.relativeColliderPos = new point_47.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_4.Interactable(new point_47.Point(0, 0), function () {
                            if (!!_this.dialogue) {
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_47.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Dude.prototype.update = function (updateData) {
                    ...
                    this.animation.transform.position = this.position.plus(this.isAlive ? new point_47.Point(0, 0) : this.deathOffset);
                    this.animation.transform.depth = this.collider.position.y + this.collider.dimensions.y;
                    this.dialogueInteract.position = this.standingPosition.minus(new point_47.Point(0, 5));
                    this.dialogueInteract.uiOffset = new point_47.Point(0, -Tilesets_26.TILE_SIZE * 1.5).plus(this.getAnimationOffsetPosition());
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_47.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_47.Point(0, 5)));
                ...
                Dude.prototype.spawnDrop = function () {
                    // TODO add velocity
                    Items_5.spawnItem(this.standingPosition.minus(new point_47.Point(0, 2)), 0 /* COIN */);
                };
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    return new point_47.Point(0, arr[f]);
                };
                ...
                Dude.prototype.getIndicator = function () {
                    ...
                    if (!tile || this.dialogueInteract.isShowingUI || DialogueDisplay_2.DialogueDisplay.instance.dude === this) {
                        ...
                        return [tile.toImageRender(new TileTransform_19.TileTransform(this.standingPosition.plusY(-28).plus(new point_47.Point(1, 1).times(-Tilesets_26.TILE_SIZE / 2)).plus(this.getAnimationOffsetPosition()), new point_47.Point(Tilesets_26.TILE_SIZE, Tilesets_26.TILE_SIZE), 0, false, false, UIStateManager_12.UIStateManager.UI_SPRITE_DEPTH))];
                    }
                };
                Dude.COLLISION_LAYER = "dube";
                return Dude;
            }(component_21.Component));
            exports_88("Dude", Dude);
        }
    };
});
System.register("game/characters/Player", ["engine/point", "engine/component", "game/characters/Dude", "game/world/elements/Interactable", "game/world/elements/Hittable", "game/ui/UIStateManager", "game/Controls", "engine/util/Lists"], function (exports_89, context_89) {
    "use strict";
    var point_48, component_22, Dude_3, Interactable_5, Hittable_2, UIStateManager_13, Controls_7, Lists_2, Player;
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_48.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    if (updateData.input.isKeyDown(80 /* P */)) {
                        ...
                        this.dude.damage(.25, new point_48.Point(-1, Math.random() - .5), 30);
                    }
                ...
                Player.prototype.updateInteractables = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_48.Point(0, 7));
            ...
            exports_89("Player", Player);
        }
    };
});
System.register("game/characters/NPCSchedule", [], function (exports_90, context_90) {
    "use strict";
    var NPCSchedules;
    ...
    return {
        setters: [],
        execute: function () {
            exports_90("NPCSchedules", NPCSchedules = {
                SCHEDULE_KEY: "sch",
...
System.register("game/characters/NPC", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point", "game/world/LocationManager", "game/graphics/Tilesets", "engine/util/Lists", "game/characters/NPCSchedule", "game/ui/DialogueDisplay"], function (exports_91, context_91) {
    "use strict";
    var component_23, Dude_4, Player_7, point_49, LocationManager_13, Tilesets_27, Lists_3, NPCSchedule_1, DialogueDisplay_3, NPC;
        ...
        execute: function () {
            ...
            NPC = /** @class */ (function (_super) {
                ...
                function NPC(defaultSchedule) {
                    ...
                    _this.findTargetRange = Tilesets_27.TILE_SIZE * 10;
                ...
                NPC.prototype.doAttack = function (updateData) {
                    ...
                    if (!this.attackTarget || !this.attackTarget.isAlive) {
                        this.dude.move(updateData, new point_49.Point(0, 0));
                        return;
                    }
                ...
                NPC.prototype.findPath = function (tilePt, h) {
                    ...
                    var _a;
                    var start = Tilesets_27.pixelPtToTilePt(this.dude.standingPosition);
                    var end = tilePt;
                ...
                NPC.prototype.tilePtToStandingPos = function (tilePt) {
                    ...
                    return tilePt.plus(ptOffset).times(Tilesets_27.TILE_SIZE);
                };
                return NPC;
...
System.register("game/characters/Enemy", ["engine/component", "game/characters/Dude", "game/characters/NPC"], function (exports_92, context_92) {
    "use strict";
    var component_24, Dude_5, NPC_1, Enemy;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_92("Enemy", Enemy);
        }
    };
});
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_93, context_93) {
    "use strict";
    var component_25, Player_8, Dude_6, point_50, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_50.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_50.Point.ZERO;
                };
            ...
            exports_93("CutscenePlayerController", CutscenePlayerController);
        }
    };
});
System.register("game/characters/Villager", ["engine/component", "game/characters/NPC"], function (exports_94, context_94) {
    "use strict";
    var component_26, NPC_2, Villager;
...
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/cutscenes/CutscenePlayerController", "game/characters/Villager", "game/characters/NPCSchedule", "engine/util/Lists"], function (exports_95, context_95) {
    "use strict";
    var Entity_17, point_51, Player_9, Dude_7, NPC_3, LocationManager_14, Enemy_1, Inventory_1, CutscenePlayerController_1, Villager_1, NPCSchedule_2, Lists_4, DudeFactory;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.load = function (saveState, location) {
                    var d = this.make(saveState.type, point_51.Point.fromString(saveState.pos), saveState, location);
                    location.dudes.add(d);
                };
                    ...
                    switch (type) {
                        ...
                        case 1 /* DIP */: {
                            ...
                            additionalComponents = [
                                new NPC_3.NPC(NPCSchedule_2.NPCSchedules.newGoToSchedule(new point_51.Point(0, 0))),
                        ...
                        case 4 /* HERALD */: {
                            ...
                            additionalComponents = [
                                ...
                                Lists_4.Lists.oneOf([new point_51.Point(-3, 0), new point_51.Point(-3, 1), new point_51.Point(-2, 0), new point_51.Point(-2, 1)].filter(function (pt) { return !location.elements.get(pt); })))),
                                new Villager_1.Villager()
                            ];
                            break;
                        }
            ...
            exports_95("DudeFactory", DudeFactory);
        }
    };
});
System.register("game/saves/DudeSaveState", [], function (exports_96, context_96) {
    "use strict";
    var DudeSaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_96("DudeSaveState", DudeSaveState);
        }
    };
});
System.register("game/saves/LocationSaveState", [], function (exports_97, context_97) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_97("LocationSaveState", LocationSaveState);
        }
    };
});
System.register("game/saves/uuid", [], function (exports_98, context_98) {
    "use strict";
    var newUUID;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_98("newUUID", newUUID = function () {
...
System.register("game/world/ground/GroundComponent", ["engine/component"], function (exports_99, context_99) {
    "use strict";
    var component_27, GroundComponent;
        ...
        execute: function () {
            WorldLocation = /** @class */ (function () {
                ...
                WorldLocation.prototype.getTeleporterLinkedPos = function (to, id) {
                    ...
                    return point_52.Point.fromString(link);
                };
                WorldLocation.prototype.useTeleporter = function (to, id) {
                    ...
                    var niceTransition = Tilesets_28.TILE_SIZE * 2 * (linkedLocation.isInterior ? -1 : 1);
                ...
                WorldLocation.load = function (locationManager, saveState) {
                    ...
                    saveState.elements.forEach(function (el) { return n.addWorldElement(el.type, point_52.Point.fromString(el.pos), el.obj); });
                    saveState.ground.forEach(function (el) { return n.addGroundElement(el.type, point_52.Point.fromString(el.pos), el.obj); });
            ...
            exports_100("WorldLocation", WorldLocation);
        }
    };
});
System.register("game/world/GroundRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/world/LocationManager", "engine/tiles/TileTransform"], function (exports_101, context_101) {
    "use strict";
    var point_53, ImageRender_3, Entity_18, BasicRenderComponent_6, Camera_5, MapGenerator_4, Tilesets_29, Grid_3, LocationManager_16, TileTransform_20, GroundRenderer;
        ...
        execute: function () {
            ...
            GroundRenderer = /** @class */ (function () {
                function GroundRenderer() {
                    // no lights should live outside of this range
                    this.size = MapGenerator_4.MapGenerator.MAP_SIZE * Tilesets_29.TILE_SIZE * 2;
                    this.shift = new point_53.Point(this.size / 2, this.size / 2);
                    this.tiles = new Map();
                    this.gridDirty = true;
                ...
                GroundRenderer.prototype.renderToOffscreenCanvas = function () {
                    ...
                    locationTileGrid.entries().forEach(function (entry) {
                        var pos = entry[0].times(Tilesets_29.TILE_SIZE).plus(_this.shift);
                        var tile = entry[1];
                        var imageRender = tile.toImageRender(new TileTransform_20.TileTransform());
                        _this.context.drawImage(imageRender.source, imageRender.sourcePosition.x, imageRender.sourcePosition.y, Tilesets_29.TILE_SIZE, Tilesets_29.TILE_SIZE, pos.x, pos.y, Tilesets_29.TILE_SIZE, Tilesets_29.TILE_SIZE);
                    });
                };
                GroundRenderer.prototype.getEntity = function () {
                    ...
                    var dimensions = Camera_5.Camera.instance.dimensions.plus(new point_53.Point(1, 1));
                    return new Entity_18.Entity([new BasicRenderComponent_6.BasicRenderComponent(new ImageRender_3.ImageRender(this.canvas, Camera_5.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_5.Camera.instance.position.apply(Math.floor), dimensions, Number.MIN_SAFE_INTEGER))]);
                };
                return GroundRenderer;
            }());
            exports_101("GroundRenderer", GroundRenderer);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "game/world/GroundRenderer"], function (exports_102, context_102) {
    "use strict";
    var point_54, Tilesets_30, GroundComponent_1, Entity_19, GroundRenderer_1, makeGrass;
    ...
    return {
        ...
        execute: function () {
            exports_102("makeGrass", makeGrass = function (d) {
                var _a;
                var tile;
                var index = (_a = d.data["index"]) !== null && _a !== void 0 ? _a : (Math.random() < .65 ? Math.floor(Math.random() * 4) : 0);
                if (index > 0) {
                    tile = Tilesets_30.Tilesets.instance.tilemap.getTileAt(new point_54.Point(0, index));
                }
                else {
                    tile = Tilesets_30.Tilesets.instance.tilemap.getTileAt(new point_54.Point(0, 7));
                }
                GroundRenderer_1.GroundRenderer.instance.addTile(d.wl, d.pos, tile);
                return new Entity_19.Entity().addComponent(new GroundComponent_1.GroundComponent(2 /* GRASS */, function () { return { index: index }; }));
            });
        }
    };
});
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_103, context_103) {
    "use strict";
    var GroundComponent_2, Entity_20, ConnectingTile_1, Ground_2, makePath;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_103("makePath", makePath = function (d) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_104, context_104) {
    "use strict";
    var Tilesets_31, GroundComponent_3, Entity_21, TileTransform_21, makeBasicGround, makeBasicNineSliceGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_104("makeBasicGround", makeBasicGround = function (d) {
                var key = d.data["k"];
                var tile = Tilesets_31.Tilesets.instance.getBasicTileSource(key);
                var c = tile.toComponent(new TileTransform_21.TileTransform(d.pos.times(Tilesets_31.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                return new Entity_21.Entity([c]).addComponent(new GroundComponent_3.GroundComponent(0 /* BASIC */, function () { return d.data; }));
            });
            exports_104("makeBasicNineSliceGround", makeBasicNineSliceGround = function (d) {
                var key = d.data["k"];
                var slice = Tilesets_31.Tilesets.instance.getBasicTileNineSlice(key);
                var nineSliceIndex = d.data["i"];
                var c = slice[nineSliceIndex].toComponent(new TileTransform_21.TileTransform(d.pos.times(Tilesets_31.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                return new Entity_21.Entity([c]).addComponent(new GroundComponent_3.GroundComponent(1 /* BASIC_NINE_SLICE */, function () { return d.data; }));
            });
        }
    };
});
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_105, context_105) {
    "use strict";
    var point_55, Tilesets_32, GroundComponent_4, Entity_22, TileTransform_22, makeLedge;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_105("makeLedge", makeLedge = function (d) {
                var c = Tilesets_32.Tilesets.instance.tilemap.getTileAt(new point_55.Point(3, 2)).toComponent(new TileTransform_22.TileTransform(d.pos.times(Tilesets_32.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
                return new Entity_22.Entity([c]).addComponent(new GroundComponent_4.GroundComponent(2 /* GRASS */, function () { return {}; }));
            });
        }
    };
});
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/BasicGround", "game/world/ground/Ledge"], function (exports_106, context_106) {
    "use strict";
    var point_56, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_33, BasicGround_1, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_106("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(2, 6)))
                        .angle(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(0, 5)))
                        .tShape(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(3, 5)))
                        .plusShape(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(5, 5)))
                        .cap(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(2, 6)))
                        .single(Tilesets_33.Tilesets.instance.tilemap.getTileAt(new point_56.Point(7, 5)));
            ...
            exports_106("Ground", Ground);
        }
    };
});
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_107, context_107) {
    "use strict";
    var point_57, TileTransform_23, ConnectingTile_2, ConnectingTileSchema;
        ...
        execute: function () {
            ...
            ConnectingTileSchema = /** @class */ (function () {
                ...
                ConnectingTileSchema.prototype.render = function (grid, position) {
                    ...
                    var y = position.y;
                    // TODO: add diagonals?
                    var n = this.get(grid, new point_57.Point(x, y - 1));
                    var s = this.get(grid, new point_57.Point(x, y + 1));
                    var e = this.get(grid, new point_57.Point(x + 1, y));
                    var w = this.get(grid, new point_57.Point(x - 1, y));
                    ...
                    return result.toImageRender(new TileTransform_23.TileTransform(position.times(result.dimensions.x), null, rotation, false, false, Number.MIN_SAFE_INTEGER));
                };
            ...
            exports_107("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_108, context_108) {
    "use strict";
    var point_58, component_28, ConnectingTile;
        ...
        execute: function () {
            ConnectingTile = /** @class */ (function (_super) {
                ...
                function ConnectingTile(schema, grid, position) {
                    if (position === void 0) { position = new point_58.Point(0, 0); }
                    var _this = _super.call(this) || this;
                    _this.schema = schema;
                    _this.grid = grid;
                    _this.position = position;
            ...
            exports_108("ConnectingTile", ConnectingTile);
        }
    };
});
/*
...
*
*/
System.register("engine/util/Noise", [], function (exports_109, context_109) {
    "use strict";
    ...
    return {
        ...
        execute: function () {/*
            ...
            */
            ...
            exports_109("Noise", Noise);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/tiles/ConnectingTile", "engine/collision/BoxCollider", "game/world/LocationManager", "game/world/ground/Ground", "engine/util/Noise", "engine/util/Grid", "game/graphics/Tilesets"], function (exports_110, context_110) {
    "use strict";
    var point_59, ConnectingTile_3, BoxCollider_8, LocationManager_17, Ground_3, Noise_1, Grid_4, Tilesets_34, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    ...
                    this.tentPos = new point_59.Point(-3, -3);
                }
                ...
                MapGenerator.prototype.spawnTrees = function () {
                    ...
                    for (var i = 0; i < trees; i++) {
                        var pt = new point_59.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE - 1)) - MapGenerator.MAP_SIZE / 2);
                        var occupiedPoints = [pt, pt.plus(new point_59.Point(0, 1))];
                ...
                MapGenerator.prototype.clearPathToCenter = function () {
                    ...
                    for (var x = MapGenerator.MAP_SIZE / 2 - 11; x < MapGenerator.MAP_SIZE / 2; x++) {
                        for (var y = MapGenerator.MAP_SIZE / 2 - 10; y < MapGenerator.MAP_SIZE / 2 - 8; y++) {
                            var element = this.location.elements.get(new point_59.Point(x, y));
                    ...
                    // clear around tent
                    var clearingCorner = this.tentPos.minus(new point_59.Point(1, 0));
                    for (var x = 0; x < 6; x++) {
                        for (var y = 0; y < 4; y++) {
                            var element = this.location.elements.get(clearingCorner.plus(new point_59.Point(x, y)));
                            if (!!element && typesToClear.indexOf(element.type) !== -1) {
                                this.location.elements.removeAll(element);
                            }
                        }
                ...
                MapGenerator.prototype.spawnRocks = function () {
                    ...
                    while (placedRocks < 20) {
                        var p = new point_59.Point(Math.floor(Math.random() * MapGenerator.MAP_SIZE) - MapGenerator.MAP_SIZE / 2, Math.floor(Math.random() * (MapGenerator.MAP_SIZE)) - MapGenerator.MAP_SIZE / 2);
                ...
                MapGenerator.prototype.noise = function () {
                    ...
                    for (var i = -MapGenerator.MAP_SIZE / 2; i < MapGenerator.MAP_SIZE / 2; i++) {
                        for (var j = -MapGenerator.MAP_SIZE / 2; j < MapGenerator.MAP_SIZE / 2; j++) {
                            ...
                            str += v;
                            grid.set(new point_59.Point(j, i), v);
                        }
                        str += "\n";
                    }
                    console.log(str);
                ...
                MapGenerator.ENTER_LAND_POS = new point_59.Point(1, 1).times(MapGenerator.MAP_SIZE / 2 * Tilesets_34.TILE_SIZE).plusY(-Tilesets_34.TILE_SIZE * 10).plusX(Tilesets_34.TILE_SIZE * 2);
                return MapGenerator;
            }());
...
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager", "game/ui/ControlsUI"], function (exports_111, context_111) {
    "use strict";
    var component_29, CutscenePlayerController_2, Player_11, point_60, Camera_6, CutsceneManager_2, LocationManager_18, ControlsUI_2, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_60.Point(-1, 0));
                    ...
                    setTimeout(function () {
                        Camera_6.Camera.instance.focusOnPoint(_this.dip.standingPosition);
                        CutscenePlayerController_2.CutscenePlayerController.instance.disable();
                    }, this.PAN_TO_DIP);
                    setTimeout(function () {
                        _this.showControls = true;
                        Camera_6.Camera.instance.focusOnDude(Player_11.Player.instance.dude);
                ...
                IntroCutscene.prototype.getRenderMethods = function () {
                    if (this.showControls) {
                        return ControlsUI_2.makeControlsUI(Camera_6.Camera.instance.dimensions, Camera_6.Camera.instance.position);
                    }
                    return [];
                };
                return IntroCutscene;
            }(component_29.Component));
            exports_111("IntroCutscene", IntroCutscene);
        }
    };
});
System.register("game/quest_game", ["engine/point", "engine/game", "game/world/MapGenerator", "game/graphics/Tilesets", "game/characters/DudeFactory", "game/world/LocationManager", "game/characters/Dude", "engine/collision/CollisionEngine", "game/items/DroppedItem", "game/ui/UIStateManager", "game/world/elements/Elements", "game/world/ground/Ground", "game/cutscenes/CutsceneManager", "game/cutscenes/IntroCutscene", "game/cutscenes/Camera", "game/SaveManager", "game/world/PointLightMaskRenderer", "game/world/WorldTime", "game/world/events/EventQueue", "game/world/GroundRenderer"], function (exports_112, context_112) {
    "use strict";
    var point_61, game_1, MapGenerator_5, Tilesets_35, DudeFactory_3, LocationManager_19, Dude_8, CollisionEngine_4, DroppedItem_2, UIStateManager_14, Elements_3, Ground_4, CutsceneManager_3, IntroCutscene_1, Camera_7, SaveManager_4, PointLightMaskRenderer_2, WorldTime_4, EventQueue_4, GroundRenderer_2, ZOOM, QuestGame;
        ...
        execute: function () {
            ...
            QuestGame = /** @class */ (function (_super) {
                ...
                QuestGame.prototype.initialize = function () {
                    ...
                    new Tilesets_35.Tilesets();
                    new UIStateManager_14.UIStateManager();
                ...
                QuestGame.prototype.newGame = function () {
                    ...
                    Camera_7.Camera.instance.focusOnDude(playerDude);
                    DudeFactory_3.DudeFactory.instance.new(1 /* DIP */, point_61.Point.ZERO);
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_61.Point(3, 1).times(Tilesets_35.TILE_SIZE));
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_61.Point(-1, 3).times(Tilesets_35.TILE_SIZE));
                    DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_61.Point(-4, 0).times(Tilesets_35.TILE_SIZE));
                ...
                QuestGame.prototype.getViews = function (updateViewsContext) {
                    ...
                    if (updateViewsContext.input.isKeyDown(76 /* L */)) {
                        DudeFactory_3.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_61.Point(40, 30));
                    }
                ...
                QuestGame.prototype.updateViews = function (updateViewsContext) {
                    ...
                    var cameraOffset = Camera_7.Camera.instance.getUpdatedPosition(dimensions, updateViewsContext.elapsedTimeMillis);
                    this.gameEntityView = {
                        zoom: ZOOM,
                        offset: cameraOffset,
                    ...
                    this.uiView = {
                        zoom: ZOOM,
                        offset: point_61.Point.ZERO,
                        entities: UIStateManager_14.UIStateManager.instance.get(dimensions, updateViewsContext.elapsedTimeMillis)
                    };
                };
                return QuestGame;
            }(game_1.Game));
            exports_112("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_113, context_113) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_36, Assets_4;
    ...
    return {
        ...
        execute: function () {
            Assets_4.assets.loadImageFiles(Tilesets_36.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/renderer/TintRender", ["engine/renderer/RenderMethod"], function (exports_114, context_114) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_114("TintRender", TintRender);
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_115, context_115) {
    "use strict";
    var component_30, utils_7, Clickable;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_115("Clickable", Clickable);
        }
    };
});
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_116, context_116) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_116("serialize", serialize = function (object) {
...
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_117, context_117) {
    "use strict";
    var component_31, Tilesets_37, TileTransform_24, point_62, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_37.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_24.TileTransform(_this.topLeftPos.plus(new point_62.Point(10 * i, 0))));
                    });
                };
            ...
            exports_117("StringTiles", StringTiles);
        }
    };
});
