...
System.register("game/characters/Dialogue", ["game/characters/Player", "game/Controls", "game/world/LocationManager", "game/SaveManager", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/WorldTime"], function (exports_69, context_69) {
    "use strict";
    var _a, Player_6, Controls_3, LocationManager_9, SaveManager_1, EventQueue_3, QueuedEvent_2, WorldTime_2, DialogueInstance, dialogueWithOptions, dialogue, option, saveAfterDialogueStage, DialogueOption, NextDialogue, getDialogue, ROCKS_NEEDED_FOR_CAMPFIRE, DIALOGUE_MAP;
    ...
    return {
        ...
        execute: function () {
            ...
            dialogueWithOptions = function (lines) {
                var options = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    options[_i - 1] = arguments[_i];
                }
                return new DialogueInstance(lines, function () { }, options);
            };
            dialogue = function (lines, next) {
                if (next === void 0) { next = function () { }; }
                return new DialogueInstance(lines, next, []);
            };
             ...
             */
            DIALOGUE_MAP = (_a = {},
                _a[1 /* DIP_0 */] = function () { return dialogueWithOptions(["Phew, thanks for your help! They almost had me. I thought for sure that those Orcs were gonna eat my butt."], option("Are you okay?", 2 /* DIP_1 */), option("I expect a reward.", 3 /* DIP_2 */), option("... Eat your butt?", 4 /* DIP_3 */)); },
                ...
                _a[6 /* DIP_MAKE_CAMPFIRE */] = function () {
                    if (Player_6.Player.instance.dude.inventory.getItemCount(1 /* ROCK */) >= ROCKS_NEEDED_FOR_CAMPFIRE) {
                        return dialogueWithOptions(["It looks like you have enough rocks. Can I have " + ROCKS_NEEDED_FOR_CAMPFIRE + " to make a campfire?"], option("<Give rocks>", 7 /* DIP_ROCKS_RECEIVED */), option("Not yet.", 6 /* DIP_MAKE_CAMPFIRE */, false));
                    }
                    else {
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "game/graphics/Tilesets", "game/ui/Text", "engine/renderer/TextRender", "game/ui/UIStateManager", "engine/util/utils"], function (exports_70, context_70) {
    "use strict";
    var component_15, point_32, Tilesets_12, Text_3, TextRender_5, UIStateManager_5, utils_6, TextButton;
            ...
            TextButton = /** @class */ (function (_super) {
                ...
                function TextButton(position, text, onClick, buttonColor, textColor, hoverColor) {
                    ...
                    _this.start = function () {
                        ...
                        var rightPos = leftPos.plus(new point_32.Point(_this.width - Tilesets_12.TILE_SIZE, 0)).apply(Math.floor);
                        _this.left.transform.position = leftPos;
                        _this.center.transform.position = centerPos;
                        _this.right.transform.position = rightPos;
                        _this.center.transform.dimensions = new point_32.Point(_this.width + TextButton.margin * 2 - Tilesets_12.TILE_SIZE * 2, Tilesets_12.TILE_SIZE);
                ...
                TextButton.prototype.update = function (updateData) {
                    this.hovering = utils_6.rectContains(this.position, new point_32.Point(this.width, Tilesets_12.TILE_SIZE), updateData.input.mousePos);
                ...
                TextButton.margin = 6;
                TextButton.textOffset = new point_32.Point(TextButton.margin, TextButton.margin - 2);
                return TextButton;
...
System.register("game/ui/ButtonsMenu", ["engine/point", "game/ui/TextButton", "game/ui/UIStateManager", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/ui/Text", "engine/Entity"], function (exports_71, context_71) {
    "use strict";
    var point_33, TextButton_1, UIStateManager_6, Tilesets_13, NineSlice_3, Text_4, Entity_9, ButtonsMenu;
        ...
        execute: function () {
            exports_71("ButtonsMenu", ButtonsMenu = {
                render: function (screenDimensions, backgroundColor, options) {
                    ...
                    var marginSide = 9;
                    var buttonPadding = 3;
                    var dimensions = new point_33.Point(longestOption * Text_4.TEXT_PIXEL_WIDTH + marginSide * 2 + TextButton_1.TextButton.margin * 2, (options.length - 1) * buttonPadding + options.length * Tilesets_13.TILE_SIZE + marginTop + marginBottom);
                    var topLeft = screenDimensions.div(2).minus(dimensions.div(2));
                    var backgroundTiles = NineSlice_3.makeStretchedNineSliceComponents(backgroundColor === "red" ? Tilesets_13.Tilesets.instance.oneBit.getNineSlice("invBoxNW") : Tilesets_13.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/ui/Color", "game/Controls", "game/ui/UIStateManager", "game/ui/ButtonsMenu"], function (exports_72, context_72) {
    "use strict";
    var Dialogue_1, Tilesets_14, NineSlice_4, point_34, component_16, Entity_10, BasicRenderComponent_3, Text_5, Color_3, Controls_4, UIStateManager_7, ButtonsMenu_1, DialogueDisplay;
        ...
        execute: function () {
            DialogueDisplay = /** @class */ (function (_super) {
                ...
                DialogueDisplay.prototype.renderNextLine = function (screenDimensions) {
                    var _this = this;
                    var dimensions = new point_34.Point(288, 83);
                    var bottomBuffer = Tilesets_14.TILE_SIZE;
                    var topLeft = new point_34.Point(Math.floor(screenDimensions.x / 2 - dimensions.x / 2), Math.floor(screenDimensions.y - dimensions.y - bottomBuffer));
                    var backgroundTiles = NineSlice_4.makeStretchedNineSliceComponents(Tilesets_14.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
                    backgroundTiles[0].transform.depth = UIStateManager_7.UIStateManager.UI_SPRITE_DEPTH;
                    var topOffset = 2;
                    var margin = 12;
                    var width = dimensions.x - margin * 2;
                    var formattedRenders = Text_5.formatText(this.dialogue.lines[this.lineIndex], Color_3.Color.DARK_RED, topLeft.plus(new point_34.Point(margin, topOffset + margin)), width, 1 /* CENTER */);
...
System.register("game/world/PointLightMaskRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/ui/UIStateManager", "game/world/WorldTime", "game/ui/Color"], function (exports_76, context_76) {
    "use strict";
    var point_35, ImageRender_2, Entity_13, BasicRenderComponent_4, Camera_3, MapGenerator_2, Tilesets_15, Grid_1, UIStateManager_9, WorldTime_3, Color_5, PointLightMaskRenderer;
        ...
        execute: function () {
            PointLightMaskRenderer = /** @class */ (function () {
                function PointLightMaskRenderer() {
                    ...
                    this.size = MapGenerator_2.MapGenerator.MAP_SIZE * Tilesets_15.TILE_SIZE * 2;
                ...
                PointLightMaskRenderer.prototype.getEntity = function () {
                    ...
                    var dimensions = Camera_3.Camera.instance.dimensions.plus(new point_35.Point(1, 1));
...
System.register("game/world/elements/Campfire", ["engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider", "game/world/elements/ElementComponent", "engine/Entity", "game/world/PointLightMaskRenderer"], function (exports_77, context_77) {
    "use strict";
    var TileComponent_8, AnimatedTileComponent_3, Tilesets_16, TileTransform_14, point_36, Interactable_2, BoxCollider_6, ElementComponent_5, Entity_14, PointLightMaskRenderer_1, makeCampfire;
    ...
    return {
        ...
        execute: function () {
            exports_77("makeCampfire", makeCampfire = function (wl, pos, data) {
                ...
                var campfireOff = e.addComponent(new TileComponent_8.TileComponent(Tilesets_16.Tilesets.instance.outdoorTiles.getTileSource("campfireOff"), new TileTransform_14.TileTransform(scaledPos)));
                campfireOff.enabled = !on;
                campfireOff.transform.depth = scaledPos.y + Tilesets_16.TILE_SIZE;
                var campfireOn = e.addComponent(new AnimatedTileComponent_3.AnimatedTileComponent([Tilesets_16.Tilesets.instance.outdoorTiles.getTileSetAnimation("campfireOn", 2, 200)], new TileTransform_14.TileTransform(scaledPos)));
                campfireOn.enabled = on;
                campfireOn.transform.depth = scaledPos.y + Tilesets_16.TILE_SIZE;
                var offset = new point_36.Point(0, 5);
                e.addComponent(new BoxCollider_6.BoxCollider(scaledPos.plus(offset), new point_36.Point(Tilesets_16.TILE_SIZE, Tilesets_16.TILE_SIZE).minus(offset)));
                var set = function (nowOn) {
                    ...
                    if (nowOn) {
                        PointLightMaskRenderer_1.PointLightMaskRenderer.instance.addLight(lightCenterPos, Tilesets_16.TILE_SIZE * 8);
                    }
                    else {
                ...
                e.addComponent(new Interactable_2.Interactable(scaledPos.plus(new point_36.Point(Tilesets_16.TILE_SIZE / 2, Tilesets_16.TILE_SIZE / 2)), function () { return set(!on); }));
...
System.register("game/world/elements/Elements", ["game/world/elements/Tree", "game/world/elements/Rock", "engine/point", "game/world/elements/Tent", "game/world/elements/Campfire"], function (exports_78, context_78) {
    "use strict";
    var Tree_1, Rock_1, point_37, Tent_2, Campfire_1, SavedElement, Elements;
                ...
                function Elements() {
                    ...
                    */
                    this.ELEMENT_FUNCTION_MAP = (_a = {},
                        ...
                        _a[2 /* TENT */] = [Tent_2.makeTent, new point_37.Point(4, 3)],
...
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point"], function (exports_79, context_79) {
    "use strict";
    var _a, Tilesets_17, Entity_15, LocationManager_10, DroppedItem_1, point_38, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_79("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
                _a[0 /* COIN */] = new ItemMetadata("Coin", function () { return Tilesets_17.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150); }, function () { return Tilesets_17.Tilesets.instance.oneBit.getTileSource("coin"); }),
                _a[1 /* ROCK */] = new ItemMetadata("Rock", function () { return Tilesets_17.Tilesets.instance.outdoorTiles.getTileSource("rockItem"); }, function () { return Tilesets_17.Tilesets.instance.oneBit.getTileSource("rock"); }, 100),
                _a[2 /* WOOD */] = new ItemMetadata("Wood", function () { return Tilesets_17.Tilesets.instance.outdoorTiles.getTileSource("woodItem"); }, function () { return Tilesets_17.Tilesets.instance.oneBit.getTileSource("wood"); }, 100),
                _a[3 /* TENT */] = new ItemMetadata("Tent", function () { return null; }, function () { return Tilesets_17.Tilesets.instance.oneBit.getTileSource("tent"); }, 1, 2 /* TENT */),
                _a[4 /* CAMPFIRE */] = new ItemMetadata("Campfire", function () { return null; }, function () { return Tilesets_17.Tilesets.instance.oneBit.getTileSource("campfire"); }, 1, 3 /* CAMPFIRE */),
                _a));
            /**
             * @param position The bottom center where the item should be placed
             *
            ...
            exports_79("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_38.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
...
System.register("game/characters/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_81, context_81) {
    "use strict";
    var component_18, TileComponent_9, Tilesets_18, TileTransform_15, point_39, Dude_2, State, Shield;
            ...
            Shield = /** @class */ (function (_super) {
                ...
                function Shield(shieldId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.blockingShieldSprite = _this.entity.addComponent(new TileComponent_9.TileComponent(Tilesets_18.Tilesets.instance.dungeonCharacters.getTileSource(shieldId), new TileTransform_15.TileTransform().relativeTo(_this.dude.animation.transform)));
                    };
                    return _this;
                }
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(type, faction, characterAnimName, position, weaponId, shieldId, maxHealth, health, speed, inventory, dialogue) {
                    var _this = _super.call(this) || this;
                    _this.relativeColliderPos = new point_40.Point(3, 15);
                    ...
                    _this.start = function (startData) {
                        // Set up animations
                        var idleAnim = Tilesets_19.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_idle_anim", 150);
                        var runAnim = Tilesets_19.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_run_anim", 80);
                        var height = idleAnim.getTile(0).dimensions.y;
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_16.TileTransform(new point_40.Point(0, 28 - height))));
                        if (!!weaponId) {
                        ...
                        // Set up collider
                        var colliderSize = new point_40.Point(10, 8);
                        _this.relativeColliderPos = new point_40.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_3.Interactable(new point_40.Point(0, 0), function () {
                            if (!!_this.dialogue) {
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_40.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Dude.prototype.update = function (updateData) {
                    ...
                    this.animation.transform.position = this.position.plus(this.isAlive ? new point_40.Point(0, 0) : this.deathOffset);
                    this.animation.transform.depth = this.collider.position.y + this.collider.dimensions.y;
                    this.dialogueInteract.position = this.standingPosition.minus(new point_40.Point(0, 5));
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_40.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_40.Point(0, 5)));
                ...
                Dude.prototype.spawnDrop = function () {
                    // TODO add velocity
                    Items_5.spawnItem(this.standingPosition.minus(new point_40.Point(0, 2)), 0 /* COIN */);
                };
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    if (!this.isMoving) {
                        return new point_40.Point(0, [0, 1, 2, 1][f]);
                    }
                    else {
                        return new point_40.Point(0, [-1, -2, -1, 0][f]);
                    }
                };
...
System.register("game/characters/Player", ["engine/point", "engine/component", "game/characters/Dude", "game/world/elements/Interactable", "game/world/elements/Hittable", "game/ui/UIStateManager", "game/Controls", "engine/util/Lists"], function (exports_83, context_83) {
    "use strict";
    var point_41, component_20, Dude_3, Interactable_4, Hittable_2, UIStateManager_10, Controls_5, Lists_2, Player;
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_41.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    var dx = 0;
                    var dy = 0;
                    if (!UIStateManager_10.UIStateManager.instance.isMenuOpen) {
                    ...
                    this.dude.move(updateData, new point_41.Point(dx, dy), this.dude.weapon.isDrawn() ? updateData.input.mousePos.x - this.dude.standingPosition.x : 0);
                    ...
                    if (updateData.input.isKeyDown(80 /* P */)) {
                        ...
                        this.dude.damage(.25, new point_41.Point(-1, Math.random() - .5), 30);
                    }
                ...
                Player.prototype.interact = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_41.Point(0, 7));
...
System.register("game/characters/NPC", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point"], function (exports_84, context_84) {
    "use strict";
    var component_21, Dude_4, Player_8, point_42, NPC;
            ...
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.follow = function (updateData) {
                    ...
                    if (mag > followDistance || ((followDistance - mag) < buffer && Player_8.Player.instance.dude.isMoving) && this.dude.isMoving) {
                        ...
                        this.dude.move(updateData, new point_42.Point(0, 0));
                    }
                };
                return NPC;
...
System.register("game/characters/Enemy", ["engine/component", "game/characters/Dude", "engine/point", "game/world/LocationManager", "game/graphics/Tilesets", "engine/util/Lists"], function (exports_85, context_85) {
    "use strict";
    var component_22, Dude_5, point_43, LocationManager_11, Tilesets_20, Lists_3, Enemy;
...
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/cutscenes/CutscenePlayerController"], function (exports_87, context_87) {
    "use strict";
    var Entity_16, point_45, Player_10, Dude_7, NPC_1, LocationManager_12, Enemy_1, Inventory_1, CutscenePlayerController_1, DudeFactory;
...
System.register("game/world/WorldLocation", ["engine/util/Grid", "game/saves/uuid", "game/world/elements/Elements", "engine/point", "game/world/ground/Ground", "game/characters/DudeFactory"], function (exports_91, context_91) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_91("WorldLocation", WorldLocation);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_92, context_92) {
    "use strict";
    var point_47, Tilesets_21, GroundComponent_1, Entity_17, TileTransform_17, makeGrass;
    ...
    return {
        ...
        execute: function () {
            exports_92("makeGrass", makeGrass = function (wl, pos, data) {
                var _a;
                var tile;
                var index = (_a = data["index"]) !== null && _a !== void 0 ? _a : (Math.random() < .65 ? Math.floor(Math.random() * 4) : 0);
                if (index > 0) {
                    tile = Tilesets_21.Tilesets.instance.tilemap.getTileAt(new point_47.Point(0, index));
                }
                else {
                    tile = Tilesets_21.Tilesets.instance.tilemap.getTileAt(new point_47.Point(0, 7));
                }
                var c = tile.toComponent(new TileTransform_17.TileTransform(pos.times(Tilesets_21.TILE_SIZE)));
...
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_93, context_93) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_93("makePath", makePath = function (wl, pos) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_94, context_94) {
    "use strict";
    var Tilesets_22, GroundComponent_3, Entity_19, TileTransform_18, makeBasicGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_94("makeBasicGround", makeBasicGround = function (tile) {
                return function (wl, pos, data) {
                    var c = tile.toComponent(new TileTransform_18.TileTransform(pos.times(Tilesets_22.TILE_SIZE)));
                    c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_95, context_95) {
    "use strict";
    var point_48, Tilesets_23, GroundComponent_4, Entity_20, TileTransform_19, makeLedge;
    ...
    return {
        ...
        execute: function () {
            exports_95("makeLedge", makeLedge = function (wl, pos, data) {
                var c = Tilesets_23.Tilesets.instance.tilemap.getTileAt(new point_48.Point(3, 2)).toComponent(new TileTransform_19.TileTransform(pos.times(Tilesets_23.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/Ledge"], function (exports_96, context_96) {
    "use strict";
    var point_49, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_24, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_96("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(2, 6)))
                        .angle(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(0, 5)))
                        .tShape(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(3, 5)))
                        .plusShape(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(5, 5)))
                        .cap(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(2, 6)))
                        .single(Tilesets_24.Tilesets.instance.tilemap.getTileAt(new point_49.Point(7, 5)));
            ...
            exports_96("Ground", Ground);
        }
    };
});
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_97, context_97) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_97("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_98, context_98) {
    "use strict";
    var point_51, component_25, ConnectingTile;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_98("ConnectingTile", ConnectingTile);
        }
    };
});
/*
...
*
*/
System.register("engine/util/Noise", [], function (exports_99, context_99) {
    "use strict";
    ...
    return {
        ...
        execute: function () {/*
            ...
            */
            ...
            exports_99("Noise", Noise);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/tiles/ConnectingTile", "engine/collision/BoxCollider", "game/world/LocationManager", "game/world/ground/Ground", "engine/util/Noise", "engine/util/Grid"], function (exports_100, context_100) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_100("MapGenerator", MapGenerator);
        }
    };
});
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager"], function (exports_101, context_101) {
    "use strict";
    var component_26, CutscenePlayerController_2, Player_11, point_53, Camera_4, CutsceneManager_2, LocationManager_14, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                function IntroCutscene() {
                    ...
                    _this.PAN_BACK = _this.PAN_TO_DIP + 3000;
        ...
        execute: function () {
            ...
            QuestGame = /** @class */ (function (_super) {
                ...
                QuestGame.prototype.initialize = function () {
                    ...
                    new Tilesets_25.Tilesets();
                    new UIStateManager_11.UIStateManager();
                ...
                QuestGame.prototype.newGame = function () {
                    ...
                    var playerStartPos = new point_54.Point(1, 1).times(MapGenerator_3.MapGenerator.MAP_SIZE / 2 * Tilesets_25.TILE_SIZE)
                        .plusY(-Tilesets_25.TILE_SIZE * 10)
                        .plusX(Tilesets_25.TILE_SIZE * 2);
                    ...
                    DudeFactory_2.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_54.Point(3, 1).times(Tilesets_25.TILE_SIZE));
                    DudeFactory_2.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_54.Point(-1, 3).times(Tilesets_25.TILE_SIZE));
                    DudeFactory_2.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_54.Point(-4, 0).times(Tilesets_25.TILE_SIZE));
                ...
                QuestGame.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.uiView = {
                        ...
                        entities: UIStateManager_11.UIStateManager.instance.get(dimensions, updateViewsContext.elapsedTimeMillis)
                    };
                };
                return QuestGame;
            }(game_1.Game));
            exports_102("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_103, context_103) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_26, Assets_4;
    ...
    return {
        ...
        execute: function () {
            Assets_4.assets.loadImageFiles(Tilesets_26.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/renderer/TintRender", ["engine/renderer/RenderMethod"], function (exports_104, context_104) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_104("TintRender", TintRender);
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_105, context_105) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_105("Clickable", Clickable);
        }
    };
});
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_106, context_106) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_106("serialize", serialize = function (object) {
...
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_107, context_107) {
    "use strict";
    var component_28, Tilesets_27, TileTransform_21, point_55, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_27.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_21.TileTransform(_this.topLeftPos.plus(new point_55.Point(10 * i, 0))));
                    });
                };
            ...
            exports_107("StringTiles", StringTiles);
        }
    };
});
