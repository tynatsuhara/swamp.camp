...
System.register("game/graphics/Tilesets", ["game/graphics/SingleFileTileLoader", "game/graphics/DungeonTilesetII", "game/graphics/SplitFileTileLoader", "game/graphics/OneBitTileset", "game/graphics/OutdoorTileset", "game/graphics/ExtraCharacterSet2TileLoader", "game/graphics/OGTileset"], function (exports_38, context_38) {
    "use strict";
    var SingleFileTileLoader_4, DungeonTilesetII_1, SplitFileTileLoader_1, OneBitTileset_1, OutdoorTileset_1, ExtraCharacterSet2TileLoader_1, OGTileset_1, TILE_SIZE, pixelPtToTilePt, Tilesets;
...
System.register("engine/util/Grid", ["engine/point", "engine/util/BinaryHeap"], function (exports_42, context_42) {
    "use strict";
    var point_19, BinaryHeap_1, Grid;
        ...
        execute: function () {
            ...
            Grid = /** @class */ (function () {
                ...
                Grid.prototype.entries = function () {
                    return Object.entries(this.map).map(function (tuple) { return [point_19.Point.fromString(tuple[0]), tuple[1]]; });
                };
                Grid.prototype.keys = function () {
                    return Object.keys(this.map).map(function (ptStr) { return point_19.Point.fromString(ptStr); });
                };
                /**
...
System.register("game/characters/NPCSchedule", [], function (exports_43, context_43) {
    "use strict";
    var NPCSchedules;
    ...
    return {
        setters: [],
        execute: function () {
            exports_43("NPCSchedules", NPCSchedules = {
                SCHEDULE_KEY: "sch",
...
System.register("game/world/events/EventQueue", ["engine/util/BinaryHeap", "game/world/events/QueuedEvent"], function (exports_44, context_44) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_44("EventQueue", EventQueue);
        }
    };
});
System.register("game/world/TimeUnit", [], function (exports_45, context_45) {
    "use strict";
    var TimeUnit;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_45("TimeUnit", TimeUnit);
        }
    };
});
System.register("game/world/WorldTime", ["engine/Entity", "engine/component", "game/world/events/EventQueue", "game/world/TimeUnit"], function (exports_46, context_46) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_46("WorldTime", WorldTime);
        }
    };
});
System.register("game/world/elements/ElementComponent", ["engine/component", "game/world/LocationManager"], function (exports_47, context_47) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_47("ElementComponent", ElementComponent);
        }
    };
});
System.register("game/ui/Text", ["engine/point", "engine/renderer/TextRender"], function (exports_48, context_48) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_48("TEXT_PIXEL_WIDTH", TEXT_PIXEL_WIDTH = 8);
            exports_48("TEXT_SIZE", TEXT_SIZE = 8);
...
System.register("game/ui/KeyPressIndicator", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/renderer/TextRender", "game/Controls", "game/ui/Text", "game/ui/UIStateManager"], function (exports_49, context_49) {
    "use strict";
    var component_7, Tilesets_1, TileTransform_5, point_21, TextRender_3, Controls_1, Text_1, UIStateManager_1, KeyPressIndicator;
        ...
        execute: function () {
            KeyPressIndicator = /** @class */ (function (_super) {
                ...
                KeyPressIndicator.prototype.getRenderMethods = function () {
                    return [
                        Tilesets_1.Tilesets.instance.oneBit.getTileSource("keycap").toImageRender(new TileTransform_5.TileTransform(this.pos, null, 0, false, false, UIStateManager_1.UIStateManager.UI_SPRITE_DEPTH)),
                        new TextRender_3.TextRender(Controls_1.Controls.keyString(this.key).toLowerCase(), this.pos.plus(new point_21.Point(4, 4)), Text_1.TEXT_SIZE, Text_1.TEXT_FONT, "#222222" /* BLACK */, UIStateManager_1.UIStateManager.UI_SPRITE_DEPTH)
                    ];
                };
                return KeyPressIndicator;
            }(component_7.Component));
            exports_49("KeyPressIndicator", KeyPressIndicator);
        }
    };
});
System.register("game/world/elements/Interactable", ["engine/component", "engine/point", "game/ui/KeyPressIndicator", "game/Controls", "game/graphics/Tilesets", "game/ui/UIStateManager"], function (exports_50, context_50) {
    "use strict";
    var component_8, point_22, KeyPressIndicator_1, Controls_2, Tilesets_2, UIStateManager_2, Interactable;
        ...
        execute: function () {
            Interactable = /** @class */ (function (_super) {
                ...
                function Interactable(position, fn, uiOffset, isInteractable) {
                    ...
                    if (isInteractable === void 0) { isInteractable = function () { return !UIStateManager_2.UIStateManager.instance.isMenuOpen; }; }
                    var _this = _super.call(this) || this;
                    _this.position = position;
                    _this.interact = fn;
                ...
                Interactable.prototype.getRenderMethods = function () {
                    ...
                    return new KeyPressIndicator_1.KeyPressIndicator(this.position.minus(new point_22.Point(Tilesets_2.TILE_SIZE / 2, Tilesets_2.TILE_SIZE / 2)).plus(this.uiOffset), Controls_2.Controls.interactButton).getRenderMethods();
                };
                return Interactable;
            }(component_8.Component));
            exports_50("Interactable", Interactable);
        }
    };
});
System.register("game/world/elements/ElementFactory", [], function (exports_51, context_51) {
    "use strict";
    var ElementFactory;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_51("ElementFactory", ElementFactory);
        }
    };
});
System.register("game/world/Teleporter", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/elements/ElementComponent", "game/world/elements/Interactable", "game/world/elements/ElementFactory"], function (exports_52, context_52) {
    "use strict";
    var component_9, Entity_3, point_23, TileTransform_6, Tilesets_3, ElementComponent_1, Interactable_1, ElementFactory_1, Teleporters, TeleporterFactory;
    ...
    return {
        ...
        execute: function () {
            exports_52("Teleporters", Teleporters = {
            ...
            TeleporterFactory = /** @class */ (function (_super) {
                ...
                TeleporterFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var id = data["id"];
                    var interactComponent = e.addComponent(new Interactable_1.Interactable(interactPos, function () { return wl.useTeleporter(destinationUUID, id); }, new point_23.Point(0, Tilesets_3.TILE_SIZE / 2)));
                    ...
                    e.addComponent(new /** @class */ (function (_super) {
                        ...
                        class_1.prototype.getRenderMethods = function () {
                            ...
                            return [Tilesets_3.Tilesets.instance.oneBit.getTileSource("small_arrow_down").toImageRender(new TileTransform_6.TileTransform(pos.times(Tilesets_3.TILE_SIZE)))];
                        };
                        return class_1;
        ...
        execute: function () {
            PointLightMaskRenderer = /** @class */ (function () {
                function PointLightMaskRenderer() {
                    ...
                    this.size = MapGenerator_1.MapGenerator.MAP_SIZE * Tilesets_4.TILE_SIZE;
                ...
                PointLightMaskRenderer.prototype.isDark = function (pixelPt) {
                    ...
                    var grid = this.lightTiles.get(LocationManager_2.LocationManager.instance.currentLocation);
                ...
                PointLightMaskRenderer.prototype.updateColorForTime = function () {
                    var time = WorldTime_1.WorldTime.instance.time;
                ...
                PointLightMaskRenderer.prototype.renderToOffscreenCanvas = function () {
                    var _this = this;
                    this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
                    var location = LocationManager_2.LocationManager.instance.currentLocation;
                ...
                PointLightMaskRenderer.prototype.getEntity = function () {
                    ...
                    if (this.gridDirty || this.lastLocationRendered !== LocationManager_2.LocationManager.instance.currentLocation) {
                        this.renderToOffscreenCanvas();
                        // this.updateLitGrid()
                        this.gridDirty = false;
                        this.lastLocationRendered = LocationManager_2.LocationManager.instance.currentLocation;
                    }
                    // prevent tint not extending to the edge
                    var dimensions = Camera_1.Camera.instance.dimensions.plus(new point_24.Point(1, 1));
                    return new Entity_4.Entity([new BasicRenderComponent_2.BasicRenderComponent(new ImageRender_2.ImageRender(this.canvas, Camera_1.Camera.instance.position.plus(this.shift).apply(Math.floor), dimensions, Camera_1.Camera.instance.position.apply(Math.floor), dimensions, UIStateManager_3.UIStateManager.UI_SPRITE_DEPTH - 100 // make sure all UI goes on top of light
                        ))]);
                };
                return PointLightMaskRenderer;
            }());
            exports_53("PointLightMaskRenderer", PointLightMaskRenderer);
        }
    };
});
System.register("game/ui/DudeInteractIndicator", ["game/graphics/Tilesets", "engine/point"], function (exports_54, context_54) {
    "use strict";
    var Tilesets_5, point_25, DudeInteractIndicator;
    ...
    return {
        ...
        execute: function () {
            exports_54("DudeInteractIndicator", DudeInteractIndicator = {
                NONE: "",
                IMPORTANT_DIALOGUE: "!",
                getTile: function (indicator) {
                    switch (indicator) {
                        ...
                        case DudeInteractIndicator.IMPORTANT_DIALOGUE:
                            return Tilesets_5.Tilesets.instance.oneBit.getTileAt(new point_25.Point(19, 25));
                    }
                },
            });
        }
...
System.register("game/characters/dialogues/ItemDialogues", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator", "game/ui/DialogueDisplay", "game/world/elements/Campfire", "game/characters/Player"], function (exports_55, context_55) {
    "use strict";
    var _a, Dialogue_1, DudeInteractIndicator_1, DialogueDisplay_1, Campfire_1, Player_1, CAMPFIRE_DIALOGUE, ITEM_DIALOGUES;
    ...
    return {
        ...
        execute: function () {
            exports_55("CAMPFIRE_DIALOGUE", CAMPFIRE_DIALOGUE = "campfire");
            exports_55("ITEM_DIALOGUES", ITEM_DIALOGUES = (_a = {},
                _a[CAMPFIRE_DIALOGUE] = function () {
                    ...
                    var playerLogCount = Player_1.Player.instance.dude.inventory.getItemCount(2 /* WOOD */);
                    ...
                    var completeDialogue = function (logsTransferred) {
                        return function () {
                            Player_1.Player.instance.dude.inventory.removeItem(2 /* WOOD */, logsTransferred);
        ...
        execute: function () {
            CampfireFactory = /** @class */ (function (_super) {
                ...
                CampfireFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var scaledPos = pos.times(Tilesets_6.TILE_SIZE);
                    var campfireOff = e.addComponent(new TileComponent_3.TileComponent(Tilesets_6.Tilesets.instance.outdoorTiles.getTileSource("campfireOff"), new TileTransform_7.TileTransform(scaledPos)));
                    campfireOff.transform.depth = scaledPos.y + Tilesets_6.TILE_SIZE;
                    var campfireOn = e.addComponent(new AnimatedTileComponent_2.AnimatedTileComponent([Tilesets_6.Tilesets.instance.outdoorTiles.getTileSetAnimation("campfireOn", 2, 200)], new TileTransform_7.TileTransform(scaledPos)));
                    campfireOn.transform.depth = scaledPos.y + Tilesets_6.TILE_SIZE;
                    var offset = new point_26.Point(0, 5);
                    e.addComponent(new BoxCollider_1.BoxCollider(scaledPos.plus(offset), new point_26.Point(Tilesets_6.TILE_SIZE, Tilesets_6.TILE_SIZE).minus(offset)));
                    ...
                    var updateFire = function (logCount) {
                        ...
                        var lightCenterPos = pos.times(Tilesets_6.TILE_SIZE).plus(new point_26.Point(Tilesets_6.TILE_SIZE / 2, Tilesets_6.TILE_SIZE / 2));
                        if (campfireOn.enabled) {
                            PointLightMaskRenderer_1.PointLightMaskRenderer.instance.addLight(wl, lightCenterPos, Tilesets_6.TILE_SIZE * (5 + logCount / 2));
                        }
                        else {
            ...
            exports_56("CampfireFactory", CampfireFactory);
            Campfire = /** @class */ (function (_super) {
                ...
                Campfire.prototype.update = function () {
                    ...
                    while (this.logs > 0 && WorldTime_2.WorldTime.instance.time > this.lastLogConsumedTime + Campfire.LOG_DURATION) {
                ...
                Campfire.prototype.addLogs = function (count) {
                    if (this.logs === 0) {
                        this.lastLogConsumedTime = WorldTime_2.WorldTime.instance.time;
                    }
                    this.logs += count;
                    this.updateFire(this.logs);
                };
            ...
            exports_56("Campfire", Campfire);
        }
    };
});
System.register("game/world/interior/House", ["engine/point", "game/graphics/Tilesets", "game/world/LocationManager"], function (exports_57, context_57) {
    "use strict";
    var point_27, Tilesets_7, LocationManager_3, makeHouseInterior;
    ...
    return {
        ...
        execute: function () {
            exports_57("makeHouseInterior", makeHouseInterior = function (outside) {
                var l = LocationManager_3.LocationManager.instance.newLocation(true);
                var dimensions = new point_27.Point(7, 5);
                ...
                for (var x = 0; x < dimensions.x; x++) {
                    for (var y = 0; y < dimensions.y; y++) {
                        l.addGroundElement(0 /* BASIC */, new point_27.Point(x, y), { k: "hardwood" + woodType });
                    }
                    ...
                    l.addGroundElement(0 /* BASIC */, new point_27.Point(x, -1), { k: topAndBottomTiles[0] });
                    l.addGroundElement(5 /* BASIC_ROTATED_180 */, new point_27.Point(x, -2), { k: topAndBottomTiles[1] });
                }
                return l;
            });
        }
...
System.register("game/world/elements/ElementUtils", ["engine/point"], function (exports_58, context_58) {
    "use strict";
    var point_28, ElementUtils;
    ...
    return {
        ...
        execute: function () {
            exports_58("ElementUtils", ElementUtils = {
                rectPoints: function (position, dimensions) {
                    var result = [];
                    for (var x = 0; x < dimensions.x; x++) {
                        for (var y = 0; y < dimensions.y; y++) {
                            result.push(position.plus(new point_28.Point(x, y)));
                        }
                    }
                    return result;
                }
        ...
        execute: function () {
            ...
            HouseFactory = /** @class */ (function (_super) {
                ...
                HouseFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactablePos = pos.plus(new point_29.Point(2.5, 3)).times(Tilesets_8.TILE_SIZE);
                    ...
                    // flat roof
                    var flatRoofTopLeft = new point_29.Point(6, 0);
                    ...
                    // door
                    addTile(new point_29.Point(7, 6), basePos.plusY(2).plusX(1));
                    // no windows
                    addTile(new point_29.Point(7, 5), basePos.plusY(2));
                    addTile(new point_29.Point(9, 5), basePos.plusY(2).plusX(2));
                    // alternative with windows
                    // addTile(new Point(5, 6), basePos.plusY(2))
                    // addTile(new Point(6, 6), basePos.plusY(2).plusX(2))
                    e.addComponent(new BoxCollider_2.BoxCollider(basePos.plus(new point_29.Point(0, 1)).times(Tilesets_8.TILE_SIZE), new point_29.Point(Tilesets_8.TILE_SIZE * 3, Tilesets_8.TILE_SIZE * 2)));
                    // Set up teleporter
                    e.addComponent(new Interactable_3.Interactable(interactablePos, function () { return wl.useTeleporter(destinationUUID); }, new point_29.Point(0, -Tilesets_8.TILE_SIZE * 1.4)));
            ...
            exports_59("HouseFactory", HouseFactory);
            ...
            exports_59("House", House);
        }
    };
});
System.register("game/world/elements/Hittable", ["engine/component", "engine/util/Animator"], function (exports_60, context_60) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_60("Hittable", Hittable);
        }
    };
});
System.register("game/world/elements/HittableResource", ["engine/collision/BoxCollider", "engine/point", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/elements/ElementComponent", "game/world/elements/Hittable"], function (exports_61, context_61) {
    "use strict";
    var BoxCollider_3, point_30, Tilesets_9, Items_1, LocationManager_4, ElementComponent_4, Hittable_1, HittableResource;
    ...
    return {
        ...
        execute: function () {
                ...
                HittableResource.prototype.hitCallback = function (hitDir) {
                    ...
                    for (var i = 0; i < itemsOut; i++) {
                        ...
                        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                            var item = items_1[_i];
                            var randomness = .5;
                            var itemDirection = hitDir.plus(new point_30.Point(randomness - Math.random() * randomness * 2, randomness - Math.random() * randomness * 2)).normalized();
                            var velocity = itemDirection.times(1 + 3 * Math.random());
                            Items_1.spawnItem(this.position.plus(new point_30.Point(0, Tilesets_9.TILE_SIZE / 2)).plus(itemDirection.times(placeDistance)), // bottom center, then randomly adjusted
            ...
            exports_61("HittableResource", HittableResource);
        }
    };
});
System.register("game/characters/weapons/WeaponType", [], function (exports_62, context_62) {
    "use strict";
    var WeaponType;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_62("WeaponType", WeaponType);
        }
    };
});
System.register("game/world/elements/Rock", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/ElementComponent", "game/world/elements/HittableResource", "game/characters/Player", "game/characters/weapons/WeaponType", "game/world/elements/ElementFactory"], function (exports_63, context_63) {
    "use strict";
    var point_31, Tilesets_10, BoxCollider_4, TileComponent_5, TileTransform_9, Entity_7, ElementComponent_5, HittableResource_1, Player_2, WeaponType_1, ElementFactory_4, RockFactory;
        ...
        execute: function () {
            RockFactory = /** @class */ (function (_super) {
                ...
                RockFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var hitboxDims = new point_31.Point(12, 4);
                    e.addComponent(new BoxCollider_4.BoxCollider(pos.plus(new point_31.Point(.5, 1)).times(Tilesets_10.TILE_SIZE).minus(new point_31.Point(hitboxDims.x / 2, hitboxDims.y + 2)), hitboxDims));
                    var hittableResource = e.addComponent(new HittableResource_1.HittableResource(pos.plus(new point_31.Point(.5, .5)).times(Tilesets_10.TILE_SIZE), [tile.transform], availableResources, maxResourcesCount, function () {
                        if (Player_2.Player.instance.dude.weaponType === WeaponType_1.WeaponType.PICKAXE) {
            ...
            exports_63("RockFactory", RockFactory);
        }
    };
});
System.register("engine/tiles/NineSlice", ["engine/point", "engine/tiles/TileTransform"], function (exports_64, context_64) {
    "use strict";
    var point_32, TileTransform_10, NineSlice;
    ...
    return {
        ...
        execute: function () {
            exports_64("NineSlice", NineSlice = {
                nineSliceForEach: function (dimensions, fn) {
                    ...
                    var _loop_1 = function (x) {
                        var _loop_2 = function (y) {
                            ...
                            fn(new point_32.Point(x, y), getIndex());
                        };
                        for (var y = 0; y < dimensions.y; y++) {
                            _loop_2(y);
                        }
                ...
                makeNineSliceComponents: function (slice, pos, dimensions) {
                    ...
                    var tiles = [];
                    tiles.push(slice[0].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, 0))));
                    tiles.push(slice[2].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - 1, 0))));
                    tiles.push(slice[6].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, dimensions.y - 1))));
                    tiles.push(slice[8].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - 1, dimensions.y - 1))));
                    // horizontal lines
                    for (var i = 1; i < dimensions.x - 1; i++) {
                        tiles.push(slice[1].toComponent(new TileTransform_10.TileTransform(new point_32.Point(i, 0))));
                        tiles.push(slice[7].toComponent(new TileTransform_10.TileTransform(new point_32.Point(i, dimensions.y - 1))));
                    }
                    // vertical lines
                    for (var j = 1; j < dimensions.y - 1; j++) {
                        tiles.push(slice[3].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, j))));
                        tiles.push(slice[5].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - 1, j))));
                    }
                    // middle
                    for (var x = 1; x < dimensions.x - 1; x++) {
                        for (var y = 1; y < dimensions.y - 1; y++) {
                            tiles.push(slice[4].toComponent(new TileTransform_10.TileTransform(new point_32.Point(x, y))));
                        }
                    }
                ...
                makeStretchedNineSliceComponents: function (slice, pos, dimensions) {
                    ...
                    // }
                    var tiles = [];
                    var topLeft = slice[0].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, 0)));
                    var tileSize = topLeft.transform.dimensions.x;
                    // corners
                    tiles.push(topLeft);
                    tiles.push(slice[2].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - tileSize, 0))));
                    tiles.push(slice[6].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, dimensions.y - tileSize))));
                    tiles.push(slice[8].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - tileSize, dimensions.y - tileSize))));
                    // horizontal lines
                    var horizontalDimensions = new point_32.Point(dimensions.x - tileSize * 2, tileSize);
                    tiles.push(slice[1].toComponent(new TileTransform_10.TileTransform(new point_32.Point(tileSize, 0), horizontalDimensions)));
                    tiles.push(slice[7].toComponent(new TileTransform_10.TileTransform(new point_32.Point(tileSize, dimensions.y - tileSize), horizontalDimensions)));
                    // vertical lines
                    var verticalDimensions = new point_32.Point(tileSize, dimensions.y - tileSize * 2);
                    tiles.push(slice[3].toComponent(new TileTransform_10.TileTransform(new point_32.Point(0, tileSize), verticalDimensions)));
                    tiles.push(slice[5].toComponent(new TileTransform_10.TileTransform(new point_32.Point(dimensions.x - tileSize, tileSize), verticalDimensions)));
                    // middle
                    tiles.push(slice[4].toComponent(new TileTransform_10.TileTransform(new point_32.Point(tileSize, tileSize), new point_32.Point(dimensions.x - tileSize * 2, dimensions.y - tileSize * 2))));
                    var mainTransform = tiles[0].transform;
                    tiles.forEach(function (c, i) {
                        if (i > 0) {
                            c.transform.relativeTo(mainTransform);
...
System.register("game/world/interior/AsciiInteriorBuilder", ["engine/point"], function (exports_65, context_65) {
    "use strict";
    var point_33, AsciiInteriorBuilder;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_65("AsciiInteriorBuilder", AsciiInteriorBuilder);
        }
    };
});
System.register("game/world/interior/Tent", ["game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_66, context_66) {
    "use strict";
    var LocationManager_5, point_34, Tilesets_11, NineSlice_1, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_66("makeTentInterior", makeTentInterior = function (outside, color) {
...
System.register("game/world/elements/Tent", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Interactable", "game/world/elements/ElementComponent", "game/world/elements/ElementUtils", "game/world/interior/Tent", "game/world/elements/ElementFactory"], function (exports_67, context_67) {
    "use strict";
    var point_35, Tilesets_12, BoxCollider_5, TileComponent_6, TileTransform_11, Entity_8, Interactable_4, ElementComponent_6, ElementUtils_2, Tent_1, ElementFactory_5, TentFactory, addTile;
        ...
        execute: function () {
            ...
            TentFactory = /** @class */ (function (_super) {
                ...
                TentFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var interactablePos = pos.plus(new point_35.Point(2, 2)).times(Tilesets_12.TILE_SIZE);
                    ...
                    addTile(e, color + "tentNE", pos.plus(new point_35.Point(2, 0)), depth);
                    addTile(e, color + "tentSW", pos.plus(new point_35.Point(1, 1)), depth);
                    addTile(e, color + "tentSE", pos.plus(new point_35.Point(2, 1)), depth);
            ...
            exports_67("TentFactory", TentFactory);
...
System.register("game/world/elements/Tree", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/HittableResource", "game/world/elements/ElementComponent", "game/characters/weapons/WeaponType", "game/characters/Player", "game/world/elements/ElementFactory", "engine/component", "game/world/WorldTime", "game/world/TimeUnit"], function (exports_68, context_68) {
    "use strict";
    var point_36, Tilesets_13, BoxCollider_6, TileComponent_7, TileTransform_12, Entity_9, HittableResource_2, ElementComponent_7, WeaponType_2, Player_3, ElementFactory_6, component_13, WorldTime_3, TimeUnit_4, NEXT_GROWTH_TIME, SIZE, AVAILABLE_RESOURCES, TreeFactory, GrowableTree;
        ...
        execute: function () {
            ...
            TreeFactory = /** @class */ (function (_super) {
                ...
                TreeFactory.prototype.make = function (wl, pos, data) {
                    ...
                    var tiles;
                    if (size === 3) {
                        tiles = [addTile(prefix + "Top", pos), addTile(prefix + "Base", pos.plus(new point_36.Point(0, 1)))];
                    }
                    else {
                        tiles = [addTile("" + prefix + ["Sapling", "Small"][size - 1], pos.plus(new point_36.Point(0, 1)))];
                    }
                    ...
                    return e.addComponent(new ElementComponent_7.ElementComponent(this.type, pos, [pos.plusY(1)], function () {
                        var _a;
                        return _a = {},
                ...
                TreeFactory.prototype.nextGrowthTime = function () {
                    ...
                    return WorldTime_3.WorldTime.instance.time + TimeUnit_4.TimeUnit.DAY * (1 + Math.random());
                };
                return TreeFactory;
            }(ElementFactory_6.ElementFactory));
            exports_68("TreeFactory", TreeFactory);
...
System.register("game/world/elements/Elements", ["game/world/Teleporter", "game/world/elements/Campfire", "game/world/elements/House", "game/world/elements/Rock", "game/world/elements/Tent", "game/world/elements/Tree"], function (exports_69, context_69) {
    "use strict";
    var Teleporter_1, Campfire_2, House_2, Rock_1, Tent_2, Tree_1, SavedElement, Elements;
...
System.register("game/world/events/QueuedEvent", ["game/characters/DudeFactory", "game/world/MapGenerator", "game/world/LocationManager", "game/characters/NPCSchedule", "game/characters/NPC", "game/graphics/Tilesets", "game/world/events/EventQueue", "game/world/WorldTime", "game/world/elements/House"], function (exports_70, context_70) {
    "use strict";
    var _a, DudeFactory_1, MapGenerator_2, LocationManager_6, NPCSchedule_1, NPC_1, Tilesets_14, EventQueue_2, WorldTime_4, House_3, QueuedEventType, EVENT_QUEUE_HANDLERS;
        ...
        execute: function () {
            ...
            exports_70("EVENT_QUEUE_HANDLERS", EVENT_QUEUE_HANDLERS = (_a = {},
                ...
                _a[QueuedEventType.HERALD_DEPARTURE] = function (data) {
                    ...
                    npc.setSchedule(NPCSchedule_1.NPCSchedules.newGoToSchedule(Tilesets_14.pixelPtToTilePt(goalPosition)));
                    // check repeatedly until he's at the goal
                    if (berto.standingPosition.distanceTo(goalPosition) > Tilesets_14.TILE_SIZE) {
                ...
                _a[QueuedEventType.HERALD_RETURN_WITH_NPC] = function (data) {
                    ...
                    var villager = DudeFactory_1.DudeFactory.instance.new(7 /* VILLAGER */, MapGenerator_2.MapGenerator.ENTER_LAND_POS, LocationManager_6.LocationManager.instance.exterior());
                    var house = LocationManager_6.LocationManager.instance.currentLocation.getElementsOfType(6 /* HOUSE */)
...
System.register("game/saves/SaveGame", [], function (exports_71, context_71) {
    "use strict";
    var Save, SaveState;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_71("SaveState", SaveState);
        }
    };
});
System.register("game/SaveManager", ["game/characters/Player", "game/saves/SaveGame", "game/world/LocationManager", "game/ui/UIStateManager", "game/cutscenes/Camera", "game/ui/HUD", "game/world/WorldTime", "game/world/events/EventQueue"], function (exports_72, context_72) {
    "use strict";
    var Player_4, SaveGame_1, LocationManager_7, UIStateManager_4, Camera_2, HUD_1, WorldTime_5, EventQueue_3, SAVE_KEY, SaveManager, saveManager;
    ...
    return {
        ...
        execute: function () {
            ...
            SaveManager = /** @class */ (function () {
                ...
                SaveManager.prototype.save = function () {
                    ...
                    var save = {
                        ...
                        worldTime: WorldTime_5.WorldTime.instance.time,
                ...
                SaveManager.prototype.load = function () {
                    ...
                    LocationManager_7.LocationManager.instance.initialize(save.locations);
                    WorldTime_5.WorldTime.instance.initialize(save.worldTime);
                    ...
                    UIStateManager_4.UIStateManager.instance.destroy();
                };
            ...
            exports_72("saveManager", saveManager = new SaveManager());
        }
    };
});
System.register("game/ui/Tooltip", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/renderer/TextRender", "game/ui/Text", "game/ui/UIStateManager"], function (exports_73, context_73) {
    "use strict";
    var component_14, Tilesets_15, point_37, TextRender_4, Text_2, UIStateManager_5, Tooltip;
        ...
        execute: function () {
            Tooltip = /** @class */ (function (_super) {
                ...
                function Tooltip(text) {
                    ...
                    var _this = _super.call(this) || this;
                    _this.position = new point_37.Point(0, 0);
                    _this.text = text;
                    _this.start = function () {
                        _this.left = _this.entity.addComponent(Tilesets_15.Tilesets.instance.oneBit.getTileSource("tooltipLeft").toComponent());
                        _this.center = _this.entity.addComponent(Tilesets_15.Tilesets.instance.oneBit.getTileSource("tooltipCenter").toComponent());
                        _this.right = _this.entity.addComponent(Tilesets_15.Tilesets.instance.oneBit.getTileSource("tooltipRight").toComponent());
                    };
                    return _this;
                }
                ...
                Tooltip.prototype.update = function (updateData) {
                    ...
                    var leftPos = this.position.plus(new point_37.Point(Tilesets_15.TILE_SIZE / 2, -Tilesets_15.TILE_SIZE)).apply(Math.floor);
                    var centerPos = leftPos.plus(new point_37.Point(Tilesets_15.TILE_SIZE, 0));
                    var rightPos = leftPos.plus(new point_37.Point(width - Tilesets_15.TILE_SIZE + Tooltip.margin * 2, 0)).apply(Math.floor);
                    this.left.transform.position = leftPos;
                    this.center.transform.position = centerPos;
                    this.right.transform.position = rightPos;
                    this.center.transform.dimensions = new point_37.Point(width + Tooltip.margin * 2 - Tilesets_15.TILE_SIZE * 2, Tilesets_15.TILE_SIZE);
                    var totalWidth = width + Tooltip.margin * 2;
                    if (this.position.x + totalWidth > updateData.dimensions.x) {
                        // shift left
                        tiles.forEach(function (t) { return t.transform.position = t.transform.position.plusX(-totalWidth - Tilesets_15.TILE_SIZE); });
                    }
                };
                ...
                Tooltip.margin = 6;
                Tooltip.textOffset = new point_37.Point(Tooltip.margin, Tooltip.margin - 1);
                return Tooltip;
...
System.register("game/ui/CraftingMenu", ["engine/Entity", "engine/component", "engine/point", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "engine/tiles/NineSlice", "game/graphics/Tilesets", "engine/renderer/ImageRender", "game/ui/UIStateManager", "game/items/Items", "game/ui/Text", "engine/tiles/TileTransform", "game/graphics/ImageFilters", "game/characters/Player", "engine/util/utils", "game/ui/Tooltip"], function (exports_74, context_74) {
    ...
    return {
        ...
        execute: function () {
            CraftingMenu = /** @class */ (function (_super) {
                ...
                CraftingMenu.prototype.renderCategories = function (updateData, topLeft) {
                    ...
                    for (var i = 0; i < this.recipes.length; i++) {
                        ...
                        var hovered = utils_3.rectContains(pos, dims.times(Tilesets_16.TILE_SIZE), updateData.input.mousePos);
                        result.push.apply(result, NineSlice_2.NineSlice.makeNineSliceComponents(Tilesets_16.Tilesets.instance.oneBit.getNineSlice("invBoxNW"), pos, dims));
                ...
                CraftingMenu.prototype.renderRecipes = function (updateData, topLeft, recipes) {
                    ...
                    // draw background
                    var backgroundTiles = NineSlice_2.NineSlice.makeStretchedNineSliceComponents(Tilesets_16.Tilesets.instance.outdoorTiles.getNineSlice("invBoxFrame"), topLeft, this.dimensions);
                    ...
                    for (var r = 0; r < recipes.length; r++) {
                        var hovered = utils_3.rectContains(topLeft.plusX(margin).plusY(rowHeight * r + margin * 2), new point_38.Point(this.innerDimensions.x, rowHeight), shiftedMousePos) && utils_3.rectContains(// within the frame itself
                        ...
                        for (var i = 0; i < recipe.input.length; i++) {
                            ...
                            new point_38.Point(width - offsetFromRight + margin, verticalOffset + margin * 1.5).plus(topLeft), new point_38.Point(Tilesets_16.TILE_SIZE, Tilesets_16.TILE_SIZE), updateData.input.mousePos)) {
                    ...
                    var renderComp = new BasicRenderComponent_3.BasicRenderComponent(new ImageRender_3.ImageRender(this.canvas, point_38.Point.ZERO, this.innerDimensions, innerOffset.plus(topLeft).apply(Math.floor), this.innerDimensions, UIStateManager_6.UIStateManager.UI_SPRITE_DEPTH - 10));
            ...
            exports_74("CraftingMenu", CraftingMenu);
        }
    };
});
System.register("game/characters/dialogues/DipIntro", ["game/characters/Dialogue", "game/ui/DudeInteractIndicator", "game/Controls", "game/world/LocationManager", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/WorldTime", "game/ui/CraftingMenu", "game/items/CraftingRecipe"], function (exports_75, context_75) {
    "use strict";
    var _a, Dialogue_2, DudeInteractIndicator_2, Controls_3, LocationManager_8, EventQueue_4, QueuedEvent_2, WorldTime_6, CraftingMenu_1, CraftingRecipe_1, ROCKS_NEEDED_FOR_CAMPFIRE, WOOD_NEEDED_FOR_CAMPFIRE, CRAFT_OPTION, DIP_STARTING_DIALOGUE, DIP_1, DIP_2, DIP_3, DIP_BEFRIEND, DIP_MAKE_CAMPFIRE, DIP_CRAFT, DIP_INTRO_DIALOGUE;
    ...
    return {
        ...
        execute: function () {
            exports_75("ROCKS_NEEDED_FOR_CAMPFIRE", ROCKS_NEEDED_FOR_CAMPFIRE = 10);
            exports_75("WOOD_NEEDED_FOR_CAMPFIRE", WOOD_NEEDED_FOR_CAMPFIRE = 5);
            CRAFT_OPTION = "<Craft>";
                    ...
                    if (campfires.length > 0) { // campfire has been placed
                        ...
                        return Dialogue_2.dialogue(lines, function () {
                            ...
                            EventQueue_4.EventQueue.instance.addEvent({
                                ...
                                time: WorldTime_6.WorldTime.instance.future({ minutes: 10 })
                            });
...
System.register("game/items/CraftingRecipe", ["game/items/Inventory", "game/graphics/Tilesets", "engine/point", "game/characters/dialogues/DipIntro"], function (exports_76, context_76) {
    "use strict";
    var Inventory_1, Tilesets_17, point_39, DipIntro_1, getDipRecipes;
    ...
    return {
        ...
        execute: function () {
            exports_76("getDipRecipes", getDipRecipes = function () { return [{
                    icon: Tilesets_17.Tilesets.instance.oneBit.getTileAt(new point_39.Point(0, 7)),
                    ...
                    icon: Tilesets_17.Tilesets.instance.oneBit.getTileAt(new point_39.Point(10, 27)),
                    name: "Equipment",
                    recipes: [{
                    ...
                    icon: Tilesets_17.Tilesets.instance.oneBit.getTileAt(new point_39.Point(0, 19)),
                    name: "Buildings",
                    recipes: [{
                            output: 3 /* TENT */,
...
System.register("game/ui/SellMenu", ["engine/Entity", "engine/component", "engine/point", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "engine/tiles/NineSlice", "game/graphics/Tilesets", "engine/renderer/ImageRender", "game/ui/UIStateManager", "game/items/Items", "game/ui/Text", "game/graphics/ImageFilters", "game/characters/Player", "engine/util/utils", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/TextRender"], function (exports_77, context_77) {
    "use strict";
    var Entity_11, component_16, point_40, BasicRenderComponent_4, Camera_4, NineSlice_3, Tilesets_18, ImageRender_4, UIStateManager_7, Items_3, Text_4, ImageFilters_2, Player_6, utils_4, Tooltip_2, AnimatedTileComponent_3, TileTransform_14, TextRender_5, SellMenu;
        ...
        execute: function () {
            ...
            SellMenu = /** @class */ (function (_super) {
                ...
                function SellMenu() {
                    ...
                    _this.coinsOffset = new point_40.Point(7, -11); // for the spinny coin in the corner
                    _this.isOpen = false;
                    _this.dimensions = new point_40.Point(160, 158);
                    _this.innerDimensions = _this.dimensions.minus(new point_40.Point(10, 14));
                    _this.scrollOffset = 0;
                ...
                SellMenu.prototype.renderRecipes = function (updateData, topLeft, items) {
                    ...
                    var coinCountComponent = new BasicRenderComponent_4.BasicRenderComponent(new TextRender_5.TextRender("x" + inv.getItemCount(0 /* COIN */), new point_40.Point(9, 1).plus(topLeft).plus(this.coinsOffset), Text_4.TEXT_SIZE, Text_4.TEXT_FONT, "#facb3e" /* YELLOW */, UIStateManager_7.UIStateManager.UI_SPRITE_DEPTH));
                    this.context.imageSmoothingEnabled = false; // TODO figure out why text is aliased
                    this.context.font = Text_4.TEXT_SIZE + "px '" + Text_4.TEXT_FONT + "'";
                    // draw background
                    var backgroundTiles = NineSlice_3.NineSlice.makeStretchedNineSliceComponents(Tilesets_18.Tilesets.instance.outdoorTiles.getNineSlice("invBoxFrame"), topLeft, this.dimensions);
                    ...
                    for (var r = 0; r < items.length; r++) {
                        var hovered = utils_4.rectContains(topLeft.plusX(margin).plusY(rowHeight * r + margin * 2), new point_40.Point(this.innerDimensions.x, rowHeight), shiftedMousePos) && utils_4.rectContains(// within the frame itself
                        topLeft.plus(innerOffset), this.innerDimensions, updateData.input.mousePos);
                        var sale = items[r];
                    ...
                    var renderComp = new BasicRenderComponent_4.BasicRenderComponent(new ImageRender_4.ImageRender(this.canvas, point_40.Point.ZERO, this.innerDimensions, innerOffset.plus(topLeft).apply(Math.floor), this.innerDimensions, UIStateManager_7.UIStateManager.UI_SPRITE_DEPTH - 10));
...
System.register("game/characters/dialogues/BertoIntro", ["game/ui/DudeInteractIndicator", "game/ui/SellMenu", "game/world/elements/House", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/LocationManager", "game/world/WorldTime", "game/characters/Dialogue"], function (exports_78, context_78) {
    "use strict";
    var _a, DudeInteractIndicator_3, SellMenu_1, House_4, EventQueue_5, QueuedEvent_3, LocationManager_9, WorldTime_7, Dialogue_3, BERTO_STARTING_DIALOGUE, BERT_MENU, BERT_MENU_INTRO, BERT_VILLAGERS, BERT_VILLAGER_NEEDS_HOUSE, BERT_LEAVING, getItemsToSell, getGreeting, BERTO_INTRO_DIALOGUE;
        ...
        execute: function () {
            ...
            exports_78("BERTO_INTRO_DIALOGUE", BERTO_INTRO_DIALOGUE = (_a = {},
                ...
                _a[BERT_VILLAGERS] = function () { return Dialogue_3.dialogueWithOptions(["At present, only felonious peons can be spared by The King.",
                    ...
                    var openHouses = LocationManager_9.LocationManager.instance.currentLocation.getElementsOfType(6 /* HOUSE */)
...
System.register("game/characters/Dialogue", ["game/SaveManager", "game/ui/DudeInteractIndicator", "game/characters/dialogues/BertoIntro", "game/characters/dialogues/DipIntro", "game/characters/dialogues/ItemDialogues", "game/characters/Player"], function (exports_79, context_79) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_79("EMPTY_DIALOGUE", EMPTY_DIALOGUE = "-");
            ...
            exports_79("DialogueInstance", DialogueInstance);
            // Shorthand functions for creating dialogue
            exports_79("dialogueWithOptions", dialogueWithOptions = function (lines, indicator) {
                if (indicator === void 0) { indicator = DudeInteractIndicator_4.DudeInteractIndicator.NONE; }
                var options = [];
            ...
            exports_79("dialogue", dialogue = function (lines, next, indicator) {
                if (next === void 0) { next = function () { }; }
                if (indicator === void 0) { indicator = DudeInteractIndicator_4.DudeInteractIndicator.NONE; }
                return new DialogueInstance(lines, next, [], indicator);
            });
            exports_79("option", option = function (text, nextDialogue, open) {
                if (open === void 0) { open = true; }
                return new DialogueOption(text, function () { return new NextDialogue(nextDialogue, open); });
            });
            exports_79("saveAfterDialogueStage", saveAfterDialogueStage = function () {
            ...
            exports_79("inv", inv = function () { return Player_7.Player.instance.dude.inventory; });
            ...
            exports_79("DialogueOption", DialogueOption);
            ...
            exports_79("NextDialogue", NextDialogue);
             ...
             * @param dialogue the unique dialogue key
             */
            exports_79("getDialogue", getDialogue = function (dialogue) {
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/tiles/TileTransform", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_80, context_80) {
    "use strict";
    var component_17, point_41, TextRender_6, TileTransform_15, utils_5, Tilesets_19, Text_5, UIStateManager_8, TextButton;
            ...
            TextButton = /** @class */ (function (_super) {
                ...
                function TextButton(position, text, onClick, buttonColor, textColor, hoverColor) {
                    ...
                    _this.start = function () {
                        ...
                        var centerPos = leftPos.plus(new point_41.Point(Tilesets_19.TILE_SIZE, 0));
                        var rightPos = leftPos.plus(new point_41.Point(_this.width - Tilesets_19.TILE_SIZE, 0)).apply(Math.floor);
                        _this.left = Tilesets_19.Tilesets.instance.oneBit.getTileSource("btnLeft_" + buttonColor).toImageRender(new TileTransform_15.TileTransform(leftPos));
                        _this.center = Tilesets_19.Tilesets.instance.oneBit.getTileSource("btnCenter_" + buttonColor).toImageRender(new TileTransform_15.TileTransform(centerPos, new point_41.Point(_this.width + TextButton.margin * 2 - Tilesets_19.TILE_SIZE * 2, Tilesets_19.TILE_SIZE)));
                        _this.right = Tilesets_19.Tilesets.instance.oneBit.getTileSource("btnRight_" + buttonColor).toImageRender(new TileTransform_15.TileTransform(rightPos));
                ...
                TextButton.prototype.update = function (updateData) {
                    this.hovering = utils_5.rectContains(this.position, new point_41.Point(this.width, Tilesets_19.TILE_SIZE), updateData.input.mousePos);
                ...
                TextButton.margin = 6;
                TextButton.textOffset = new point_41.Point(TextButton.margin, TextButton.margin - 2);
                return TextButton;
            }(component_17.Component));
            exports_80("TextButton", TextButton);
        }
    };
});
System.register("game/ui/ButtonsMenu", ["engine/point", "game/ui/TextButton", "game/ui/UIStateManager", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/ui/Text", "engine/Entity"], function (exports_81, context_81) {
    "use strict";
    var point_42, TextButton_1, UIStateManager_9, Tilesets_20, NineSlice_4, Text_6, Entity_12, ButtonsMenu;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_81("ButtonsMenu", ButtonsMenu = {
                render: function (screenDimensions, backgroundColor, options) {
                    ...
                    var marginSide = 9;
                    var buttonPadding = 3;
                    var dimensions = new point_42.Point(longestOption * Text_6.TEXT_PIXEL_WIDTH + marginSide * 2 + TextButton_1.TextButton.margin * 2, (options.length - 1) * buttonPadding + options.length * Tilesets_20.TILE_SIZE + marginTop + marginBottom);
                    var topLeft = screenDimensions.div(2).minus(dimensions.div(2));
                    var backgroundTiles = NineSlice_4.NineSlice.makeStretchedNineSliceComponents(backgroundColor === "red" ? Tilesets_20.Tilesets.instance.oneBit.getNineSlice("invBoxNW") : Tilesets_20.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
                    ...
                    options.forEach(function (option, i) { return e.addComponent(new TextButton_1.TextButton(topLeft.plus(new point_42.Point(dimensions.x / 2 - (Text_6.TEXT_PIXEL_WIDTH * option.text.length / 2) - TextButton_1.TextButton.margin, marginTop + i * (Tilesets_20.TILE_SIZE + buttonPadding))), option.text, function () { return option.fn(); }, option.buttonColor, option.textColor, option.hoverColor)); });
                    return e;
                }
            });
        }
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/Controls", "game/ui/UIStateManager", "game/ui/ButtonsMenu"], function (exports_82, context_82) {
    "use strict";
    var Dialogue_4, Tilesets_21, NineSlice_5, point_43, component_18, Entity_13, BasicRenderComponent_5, Text_7, Controls_4, UIStateManager_10, ButtonsMenu_1, DialogueDisplay;
        ...
        execute: function () {
            DialogueDisplay = /** @class */ (function (_super) {
                ...
                DialogueDisplay.prototype.renderNextLine = function (screenDimensions) {
                    var _this = this;
                    var dimensions = new point_43.Point(288, 83);
                    var bottomBuffer = Tilesets_21.TILE_SIZE;
                    var topLeft = new point_43.Point(Math.floor(screenDimensions.x / 2 - dimensions.x / 2), Math.floor(screenDimensions.y - dimensions.y - bottomBuffer));
                    var backgroundTiles = NineSlice_5.NineSlice.makeStretchedNineSliceComponents(Tilesets_21.Tilesets.instance.outdoorTiles.getNineSlice("dialogueBG"), topLeft, dimensions);
                    backgroundTiles[0].transform.depth = UIStateManager_10.UIStateManager.UI_SPRITE_DEPTH;
                    var topOffset = 2;
                    var margin = 12;
                    var width = dimensions.x - margin * 2;
                    var formattedRenders = Text_7.formatText(this.dialogue.lines[this.lineIndex], "#62232f" /* DARK_RED */, topLeft.plus(new point_43.Point(margin, topOffset + margin)), width, 1 /* CENTER */);
            ...
            exports_82("DialogueDisplay", DialogueDisplay);
        }
    };
});
System.register("game/characters/NPC", ["engine/component", "engine/point", "engine/util/Lists", "game/graphics/Tilesets", "game/ui/DialogueDisplay", "game/world/LocationManager", "game/world/PointLightMaskRenderer", "game/characters/Dude", "game/characters/NPCSchedule", "game/characters/Player"], function (exports_83, context_83) {
    "use strict";
    var component_19, point_44, Lists_1, Tilesets_22, DialogueDisplay_3, LocationManager_10, PointLightMaskRenderer_2, Dude_1, NPCSchedule_2, Player_8, NPC;
            ...
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.update = function (updateData) {
                    ...
                    if (DialogueDisplay_3.DialogueDisplay.instance.dialogueSource === this.dude) {
                        ...
                        this.dude.move(updateData, point_44.Point.ZERO, Player_8.Player.instance.dude.standingPosition.x - this.dude.standingPosition.x);
                    }
                ...
                NPC.prototype.doNormalScheduledActivity = function (updateData) {
                    ...
                    if (schedule.type === 0 /* DO_NOTHING */) {
                        this.dude.move(updateData, point_44.Point.ZERO);
                    }
                    else if (schedule.type === 1 /* GO_TO_SPOT */) {
                        this.walkTo(point_44.Point.fromString(schedule["p"]), updateData);
                    }
                    else if (schedule.type === 3 /* ROAM */) {
                        this.doFlee(updateData, 0.5);
                    }
                    else if (schedule.type === 2 /* ROAM_IN_DARKNESS */) {
                        this.doFlee(updateData, PointLightMaskRenderer_2.PointLightMaskRenderer.instance.isDark(this.dude.standingPosition) ? 0.5 : 1, function (pt) { return PointLightMaskRenderer_2.PointLightMaskRenderer.instance.isDark(pt.times(Tilesets_22.TILE_SIZE)); });
                    }
                    else if (schedule.type === 4 /* DEFAULT_VILLAGER */) {
                        var location_1 = LocationManager_10.LocationManager.instance.currentLocation;
                        this.doFlee(updateData, 0.5);
                    }
                    else {
                ...
                NPC.prototype.doAttack = function (updateData) {
                    ...
                    if (this.targetPath.length === 0) {
                        this.targetPath = this.findPath(Tilesets_22.pixelPtToTilePt(this.attackTarget.standingPosition), this.dude.standingPosition);
                    }
                ...
                NPC.prototype.walkDirectlyTo = function (pt, updateData, stopWhenClose, speedMultiplier, facingOverride) {
                    ...
                    if (isCloseEnough && stopWhenClose) {
                        this.dude.move(updateData, point_44.Point.ZERO, facingOverride);
                    }
                    else {
                ...
                NPC.prototype.checkForEnemies = function () {
                    ...
                    if (!!target) {
                        ...
                        if (target === this.attackTarget && !!this.targetPath && this.targetPath.length > 0) {
                            ...
                            var newGoal = Tilesets_22.pixelPtToTilePt(target.standingPosition);
                            var currentPos = Tilesets_22.pixelPtToTilePt(this.dude.standingPosition);
                        ...
                        if (shouldComputePath) {
                            this.targetPath = this.findPath(Tilesets_22.pixelPtToTilePt(target.standingPosition));
                        }
                ...
                NPC.prototype.findPath = function (tilePt, pixelPtStart) {
                    ...
                    var start = Tilesets_22.pixelPtToTilePt(pixelPtStart);
                    var end = tilePt;
...
System.register("game/saves/uuid", [], function (exports_84, context_84) {
    "use strict";
    var newUUID;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_84("newUUID", newUUID = function () {
...
System.register("game/world/WorldLocation", ["engine/point", "engine/util/Grid", "game/characters/DudeFactory", "game/characters/NPC", "game/characters/Player", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/saves/uuid", "game/world/elements/Elements", "game/world/elements/ElementUtils", "game/world/ground/Ground", "game/world/LocationManager", "game/world/Teleporter"], function (exports_86, context_86) {
    "use strict";
    var point_45, Grid_2, DudeFactory_2, NPC_2, Player_9, Camera_5, Tilesets_23, uuid_1, Elements_1, ElementUtils_3, Ground_1, LocationManager_11, Teleporter_2, WorldLocation;
        ...
        execute: function () {
            WorldLocation = /** @class */ (function () {
                ...
                WorldLocation.prototype.getTeleporterLinkedPos = function (to, id) {
                    var dest = LocationManager_11.LocationManager.instance.get(to);
                ...
                WorldLocation.prototype.useTeleporter = function (to, id) {
                    if (id === void 0) { id = null; }
                    var linkedLocation = LocationManager_11.LocationManager.instance.get(to);
                    ...
                    LocationManager_11.LocationManager.instance.currentLocation = linkedLocation;
                    ...
                    var niceTransition = Tilesets_23.TILE_SIZE * 2 * (linkedLocation.isInterior ? -1 : 1);
                ...
                WorldLocation.load = function (saveState) {
                    ...
                    saveState.elements.forEach(function (el) { return n.addElement(el.type, point_45.Point.fromString(el.pos), el.obj); });
                    saveState.ground.forEach(function (el) { return n.addGroundElement(el.type, point_45.Point.fromString(el.pos), el.obj); });
                    saveState.dudes.forEach(function (d) { return DudeFactory_2.DudeFactory.instance.load(d, n); });
                    return n;
                };
                return WorldLocation;
            }());
            exports_86("WorldLocation", WorldLocation);
        }
    };
});
System.register("game/world/GroundRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/world/LocationManager", "engine/tiles/TileTransform"], function (exports_87, context_87) {
    "use strict";
    var point_46, ImageRender_5, Entity_14, BasicRenderComponent_6, Camera_6, MapGenerator_3, Tilesets_24, Grid_3, LocationManager_12, TileTransform_16, GroundRenderer;
        ...
        execute: function () {
            ...
            GroundRenderer = /** @class */ (function () {
                function GroundRenderer() {
                    // no lights should live outside of this range
                    this.size = MapGenerator_3.MapGenerator.MAP_SIZE * Tilesets_24.TILE_SIZE * 2;
                    this.shift = new point_46.Point(this.size / 2, this.size / 2);
                    this.tiles = new Map();
                    this.gridDirty = true;
                ...
                GroundRenderer.prototype.renderToOffscreenCanvas = function () {
                    var _this = this;
                    this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
                    var location = LocationManager_12.LocationManager.instance.currentLocation;
                    ...
                    locationTileGrid.entries().forEach(function (entry) {
                        var pos = entry[0].times(Tilesets_24.TILE_SIZE).plus(_this.shift);
                        var tile = entry[1];
                        var imageRender = tile.toImageRender(new TileTransform_16.TileTransform());
                        _this.context.drawImage(imageRender.source, imageRender.sourcePosition.x, imageRender.sourcePosition.y, Tilesets_24.TILE_SIZE, Tilesets_24.TILE_SIZE, pos.x, pos.y, Tilesets_24.TILE_SIZE, Tilesets_24.TILE_SIZE);
                    });
                };
                GroundRenderer.prototype.getEntity = function () {
                    if (this.gridDirty || this.lastLocationRendered !== LocationManager_12.LocationManager.instance.currentLocation) {
                        this.renderToOffscreenCanvas();
                        this.gridDirty = false;
                        this.lastLocationRendered = LocationManager_12.LocationManager.instance.currentLocation;
                    }
                    var dimensions = Camera_6.Camera.instance.dimensions.plus(new point_46.Point(1, 1));
            ...
            exports_87("GroundRenderer", GroundRenderer);
        }
    };
});
System.register("game/world/ground/Grass", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/ground/GroundComponent"], function (exports_88, context_88) {
    "use strict";
    var component_21, Entity_15, point_47, TileTransform_17, Tilesets_25, GroundRenderer_1, LocationManager_13, GroundComponent_1, INDEX, TALL_GRASS_COUNT, makeGrass, TallGrass;
    ...
    return {
        ...
        execute: function () {
            INDEX = "i";
            TALL_GRASS_COUNT = "t";
            exports_88("makeGrass", makeGrass = function (d) {
                var _a, _b;
                var tile;
                ...
                if (index > 0) {
                    tile = Tilesets_25.Tilesets.instance.tilemap.getTileAt(new point_47.Point(0, index));
                }
                else {
                    tile = Tilesets_25.Tilesets.instance.tilemap.getTileAt(new point_47.Point(0, 7));
                }
            ...
            TallGrass = /** @class */ (function (_super) {
                ...
                function TallGrass(tilePos) {
                    ...
                    var offset = new point_47.Point(-6 + Math.round(Math.random() * 11), -Tilesets_25.TILE_SIZE + 2 + Math.round(Math.random() * (Tilesets_25.TILE_SIZE - 2)));
                ...
                TallGrass.prototype.update = function () {
                    if (LocationManager_13.LocationManager.instance.currentLocation.isOccupied(this.tilePos)) {
                        this.delete();
                    }
                };
                return TallGrass;
...
System.register("game/world/ground/Path", ["game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/ConnectingTile", "game/world/ground/Ground"], function (exports_89, context_89) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_89("makePath", makePath = function (d) {
...
System.register("game/world/ground/BasicGround", ["game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_90, context_90) {
    "use strict";
    var Tilesets_26, GroundComponent_3, Entity_17, TileTransform_18, makeBasicGround, makeBasicNineSliceGround;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_90("makeBasicGround", makeBasicGround = function (g, d, rotation) {
                var key = d.data["k"];
                var tile = Tilesets_26.Tilesets.instance.getBasicTileSource(key);
                var c = tile.toComponent(new TileTransform_18.TileTransform(d.pos.times(Tilesets_26.TILE_SIZE)));
            ...
            exports_90("makeBasicNineSliceGround", makeBasicNineSliceGround = function (d) {
                var key = d.data["k"];
                var slice = Tilesets_26.Tilesets.instance.getBasicTileNineSlice(key);
                var nineSliceIndex = d.data["i"];
                var c = slice[nineSliceIndex].toComponent(new TileTransform_18.TileTransform(d.pos.times(Tilesets_26.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ledge", ["engine/point", "game/graphics/Tilesets", "game/world/ground/GroundComponent", "engine/Entity", "engine/tiles/TileTransform"], function (exports_91, context_91) {
    "use strict";
    var point_48, Tilesets_27, GroundComponent_4, Entity_18, TileTransform_19, makeLedge;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_91("makeLedge", makeLedge = function (d) {
                var c = Tilesets_27.Tilesets.instance.tilemap.getTileAt(new point_48.Point(3, 2)).toComponent(new TileTransform_19.TileTransform(d.pos.times(Tilesets_27.TILE_SIZE)));
                c.transform.depth = Number.MIN_SAFE_INTEGER;
...
System.register("game/world/ground/Ground", ["engine/point", "game/world/ground/Grass", "game/world/ground/Path", "engine/tiles/ConnectingTileSchema", "game/graphics/Tilesets", "game/world/ground/BasicGround", "game/world/ground/Ledge"], function (exports_92, context_92) {
    "use strict";
    var point_49, Grass_1, Path_1, ConnectingTileSchema_1, Tilesets_28, BasicGround_1, Ledge_1, SavedGround, Ground;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_92("SavedGround", SavedGround);
            /**
            ...
            Ground = /** @class */ (function () {
                function Ground() {
                    ...
                    this.PATH_CONNECTING_SCHEMA = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(2, 6)))
                        .angle(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(0, 5)))
                        .tShape(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(3, 5)))
                        .plusShape(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(5, 5)))
                        .cap(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(2, 6)))
                        .single(Tilesets_28.Tilesets.instance.tilemap.getTileAt(new point_49.Point(7, 5)));
            ...
            exports_92("Ground", Ground);
        }
    };
});
System.register("engine/tiles/ConnectingTileSchema", ["engine/point", "engine/tiles/TileTransform", "engine/tiles/ConnectingTile"], function (exports_93, context_93) {
    "use strict";
    var point_50, TileTransform_20, ConnectingTile_2, ConnectingTileSchema;
        ...
        execute: function () {
            ...
            ConnectingTileSchema = /** @class */ (function () {
                ...
                ConnectingTileSchema.prototype.render = function (grid, position) {
                    ...
                    var y = position.y;
                    // TODO: add diagonals?
                    var n = this.get(grid, new point_50.Point(x, y - 1));
                    var s = this.get(grid, new point_50.Point(x, y + 1));
                    var e = this.get(grid, new point_50.Point(x + 1, y));
                    var w = this.get(grid, new point_50.Point(x - 1, y));
            ...
            exports_93("ConnectingTileSchema", ConnectingTileSchema);
        }
    };
});
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_94, context_94) {
    "use strict";
    var point_51, component_22, ConnectingTile;
        ...
        execute: function () {
            ConnectingTile = /** @class */ (function (_super) {
                ...
                function ConnectingTile(schema, grid, position) {
                    if (position === void 0) { position = new point_51.Point(0, 0); }
                    var _this = _super.call(this) || this;
                    _this.schema = schema;
                    _this.grid = grid;
                    _this.position = position;
            ...
            exports_94("ConnectingTile", ConnectingTile);
        }
    };
});
/*
...
*
*/
System.register("engine/util/Noise", [], function (exports_95, context_95) {
    "use strict";
    ...
    return {
        ...
        execute: function () {/*
            ...
            */
            ...
            exports_95("Noise", Noise);
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "game/world/LocationManager", "engine/util/Noise", "engine/util/Grid", "game/graphics/Tilesets"], function (exports_96, context_96) {
    "use strict";
    var point_52, LocationManager_14, Noise_1, Grid_4, Tilesets_29, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    this.location = LocationManager_14.LocationManager.instance.newLocation(false);
                ...
                MapGenerator.prototype.clearPathToCenter = function () {
                    ...
                    for (var x = MapGenerator.MAP_SIZE / 2 - 11; x < MapGenerator.MAP_SIZE / 2; x++) {
                        for (var y = MapGenerator.MAP_SIZE / 2 - 10; y < MapGenerator.MAP_SIZE / 2 - 8; y++) {
                            var element = this.location.getElement(new point_52.Point(x, y));
                    ...
                    for (var x = 0; x < 6; x++) {
                        for (var y = 0; y < 4; y++) {
                            var element = this.location.getElement(clearingCorner.plus(new point_52.Point(x, y)));
                            if (!!element && typesToClear.indexOf(element.type) !== -1) {
                                this.location.removeElement(element);
                            }
                        }
                ...
                MapGenerator.prototype.noise = function () {
                    ...
                    for (var i = -MapGenerator.MAP_SIZE / 2; i < MapGenerator.MAP_SIZE / 2; i++) {
                        for (var j = -MapGenerator.MAP_SIZE / 2; j < MapGenerator.MAP_SIZE / 2; j++) {
                            ...
                            str += v;
                            grid.set(new point_52.Point(j, i), v);
                        }
                        str += "\n";
                    }
                    console.log(str);
                ...
                MapGenerator.ENTER_LAND_POS = new point_52.Point(1, 1).times(MapGenerator.MAP_SIZE / 2 * Tilesets_29.TILE_SIZE).plusY(-Tilesets_29.TILE_SIZE * 10).plusX(Tilesets_29.TILE_SIZE * 2);
                return MapGenerator;
            }());
            exports_96("MapGenerator", MapGenerator);
        }
    };
});
System.register("game/cutscenes/Camera", ["engine/point", "game/world/MapGenerator", "game/graphics/Tilesets"], function (exports_97, context_97) {
    "use strict";
    var point_53, MapGenerator_4, Tilesets_30, Camera;
        ...
        execute: function () {
            Camera = /** @class */ (function () {
                ...
                Camera.prototype.getUpdatedPosition = function (dimensions, elapsedTimeMillis) {
                    ...
                    var xLimit = MapGenerator_4.MapGenerator.MAP_SIZE / 2 * Tilesets_30.TILE_SIZE - dimensions.x / 2;
                    var yLimit = MapGenerator_4.MapGenerator.MAP_SIZE / 2 * Tilesets_30.TILE_SIZE - dimensions.y / 2;
                    var trackedPoint = (_b = (_a = this.dudeTarget) === null || _a === void 0 ? void 0 : _a.position) !== null && _b !== void 0 ? _b : this.pointTarget;
                    var clampedTrackedPoint = new point_53.Point(this.clamp(trackedPoint.x, -xLimit, xLimit), this.clamp(trackedPoint.y, -yLimit, yLimit));
            ...
            exports_97("Camera", Camera);
        }
    };
});
System.register("game/ui/OffScreenMarker", ["engine/point", "engine/util/utils", "engine/util/Lists", "engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/world/LocationManager", "game/cutscenes/Camera"], function (exports_98, context_98) {
    "use strict";
    var point_54, utils_6, Lists_2, component_23, Tilesets_31, TileTransform_21, LocationManager_15, Camera_7, OffScreenMarker;
        ...
        execute: function () {
            OffScreenMarker = /** @class */ (function (_super) {
                ...
                function OffScreenMarker() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.markerDistFromEdge = 12 + Tilesets_31.TILE_SIZE;
                    return _this;
                }
                OffScreenMarker.prototype.update = function (updateData) {
                    ...
                    var dips = Array.from(LocationManager_15.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 1 /* DIP */; }).map(function (d) { return d.standingPosition; });
                    if (dips.length === 0) {
                        return;
                    }
                    var point = dips[0];
                    ...
                    this.tilePoint = intersect[1]
                        ...
                        .minus(new point_54.Point(.5, .5).times(Tilesets_31.TILE_SIZE));
                    this.tileSource = "arrow_" + intersect[0] + "_2";
                };
                OffScreenMarker.prototype.getRenderMethods = function () {
                    if (!this.tileSource)
                        return [];
                    return [Tilesets_31.Tilesets.instance.oneBit.getTileSource(this.tileSource).toImageRender(new TileTransform_21.TileTransform(this.tilePoint))];
                };
                OffScreenMarker.prototype.cameraEdgeIntersectPoint = function (outsidePoint, cameraPos, cameraDimensions) {
                    cameraPos = cameraPos.plus(new point_54.Point(1, 1).times(this.markerDistFromEdge));
                    cameraDimensions = cameraDimensions.minus(new point_54.Point(2, 2).times(this.markerDistFromEdge));
                ...
                OffScreenMarker.prototype.lineIntersectPoint = function (ps1, pe1, ps2, pe2) {
                    ...
                    return new point_54.Point((B2 * C1 - B1 * C2) * invdelta, (A1 * C2 - A2 * C1) * invdelta);
                };
                return OffScreenMarker;
            }(component_23.Component));
            exports_98("OffScreenMarker", OffScreenMarker);
        }
    };
});
System.register("game/ui/HUD", ["game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/tiles/TileComponent", "engine/Entity", "game/ui/OffScreenMarker"], function (exports_99, context_99) {
    "use strict";
    var Tilesets_32, TileTransform_22, point_55, TileComponent_8, Entity_19, OffScreenMarker_1, HUD;
        ...
        execute: function () {
            HUD = /** @class */ (function () {
                function HUD() {
                    ...
                    this.autosaveComponent = new Entity_19.Entity().addComponent(Tilesets_32.Tilesets.instance.oneBit.getTileSource("floppy_drive").toComponent());
                    this.isShowingAutosaveIcon = false;
                    this.offset = new point_55.Point(4, 4);
                ...
                HUD.prototype.updateHearts = function (health, maxHealth) {
                    ...
                    this.heartsEntity = new Entity_19.Entity();
                    var heartOffset = new point_55.Point(16, 0);
                    var full = Tilesets_32.Tilesets.instance.dungeonCharacters.getTileSource("ui_heart_full");
                    var half = Tilesets_32.Tilesets.instance.dungeonCharacters.getTileSource("ui_heart_half");
                    var empty = Tilesets_32.Tilesets.instance.dungeonCharacters.getTileSource("ui_heart_empty");
                    var result = [];
                ...
                HUD.prototype.updateAutosave = function (screenDimensions, elapsedMillis) {
                    var base = screenDimensions.minus(this.offset).minus(new point_55.Point(Tilesets_32.TILE_SIZE, Tilesets_32.TILE_SIZE));
                    var lerpRate = 0.005 * elapsedMillis;
                    if (this.autosaveComponent.transform.position.equals(point_55.Point.ZERO)) { // for initializing
                        lerpRate = 1;
                    }
                    var goal = this.isShowingAutosaveIcon ? point_55.Point.ZERO : new point_55.Point(0, 40);
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils", "engine/tiles/TileTransform"], function (exports_100, context_100) {
    "use strict";
    var component_24, Tilesets_33, point_56, NineSlice_6, UIStateManager_11, LocationManager_16, PlaceElementDisplay_1, utils_7, TileTransform_23, PlaceElementFrame;
        ...
        execute: function () {
            ...
            PlaceElementFrame = /** @class */ (function (_super) {
                ...
                function PlaceElementFrame(dimensions) {
                    ...
                    _this.pixelPtToTilePt = function (pixelPt) {
                        return pixelPt.apply(function (n) {
                            return Math.round(Math.abs(n) / Tilesets_33.TILE_SIZE) * Math.sign(n);
                        });
                    };
                    _this.dimensions = dimensions;
                ...
                PlaceElementFrame.prototype.getTiles = function (suffix) {
                    ...
                    return NineSlice_6.NineSlice.makeNineSliceComponents(Tilesets_33.Tilesets.instance.outdoorTiles.getNineSlice("placingElementFrame_" + suffix), new point_56.Point(0, 0), this.dimensions);
                };
                PlaceElementFrame.prototype.update = function (updateData) {
                    var startPos = updateData.input.mousePos;
                    var tilePt = this.pixelPtToTilePt(startPos.minus(new point_56.Point(this.dimensions.x / 2, this.dimensions.y / 2).times(Tilesets_33.TILE_SIZE)));
                    ...
                    this.goodTiles[0].transform.position = tilePt.times(Tilesets_33.TILE_SIZE);
                    this.badTiles[0].transform.position = tilePt.times(Tilesets_33.TILE_SIZE);
                ...
                PlaceElementFrame.prototype.canPlace = function (pos) {
                    for (var x = pos.x; x < pos.x + this.dimensions.x; x++) {
                        for (var y = pos.y; y < pos.y + this.dimensions.y; y++) {
                            if (!!LocationManager_16.LocationManager.instance.currentLocation.getElement(new point_56.Point(x, y))) {
                                return false;
                            }
                        }
                    }
                    var p = pos.times(Tilesets_33.TILE_SIZE);
                    var d = this.dimensions.times(Tilesets_33.TILE_SIZE);
                    return !Array.from(LocationManager_16.LocationManager.instance.currentLocation.dudes).some(function (dude) {
                        return utils_7.rectContains(p, d, dude.standingPosition) || utils_7.rectContains(p, d, dude.standingPosition.plusY(-Tilesets_33.TILE_SIZE));
                    });
                    // TODO: Element-specific restrictions (trees can only go on grass)
                };
                return PlaceElementFrame;
            }(component_24.Component));
            exports_100("PlaceElementFrame", PlaceElementFrame);
        }
    };
});
System.register("game/ui/PlaceElementDisplay", ["engine/Entity", "engine/component", "game/world/elements/Elements", "game/Controls", "game/world/LocationManager", "game/characters/Player", "game/ui/PlaceElementFrame"], function (exports_101, context_101) {
    "use strict";
    var Entity_20, component_25, Elements_2, Controls_5, LocationManager_17, Player_10, PlaceElementFrame_1, PlaceElementDisplay;
        ...
        execute: function () {
            PlaceElementDisplay = /** @class */ (function (_super) {
                ...
                PlaceElementDisplay.prototype.finishPlacing = function (elementPos) {
                    ...
                    LocationManager_17.LocationManager.instance.currentLocation.addElement(this.element, elementPos);
                    this.close();
                };
            ...
            exports_101("PlaceElementDisplay", PlaceElementDisplay);
        }
    };
});
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/point", "engine/util/utils", "game/graphics/Tilesets", "game/characters/Player", "engine/Entity", "game/ui/UIStateManager", "engine/tiles/NineSlice", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "game/items/Items", "game/ui/Text", "game/Controls", "game/ui/PlaceElementDisplay", "game/SaveManager"], function (exports_102, context_102) {
    "use strict";
    var component_26, point_57, utils_8, Tilesets_34, Player_11, Entity_21, UIStateManager_12, NineSlice_7, Tooltip_3, AnimatedTileComponent_4, TileTransform_24, BasicRenderComponent_7, TextRender_7, Items_4, Text_8, Controls_6, PlaceElementDisplay_2, SaveManager_2, InventoryDisplay;
        ...
        execute: function () {
            InventoryDisplay = /** @class */ (function (_super) {
                ...
                function InventoryDisplay() {
                    ...
                    _this.coinsOffset = new point_57.Point(0, -18);
                ...
                InventoryDisplay.prototype.update = function (updateData) {
                    ...
                    if (updateData.input.isMouseDown) {
                        inv.forEach(function (stack, index) {
                            if (utils_8.rectContains(_this.getPositionForInventoryIndex(index), new point_57.Point(Tilesets_34.TILE_SIZE, Tilesets_34.TILE_SIZE), updateData.input.mousePos)) {
                ...
                InventoryDisplay.prototype.spawnBG = function () {
                    var _this = this;
                    this.bgTiles = NineSlice_7.NineSlice.makeNineSliceComponents(Tilesets_34.Tilesets.instance.oneBit.getNineSlice("invBoxNW"), this.offset.minus(new point_57.Point(Tilesets_34.TILE_SIZE / 2, Tilesets_34.TILE_SIZE / 2)), new point_57.Point(1 + InventoryDisplay.COLUMNS, 1 + this.inventory().inventory.length / InventoryDisplay.COLUMNS));
                ...
                InventoryDisplay.prototype.show = function (screenDimensions) {
                    ...
                    var displayDimensions = new point_57.Point(InventoryDisplay.COLUMNS, this.inventory().inventory.length / InventoryDisplay.COLUMNS).times(Tilesets_34.TILE_SIZE);
                    this.offset = new point_57.Point(Math.floor(screenDimensions.x / 2 - displayDimensions.x / 2), Math.floor(screenDimensions.y / 5));
                    this.displayEntity = new Entity_21.Entity();
                    // coins
                    this.displayEntity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([Tilesets_34.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150)], new TileTransform_24.TileTransform(this.offset.plus(this.coinsOffset))));
                    this.displayEntity.addComponent(new BasicRenderComponent_7.BasicRenderComponent(new TextRender_7.TextRender("x" + SaveManager_2.saveManager.getState().coins, new point_57.Point(9, 1).plus(this.offset).plus(this.coinsOffset), Text_8.TEXT_SIZE, Text_8.TEXT_FONT, "#facb3e" /* YELLOW */, UIStateManager_12.UIStateManager.UI_SPRITE_DEPTH)));
                    // background
                    this.spawnBG();
                    // icons
                ...
                InventoryDisplay.prototype.getPositionForInventoryIndex = function (i) {
                    return new point_57.Point(i % InventoryDisplay.COLUMNS, Math.floor(i / InventoryDisplay.COLUMNS)).times(Tilesets_34.TILE_SIZE).plus(this.offset);
                };
                InventoryDisplay.prototype.getInventoryIndexForPosition = function (pos) {
                    var p = pos.minus(this.offset);
                    var x = Math.floor(p.x / Tilesets_34.TILE_SIZE);
                    var y = Math.floor(p.y / Tilesets_34.TILE_SIZE);
            ...
            exports_102("InventoryDisplay", InventoryDisplay);
        }
    };
});
System.register("game/cutscenes/CutsceneManager", ["engine/Entity", "game/SaveManager"], function (exports_103, context_103) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_103("CutsceneManager", CutsceneManager);
        }
    };
});
System.register("game/ui/ControlsUI", ["game/ui/KeyPressIndicator", "engine/point", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/ui/Text", "game/ui/UIStateManager"], function (exports_104, context_104) {
    "use strict";
    var KeyPressIndicator_2, point_58, Tilesets_35, TileTransform_25, Text_9, UIStateManager_13, makeControlsUI;
    ...
    return {
        ...
        execute: function () {
            exports_104("makeControlsUI", makeControlsUI = function (dimensions, offset) {
                var topLeft = new point_58.Point(dimensions.x / 2 - Tilesets_35.TILE_SIZE * 4 + 1, dimensions.y / 2 - Tilesets_35.TILE_SIZE * 5).plus(offset);
                var mouseButtVertOffset = 5;
                return __spreadArrays(new KeyPressIndicator_2.KeyPressIndicator(topLeft.plusX(Tilesets_35.TILE_SIZE), 87 /* W */).getRenderMethods(), new KeyPressIndicator_2.KeyPressIndicator(topLeft.plusY(Tilesets_35.TILE_SIZE), 65 /* A */).getRenderMethods(), new KeyPressIndicator_2.KeyPressIndicator(topLeft.plusX(Tilesets_35.TILE_SIZE).plusY(Tilesets_35.TILE_SIZE), 83 /* S */).getRenderMethods(), new KeyPressIndicator_2.KeyPressIndicator(topLeft.plusX(Tilesets_35.TILE_SIZE * 2).plusY(Tilesets_35.TILE_SIZE), 68 /* D */).getRenderMethods(), [
                    Tilesets_35.Tilesets.instance.oneBit.getTileSource("leftClick").toImageRender(new TileTransform_25.TileTransform(topLeft.plusX(Tilesets_35.TILE_SIZE * 4).plusY(mouseButtVertOffset))),
                    Tilesets_35.Tilesets.instance.oneBit.getTileSource("rightClick").toImageRender(new TileTransform_25.TileTransform(topLeft.plusX(Tilesets_35.TILE_SIZE * 4).plusY(Tilesets_35.TILE_SIZE * 1 + mouseButtVertOffset)))
                ], Text_9.formatText("MOVE", "#fdf7ed" /* WHITE */, topLeft.plusX(Tilesets_35.TILE_SIZE / 2).plusY(Tilesets_35.TILE_SIZE * 2 + 2), 100), Text_9.formatText("ATTACK", "#fdf7ed" /* WHITE */, topLeft.plusX(Tilesets_35.TILE_SIZE * 5).plusY(4 + mouseButtVertOffset), 100), Text_9.formatText("BLOCK", "#fdf7ed" /* WHITE */, topLeft.plusX(Tilesets_35.TILE_SIZE * 5).plusY(Tilesets_35.TILE_SIZE + 4 + mouseButtVertOffset), 100)).map(function (r) {
...
System.register("game/ui/PauseMenu", ["engine/component", "engine/Entity", "game/ui/UIStateManager", "engine/point", "game/ui/ButtonsMenu", "game/SaveManager", "game/cutscenes/CutsceneManager", "game/ui/ControlsUI", "engine/renderer/BasicRenderComponent"], function (exports_105, context_105) {
    "use strict";
    var component_27, Entity_23, UIStateManager_14, point_59, ButtonsMenu_2, SaveManager_4, CutsceneManager_1, ControlsUI_1, BasicRenderComponent_8, PauseMenu;
        ...
        execute: function () {
            PauseMenu = /** @class */ (function (_super) {
                ...
                PauseMenu.prototype.show = function (dimensions) {
                    ...
                    this.controlsDisplay = new Entity_23.Entity([new (BasicRenderComponent_8.BasicRenderComponent.bind.apply(BasicRenderComponent_8.BasicRenderComponent, __spreadArrays([void 0], ControlsUI_1.makeControlsUI(dimensions, point_59.Point.ZERO))))()]);
                };
            ...
            exports_105("PauseMenu", PauseMenu);
        }
    };
});
System.register("game/ui/UIStateManager", ["game/ui/HUD", "game/characters/Player", "game/ui/InventoryDisplay", "game/ui/DialogueDisplay", "game/ui/PlaceElementDisplay", "game/ui/PauseMenu", "game/ui/CraftingMenu", "game/ui/SellMenu"], function (exports_106, context_106) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_106("UIStateManager", UIStateManager);
        }
    };
});
System.register("game/characters/Player", ["engine/component", "engine/point", "engine/util/Lists", "game/Controls", "game/ui/UIStateManager", "game/world/elements/Interactable", "game/characters/Dude", "game/characters/DudeFactory"], function (exports_107, context_107) {
    "use strict";
    var component_28, point_60, Lists_3, Controls_7, UIStateManager_15, Interactable_5, Dude_2, DudeFactory_3, Player;
    ...
    return {
        ...
        execute: function () {
            Player = /** @class */ (function (_super) {
                ...
                function Player() {
                    var _this = _super.call(this) || this;
                    _this.lerpedLastMoveDir = new point_60.Point(1, 0); // used for crosshair
                ...
                Player.prototype.update = function (updateData) {
                    ...
                    if (updateData.input.isKeyDown(80 /* P */)) {
                        ...
                        this.dude.damage(.25, new point_60.Point(-1, Math.random() - .5), 30);
                    }
                ...
                Player.prototype.updateInteractables = function (updateData) {
                    ...
                    var interactCenter = this.dude.standingPosition.minus(new point_60.Point(0, 7));
            ...
            exports_107("Player", Player);
        }
    };
});
System.register("game/characters/Enemy", ["engine/component", "game/graphics/Tilesets", "game/world/PointLightMaskRenderer", "game/characters/Dude", "game/characters/NPC"], function (exports_108, context_108) {
    "use strict";
    var component_29, Tilesets_36, PointLightMaskRenderer_3, Dude_3, NPC_3, Enemy;
    ...
    return {
        ...
        execute: function () {
                ...
                Enemy.prototype.awake = function () {
                    ...
                    if (this.dude.factions.includes(3 /* DEMONS */)) {
                        ...
                        this.npc.pathFindingHeuristic = function (pt, goal) {
                            return pt.distanceTo(goal) + (PointLightMaskRenderer_3.PointLightMaskRenderer.instance.isDark(pt.times(Tilesets_36.TILE_SIZE)) ? 0 : 100);
                        };
            ...
            exports_108("Enemy", Enemy);
        }
    };
});
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_109, context_109) {
    "use strict";
    var component_30, Player_13, Dude_4, point_61, CutscenePlayerController;
        ...
        execute: function () {
            CutscenePlayerController = /** @class */ (function (_super) {
                ...
                function CutscenePlayerController() {
                    var _this = _super.call(this) || this;
                    _this.moveDir = point_61.Point.ZERO;
                ...
                CutscenePlayerController.prototype.stopMoving = function () {
                    this.moveDir = point_61.Point.ZERO;
                };
            ...
            exports_109("CutscenePlayerController", CutscenePlayerController);
        }
    };
});
System.register("game/characters/ShroomNPC", ["engine/component", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/characters/Dude", "game/characters/DudeFactory", "game/characters/Enemy", "game/characters/weapons/WeaponType"], function (exports_110, context_110) {
    "use strict";
    var component_31, LocationManager_18, TimeUnit_5, WorldTime_8, Dude_5, DudeFactory_4, Enemy_1, WeaponType_3, SIZE, NEXT_GROWTH_TIME, ShroomNPC;
    ...
    return {
        ...
        execute: function () {
            ...
            ShroomNPC = /** @class */ (function (_super) {
                ...
                ShroomNPC.prototype.update = function (data) {
                    ...
                    if (ogSize === 3 || Math.random() > 0.5) {
                        // split
                        DudeFactory_4.DudeFactory.instance.new(6 /* SHROOM */, this.dude.position, LocationManager_18.LocationManager.instance.exterior());
                    }
                    else {
                        // grow
                        ...
                        this.entity.selfDestruct();
                        DudeFactory_4.DudeFactory.instance.load(data_1, LocationManager_18.LocationManager.instance.exterior());
                    }
                };
            ...
            exports_110("ShroomNPC", ShroomNPC);
        }
    };
});
System.register("game/characters/Villager", ["engine/component", "game/characters/Dude", "game/characters/NPC", "game/world/PointLightMaskRenderer", "game/characters/ShroomNPC"], function (exports_111, context_111) {
    "use strict";
    var component_32, Dude_6, NPC_4, PointLightMaskRenderer_4, ShroomNPC_1, Villager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_111("Villager", Villager);
        }
    };
});
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/characters/Dialogue", "game/cutscenes/CutscenePlayerController", "game/characters/Villager", "game/characters/NPCSchedule", "engine/util/Lists", "game/characters/weapons/WeaponType", "game/characters/dialogues/BertoIntro", "game/characters/ShroomNPC", "game/saves/uuid"], function (exports_112, context_112) {
    "use strict";
    var Entity_24, point_62, Player_14, Dude_7, NPC_5, LocationManager_19, Enemy_2, Inventory_2, Dialogue_5, CutscenePlayerController_1, Villager_1, NPCSchedule_3, Lists_4, WeaponType_4, BertoIntro_2, ShroomNPC_2, uuid_2, DudeFactory;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.load = function (saveState, location) {
                    var d = this.make(saveState.type, point_62.Point.fromString(saveState.pos), saveState, location);
                    location.dudes.add(d);
                };
                    ...
                    switch (type) {
                        ...
                        case 1 /* DIP */: {
                            ...
                            additionalComponents = [
                                new NPC_5.NPC(NPCSchedule_3.NPCSchedules.newGoToSchedule(new point_62.Point(0, 0))),
                        ...
                        case 4 /* HERALD */: {
                            ...
                            additionalComponents = [
                                ...
                                Lists_4.Lists.oneOf([new point_62.Point(-3, 0), new point_62.Point(-3, 1), new point_62.Point(-2, 0), new point_62.Point(-2, 1)].filter(function (pt) { return !location.isOccupied(pt); })))),
                                new Villager_1.Villager()
                            ];
                        ...
                        case 7 /* VILLAGER */:
                            ...
                            additionalComponents = [new NPC_5.NPC(NPCSchedule_3.NPCSchedules.newDefaultVillagerSchedule()), new Villager_1.Villager()];
                            speed *= (.3 + Math.random() / 2);
                            break;
                        default: {
...
System.register("game/saves/DudeSaveState", [], function (exports_113, context_113) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_113("DudeSaveState", DudeSaveState);
        }
    };
});
System.register("game/saves/LocationSaveState", [], function (exports_114, context_114) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_114("LocationSaveState", LocationSaveState);
        }
    };
});
System.register("game/saves/LocationManagerSaveState", [], function (exports_115, context_115) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_115("LocationManagerSaveState", LocationManagerSaveState);
        }
    };
});
System.register("game/world/LocationManager", ["game/world/WorldLocation"], function (exports_116, context_116) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_116("LocationManager", LocationManager);
        }
    };
});
System.register("game/items/DroppedItem", ["engine/collision/BoxCollider", "engine/component", "engine/point", "game/characters/Player", "game/world/LocationManager", "game/items/Items", "game/SaveManager"], function (exports_117, context_117) {
    "use strict";
    var BoxCollider_7, component_33, point_63, Player_15, LocationManager_20, Items_5, SaveManager_5, DroppedItem;
    ...
    return {
        ...
        execute: function () {
            DroppedItem = /** @class */ (function (_super) {
                ...
                function DroppedItem(position, item, velocity, sourceCollider) {
                    ...
                    _this.start = function () {
                        ...
                        var pos = position.minus(new point_63.Point(_this.tile.transform.dimensions.x / 2, _this.tile.transform.dimensions.y));
                        _this.tile.transform.position = pos;
                        var colliderSize = new point_63.Point(8, 8);
                            ...
                            setTimeout(function () {
                                if (Player_15.Player.instance.dude.isAlive && !!_this.entity) {
                                    ...
                                    if (_this.itemType === 0 /* COIN */ || Player_15.Player.instance.dude.inventory.addItem(_this.itemType)) {
                                        LocationManager_20.LocationManager.instance.currentLocation.droppedItems.delete(_this.entity);
                ...
                DroppedItem.prototype.reposition = function (delta) {
                    if (delta === void 0) { delta = new point_63.Point(0, 0); }
            ...
            exports_117("DroppedItem", DroppedItem);
        }
    };
});
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point", "game/characters/weapons/WeaponType"], function (exports_118, context_118) {
    "use strict";
    var _a, Tilesets_37, Entity_25, LocationManager_21, DroppedItem_1, point_64, WeaponType_5, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_118("ItemMetadata", ItemMetadata);
            // Data that doesn't get serialized (TODO make builder pattern)
            exports_118("ITEM_METADATA_MAP", ITEM_METADATA_MAP = (_a = {},
                _a[0 /* COIN */] = new ItemMetadata({
                    displayName: "Coin",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("coin"); },
                    droppedIconSupplier: function () { return Tilesets_37.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150); },
                    stackLimit: Number.MAX_SAFE_INTEGER,
                }),
                _a[1 /* ROCK */] = new ItemMetadata({
                    displayName: "Rock",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("rock"); },
                    droppedIconSupplier: function () { return Tilesets_37.Tilesets.instance.outdoorTiles.getTileSource("rockItem"); },
                }),
                _a[2 /* WOOD */] = new ItemMetadata({
                    displayName: "Wood",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("wood"); },
                    droppedIconSupplier: function () { return Tilesets_37.Tilesets.instance.outdoorTiles.getTileSource("woodItem"); },
                }),
                ...
                _a[5 /* IRON */] = new ItemMetadata({
                    displayName: "Iron",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("iron"); },
                    droppedIconSupplier: function () { return Tilesets_37.Tilesets.instance.outdoorTiles.getTileSource("ironItem"); },
                }),
                ...
                _a[100012 /* AXE */] = new ItemMetadata({
                    displayName: "Axe",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("axe"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.AXE
                }),
                _a[100022 /* PICKAXE */] = new ItemMetadata({
                    displayName: "Pickaxe",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("pickaxe"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.PICKAXE
                }),
                _a[100003 /* SWORD */] = new ItemMetadata({
                    displayName: "Sword",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("sword"); },
                    stackLimit: 1,
                    equippable: WeaponType_5.WeaponType.SWORD
                }),
                _a[100021 /* SPEAR */] = new ItemMetadata({
                    displayName: "Spear",
                    inventoryIconSupplier: function () { return Tilesets_37.Tilesets.instance.oneBit.getTileSource("spear"); },
                    stackLimit: 1,
             ...
             * @param position The bottom center where the item should be placed
             */
            exports_118("spawnItem", spawnItem = function (pos, item, velocity, sourceCollider) {
                if (velocity === void 0) { velocity = new point_64.Point(0, 0); }
                if (sourceCollider === void 0) { sourceCollider = null; }
                LocationManager_21.LocationManager.instance.currentLocation.droppedItems.add(new Entity_25.Entity([
...
System.register("game/items/Inventory", ["game/items/Items"], function (exports_119, context_119) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_119("ItemStack", ItemStack);
            ...
            exports_119("Inventory", Inventory);
        }
    };
});
System.register("game/characters/DudeAnimationUtils", ["game/graphics/ImageFilters", "game/graphics/Tilesets", "game/SaveManager"], function (exports_120, context_120) {
    "use strict";
    var ImageFilters_3, Tilesets_38, SaveManager_6, maybeFilter, DudeAnimationUtils;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_120("DudeAnimationUtils", DudeAnimationUtils = {
                getCharacterIdleAnimation: function (characterAnimName, blob) {
                    var animSpeed = 150;
                    var anim = Tilesets_38.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_idle_anim", animSpeed)
                        || Tilesets_38.Tilesets.instance.extraCharacterSet1.getTileSetAnimation(characterAnimName + "_Idle", 4, animSpeed)
                        || Tilesets_38.Tilesets.instance.extraCharacterSet2.getIdleAnimation(characterAnimName, animSpeed);
                    return maybeFilter(characterAnimName, blob, anim);
                },
                getCharacterWalkAnimation: function (characterAnimName, blob) {
                    var animSpeed = 80;
                    var anim = Tilesets_38.Tilesets.instance.dungeonCharacters.getTileSetAnimation(characterAnimName + "_run_anim", animSpeed)
                        || Tilesets_38.Tilesets.instance.extraCharacterSet1.getTileSetAnimation(characterAnimName + "_Walk", 4, animSpeed)
                        || Tilesets_38.Tilesets.instance.extraCharacterSet2.getWalkAnimation(characterAnimName, animSpeed);
                    return maybeFilter(characterAnimName, blob, anim);
                },
            });
        }
...
System.register("game/characters/weapons/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_121, context_121) {
    "use strict";
    var component_34, TileComponent_9, Tilesets_39, TileTransform_26, point_65, Dude_8, State, Shield;
    ...
    return {
        ...
        execute: function () {
            ...
            Shield = /** @class */ (function (_super) {
                ...
                function Shield(shieldId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.blockingShieldSprite = _this.entity.addComponent(new TileComponent_9.TileComponent(Tilesets_39.Tilesets.instance.dungeonCharacters.getTileSource(shieldId), new TileTransform_26.TileTransform().relativeTo(_this.dude.animation.transform)));
                    };
                    return _this;
                }
                Shield.prototype.update = function (updateData) {
                    // default (drawn) position
                    var pos = this.dude.animation.transform.dimensions.minus(new point_65.Point(12, 16));
                    if (this.state === State.ON_BACK) {
                        pos = pos.plus(new point_65.Point(-6, -1));
                    }
                    else if (this.state === State.DRAWN) {
                        pos = pos.plus(new point_65.Point(5, 4).times(this.raisedPerc < .7 ? this.raisedPerc : 1.4 - this.raisedPerc).apply(Math.floor));
            ...
            exports_121("Shield", Shield);
        }
    };
});
System.register("game/characters/weapons/Weapon", ["engine/component", "game/world/LocationManager", "game/characters/Dude", "game/world/elements/Hittable", "engine/point"], function (exports_122, context_122) {
    "use strict";
    var component_35, LocationManager_22, Dude_9, Hittable_2, point_66, Weapon;
        ...
        execute: function () {
            Weapon = /** @class */ (function (_super) {
                ...
                Weapon.prototype.awake = function () {
                    this.dude = this.entity.getComponent(Dude_9.Dude);
                };
                // TODO find a better place for these static functions?
                Weapon.getEnemiesInRange = function (attacker, attackDistance) {
                    return Array.from(LocationManager_22.LocationManager.instance.currentLocation.dudes)
                ...
                Weapon.hitResources = function (dude) {
                    var interactDistance = 20;
                    var interactCenter = dude.standingPosition.minus(new point_66.Point(0, 7));
                    var possibilities = LocationManager_22.LocationManager.instance.currentLocation.getElements()
            ...
            exports_122("Weapon", Weapon);
        }
    };
});
System.register("game/characters/weapons/UnarmedWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType"], function (exports_123, context_123) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_123("UnarmedWeapon", UnarmedWeapon);
        }
    };
});
System.register("game/characters/weapons/MeleeWeapon", ["game/characters/weapons/Weapon", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator"], function (exports_124, context_124) {
    "use strict";
    var Weapon_2, TileTransform_27, point_67, Tilesets_40, Animator_3, State, MeleeWeapon;
        ...
        execute: function () {
            ...
            MeleeWeapon = /** @class */ (function (_super) {
                ...
                function MeleeWeapon(weaponType, weaponId, offsetFromCenter) {
                    ...
                    _this.currentAnimationFrame = 0;
                    _this.start = function (startData) {
                        _this.weaponSprite = Tilesets_40.Tilesets.instance.dungeonCharacters.getTileSource(weaponId);
                ...
                MeleeWeapon.prototype.animate = function () {
                    ...
                    if (this.state === State.DRAWN) {
                        ...
                        // center on back
                        pos = offsetFromEdge.plus(new point_67.Point(3, -1));
                    }
                ...
                MeleeWeapon.prototype.getAttackAnimationPosition = function () {
                    ...
                    if (this.currentAnimationFrame < swingStartFrame) {
                        return [new point_67.Point(this.currentAnimationFrame * 3, 0), 0];
                    }
                    else if (this.currentAnimationFrame < resettingFrame) {
                        return [
                            new point_67.Point((6 - this.currentAnimationFrame) + this.weaponTransform.dimensions.y - swingStartFrame * 3, Math.floor(this.weaponTransform.dimensions.y / 2 - 1)),
                            90
                        ];
                    }
                    else {
                        return [new point_67.Point((1 - this.currentAnimationFrame + resettingFrame) * 3, 2), 0];
                    }
                };
                return MeleeWeapon;
            }(Weapon_2.Weapon));
            exports_124("MeleeWeapon", MeleeWeapon);
        }
    };
});
System.register("game/characters/weapons/Projectile", ["engine/collision/BoxCollider", "engine/component", "engine/Entity", "engine/point", "game/world/LocationManager", "game/items/DroppedItem", "engine/util/Lists"], function (exports_125, context_125) {
    "use strict";
    var BoxCollider_8, component_36, Entity_26, point_68, LocationManager_23, DroppedItem_2, Lists_5, Projectile, spawnProjectile;
    ...
    return {
        ...
        execute: function () {
            Projectile = /** @class */ (function (_super) {
                ...
                function Projectile(position, sprite, item, velocity, attacker) {
                    ...
                    _this.start = function () {
                        ...
                        var pos = position.minus(new point_68.Point(_this.tile.transform.dimensions.x / 2, _this.tile.transform.dimensions.y));
                        _this.tile.transform.position = pos;
                        _this.tile.transform.rotation = velocity.x > 0 ? 90 : -90;
                        _this.tile.transform.mirrorX = velocity.x > 0;
                        var colliderSize = new point_68.Point(8, 8);
                        var sourceCollider = attacker.entity.getComponent(BoxCollider_8.BoxCollider);
                        _this.collider = _this.entity.addComponent(new BoxCollider_8.BoxCollider(pos.plus(new point_68.Point(10, 10)), colliderSize, DroppedItem_2.DroppedItem.COLLISION_LAYER, !!sourceCollider ? [sourceCollider] : []));
                        _this.reposition();
                        var last = new Date().getTime();
                        var move = function () {
                            if (!_this.enabled) {
                            ...
                            if (diff > 0) {
                                if (_this.reposition(velocity)) {
                                    ...
                                    if (!!enemy) {
                                        ...
                                        _this.tile.transform.position = new point_68.Point(_this.tile.transform.dimensions.y - 10, relativeOffset.y);
                ...
                Projectile.prototype.getEnemy = function (attacker, projectilePos, velocity, attackDistance) {
                    var allEnemies = Array.from(LocationManager_23.LocationManager.instance.currentLocation.dudes)
                        .filter(function (d) { return !!d && d !== attacker && d.isEnemy(attacker); })
                ...
                Projectile.prototype.reposition = function (delta) {
                    if (delta === void 0) { delta = new point_68.Point(0, 0); }
                    var colliderOffset = this.collider.position.minus(this.tile.transform.position);
            ...
            exports_125("spawnProjectile", spawnProjectile = function (pos, sprite, item, velocity, attacker) {
                LocationManager_23.LocationManager.instance.currentLocation.droppedItems.add(new Entity_26.Entity([
...
System.register("game/characters/weapons/SpearWeapon", ["game/characters/weapons/Weapon", "game/characters/weapons/WeaponType", "engine/tiles/TileTransform", "engine/point", "game/graphics/Tilesets", "engine/util/Animator", "game/characters/weapons/Projectile"], function (exports_126, context_126) {
    "use strict";
    var Weapon_3, WeaponType_7, TileTransform_28, point_69, Tilesets_41, Animator_4, Projectile_1, State, SpearWeapon;
        ...
        execute: function () {
            ...
            SpearWeapon = /** @class */ (function (_super) {
                ...
                function SpearWeapon() {
                    ...
                    _this.currentAnimationFrame = 0;
                    _this.start = function (startData) {
                        _this.weaponSprite = Tilesets_41.Tilesets.instance.dungeonCharacters.getTileSource("weapon_spear");
                        _this.weaponTransform = new TileTransform_28.TileTransform(point_69.Point.ZERO, _this.weaponSprite.dimensions).relativeTo(_this.dude.animation.transform);
                        _this.offsetFromCenter = new point_69.Point(-5, 0);
                        _this._range = _this.weaponSprite.dimensions.y;
                    };
                    return _this;
                }
                ...
                SpearWeapon.prototype.cancelAttack = function () {
                    ...
                    if (this.timeDrawn > timeToThrow) {
                        ...
                        Projectile_1.spawnProjectile(newTransform.position.plusY(24), this.weaponSprite, 100021 /* SPEAR */, new point_69.Point(40 * this.dude.facingMultipler(), 4.5), this.dude);
                    }
                    else {
                        this.state = State.ATTACKING;
                        setTimeout(function () { return _this.damageEnemies(); }, 100);
                ...
                SpearWeapon.prototype.getBasePosition = function (rotation) {
                    var offset = new point_69.Point(this.dude.animation.transform.dimensions.x / 2 - this.weaponTransform.dimensions.x / 2, this.dude.animation.transform.dimensions.y - this.weaponTransform.dimensions.y).plus(this.offsetFromCenter);
                    if (rotation === 90) {
                        offset = offset.plus(new point_69.Point(10, 10));
                    }
                    return offset.plus(this.dude.getAnimationOffsetPosition());
                };
                SpearWeapon.prototype.animate = function () {
                    var drawSpeed = 100;
                    var pos = point_69.Point.ZERO;
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                ...
                SpearWeapon.prototype.getAttackAnimationPosition = function () {
                    if (this.currentAnimationFrame >= this.frameCount - 1) {
                        return [new point_69.Point(2, 0), 90];
                    }
                    else {
                        var x = [8, 14, 16, 12, 8][this.currentAnimationFrame];
                        return [new point_69.Point(x, 0), 90];
                    }
                };
                return SpearWeapon;
            }(Weapon_3.Weapon));
            exports_126("SpearWeapon", SpearWeapon);
        }
    };
});
System.register("game/characters/weapons/WeaponFactory", ["game/characters/weapons/WeaponType", "game/characters/weapons/UnarmedWeapon", "game/characters/weapons/MeleeWeapon", "engine/point", "game/characters/weapons/SpearWeapon"], function (exports_127, context_127) {
    "use strict";
    var WeaponType_8, UnarmedWeapon_1, MeleeWeapon_1, point_70, SpearWeapon_1, WeaponFactory;
    ...
    return {
        ...
        execute: function () {
            exports_127("WeaponFactory", WeaponFactory = {
                ...
                make: function (type) {
                    switch (type) {
                        ...
                        case WeaponType_8.WeaponType.SWORD:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.SWORD, "weapon_regular_sword", new point_70.Point(-6, -2));
                        case WeaponType_8.WeaponType.CLUB:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.CLUB, "weapon_baton_with_spikes", new point_70.Point(-6, -2));
                        case WeaponType_8.WeaponType.PICKAXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.PICKAXE, "weapon_pickaxe", new point_70.Point(-5, -2));
                        case WeaponType_8.WeaponType.AXE:
                            return new MeleeWeapon_1.MeleeWeapon(WeaponType_8.WeaponType.AXE, "weapon_axe", new point_70.Point(-3, -1));
...
System.register("game/characters/Dude", ["engine/collision/BoxCollider", "engine/component", "engine/point", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "game/graphics/ImageFilters", "game/graphics/Tilesets", "game/items/Items", "game/ui/DialogueDisplay", "game/ui/DudeInteractIndicator", "game/ui/UIStateManager", "game/world/elements/Interactable", "game/world/LocationManager", "game/characters/DudeAnimationUtils", "game/characters/Dialogue", "game/characters/weapons/Shield", "game/characters/weapons/WeaponType", "game/characters/weapons/WeaponFactory"], function (exports_128, context_128) {
    "use strict";
    var BoxCollider_9, component_37, point_71, AnimatedTileComponent_5, TileTransform_29, ImageFilters_4, Tilesets_42, Items_7, DialogueDisplay_5, DudeInteractIndicator_5, UIStateManager_16, Interactable_6, LocationManager_24, DudeAnimationUtils_1, Dialogue_6, Shield_1, WeaponType_9, WeaponFactory_1, Dude;
            ...
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(uuid, type, factions, characterAnimName, position, weaponType, shieldId, maxHealth, health, speed, inventory, dialogue, blob) {
                    ...
                    _this.awake = function () {
                        ...
                        _this._animation = _this.entity.addComponent(new AnimatedTileComponent_5.AnimatedTileComponent([idleAnim, runAnim], new TileTransform_29.TileTransform(new point_71.Point(0, 28 - height))));
                        ...
                        var colliderSize = new point_71.Point(10, 8);
                        _this.relativeColliderPos = new point_71.Point(_this.animation.transform.dimensions.x / 2 - colliderSize.x / 2, _this.animation.transform.dimensions.y - colliderSize.y);
                        ...
                        _this.dialogueInteract = _this.entity.addComponent(new Interactable_6.Interactable(new point_71.Point(0, 0), function () { return DialogueDisplay_5.DialogueDisplay.instance.startDialogue(_this); }, point_71.Point.ZERO, function () { return !UIStateManager_16.UIStateManager.instance.isMenuOpen && !_this.isMoving && !!_this.dialogue; }));
                    };
                    return _this;
                }
                ...
                Object.defineProperty(Dude.prototype, "standingPosition", {
                    ...
                    get: function () {
                        return this.position.plus(new point_71.Point(this.animation.transform.dimensions.x / 2, this.animation.transform.dimensions.y));
                    },
                    enumerable: false,
                    configurable: true
                });
                ...
                Dude.prototype.die = function (direction) {
                    var _this = this;
                    if (direction === void 0) { direction = new point_71.Point(-1, 0); }
                    this._health = 0;
                    var prePos = this.animation.transform.position;
                    this.animation.transform.rotate(90 * (direction.x >= 0 ? 1 : -1), this.standingPosition.minus(new point_71.Point(0, 5)));
                ...
                Dude.prototype.getAnimationOffsetPosition = function () {
                    ...
                    return new point_71.Point(0, arr[f]);
                };
                ...
                Dude.prototype.delete = function () {
                    var _this = this;
                    LocationManager_24.LocationManager.instance.getLocations().forEach(function (l) { return l.dudes.delete(_this); });
                    _super.prototype.delete.call(this);
                };
                Dude.prototype.getIndicator = function () {
                    ...
                    if (!tile || this.dialogueInteract.isShowingUI || DialogueDisplay_5.DialogueDisplay.instance.dialogueSource === this) {
                        ...
                        return [tile.toImageRender(new TileTransform_29.TileTransform(this.standingPosition.plusY(-28).plus(new point_71.Point(1, 1).times(-Tilesets_42.TILE_SIZE / 2)).plus(this.getAnimationOffsetPosition()), new point_71.Point(Tilesets_42.TILE_SIZE, Tilesets_42.TILE_SIZE), 0, false, false, UIStateManager_16.UIStateManager.UI_SPRITE_DEPTH))];
                    }
                };
...
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager", "game/ui/ControlsUI", "game/characters/dialogues/DipIntro"], function (exports_129, context_129) {
    "use strict";
    var component_38, CutscenePlayerController_2, Player_16, point_72, Camera_8, CutsceneManager_2, LocationManager_25, ControlsUI_2, DipIntro_3, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    CutscenePlayerController_2.CutscenePlayerController.instance.startMoving(new point_72.Point(-1, 0));
                    this.dip = Array.from(LocationManager_25.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 1 /* DIP */; })[0];
                    setTimeout(function () {
                ...
                IntroCutscene.prototype.update = function (updateData) {
                    ...
                    if (!this.orcs) {
                        this.orcs = Array.from(LocationManager_25.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.factions.includes(1 /* ORCS */); });
                    }
            ...
            exports_129("IntroCutscene", IntroCutscene);
        }
    };
});
System.register("game/scenes/GameScene", ["engine/collision/CollisionEngine", "engine/point", "game/characters/Dude", "game/characters/DudeFactory", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/cutscenes/IntroCutscene", "game/graphics/Tilesets", "game/items/DroppedItem", "game/SaveManager", "game/ui/UIStateManager", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/MapGenerator", "game/world/PointLightMaskRenderer", "game/world/TimeUnit", "game/world/WorldTime"], function (exports_130, context_130) {
    "use strict";
    var CollisionEngine_4, point_73, Dude_10, DudeFactory_5, Camera_9, CutsceneManager_3, IntroCutscene_1, Tilesets_43, DroppedItem_3, SaveManager_7, UIStateManager_17, GroundRenderer_2, LocationManager_26, MapGenerator_5, PointLightMaskRenderer_5, TimeUnit_6, WorldTime_9, ZOOM, GameScene;
        ...
        execute: function () {
            ...
            GameScene = /** @class */ (function () {
                ...
                GameScene.prototype.newGame = function () {
                    ...
                    DudeFactory_5.DudeFactory.instance.new(1 /* DIP */, point_73.Point.ZERO);
                    DudeFactory_5.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_73.Point(3, 1).times(Tilesets_43.TILE_SIZE));
                    DudeFactory_5.DudeFactory.instance.new(3 /* ORC_WARRIOR */, new point_73.Point(-1, 3).times(Tilesets_43.TILE_SIZE));
                ...
                GameScene.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.gameEntityView = {
                        zoom: ZOOM,
                        offset: cameraOffset,
                        entities: LocationManager_26.LocationManager.instance.currentLocation.getEntities().concat([
                            CutsceneManager_3.CutsceneManager.instance.getEntity(),
                            WorldTime_9.WorldTime.instance.getEntity(),
            ...
            exports_130("GameScene", GameScene);
        }
    };
});
System.register("game/ui/MainMenuButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_131, context_131) {
    "use strict";
    var component_39, point_74, TextRender_8, utils_9, Tilesets_44, Text_10, UIStateManager_18, MainMenuButton;
        ...
        execute: function () {
            MainMenuButton = /** @class */ (function (_super) {
                ...
                MainMenuButton.prototype.update = function (updateData) {
                    this.hovering = utils_9.rectContains(this.position.plusX(-this.width / 2).plusY(-4), new point_74.Point(this.width, Tilesets_44.TILE_SIZE), updateData.input.mousePos);
                    if (this.hovering && updateData.input.isMouseDown) {
                        this.onClick();
                    }
                };
            ...
            exports_131("MainMenuButton", MainMenuButton);
        }
    };
});
System.register("engine/renderer/RectRender", ["engine/point", "engine/renderer/RenderMethod"], function (exports_132, context_132) {
    "use strict";
    var point_75, RenderMethod_4, RectRender;
        ...
        execute: function () {
            RectRender = /** @class */ (function (_super) {
                ...
                function RectRender(_a) {
                    var _b = _a === void 0 ? {} : _a, _c = _b.depth, depth = _c === void 0 ? 0 : _c, _d = _b.position, position = _d === void 0 ? point_75.Point.ZERO : _d, _e = _b.dimensions, dimensions = _e === void 0 ? point_75.Point.ZERO : _e, _f = _b.color, color = _f === void 0 ? "#ff0000" : _f;
                    var _this = _super.call(this, depth) || this;
                    _this.position = position;
                    _this.dimensions = dimensions;
                    _this.color = color;
            ...
            exports_132("RectRender", RectRender);
        }
    };
});
System.register("game/ui/PlumePicker", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/RectRender", "engine/util/utils", "game/graphics/Tilesets", "game/SaveManager"], function (exports_133, context_133) {
    "use strict";
    var component_40, Entity_27, point_76, RectRender_1, utils_10, Tilesets_45, SaveManager_8, CUSTOMIZATION_OPTIONS, PlumePicker;
        ...
        execute: function () {
            ...
            PlumePicker = /** @class */ (function (_super) {
                ...
                function PlumePicker(callback) {
                    var _this = _super.call(this) || this;
                    _this.position = point_76.Point.ZERO; // top-center position
                ...
                PlumePicker.prototype.update = function (updateData) {
                    var _this = this;
                    var sqSize = Tilesets_45.TILE_SIZE;
                    var rowLen = 9;
                    var topLeftPos = this.position.plusX(-rowLen * sqSize / 2);
                    this.renders = CUSTOMIZATION_OPTIONS.map(function (colors, index) {
                        var position = topLeftPos.plusX((index % rowLen) * Tilesets_45.TILE_SIZE)
                            .plusY(Math.floor(index / rowLen) * Tilesets_45.TILE_SIZE);
                        var dimensions = new point_76.Point(Tilesets_45.TILE_SIZE, Tilesets_45.TILE_SIZE);
                        ...
                        return new RectRender_1.RectRender({
                            position: position.plus(big ? new point_76.Point(-bigBuffer, -bigBuffer) : point_76.Point.ZERO),
                            dimensions: dimensions.plus(big ? new point_76.Point(bigBuffer, bigBuffer).times(2) : point_76.Point.ZERO),
                            color: colors[1],
            ...
            exports_133("PlumePicker", PlumePicker);
        }
    };
});
System.register("game/scenes/MainMenuScene", ["engine/Entity", "engine/point", "game/characters/DudeAnimationUtils", "game/SaveManager", "game/ui/MainMenuButton", "game/ui/PlumePicker"], function (exports_134, context_134) {
    "use strict";
    var Entity_28, point_77, DudeAnimationUtils_2, SaveManager_9, MainMenuButton_1, PlumePicker_1, ZOOM, MainMenuScene;
        ...
        execute: function () {
            ...
            MainMenuScene = /** @class */ (function () {
                ...
                MainMenuScene.prototype.getViews = function (updateViewsContext) {
                    ...
                    return [{
                            zoom: ZOOM,
                            offset: point_77.Point.ZERO,
                            entities: entities
                        }];
                };
                return MainMenuScene;
            }());
            exports_134("MainMenuScene", MainMenuScene);
        }
    };
});
System.register("game/quest_game", ["engine/game", "game/scenes/GameScene", "game/scenes/MainMenuScene"], function (exports_135, context_135) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_135("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_136, context_136) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_46, Assets_5;
    ...
    return {
        ...
        execute: function () {
            Assets_5.assets.loadImageFiles(Tilesets_46.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_137, context_137) {
    "use strict";
    var component_41, utils_11, Clickable;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_137("Clickable", Clickable);
        }
    };
});
System.register("engine/util/Comparators", [], function (exports_138, context_138) {
    "use strict";
    var Comparators;
    ...
    return {
        setters: [],
        execute: function () {
            exports_138("Comparators", Comparators = {
                orderBy: function (fn) {
...
window['dice'] = doGame;
System.register("game/saves/SerializeObject", ["engine/profiler", "game/saves/uuid"], function (exports_139, context_139) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_139("serialize", serialize = function (object) {
...
// TODO
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_140, context_140) {
    "use strict";
    var component_42, Tilesets_47, TileTransform_30, point_78, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_47.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_30.TileTransform(_this.topLeftPos.plus(new point_78.Point(10 * i, 0))));
                    });
                };
            ...
            exports_140("StringTiles", StringTiles);
        }
    };
});
