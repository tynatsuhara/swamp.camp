...
System.register("game/world/elements/ElementComponent", ["engine/component"], function (exports_47, context_47) {
    "use strict";
...
System.register("game/world/PointLightMaskRenderer", ["engine/Entity", "engine/point", "engine/renderer/BasicRenderComponent", "engine/renderer/ImageRender", "engine/util/Grid", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/ui/UIStateManager", "game/world/LocationManager", "game/world/MapGenerator", "game/world/TimeUnit", "game/world/WorldTime"], function (exports_53, context_53) {
    "use strict";
    var Entity_4, point_24, BasicRenderComponent_2, ImageRender_2, Grid_1, Camera_1, Tilesets_4, UIStateManager_3, LocationManager_1, MapGenerator_1, TimeUnit_2, WorldTime_1, PointLightMaskRenderer;
...
System.register("game/world/interior/House", ["engine/point", "game/graphics/Tilesets", "game/world/LocationManager"], function (exports_57, context_57) {
    "use strict";
    var point_27, Tilesets_7, LocationManager_2, makeHouseInterior;
    ...
    return {
        ...
        execute: function () {
            exports_57("makeHouseInterior", makeHouseInterior = function (outside) {
                var l = LocationManager_2.LocationManager.instance.newLocation(true);
...
System.register("game/world/elements/HittableResource", ["engine/collision/BoxCollider", "engine/point", "game/graphics/Tilesets", "game/items/Items", "game/world/LocationManager", "game/world/elements/ElementComponent", "game/world/elements/Hittable"], function (exports_61, context_61) {
    "use strict";
    var BoxCollider_3, point_30, Tilesets_9, Items_1, LocationManager_3, ElementComponent_4, Hittable_1, HittableResource;
        ...
        execute: function () {
            HittableResource = /** @class */ (function (_super) {
                ...
                HittableResource.prototype.hitCallback = function (hitDir) {
                    ...
                    if (finishingMove) {
                        LocationManager_3.LocationManager.instance.currentLocation.removeElement(this.entity.getComponent(ElementComponent_4.ElementComponent));
...
System.register("game/world/interior/Tent", ["game/world/LocationManager", "engine/point", "game/graphics/Tilesets", "engine/tiles/NineSlice", "game/world/interior/AsciiInteriorBuilder"], function (exports_66, context_66) {
    "use strict";
    var LocationManager_4, point_34, Tilesets_11, NineSlice_1, AsciiInteriorBuilder_1, makeTentInterior;
    ...
    return {
        ...
        execute: function () {
            exports_66("makeTentInterior", makeTentInterior = function (outside, color) {
                var l = LocationManager_4.LocationManager.instance.newLocation(true);
...
System.register("game/world/elements/Tree", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/HittableResource", "game/world/elements/ElementComponent", "game/characters/weapons/WeaponType", "game/characters/Player", "game/world/elements/ElementFactory"], function (exports_68, context_68) {
    "use strict";
    var point_36, Tilesets_13, BoxCollider_6, TileComponent_7, TileTransform_12, Entity_9, HittableResource_2, ElementComponent_7, WeaponType_2, Player_3, ElementFactory_6, TreeFactory, addTile;
...
System.register("game/world/events/QueuedEvent", ["game/characters/DudeFactory", "game/world/MapGenerator", "game/world/LocationManager", "game/characters/NPCSchedule", "game/characters/NPC", "game/graphics/Tilesets", "game/world/events/EventQueue", "game/world/WorldTime", "game/world/elements/House"], function (exports_70, context_70) {
    "use strict";
    var _a, DudeFactory_1, MapGenerator_2, LocationManager_5, NPCSchedule_1, NPC_1, Tilesets_14, EventQueue_2, WorldTime_3, House_3, QueuedEventType, EVENT_QUEUE_HANDLERS;
        ...
        execute: function () {
            ...
            exports_70("EVENT_QUEUE_HANDLERS", EVENT_QUEUE_HANDLERS = (_a = {},
                _a[QueuedEventType.HERALD_ARRIVAL] = function () {
                    DudeFactory_1.DudeFactory.instance.new(4 /* HERALD */, MapGenerator_2.MapGenerator.ENTER_LAND_POS, LocationManager_5.LocationManager.instance.exterior());
                ...
                _a[QueuedEventType.HERALD_DEPARTURE] = function (data) {
                    ...
                    var berto = LocationManager_5.LocationManager.instance.exterior().getDude(4 /* HERALD */);
                    if (!berto) {
                        return;
                    }
...
System.register("game/SaveManager", ["game/characters/Player", "game/saves/SaveGame", "game/world/LocationManager", "game/ui/UIStateManager", "game/cutscenes/Camera", "game/ui/HUD", "game/world/WorldTime", "game/world/events/EventQueue"], function (exports_72, context_72) {
    "use strict";
    var Player_4, SaveGame_1, LocationManager_6, UIStateManager_4, Camera_2, HUD_1, WorldTime_4, EventQueue_3, SAVE_KEY, SaveManager, saveManager;
            ...
            SaveManager = /** @class */ (function () {
                ...
                SaveManager.prototype.save = function () {
                    ...
                    var save = {
                        ...
                        saveVersion: 0,
                        locations: LocationManager_6.LocationManager.instance.save(),
                ...
                SaveManager.prototype.load = function () {
                    ...
                    LocationManager_6.LocationManager.instance.initialize(save.locations);
                    WorldTime_4.WorldTime.instance.initialize(save.worldTime);
                    EventQueue_3.EventQueue.instance.initialize(save.eventQueue);
                    Camera_2.Camera.instance.focusOnDude(Array.from(LocationManager_6.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 0 /* PLAYER */; })[0]);
...
System.register("game/ui/Tooltip", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/renderer/TextRender", "game/ui/Text", "game/ui/UIStateManager"], function (exports_73, context_73) {
    "use strict";
    var component_13, Tilesets_15, point_37, TextRender_4, Text_2, UIStateManager_5, Tooltip;
...
System.register("game/ui/CraftingMenu", ["engine/Entity", "engine/component", "engine/point", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "engine/tiles/NineSlice", "game/graphics/Tilesets", "engine/renderer/ImageRender", "game/ui/UIStateManager", "game/items/Items", "game/ui/Text", "engine/tiles/TileTransform", "game/graphics/ImageFilters", "game/characters/Player", "engine/util/utils", "game/ui/Tooltip"], function (exports_74, context_74) {
    "use strict";
    var Entity_10, component_14, point_38, BasicRenderComponent_3, Camera_3, NineSlice_2, Tilesets_16, ImageRender_3, UIStateManager_6, Items_2, Text_3, TileTransform_13, ImageFilters_1, Player_5, utils_3, Tooltip_1, CraftingMenu;
...
System.register("game/ui/SellMenu", ["engine/Entity", "engine/component", "engine/point", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "engine/tiles/NineSlice", "game/graphics/Tilesets", "engine/renderer/ImageRender", "game/ui/UIStateManager", "game/items/Items", "game/ui/Text", "game/graphics/ImageFilters", "game/characters/Player", "engine/util/utils", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/TextRender"], function (exports_77, context_77) {
    "use strict";
    var Entity_11, component_15, point_40, BasicRenderComponent_4, Camera_4, NineSlice_3, Tilesets_18, ImageRender_4, UIStateManager_7, Items_3, Text_4, ImageFilters_2, Player_6, utils_4, Tooltip_2, AnimatedTileComponent_3, TileTransform_14, TextRender_5, SellMenu;
...
System.register("game/characters/dialogues/BertoIntro", ["game/ui/DudeInteractIndicator", "game/ui/SellMenu", "game/world/elements/House", "game/world/events/EventQueue", "game/world/events/QueuedEvent", "game/world/LocationManager", "game/world/WorldTime", "game/characters/Dialogue"], function (exports_78, context_78) {
    "use strict";
    var _a, DudeInteractIndicator_3, SellMenu_1, House_4, EventQueue_5, QueuedEvent_3, LocationManager_8, WorldTime_6, Dialogue_3, BERTO_STARTING_DIALOGUE, BERT_MENU, BERT_MENU_INTRO, BERT_VILLAGERS, BERT_VILLAGER_NEEDS_HOUSE, BERT_LEAVING, getItemsToSell, getGreeting, BERTO_INTRO_DIALOGUE;
...
System.register("game/ui/TextButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/tiles/TileTransform", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_80, context_80) {
    "use strict";
    var component_16, point_41, TextRender_6, TileTransform_15, utils_5, Tilesets_19, Text_5, UIStateManager_8, TextButton;
...
System.register("game/ui/DialogueDisplay", ["game/characters/Dialogue", "game/graphics/Tilesets", "engine/tiles/NineSlice", "engine/point", "engine/component", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/ui/Text", "game/Controls", "game/ui/UIStateManager", "game/ui/ButtonsMenu"], function (exports_82, context_82) {
    "use strict";
    var Dialogue_4, Tilesets_21, NineSlice_5, point_43, component_17, Entity_13, BasicRenderComponent_5, Text_7, Controls_4, UIStateManager_10, ButtonsMenu_1, DialogueDisplay;
...
System.register("game/characters/NPC", ["engine/component", "engine/point", "engine/util/Lists", "game/graphics/Tilesets", "game/ui/DialogueDisplay", "game/world/LocationManager", "game/world/PointLightMaskRenderer", "game/characters/Dude", "game/characters/NPCSchedule", "game/characters/Player"], function (exports_83, context_83) {
    "use strict";
    var component_18, point_44, Lists_1, Tilesets_22, DialogueDisplay_3, LocationManager_9, PointLightMaskRenderer_2, Dude_1, NPCSchedule_2, Player_8, NPC;
            ...
            NPC = /** @class */ (function (_super) {
                ...
                NPC.prototype.doNormalScheduledActivity = function (updateData) {
                    ...
                    if (schedule.type === 0 /* DO_NOTHING */) {
                        ...
                        var location_1 = LocationManager_9.LocationManager.instance.currentLocation;
                        this.doFlee(updateData, 0.5);
                    }
                    else {
                ...
                NPC.prototype.doFlee = function (updateData, speedMultiplier, ptSelectionFilter) {
                    ...
                    if (!this.fleePath || this.fleePath.length === 0) { // only try once per upate() to find a path
                        var l_1 = LocationManager_9.LocationManager.instance.currentLocation;
                ...
                NPC.prototype.checkForEnemies = function () {
                    var _this = this;
                    var enemies = Array.from(LocationManager_9.LocationManager.instance.currentLocation.dudes)
                ...
                NPC.prototype.findPath = function (tilePt, pixelPtStart) {
                    ...
                    return (_a = LocationManager_9.LocationManager.instance.currentLocation
...
System.register("game/world/WorldLocation", ["engine/point", "engine/util/Grid", "game/characters/DudeFactory", "game/characters/NPC", "game/characters/Player", "game/cutscenes/Camera", "game/graphics/Tilesets", "game/saves/uuid", "game/world/elements/Elements", "game/world/elements/ElementUtils", "game/world/ground/Ground", "game/world/LocationManager", "game/world/Teleporter"], function (exports_86, context_86) {
    "use strict";
    var point_45, Grid_2, DudeFactory_2, NPC_2, Player_9, Camera_5, Tilesets_23, uuid_1, Elements_1, ElementUtils_3, Ground_1, LocationManager_10, Teleporter_2, WorldLocation;
...
System.register("game/world/GroundRenderer", ["engine/point", "engine/renderer/ImageRender", "engine/Entity", "engine/renderer/BasicRenderComponent", "game/cutscenes/Camera", "game/world/MapGenerator", "game/graphics/Tilesets", "engine/util/Grid", "game/world/LocationManager", "engine/tiles/TileTransform"], function (exports_87, context_87) {
    "use strict";
    var point_46, ImageRender_5, Entity_14, BasicRenderComponent_6, Camera_6, MapGenerator_3, Tilesets_24, Grid_3, LocationManager_11, TileTransform_16, GroundRenderer;
...
System.register("game/world/ground/Grass", ["engine/component", "engine/Entity", "engine/point", "engine/tiles/TileTransform", "game/graphics/Tilesets", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/ground/GroundComponent"], function (exports_88, context_88) {
    "use strict";
    var component_20, Entity_15, point_47, TileTransform_17, Tilesets_25, GroundRenderer_1, LocationManager_12, GroundComponent_1, INDEX, TALL_GRASS_COUNT, makeGrass, TallGrass;
...
System.register("engine/tiles/ConnectingTile", ["engine/point", "engine/component"], function (exports_94, context_94) {
    "use strict";
    var point_51, component_21, ConnectingTile;
...
System.register("game/world/MapGenerator", ["engine/point", "game/world/LocationManager", "engine/util/Noise", "engine/util/Grid", "game/graphics/Tilesets"], function (exports_96, context_96) {
    "use strict";
    var point_52, LocationManager_13, Noise_1, Grid_4, Tilesets_29, MapGenerator;
        ...
        execute: function () {
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    this.location = LocationManager_13.LocationManager.instance.newLocation(false);
...
System.register("game/ui/OffScreenMarker", ["engine/point", "engine/util/utils", "engine/util/Lists", "engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "game/world/LocationManager", "game/cutscenes/Camera"], function (exports_98, context_98) {
    "use strict";
    var point_54, utils_6, Lists_2, component_22, Tilesets_31, TileTransform_21, LocationManager_14, Camera_7, OffScreenMarker;
        ...
        execute: function () {
            OffScreenMarker = /** @class */ (function (_super) {
                ...
                OffScreenMarker.prototype.update = function (updateData) {
                    ...
                    var dips = Array.from(LocationManager_14.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 1 /* DIP */; }).map(function (d) { return d.standingPosition; });
                    if (dips.length === 0) {
                        return;
                    }
                    var point = dips[0];
...
System.register("game/ui/PlaceElementFrame", ["engine/component", "game/graphics/Tilesets", "engine/point", "engine/tiles/NineSlice", "game/ui/UIStateManager", "game/world/LocationManager", "game/ui/PlaceElementDisplay", "engine/util/utils", "engine/tiles/TileTransform"], function (exports_100, context_100) {
    "use strict";
    var component_23, Tilesets_33, point_56, NineSlice_6, UIStateManager_11, LocationManager_15, PlaceElementDisplay_1, utils_7, TileTransform_23, PlaceElementFrame;
                ...
                PlaceElementFrame.prototype.canPlace = function (pos) {
                    for (var x = pos.x; x < pos.x + this.dimensions.x; x++) {
                        for (var y = pos.y; y < pos.y + this.dimensions.y; y++) {
                            if (!!LocationManager_15.LocationManager.instance.currentLocation.getElement(new point_56.Point(x, y))) {
                                return false;
                            }
                        }
                    }
                    ...
                    return !Array.from(LocationManager_15.LocationManager.instance.currentLocation.dudes).some(function (dude) {
...
System.register("game/ui/PlaceElementDisplay", ["engine/Entity", "engine/component", "game/world/elements/Elements", "game/Controls", "game/world/LocationManager", "game/characters/Player", "game/ui/PlaceElementFrame"], function (exports_101, context_101) {
    "use strict";
    var Entity_20, component_24, Elements_2, Controls_5, LocationManager_16, Player_10, PlaceElementFrame_1, PlaceElementDisplay;
        ...
        execute: function () {
            PlaceElementDisplay = /** @class */ (function (_super) {
                ...
                PlaceElementDisplay.prototype.finishPlacing = function (elementPos) {
                    ...
                    LocationManager_16.LocationManager.instance.currentLocation.addElement(this.element, elementPos);
                    this.close();
                };
...
System.register("game/ui/InventoryDisplay", ["engine/component", "engine/point", "engine/util/utils", "game/graphics/Tilesets", "game/characters/Player", "engine/Entity", "game/ui/UIStateManager", "engine/tiles/NineSlice", "game/ui/Tooltip", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender", "game/items/Items", "game/ui/Text", "game/Controls", "game/ui/PlaceElementDisplay", "game/SaveManager"], function (exports_102, context_102) {
    "use strict";
    var component_25, point_57, utils_8, Tilesets_34, Player_11, Entity_21, UIStateManager_12, NineSlice_7, Tooltip_3, AnimatedTileComponent_4, TileTransform_24, BasicRenderComponent_7, TextRender_7, Items_4, Text_8, Controls_6, PlaceElementDisplay_2, SaveManager_2, InventoryDisplay;
...
System.register("game/ui/PauseMenu", ["engine/component", "engine/Entity", "game/ui/UIStateManager", "engine/point", "game/ui/ButtonsMenu", "game/SaveManager", "game/cutscenes/CutsceneManager", "game/ui/ControlsUI", "engine/renderer/BasicRenderComponent"], function (exports_105, context_105) {
    "use strict";
    var component_26, Entity_23, UIStateManager_14, point_59, ButtonsMenu_2, SaveManager_4, CutsceneManager_1, ControlsUI_1, BasicRenderComponent_8, PauseMenu;
...
System.register("game/characters/Player", ["engine/component", "engine/point", "engine/util/Lists", "game/Controls", "game/ui/UIStateManager", "game/world/elements/Interactable", "game/characters/Dude", "game/characters/DudeFactory"], function (exports_107, context_107) {
    "use strict";
    var component_27, point_60, Lists_3, Controls_7, UIStateManager_15, Interactable_5, Dude_2, DudeFactory_3, Player;
...
System.register("game/characters/Enemy", ["engine/component", "game/graphics/Tilesets", "game/world/PointLightMaskRenderer", "game/characters/Dude", "game/characters/NPC"], function (exports_108, context_108) {
    "use strict";
    var component_28, Tilesets_36, PointLightMaskRenderer_3, Dude_3, NPC_3, Enemy;
...
System.register("game/cutscenes/CutscenePlayerController", ["engine/component", "game/characters/Player", "game/characters/Dude", "engine/point"], function (exports_109, context_109) {
    "use strict";
    var component_29, Player_13, Dude_4, point_61, CutscenePlayerController;
...
System.register("game/characters/ShroomNPC", ["engine/component", "game/world/LocationManager", "game/world/TimeUnit", "game/world/WorldTime", "game/characters/Dude", "game/characters/DudeFactory", "game/characters/Enemy", "game/characters/weapons/WeaponType"], function (exports_110, context_110) {
    "use strict";
    var component_30, LocationManager_17, TimeUnit_4, WorldTime_7, Dude_5, DudeFactory_4, Enemy_1, WeaponType_3, SIZE, NEXT_GROWTH_TIME, ShroomNPC;
...
System.register("game/characters/Villager", ["engine/component", "game/characters/Dude", "game/characters/NPC", "game/world/PointLightMaskRenderer", "game/characters/ShroomNPC"], function (exports_111, context_111) {
    "use strict";
    var component_31, Dude_6, NPC_4, PointLightMaskRenderer_4, ShroomNPC_1, Villager;
...
System.register("game/characters/DudeFactory", ["engine/Entity", "engine/point", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager", "game/characters/Enemy", "game/items/Inventory", "game/characters/Dialogue", "game/cutscenes/CutscenePlayerController", "game/characters/Villager", "game/characters/NPCSchedule", "engine/util/Lists", "game/characters/weapons/WeaponType", "game/characters/dialogues/BertoIntro", "game/characters/ShroomNPC", "game/saves/uuid"], function (exports_112, context_112) {
    "use strict";
    var Entity_24, point_62, Player_14, Dude_7, NPC_5, LocationManager_18, Enemy_2, Inventory_2, Dialogue_5, CutscenePlayerController_1, Villager_1, NPCSchedule_3, Lists_4, WeaponType_4, BertoIntro_2, ShroomNPC_2, uuid_2, DudeFactory;
...
System.register("game/items/DroppedItem", ["engine/collision/BoxCollider", "engine/component", "engine/point", "game/characters/Player", "game/world/LocationManager", "game/items/Items", "game/SaveManager"], function (exports_117, context_117) {
    "use strict";
    var BoxCollider_7, component_32, point_63, Player_15, LocationManager_19, Items_5, SaveManager_5, DroppedItem;
...
System.register("game/items/Items", ["game/graphics/Tilesets", "engine/Entity", "game/world/LocationManager", "game/items/DroppedItem", "engine/point", "game/characters/weapons/WeaponType"], function (exports_118, context_118) {
    "use strict";
    var _a, Tilesets_37, Entity_25, LocationManager_20, DroppedItem_1, point_64, WeaponType_5, ItemMetadata, ITEM_METADATA_MAP, spawnItem;
...
System.register("game/characters/weapons/Shield", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude"], function (exports_121, context_121) {
    "use strict";
    var component_33, TileComponent_9, Tilesets_39, TileTransform_26, point_65, Dude_8, State, Shield;
...
System.register("game/characters/weapons/Weapon", ["engine/component", "game/world/LocationManager", "game/characters/Dude", "game/world/elements/Hittable", "engine/point"], function (exports_122, context_122) {
    "use strict";
    var component_34, LocationManager_21, Dude_9, Hittable_2, point_66, Weapon;
        ...
        execute: function () {
            Weapon = /** @class */ (function (_super) {
                ...
                Weapon.getEnemiesInRange = function (attacker, attackDistance) {
                    return Array.from(LocationManager_21.LocationManager.instance.currentLocation.dudes)
                ...
                Weapon.hitResources = function (dude) {
                    ...
                    var possibilities = LocationManager_21.LocationManager.instance.currentLocation.getElements()
...
System.register("game/characters/weapons/Projectile", ["engine/collision/BoxCollider", "engine/component", "engine/Entity", "engine/point", "game/world/LocationManager", "game/items/DroppedItem", "engine/util/Lists"], function (exports_125, context_125) {
    "use strict";
    var BoxCollider_8, component_35, Entity_26, point_68, LocationManager_22, DroppedItem_2, Lists_5, Projectile, spawnProjectile;
        ...
        execute: function () {
            Projectile = /** @class */ (function (_super) {
                ...
                Projectile.prototype.getEnemy = function (attacker, projectilePos, velocity, attackDistance) {
                    var allEnemies = Array.from(LocationManager_22.LocationManager.instance.currentLocation.dudes)
                        .filter(function (d) { return !!d && d !== attacker && d.isEnemy(attacker); })
            ...
            exports_125("spawnProjectile", spawnProjectile = function (pos, sprite, item, velocity, attacker) {
                LocationManager_22.LocationManager.instance.currentLocation.droppedItems.add(new Entity_26.Entity([
...
System.register("game/characters/Dude", ["engine/collision/BoxCollider", "engine/component", "engine/point", "engine/tiles/AnimatedTileComponent", "engine/tiles/TileTransform", "game/graphics/ImageFilters", "game/graphics/Tilesets", "game/items/Items", "game/ui/DialogueDisplay", "game/ui/DudeInteractIndicator", "game/ui/UIStateManager", "game/world/elements/Interactable", "game/world/LocationManager", "game/characters/DudeAnimationUtils", "game/characters/Dialogue", "game/characters/weapons/Shield", "game/characters/weapons/WeaponType", "game/characters/weapons/WeaponFactory"], function (exports_128, context_128) {
    "use strict";
    var BoxCollider_9, component_36, point_71, AnimatedTileComponent_5, TileTransform_29, ImageFilters_4, Tilesets_42, Items_7, DialogueDisplay_5, DudeInteractIndicator_5, UIStateManager_16, Interactable_6, LocationManager_23, DudeAnimationUtils_1, Dialogue_6, Shield_1, WeaponType_9, WeaponFactory_1, Dude;
        ...
        execute: function () {
            Dude = /** @class */ (function (_super) {
                ...
                Dude.prototype.delete = function () {
                    var _this = this;
                    LocationManager_23.LocationManager.instance.getLocations().forEach(function (l) { return l.dudes.delete(_this); });
                    _super.prototype.delete.call(this);
                };
...
System.register("game/cutscenes/IntroCutscene", ["engine/component", "game/cutscenes/CutscenePlayerController", "game/characters/Player", "engine/point", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/world/LocationManager", "game/ui/ControlsUI", "game/characters/dialogues/DipIntro"], function (exports_129, context_129) {
    "use strict";
    var component_37, CutscenePlayerController_2, Player_16, point_72, Camera_8, CutsceneManager_2, LocationManager_24, ControlsUI_2, DipIntro_3, IntroCutscene;
        ...
        execute: function () {
            ...
            IntroCutscene = /** @class */ (function (_super) {
                ...
                IntroCutscene.prototype.start = function (startData) {
                    ...
                    this.dip = Array.from(LocationManager_24.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.type === 1 /* DIP */; })[0];
                    setTimeout(function () {
                ...
                IntroCutscene.prototype.update = function (updateData) {
                    ...
                    if (!this.orcs) {
                        this.orcs = Array.from(LocationManager_24.LocationManager.instance.currentLocation.dudes).filter(function (d) { return d.factions.includes(1 /* ORCS */); });
                    }
...
System.register("game/scenes/GameScene", ["engine/collision/CollisionEngine", "engine/point", "game/characters/Dude", "game/characters/DudeFactory", "game/cutscenes/Camera", "game/cutscenes/CutsceneManager", "game/cutscenes/IntroCutscene", "game/graphics/Tilesets", "game/items/DroppedItem", "game/SaveManager", "game/ui/UIStateManager", "game/world/GroundRenderer", "game/world/LocationManager", "game/world/MapGenerator", "game/world/PointLightMaskRenderer", "game/world/TimeUnit", "game/world/WorldTime"], function (exports_130, context_130) {
    "use strict";
    var CollisionEngine_4, point_73, Dude_10, DudeFactory_5, Camera_9, CutsceneManager_3, IntroCutscene_1, Tilesets_43, DroppedItem_3, SaveManager_7, UIStateManager_17, GroundRenderer_2, LocationManager_25, MapGenerator_5, PointLightMaskRenderer_5, TimeUnit_5, WorldTime_8, ZOOM, GameScene;
            ...
            GameScene = /** @class */ (function () {
                ...
                GameScene.prototype.updateViews = function (updateViewsContext) {
                    ...
                    this.gameEntityView = {
                        zoom: ZOOM,
                        offset: cameraOffset,
                        entities: LocationManager_25.LocationManager.instance.currentLocation.getEntities().concat([
...
System.register("game/ui/MainMenuButton", ["engine/component", "engine/point", "engine/renderer/TextRender", "engine/util/utils", "game/graphics/Tilesets", "game/ui/Text", "game/ui/UIStateManager"], function (exports_131, context_131) {
    "use strict";
    var component_38, point_74, TextRender_8, utils_9, Tilesets_44, Text_10, UIStateManager_18, MainMenuButton;
...
System.register("game/ui/PlumePicker", ["engine/component", "engine/Entity", "engine/point", "engine/renderer/RectRender", "engine/util/utils", "game/graphics/Tilesets", "game/SaveManager"], function (exports_133, context_133) {
    "use strict";
    var component_39, Entity_27, point_76, RectRender_1, utils_10, Tilesets_45, SaveManager_8, CUSTOMIZATION_OPTIONS, PlumePicker;
...
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_140, context_140) {
    "use strict";
    var component_41, Tilesets_47, TileTransform_30, point_78, StringTiles;
