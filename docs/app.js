...
System.register("game/graphics/OutdoorTileset", ["engine/point", "game/graphics/SingleFileTileLoader"], function (exports_34, context_34) {
    "use strict";
    var point_18, SingleFileTileLoader_2, OutdoorTileset;
            ...
            OutdoorTileset = /** @class */ (function (_super) {
                ...
                function OutdoorTileset() {
                    return _super.call(this, "images/env_outdoor_recolor.png", new Map([
                        ["tree1base", new point_18.Point(15, 11)],
                        ["tree1top", new point_18.Point(15, 10)],
                        ["tree2base", new point_18.Point(18, 11)],
                        ["tree2top", new point_18.Point(18, 10)],
                        ...
                        ["bluetentNW", new point_18.Point(48, 10)],
                        ["bluetentNE", new point_18.Point(49, 10)],
                        ["bluetentSW", new point_18.Point(48, 11)],
                        ["bluetentSE", new point_18.Point(49, 11)],
                        ["campfireOff", new point_18.Point(13, 8)],
                        ["campfireOn", new point_18.Point(14, 8)],
                        ["rock1", new point_18.Point(54, 21)],
                        ["rock2", new point_18.Point(55, 21)],
                        ["rock3", new point_18.Point(56, 21)],
                        ["rock1mossy", new point_18.Point(54, 22)],
                        ["rock2mossy", new point_18.Point(55, 22)],
                        ["rock3mossy", new point_18.Point(56, 22)],
                    ])) || this;
                }
                return OutdoorTileset;
            }(SingleFileTileLoader_2.SingleFileTileLoader));
            exports_34("OutdoorTileset", OutdoorTileset);
        }
    };
});
System.register("game/graphics/Tilesets", ["game/graphics/SingleFileTileLoader", "game/graphics/DungeonTilesetII", "game/graphics/SplitFileTileLoader", "game/graphics/OneBitTileset", "game/graphics/OutdoorTileset"], function (exports_35, context_35) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            // standard tile size
            exports_35("TILE_SIZE", TILE_SIZE = 16);
            /**
            ...
            exports_35("Tilesets", Tilesets);
        }
    };
});
System.register("game/world/WorldLocation", ["engine/util/Grid"], function (exports_36, context_36) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_36("WorldLocation", WorldLocation);
        }
    };
});
System.register("engine/util/Animator", [], function (exports_37, context_37) {
    "use strict";
    var Animator;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_37("Animator", Animator);
        }
    };
});
System.register("engine/tiles/AnimatedTileComponent", ["engine/tiles/TileComponent", "engine/util/Animator", "engine/tiles/TileTransform"], function (exports_38, context_38) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_38("AnimatedTileComponent", AnimatedTileComponent);
        }
    };
});
System.register("game/world/elements/Interactable", ["engine/component"], function (exports_39, context_39) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_39("Interactable", Interactable);
        }
    };
});
System.register("game/world/elements/Campfire", ["engine/component", "engine/tiles/TileComponent", "engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/world/elements/Interactable", "engine/collision/BoxCollider"], function (exports_40, context_40) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_40("Campfire", Campfire);
        }
    };
});
System.register("game/characters/Weapon", ["engine/component", "engine/tiles/TileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "game/characters/Dude", "engine/util/Animator", "game/world/LocationManager"], function (exports_41, context_41) {
    "use strict";
    var component_7, TileComponent_4, Tilesets_2, TileTransform_6, point_20, Dude_1, Animator_2, LocationManager_1, State, Weapon;
            ...
            Weapon = /** @class */ (function (_super) {
                ...
                function Weapon(weaponId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.weaponSprite = _this.entity.addComponent(new TileComponent_4.TileComponent(Tilesets_2.Tilesets.instance.dungeonCharacters.getTileSource(weaponId), new TileTransform_6.TileTransform().relativeTo(_this.dude.animation.transform)));
                    };
                    return _this;
                }
                ...
                Weapon.prototype.animate = function () {
                    var offsetFromEdge = new point_20.Point(6, 26).minus(this.weaponSprite.transform.dimensions); // for DRAWN/SHEATHED
                    // relative position for DRAWN state when characer is facing right (mirroring logic below)
                    var pos = new point_20.Point(0, 0);
                    var rotation = 0;
                    if (this.state === State.DRAWN) {
                        ...
                        // center on back
                        pos = offsetFromEdge.plus(new point_20.Point(3, -1));
                    }
                    ...
                    if (!this.dude.isMoving) {
                        pos = pos.plus(new point_20.Point(0, f == 3 ? 1 : f));
                    }
                    else {
                        pos = pos.plus(new point_20.Point(0, f == 0 ? -1 : -((3 - this.dude.animation.currentFrame()))));
                    }
                ...
                Weapon.prototype.getAttackAnimationPosition = function () {
                    ...
                    if (this.currentAnimationFrame < swingStartFrame) {
                        return [new point_20.Point(this.currentAnimationFrame * 3, 0), 0];
                    }
                    else if (this.currentAnimationFrame < resettingFrame) {
                        return [
                            new point_20.Point((6 - this.currentAnimationFrame) + this.weaponSprite.transform.dimensions.y - swingStartFrame * 3, Math.floor(this.weaponSprite.transform.dimensions.y / 2 - 1)),
                            90
                        ];
                    }
                    else {
                        return [new point_20.Point((1 - this.currentAnimationFrame + resettingFrame) * 3, 2), 0];
                    }
                };
                return Weapon;
            }(component_7.Component));
            exports_41("Weapon", Weapon);
        }
    };
});
System.register("game/items/Coin", ["engine/component", "engine/tiles/AnimatedTileComponent", "engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "game/characters/Player", "game/characters/Dude", "game/world/LocationManager"], function (exports_42, context_42) {
    "use strict";
    var component_8, AnimatedTileComponent_2, point_21, Tilesets_3, BoxCollider_2, Player_1, Dude_2, LocationManager_2, Coin;
        ...
        execute: function () {
            ...
            Coin = /** @class */ (function (_super) {
                ...
                function Coin(position) {
                    var _this = _super.call(this) || this;
                    _this.start = function (startData) {
                        var anim = Tilesets_3.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150);
            ...
            exports_42("Coin", Coin);
        }
    };
});
System.register("game/items/Inventory", [], function (exports_43, context_43) {
    "use strict";
    var Inventory;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_43("Inventory", Inventory);
        }
    };
});
System.register("game/characters/Dude", ["engine/tiles/AnimatedTileComponent", "engine/point", "engine/component", "engine/collision/BoxCollider", "game/graphics/Tilesets", "game/characters/Weapon", "engine/Entity", "game/items/Coin", "game/items/Inventory", "game/world/LocationManager"], function (exports_44, context_44) {
    "use strict";
            ...
            Dude = /** @class */ (function (_super) {
                ...
                function Dude(archetype, position, weaponId) {
                    ...
                    _this.start = function (startData) {
                        ...
                        _this.collider = _this.entity.addComponent(new BoxCollider_3.BoxCollider(_this.position.plus(_this.relativeColliderPos), colliderSize));
                    };
                    return _this;
                }
    ...
    return {
        ...
        execute: function () {
            Hittable = /** @class */ (function (_super) {
                 ...
                 */
                function Hittable(position, tileTransforms) {
                    var _this = _super.call(this) || this;
                    _this.position = position;
...
System.register("game/characters/Player", ["engine/point", "engine/component", "game/characters/Dude", "game/world/elements/Interactable", "game/world/elements/Hittable"], function (exports_46, context_46) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_46("Player", Player);
        }
    };
});
System.register("game/world/LocationManager", ["game/characters/Player"], function (exports_47, context_47) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_47("LocationManager", LocationManager);
        }
    };
});
System.register("game/world/elements/Tent", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Interactable", "game/world/LocationManager"], function (exports_48, context_48) {
    "use strict";
    var point_24, Tilesets_5, BoxCollider_4, TileComponent_5, TileTransform_7, Entity_4, Interactable_3, LocationManager_4, TentColor, makeTent, addTile;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_48("TentColor", TentColor);
            exports_48("makeTent", makeTent = function (wl, pos, color, teleportTo) {
                ...
                e.addComponent(new BoxCollider_4.BoxCollider(pos.plus(new point_24.Point(0, 1)).times(Tilesets_5.TILE_SIZE), new point_24.Point(Tilesets_5.TILE_SIZE * 2, Tilesets_5.TILE_SIZE), false));
            ...
            addTile = function (wl, e, s, pos, depth) {
                wl.stuff.set(pos, e);
                var tile = e.addComponent(new TileComponent_5.TileComponent(Tilesets_5.Tilesets.instance.outdoorTiles.getTileSource(s), new TileTransform_7.TileTransform(pos.times(Tilesets_5.TILE_SIZE))));
                tile.transform.depth = depth;
            };
        }
    };
});
System.register("game/world/elements/Tree", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Hittable"], function (exports_49, context_49) {
    "use strict";
    var point_25, Tilesets_6, BoxCollider_5, TileComponent_6, TileTransform_8, Entity_5, Hittable_2, TreeType, makeTree, addTile;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_49("TreeType", TreeType);
            exports_49("makeTree", makeTree = function (wl, pos, type) {
                var e = new Entity_5.Entity();
                var depth = (pos.y + 2) * Tilesets_6.TILE_SIZE;
                var top = addTile(wl, e, "tree" + type + "top", pos, depth);
                var bottom = addTile(wl, e, "tree" + type + "base", pos.plus(new point_25.Point(0, 1)), depth);
                var hitboxDims = new point_25.Point(8, 3);
                e.addComponent(new BoxCollider_5.BoxCollider(pos.plus(new point_25.Point(.5, 2)).times(Tilesets_6.TILE_SIZE).minus(new point_25.Point(hitboxDims.x / 2, hitboxDims.y)), hitboxDims));
                e.addComponent(new Hittable_2.Hittable(pos.times(Tilesets_6.TILE_SIZE).plus(new point_25.Point(Tilesets_6.TILE_SIZE / 2, Tilesets_6.TILE_SIZE + Tilesets_6.TILE_SIZE / 2)), [top.transform, bottom.transform]));
            });
            addTile = function (wl, e, s, pos, depth) {
                wl.stuff.set(pos, e);
...
System.register("game/world/elements/Rock", ["engine/point", "game/graphics/Tilesets", "engine/collision/BoxCollider", "engine/tiles/TileComponent", "engine/tiles/TileTransform", "engine/Entity", "game/world/elements/Hittable"], function (exports_50, context_50) {
    "use strict";
    var point_26, Tilesets_7, BoxCollider_6, TileComponent_7, TileTransform_9, Entity_6, Hittable_3, makeRock;
    ...
    return {
        ...
        execute: function () {
            exports_50("makeRock", makeRock = function (wl, pos) {
                ...
                e.addComponent(new BoxCollider_6.BoxCollider(pos.plus(new point_26.Point(.5, 1)).times(Tilesets_7.TILE_SIZE).minus(new point_26.Point(hitboxDims.x / 2, hitboxDims.y + 2)), hitboxDims));
                e.addComponent(new Hittable_3.Hittable(pos.plus(new point_26.Point(.5, .5)).times(Tilesets_7.TILE_SIZE), [tile.transform]));
                wl.stuff.set(pos, e);
            });
        }
    };
});
System.register("game/world/MapGenerator", ["engine/point", "engine/tiles/ConnectingTileSchema", "engine/tiles/ConnectingTile", "engine/Entity", "engine/collision/BoxCollider", "game/graphics/Tilesets", "game/world/WorldLocation", "game/world/elements/Campfire", "game/world/elements/Tent", "game/world/elements/Tree", "game/world/elements/Rock"], function (exports_51, context_51) {
    "use strict";
    var point_27, ConnectingTileSchema_1, ConnectingTile_2, Entity_7, BoxCollider_7, Tilesets_8, WorldLocation_1, Campfire_1, Tent_1, Tree_1, Rock_1, MAP_SIZE, MapGenerator;
    ...
    return {
        ...
        execute: function () {
            ...
            MapGenerator = /** @class */ (function () {
                function MapGenerator() {
                    this.oldPathSchema = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(9, 7)))
                        .angle(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(7, 7)))
                        .tShape(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(5, 8)))
                        .plusShape(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(7, 12)))
                        .cap(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(6, 11)))
                        .single(Tilesets_8.Tilesets.instance.outdoorTiles.getTileAt(new point_27.Point(8, 12)));
                    this.pathSchema = new ConnectingTileSchema_1.ConnectingTileSchema()
                        .vertical(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(2, 6)))
                        .angle(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(0, 5)))
                        .tShape(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(3, 5)))
                        .plusShape(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(5, 5)))
                        .cap(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(2, 6)))
                        .single(Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(7, 5)));
                ...
                MapGenerator.prototype.doIt = function () {
                    ...
                    // spawn tent
                    Tent_1.makeTent(this.location, new point_27.Point(5, 5), Tent_1.TentColor.RED, tentLocation);
                    // spawn campfire
                    var campfirePos = new point_27.Point(3, 9);
                    this.location.stuff.set(campfirePos, new Entity_7.Entity([new Campfire_1.Campfire(campfirePos)]));
                    // make the ground
                    this.renderPath(new point_27.Point(-10, -10), new point_27.Point(10, 10), this.pathSchema, 2);
                ...
                MapGenerator.prototype.spawnTrees = function () {
                    ...
                    for (var i = 0; i < trees; i++) {
                        var pt = new point_27.Point(Math.floor(Math.random() * MAP_SIZE) - MAP_SIZE / 2, Math.floor(Math.random() * (MAP_SIZE - 1)) - MAP_SIZE / 2);
                        var occupiedPoints = [pt, pt.plus(new point_27.Point(0, 1))];
                ...
                MapGenerator.prototype.spawnRocks = function () {
                    ...
                    while (placedRocks < 20) {
                        var p = new point_27.Point(Math.floor(Math.random() * MAP_SIZE) - MAP_SIZE / 2, Math.floor(Math.random() * (MAP_SIZE)) - MAP_SIZE / 2);
                ...
                MapGenerator.prototype.renderPath = function (start, end, tileSchema, randomness) {
                    ...
                    var isOccupiedFunc = function (pt) {
                        var _a;
                        if (!!((_a = stuff.get(pt)) === null || _a === void 0 ? void 0 : _a.getComponent(BoxCollider_7.BoxCollider))) {
                            return true;
                        }
                        var el = ground.get(pt);
                        if (!el) {
                    ...
                    path.forEach(function (pt) {
                        var entity = new Entity_7.Entity([
                ...
                MapGenerator.prototype.placeGrass = function () {
                    for (var i = -MAP_SIZE / 2; i < MAP_SIZE / 2; i++) {
                        for (var j = -MAP_SIZE / 2; j < MAP_SIZE / 2; j++) {
                            var pt = new point_27.Point(i, j);
                            if (!this.location.ground.get(pt)) {
                                var tile = void 0;
                                if (Math.random() < .65) {
                                    tile = Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(0, Math.floor(Math.random() * 4)));
                                }
                                else {
                                    tile = Tilesets_8.Tilesets.instance.tilemap.getTileAt(new point_27.Point(0, 7));
                                }
            ...
            exports_51("MapGenerator", MapGenerator);
        }
    };
});
System.register("game/characters/NPC", ["engine/component", "game/characters/Dude", "game/characters/Player", "engine/point"], function (exports_52, context_52) {
    "use strict";
    var component_12, Dude_4, Player_3, point_28, NPC;
...
System.register("game/characters/DudeFactory", ["engine/Entity", "game/characters/Player", "game/characters/Dude", "game/characters/NPC", "game/world/LocationManager"], function (exports_53, context_53) {
    "use strict";
    var Entity_8, Player_4, Dude_5, NPC_1, LocationManager_5, DudeFactory;
        ...
        execute: function () {
            DudeFactory = /** @class */ (function () {
                ...
                DudeFactory.prototype.make = function (archetype, pos, weapon) {
                    ...
                    var e = new Entity_8.Entity([new Dude_5.Dude(archetype, pos, weapon)].concat(additionalComponents));
                    LocationManager_5.LocationManager.instance.currentLocation.dynamic.add(e);
                    return e.getComponent(Dude_5.Dude);
                };
                return DudeFactory;
            }());
            exports_53("DudeFactory", DudeFactory);
        }
    };
});
System.register("game/ui/StringTiles", ["engine/component", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point"], function (exports_54, context_54) {
    "use strict";
    var component_13, Tilesets_9, TileTransform_10, point_29, StringTiles;
    ...
    return {
        ...
        execute: function () {
            StringTiles = /** @class */ (function (_super) {
                ...
                StringTiles.prototype.say = function (s) {
                    ...
                    this.tiles = Array.from(s).map(function (c, i) {
                        return Tilesets_9.Tilesets.instance.oneBit.getTileSource(c).toImageRender(new TileTransform_10.TileTransform(_this.topLeftPos.plus(new point_29.Point(10 * i, 0))));
                    });
                };
            ...
            exports_54("StringTiles", StringTiles);
        }
    };
});
System.register("game/ui/HUD", ["engine/tiles/AnimatedTileComponent", "game/graphics/Tilesets", "engine/tiles/TileTransform", "engine/point", "engine/tiles/TileComponent", "engine/Entity", "engine/renderer/BasicRenderComponent", "engine/renderer/TextRender"], function (exports_55, context_55) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            HUD = /** @class */ (function () {
                function HUD() {
                    this.entity = new Entity_9.Entity();
                    this.offset = new point_30.Point(4, 4);
                    this.coinsOffset = new point_30.Point(0, 18);
                    this.hearts = [];
                    // used for determining what should be updated
                    this.lastHealthCount = 0;
                    this.lastMaxHealthCount = 0;
                    this.lastCoinsCount = -1;
                    this.entity.addComponent(new AnimatedTileComponent_4.AnimatedTileComponent([Tilesets_10.Tilesets.instance.dungeonCharacters.getTileSetAnimation("coin_anim", 150)], new TileTransform_11.TileTransform(this.offset.plus(this.coinsOffset))));
                }
                ...
                HUD.prototype.updateCoins = function (coins) {
                    ...
                    this.coinCount = this.entity.addComponent(new BasicRenderComponent_2.BasicRenderComponent(new TextRender_2.TextRender("x" + coins, new point_30.Point(9, 9).plus(this.offset).plus(this.coinsOffset), "24px 'Press Start 2P'", "#facb3e")));
                };
                return HUD;
            }());
            exports_55("HUD", HUD);
...
System.register("game/quest_game", ["engine/point", "engine/game", "engine/View", "game/world/MapGenerator", "game/graphics/Tilesets", "game/characters/DudeFactory", "game/ui/HUD", "game/world/LocationManager"], function (exports_56, context_56) {
    "use strict";
    var point_31, game_1, View_2, MapGenerator_1, Tilesets_11, DudeFactory_1, HUD_1, LocationManager_6, ZOOM, QuestGame;
        ...
        execute: function () {
            ...
            QuestGame = /** @class */ (function (_super) {
                ...
                function QuestGame() {
                    ...
                    _this.tilesets = new Tilesets_11.Tilesets();
                ...
                QuestGame.prototype.initialize = function () {
                    ...
                    this.player = this.dudeFactory.newPlayer(new point_31.Point(-2, 2).times(Tilesets_11.TILE_SIZE));
                    // TEST: Spawn some guys
                    this.dudeFactory.newElf(new point_31.Point(20, 30));
                    this.dudeFactory.newImp(new point_31.Point(80, 30));
                };
            ...
            exports_56("QuestGame", QuestGame);
        }
    };
});
System.register("app", ["game/quest_game", "engine/engine", "game/graphics/Tilesets", "engine/Assets"], function (exports_57, context_57) {
    "use strict";
    var quest_game_1, engine_1, Tilesets_12, Assets_4;
    ...
    return {
        ...
        execute: function () {
            Assets_4.assets.loadImageFiles(Tilesets_12.Tilesets.getFilesToLoad()).then(function () {
                new engine_1.Engine(new quest_game_1.QuestGame(), document.getElementById('canvas'));
            });
        }
    };
});
System.register("engine/ui/Clickable", ["engine/component", "engine/util/utils"], function (exports_58, context_58) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_58("Clickable", Clickable);
        }
    };
});
