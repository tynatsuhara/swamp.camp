...
const KEYS = {
    ...
    workbench: new Point(49, 10),
    tentNW: new Point(46, 10),
    tentNE: new Point(47, 10),
    tentSW: new Point(46, 11),
    tentSE: new Point(47, 11),
    tentInterior: new Point(3, 25),
    tentCenter: new Point(4, 26),
    tentl: new Point(0, 26),
    tenttip: new Point(1, 26),
    tentr: new Point(2, 26),
    tentdropped: new Point(56, 25),
...
export class OutdoorTileset extends SingleFileTileLoader<keyof typeof KEYS> {
    constructor() {
        super("images/env_outdoor_recolor.png", KEYS)
    }
}
