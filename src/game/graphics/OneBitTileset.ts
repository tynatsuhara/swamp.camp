...
export class OneBitTileset extends SingleFileTileLoader {
    ...
    constructor() {
        super("images/monochrome_transparent_1_bit.png", new Map([
            ...
            ["invBoxN", new Point(17, 19)],
            ["invBoxNE", new Point(18, 19)],
            ["invBoxW", new Point(16, 20)],
            ["invBoxE", new Point(18, 20)],
            ["invBoxSW", new Point(16, 21)],
            ["invBoxS", new Point(17, 21)],
            ["invBoxSE", new Point(18, 21)],
            ["invBoxCenter", new Point(17, 20)],
