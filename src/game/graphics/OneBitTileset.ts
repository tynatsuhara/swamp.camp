...
export class OneBitTileset extends SingleFileTileLoader {
    ...
    constructor() {
        super("images/monochrome_transparent_1_bit.png", new Map([
            ...
            ["btnLeft", new Point(16, 17)],
            ["btnCenter", new Point(17, 17)],
            ["btnRight", new Point(18, 17)],
            ["btnLeft_hover", new Point(16, 18)],
            ["btnCenter_hover", new Point(17, 18)],
            ["btnRight_hover", new Point(18, 18)],
